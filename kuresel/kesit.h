...
struct _orst_kesit
{
  int                      sira;
  int                      no;
  struct _orst_kesitYigini gosterenler;
  struct _orst_kesitYigini gosterilenler;
  struct _orst_kesitYigini bedenler;
...
#define orsh_uretim_kesit_yeni_ekle(__Uretim, __Kesit, __ad)                   \
  orsh_temiz_tursuz(orst_kesit, __Kesit);                                      \
  {                                                                            \
    strcpy((__Kesit)->_ad, __ad);                                              \
    orsh_dizi_yapilandir((__Kesit)->yigin, 2);                                 \
    (__Kesit)->sira = (__Uretim)->birim.kesitler.boyut;                        \
    if((__Uretim)->birim.kesitler.boyut > 0)                                   \
    {                                                                          \
      sey __Sonuncu      = orsh_son_kesit((__Uretim));                         \
      (__Kesit)->onceki  = (__Sonuncu)->sira;                                  \
      __Sonuncu->sonraki = (__Kesit)->sira;                                    \
    }                                                                          \
    orsh_dizi_ekle((__Uretim)->birim.kesitler, __Kesit);                       \
    orsh_dizi_ekle((__Uretim)->birim.cop.kesitler, __Kesit);                   \
  }
...
#define orsh_uretim_kesit_yeni(__Uretim, __Kesit, __Kok, __ad)                 \
  ...
  {                                                                            \
    (__Kesit)->no  = -1;                                                       \
    (__Kesit)->Kok = __Kok;                                                    \
    orsh_imge_yeni_harflerden(__Imge,                                          \
                              Uretim->Derleme,                                 \
                              (__ad),                                          \
                              Ors_Imge_I_Kesit);                               \
    __Imge->icerik.IcKesit = __Kesit;                                          \
    orsh_imge_nesne_anlamlandir(__Imge,                                        \
...
#define orsh_uretim_kesit_ekle(__Uretim, __Kesit)                              \
  orsh_bagli_dizi_ekle((__Uretim)->yigin.Kesitler, __Kesit);

#define orsh_kesit_isle_ve_ekle(__Uretim, __Kesit)                             \
  {                                                                            \
    orsi_uretim_llvm_satir(Uretim, (__Kesit)->Oz);                             \
...
#define orsh_imge_ic_kosullu_git_yeni(__Ad,                                    \
                                      __Uretim,                                \
                                      __Kaynak,                                \
                                      __Konum,                                 \
                                      __EvetKonumu,                            \
  ...
  {                                                                            \
    orsh_temiz_altuye((__Ad)->icerik.IcKosulluGit);                            \
    (__Ad)->icerik.IcKosulluGit->Oz          = (__Ad);                         \
    (__Ad)->icerik.IcKosulluGit->EvetKonumu  = (__EvetKonumu);                 \
    (__Ad)->icerik.IcKosulluGit->HayirKonumu = (__HayirKonumu);                \
    (__Ad)->icerik.IcKosulluGit->Kosul       = __Kaynak;                       \
  }
...
#define orsh_imge_ic_git_yeni(__Ad, __Uretim, __Kaynak, __Konum)               \
  orsh_imge_yeni_nolu(__Ad,                                                    \
                      (__Uretim)->Derleme,                                     \
                      (__Kaynak)->kesit.Bas,                                   \
                      Ors_Imge_I_Git);                                         \
  {                                                                            \
    orsh_temiz_altuye((__Ad)->icerik.IcGit);                                   \
    (__Ad)->icerik.IcGit->Oz    = (__Ad);                                      \
    (__Ad)->icerik.IcGit->Konum = (__Konum);                                   \
  }
