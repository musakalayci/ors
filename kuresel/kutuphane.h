...
orsa_kume_kokler(orst_imge_kutuphane);
struct _orst_kume_kutuphane
{
  orsa_kume(orst_imge_kutuphane);
};
...
int                  orsi_kutuphane_Uzanti(struct _orst_derleme*,
                                           orst_imge_kutuphane*,
                                           char[],
                                           char _ayrac[]);
void                 orsi_kutuphane_Sil(orst_imge_kutuphane* Kutuphane);
orst_imge_kutuphane* orsi_kutuphane_Yeni(struct _orst_derleme*);
orst_imge_kutuphane* orsi_kutuphane_YeniMetinden(struct _orst_derleme*,
                                                 char _metin[]);
orst_imge_kutuphane* orsi_kutuphane_YeniSimgeden(struct _orst_derleme*,
                                                 orst_simge* Simge);
