...
t32 orsi_uretim_clang_Nesne(struct _orst_uretim* Uretim, orst_birim* Birim);
t32 orsi_uretim_clang_Tetik(struct _orst_uretim* Uretim, orst_urun* Urun);
t32 orsi_uretim_clang_Harici(struct _orst_uretim* Uretim, orst_urun* Urun);
