...
#define orsh_ayrac_gez(__i, __yol) for(__i = 1; i < (__yol).ayraclar.boyut; i++)
...
#define orsh_yol_yapilandir(__yol)                                             \
  {                                                                            \
    ...
    orsh_dizi_yapilandir((__yol).ayraclar, 10);                                \
  }
...
#define orsh_yol_dosya_yarat(__yol, __bilgi, __hata)                           \
  {                                                                            \
    ...
    {                                                                          \
      ...
      {                                                                        \
        orsd_hata_ver(Derleme->t, Ors_Hata_Is_Dosya_Bilgisi);                  \
