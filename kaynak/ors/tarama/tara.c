...
orst_simge*
orsi_tara(orst_derleme* Derleme)
{
    ...
    tekrar:
      switch(Tara->imlec.harf)
      {
        ...
        case Ors_Simge_Cift_Tirnak:
          return orsi_siradakiMetin(Tara);
        // Harf
        case Ors_Simge_Tek_Tirnak:
          return orsi_siradakiHarf(Tara);
        case Ors_Simge_Noktali_Virgul:
          return orsi_siradakiNoktaliVirgul(Tara);
        ...
        case Ors_Simge_Tilde:
        {
          ...
          switch(noktalama)
          {
                ...
                case '=':
                {
                  ...
                  switch(Tara->imlec.harf)
                  {
                    case '>':
                      noktalamaSonu++;
                      Simge->konum.sutun++;
                      Simge->durum.detay = Ors_Simgeler_C_Degistir;
                      ilerlet(Tara);
                      break;
                    default:
                      break;
            ...
            case '/':
            {
              ...
              {
                case '*':
                  return orsi_siradakiYorum(Tara);
                case '/':
                  return orsi_siradakiYorumSatiri(Tara);
                case '=':
                {
                  ors_cift_simge_ilerlet(Tara,
                                         Simge,
        ...
        case Ors_Simge_Alt_Tire:
          return orsi_siradakiSozcuk(Tara);
        default:
          return orsi_siradakiHata(Tara, Ors_Hata_Tarama_Simge_Bilinmiyor);
      }
    }
    break;
  }
...
orst_simge*
orsi_tara_tekil(orst_derleme* Derleme)
{
  orst_tarama* Tara                = Derleme->Tarama;
  orst_simge*  Simge               = BOS;
  t32          noktalamaBaslangici = Tara->imlec.konum;
