...
orst_imge_turKismi* orsi_cozumleme_turkismi_dizi(orst_cozumleme*,
...
orst_nesne* orsi_uretim_BosHazneElemani(orst_uretim*        Uretim,
...
orst_nesne* orsi_uretim_altyapiCagri(orst_uretim*, orst_imge_cagri*);
orst_nesne* orsi_uretim_sanalCagri(orst_uretim*, orst_imge_cagri*);
orst_nesne* orsi_uretim_sanalCagriTur(orst_uretim*, orst_imge_cagri*,
                                      orst_nesne*);
void        orsi_uretim_sanalCagriHazirlik(orst_uretim*, orst_imge_dagarcik*,
...
#define orsh_uretim_durdur(__Uretim, __kod) ((__Uretim)->durum = __kod)
