...
source_filename   = "./denemeler/imla/üretim/nesne/merkez/sys_oxf.o"
; Tür bilgileri:
%gt312 = type {i64, i64}
;imla::merkez::c::sys::timespec %gt312
%gt313 = type {i64, i64, i64, i32, i32, i32, i32, i64, i64, i64, i64, %gt312, %gt312, %gt312, [3 x i64]}
;imla::merkez::c::sys::stat_t %gt313
...
declare  i32 @stat (i8*, %gt313*)
; imla::merkez::c::sys::fstat
declare  i32 @fstat (i32, %gt313*)
; imla::merkez::c::sys::open
declare  i32 @open (i8*, i32, ...)
; imla::merkez::c::sys::lstat
declare  i32 @lstat (i8*, %gt313*)
