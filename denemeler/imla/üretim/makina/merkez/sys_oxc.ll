...
source_filename   = "./denemeler/imla/üretim/nesne/merkez/sys_oxc.o"
; Tür bilgileri:
%gt297 = type {i64, i64}
;imla::merkez::c::sys::timespec %gt297
%gt298 = type {i64, i64, i64, i32, i32, i32, i32, i64, i64, i64, i64, %gt297, %gt297, %gt297, [3 x i64]}
;imla::merkez::c::sys::stat_t %gt298
...
declare  i32 @stat (i8*, %gt298*)
; imla::merkez::c::sys::fstat
declare  i32 @fstat (i32, %gt298*)
; imla::merkez::c::sys::open
declare  i32 @open (i8*, i32, ...)
; imla::merkez::c::sys::lstat
declare  i32 @lstat (i8*, %gt298*)
