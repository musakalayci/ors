...
source_filename   = "./denemeler/imla/üretim/nesne/merkez/iletişim_ox18.o"
; Tür bilgileri:
...
@h.ox18.ox11f = private unnamed_addr constant 
...
; işlem : Dene 4
; imla::merkez::iletişim::Dene::"iletişim::Dene:ox18:1CD_i"
define external i32 @"iletişim::Dene:ox18:1CD_i" (%metin* %0, ...)
{
  ;Biçim
  ...
  %6 = call i32 (i8*,...) @printf(
    i8* getelementptr inbounds ([10 x i8], [10 x i8]* @h.ox18.ox11f, i64 0, i64 0), 
    %metin* %5)
...
define external i32 @"iletişim::Yaz:ox18:1CE_i" (%metin* %0, ...)
{
  ;Biçim
  %2 = alloca %metin*, align 8
  store
...
; işlem : Gönder 4
; imla::merkez::iletişim::Gönder::"iletişim::Gönder:ox18:1CF_i"
define external i32 @"iletişim::Gönder:ox18:1CF_i" (%FILE_yt* %0, %metin* %1, ...)
{
  ;Belge
...
define external i32 @"iletişim::Acil:ox18:1D0_i" (%metin* %0, ...)
{
  ;Biçim
  %2 = alloca %metin*, align 8
  store
