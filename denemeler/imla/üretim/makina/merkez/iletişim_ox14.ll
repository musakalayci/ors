...
source_filename   = "./denemeler/imla/üretim/nesne/merkez/iletişim_ox14.o"
; Tür bilgileri:
...
@h.ox14.ox111 = private unnamed_addr constant 
...
; işlem : Dene 4
; imla::merkez::iletişim::Dene::"iletişim::Dene:ox14:1BB_i"
define external i32 @"iletişim::Dene:ox14:1BB_i" (%metin* %0, ...)
{
  ;Biçim
  ...
  %6 = call i32 (i8*,...) @printf(
    i8* getelementptr inbounds ([10 x i8], [10 x i8]* @h.ox14.ox111, i64 0, i64 0), 
    %metin* %5)
...
define external i32 @"iletişim::Yaz:ox14:1BC_i" (%metin* %0, ...)
{
  ;Biçim
  %2 = alloca %metin*, align 8
  store
...
; işlem : Gönder 4
; imla::merkez::iletişim::Gönder::"iletişim::Gönder:ox14:1BD_i"
define external i32 @"iletişim::Gönder:ox14:1BD_i" (%FILE_yt* %0, %metin* %1, ...)
{
  ;Belge
...
; işlem : Acil 4
; imla::merkez::iletişim::Acil::"iletişim::Acil:ox14:1BE_i"
define external i32 @"iletişim::Acil:ox14:1BE_i" (%metin* %0, ...)
{
  ;Biçim
  %2 = alloca %metin*, align 8
  store
