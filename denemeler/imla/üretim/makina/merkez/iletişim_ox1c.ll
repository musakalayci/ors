...
source_filename   = "./denemeler/imla/üretim/nesne/merkez/iletişim_ox1c.o"
; Tür bilgileri:
...
@h.ox1c.ox121 = private unnamed_addr constant 
...
; işlem : Dene 4
; imla::merkez::iletişim::Dene::"iletişim::Dene:ox1C:1EF_i"
define external i32 @"iletişim::Dene:ox1C:1EF_i" (%metin* %0, ...)
{
  ;Biçim
  ...
  %6 = call i32 (i8*,...) @printf(
    i8* getelementptr inbounds ([10 x i8], [10 x i8]* @h.ox1c.ox121, i64 0, i64 0), 
    %metin* %5)
...
define external i32 @"iletişim::Yaz:ox1C:1F0_i" (%metin* %0, ...)
{
  ;Biçim
  %2 = alloca %metin*, align 8
  store
...
; işlem : Gönder 4
; imla::merkez::iletişim::Gönder::"iletişim::Gönder:ox1C:1F1_i"
define external i32 @"iletişim::Gönder:ox1C:1F1_i" (%FILE_yt* %0, %metin* %1, ...)
{
  ;Belge
...
; işlem : Acil 4
; imla::merkez::iletişim::Acil::"iletişim::Acil:ox1C:1F2_i"
define external i32 @"iletişim::Acil:ox1C:1F2_i" (%metin* %0, ...)
{
  ;Biçim
  %2 = alloca %metin*, align 8
  store
