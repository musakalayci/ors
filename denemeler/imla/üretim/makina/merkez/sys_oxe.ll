...
source_filename   = "./denemeler/imla/üretim/nesne/merkez/sys_oxe.o"
; Tür bilgileri:
%gt301 = type {i64, i64}
;imla::merkez::c::sys::timespec %gt301
%gt302 = type {i64, i64, i64, i32, i32, i32, i32, i64, i64, i64, i64, %gt301, %gt301, %gt301, [3 x i64]}
;imla::merkez::c::sys::stat_t %gt302
...
declare  i32 @stat (i8*, %gt302*)
; imla::merkez::c::sys::fstat
declare  i32 @fstat (i32, %gt302*)
; imla::merkez::c::sys::open
declare  i32 @open (i8*, i32, ...)
; imla::merkez::c::sys::lstat
declare  i32 @lstat (i8*, %gt302*)
