...
source_filename   = "./denemeler/imla/üretim/nesne/merkez/iletişim_ox1a.o"
; Tür bilgileri:
...
@h.ox1a.ox121 = private unnamed_addr constant 
...
; işlem : Dene 4
; imla::merkez::iletişim::Dene::"iletişim::Dene:ox1A:1DD_i"
define external i32 @"iletişim::Dene:ox1A:1DD_i" (%metin* %0, ...)
{
  ;Biçim
  ...
  %6 = call i32 (i8*,...) @printf(
    i8* getelementptr inbounds ([10 x i8], [10 x i8]* @h.ox1a.ox121, i64 0, i64 0), 
    %metin* %5)
...
; işlem : Yaz 4
; imla::merkez::iletişim::Yaz::"iletişim::Yaz:ox1A:1DE_i"
define external i32 @"iletişim::Yaz:ox1A:1DE_i" (%metin* %0, ...)
{
  ;Biçim
  %2 = alloca %metin*, align 8
  store
...
; işlem : Gönder 4
; imla::merkez::iletişim::Gönder::"iletişim::Gönder:ox1A:1DF_i"
define external i32 @"iletişim::Gönder:ox1A:1DF_i" (%FILE_yt* %0, %metin* %1, ...)
{
  ;Belge
...
; işlem : Acil 4
; imla::merkez::iletişim::Acil::"iletişim::Acil:ox1A:1E0_i"
define external i32 @"iletişim::Acil:ox1A:1E0_i" (%metin* %0, ...)
{
  ;Biçim
  %2 = alloca %metin*, align 8
  store
