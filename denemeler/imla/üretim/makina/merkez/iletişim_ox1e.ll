...
source_filename   = "./denemeler/imla/üretim/nesne/merkez/iletişim_ox1e.o"
; Tür bilgileri:
...
@h.ox1e.ox15e = private unnamed_addr constant 
...
; işlem : Dene 4
; imla::merkez::iletişim::Dene::"iletişim::Dene:ox1E:20A_i"
define external i32 @"iletişim::Dene:ox1E:20A_i" (%metin* %0, ...)
{
  ;Biçim
  ...
  %6 = call i32 (i8*,...) @printf(
    i8* getelementptr inbounds ([10 x i8], [10 x i8]* @h.ox1e.ox15e, i64 0, i64 0), 
    %metin* %5)
...
define external i32 @"iletişim::Yaz:ox1E:20B_i" (%metin* %0, ...)
{
  ;Biçim
  %2 = alloca %metin*, align 8
  store
...
; işlem : Gönder 4
; imla::merkez::iletişim::Gönder::"iletişim::Gönder:ox1E:20C_i"
define external i32 @"iletişim::Gönder:ox1E:20C_i" (%FILE_yt* %0, %metin* %1, ...)
{
  ;Belge
...
define external i32 @"iletişim::Acil:ox1E:20D_i" (%metin* %0, ...)
{
  ;Biçim
  %2 = alloca %metin*, align 8
  store
