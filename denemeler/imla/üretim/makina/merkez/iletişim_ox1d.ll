...
source_filename   = "./denemeler/imla/üretim/nesne/merkez/iletişim_ox1d.o"
; Tür bilgileri:
...
@h.ox1d.ox12c = private unnamed_addr constant 
...
; işlem : Dene 4
; imla::merkez::iletişim::Dene::"iletişim::Dene:ox1D:1F2_i"
define external i32 @"iletişim::Dene:ox1D:1F2_i" (%metin* %0, ...)
{
  ;Biçim
  ...
  %6 = call i32 (i8*,...) @printf(
    i8* getelementptr inbounds ([10 x i8], [10 x i8]* @h.ox1d.ox12c, i64 0, i64 0), 
    %metin* %5)
...
define external i32 @"iletişim::Yaz:ox1D:1F3_i" (%metin* %0, ...)
{
  ;Biçim
  %2 = alloca %metin*, align 8
  store
...
; işlem : Gönder 4
; imla::merkez::iletişim::Gönder::"iletişim::Gönder:ox1D:1F4_i"
define external i32 @"iletişim::Gönder:ox1D:1F4_i" (%FILE_yt* %0, %metin* %1, ...)
{
  ;Belge
...
; işlem : Acil 4
; imla::merkez::iletişim::Acil::"iletişim::Acil:ox1D:1F5_i"
define external i32 @"iletişim::Acil:ox1D:1F5_i" (%metin* %0, ...)
{
  ;Biçim
  %2 = alloca %metin*, align 8
  store
