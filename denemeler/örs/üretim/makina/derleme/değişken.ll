...
define external %gt25ft* 
@"değişken::Yeni_ox130i"(%gt1e0t* %0, %metin* %1, i32 %2)#0       {
; Değişken : dönüş
  %4 = alloca %gt25ft*, align 8
  store %gt25ft* null, %gt25ft** %4, align 8
; Değişken : Hafıza
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  %13 = call i8* (%gt1e0t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      ...
      i64 8)
; Konum çevirisi:
  %14 = bitcast i8* %13 to %gt25ft*; 1

; pascal 'Değişken' örs::derleme::imge::değişken::t
  %15 = alloca %gt25ft*, align 8
  store 
    %gt25ft* %14,
    %gt25ft** %15,
    align 8
; Atama ifadesi
  %16 = load %gt25ft*, %gt25ft** %15, align 8; 2:0
...
;atama:
  store 
    ...
    align 8
; Atama ifadesi
  %19 = load %gt25ft*, %gt25ft** %15, align 8; 2:0
...
;;-> (nil) 0
  ...
  %22 = call %gt26ft* @"cins::YeniÖzet_ox10Bi" (
      %gt1e0t* %21, 
      ptr null)
;atama:
  store 
    ...
    align 8
; Atama ifadesi
  %23 = load %gt231t*, %gt231t** %11, align 8; 2:0
...
; Konum çevirisi:
  %25 = bitcast %gt230t* %24 to %gt25ft**; 2
  %26 = load %gt25ft*, %gt25ft** %15, align 8; 2:0
;atama:
  store 
    %gt25ft* %26,
    %gt25ft** %25,
    align 8
  %27 = load %gt25ft*, %gt25ft** %15, align 8; 2:0
; Dönüş :
  ret %gt25ft* %27
}
