...
define external %gt2dbt* 
@"işlem::Yeni_i"(%gt263t* %0, %metin* %1)#0       !dbg !1144 {
; Değişken : dönüş
  %3 = alloca %gt2dbt*, align 8
  store %gt2dbt* null, %gt2dbt** %3, align 8
; Değişken : Hafıza
...
; Değişken : Ad
  ...
  call void @llvm.dbg.declare(metadata %metin** %5, metadata !1150, metadata !DIExpression()), !dbg !1154
;;-> (nil) 0
  %6 = load %gt263t*, %gt263t** %4, align 8, !dbg !1156; 2:0
;;-> (nil) 0
  %7 = load %metin*, %metin** %5, align 8, !dbg !1157; 2:0
;;-> (nil) 0
  %8 = call %gt2c2t* @"imge::Adlı_i" (
      %gt263t* %6, 
      %metin* %7, 
      i32 267), !dbg !1158
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt2c2t** %9,
    align 8, !dbg !1159
  call void @llvm.dbg.declare(metadata %gt2c2t** %9, metadata !1161, metadata !DIExpression()), !dbg !1162
  %10 = load %gt263t*, %gt263t** %4, align 8, !dbg !1163; 2:0
  %11 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      %gt263t* %10, 
      i64 64, 
      i64 8), !dbg !1164
; Konum çevirisi:
  %12 = bitcast i8* %11 to %gt2dbt*; 1

; pascal 'İşlem' örs::derleme::imge::işlem::t
  %13 = alloca %gt2dbt*, align 8
  store 
    %gt2dbt* %12,
    %gt2dbt** %13,
    align 8, !dbg !1165
  call void @llvm.dbg.declare(metadata %gt2dbt** %13, metadata !1167, metadata !DIExpression()), !dbg !1168
; Atama ifadesi
  %14 = load %gt2dbt*, %gt2dbt** %13, align 8, !dbg !1169; 2:0
; tür konumu *örs::derleme::imge::işlem::t : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt2dbt, %gt2dbt* %14,
    i32 0, i32 3
  %16 = load %gt2c2t*, %gt2c2t** %9, align 8, !dbg !1171; 2:0
  store 
    %gt2c2t* %16,
    %gt2c2t** %15,
    align 8, !dbg !1172
; Atama ifadesi
  %17 = load %gt2dbt*, %gt2dbt** %13, align 8, !dbg !1173; 2:0
; tür konumu *örs::derleme::imge::işlem::t : *d32
  %18 = getelementptr inbounds 
    %gt2dbt, %gt2dbt* %17,
    i32 0, i32 0
  %19 = load %gt263t*, %gt263t** %4, align 8, !dbg !1175; 2:0
; tür konumu *örs::derleme::hafıza::t : *örs::derleme::t
  %20 = getelementptr inbounds 
    %gt263t, %gt263t* %19,
    i32 0, i32 3
  %21 = load %gt20et*, %gt20et** %20, align 8, !dbg !1177; 2:0
; tür konumu *örs::derleme::t : *örs::derleme::sayaçlar
  ...
  store 
    ...
    align 4, !dbg !1180
; Atama ifadesi
  %24 = load %gt2dbt*, %gt2dbt** %13, align 8, !dbg !1181; 2:0
; tür konumu *örs::derleme::imge::işlem::t : *örs::derleme::imge::dağarcık::t
  %25 = getelementptr inbounds 
    %gt2dbt, %gt2dbt* %24,
    i32 0, i32 6
;;-> (nil) 0
  %26 = load %gt263t*, %gt263t** %4, align 8, !dbg !1183; 2:0
  %27 = call %gt2f0t* @"dağarcık::Yeni_i" (
      %gt263t* %26, 
      i32 0), !dbg !1184
  store 
    %gt2f0t* %27,
    ...
    align 8, !dbg !1185
; Atama ifadesi
  %28 = load %gt2c2t*, %gt2c2t** %9, align 8, !dbg !1186; 2:0
...
; Konum çevirisi:
  %30 = bitcast %gt2c1t* %29 to %gt2dbt**; 2
  %31 = load %gt2dbt*, %gt2dbt** %13, align 8, !dbg !1188; 2:0
  store 
    %gt2dbt* %31,
    %gt2dbt** %30,
    align 8, !dbg !1189
  %32 = load %gt2dbt*, %gt2dbt** %13, align 8, !dbg !1190; 2:0
; Dönüş :
  ret %gt2dbt* %32
}
...
;örs::derleme::imge::dağarcık::Yeni
  declare %gt2f0t* @"dağarcık::Yeni_i"(%gt263t*, i32) #0
...
!1143 = !DINamespace(name:"işlem", scope: !1142)


!1145 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !667, size: 64)
...
!1148 = !DILocalVariable(name: "Hafıza",
  scope: !1144, file: !9, line: 22, type: !1147, arg: 1)
!1150 = !DILocalVariable(name: "Ad",
  scope: !1144, file: !9, line: 22, type: !1149, arg: 2)
!1151 = !DISubroutineType(types: !1152)
!1152 = !{null, !1147, !1149 }
!1144 = distinct !DISubprogram( name: "işlem::Yeni_i",
 scope: !1143,
 file: !9,
 line: 22,
 type: !1151, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1153 = !DILocation(line: 22, column: 19, scope: !1144)
!1154 = !DILocation(line: 22, column: 38, scope: !1144)
!1155 = distinct !DILexicalBlock(
        scope: !1144, file: !9, line: 23, column: 3)
!1156 = !DILocation(line: 24, column: 37, scope: !1155)
!1157 = !DILocation(line: 24, column: 45, scope: !1155)
!1158 = !DILocation(line: 24, column: 32, scope: !1155)
!1159 = !DILocation(line: 24, column: 5, scope: !1155)
!1160 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1161 = !DILocalVariable(name: "İmge",
  scope: !1155, file: !9, line: 24, type: !1160)
!1162 = !DILocation(line: 24, column: 5, scope: !1155)
!1163 = !DILocation(line: 25, column: 30, scope: !1155)
!1164 = !DILocation(line: 25, column: 38, scope: !1155)
!1165 = !DILocation(line: 25, column: 5, scope: !1155)
!1166 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !667, size: 64)
!1167 = !DILocalVariable(name: "İşlem",
  scope: !1155, file: !9, line: 25, type: !1166)
!1168 = !DILocation(line: 25, column: 5, scope: !1155)
!1169 = !DILocation(line: 26, column: 5, scope: !1155)
!1170 = !DILocation(line: 26, column: 5, scope: !1155)
!1171 = !DILocation(line: 26, column: 26, scope: !1155)
!1172 = !DILocation(line: 26, column: 5, scope: !1155)
!1173 = !DILocation(line: 27, column: 5, scope: !1155)
!1174 = !DILocation(line: 27, column: 5, scope: !1155)
!1175 = !DILocation(line: 27, column: 26, scope: !1155)
!1176 = !DILocation(line: 27, column: 26, scope: !1155)
!1177 = !DILocation(line: 27, column: 26, scope: !1155)
!1178 = !DILocation(line: 27, column: 26, scope: !1155)
!1179 = !DILocation(line: 27, column: 52, scope: !1155)
!1180 = !DILocation(line: 27, column: 5, scope: !1155)
!1181 = !DILocation(line: 28, column: 5, scope: !1155)
!1182 = !DILocation(line: 28, column: 5, scope: !1155)
!1183 = !DILocation(line: 28, column: 47, scope: !1155)
!1184 = !DILocation(line: 28, column: 42, scope: !1155)
!1185 = !DILocation(line: 28, column: 5, scope: !1155)
!1186 = !DILocation(line: 29, column: 5, scope: !1155)
!1187 = !DILocation(line: 29, column: 5, scope: !1155)
!1188 = !DILocation(line: 29, column: 26, scope: !1155)
!1189 = !DILocation(line: 29, column: 5, scope: !1155)
!1190 = !DILocation(line: 30, column: 9, scope: !1155)
