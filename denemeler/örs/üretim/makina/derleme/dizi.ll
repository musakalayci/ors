...
%st435_1i8 = type {%gt1e0t*, i32, i32, i8**}
;örs::derleme::hafıza::dizi::k[%st435_1i8]
; ./denemeler/örs/kaynak/derleme/hafıza/dizi.örs:7:9 [150:151]
;siralama : 8, boyut :24, no: 1562

%st435_1metin = type {%gt1e0t*, i32, i32, %metin**}
;örs::derleme::hafıza::dizi::k[%st435_1metin]
; ./denemeler/örs/kaynak/derleme/hafıza/dizi.örs:7:9 [150:151]
;siralama : 8, boyut :24, no: 1570

%gt1bbt = type {%st435_1i8}
;örs::derleme::hafıza::dizi::k[%st435_1i8]
; ./denemeler/örs/kaynak/derleme/hafıza/dizi.örs:85:7 [1664:1666]
;siralama : 8, boyut :24, no: 1562

%gt1bdt = type {%st435_1metin}
;örs::derleme::hafıza::dizi::k[%st435_1metin]
...
define external i8* 
@"dizi::Yeni_ox120i"(%gt1e0t* %0, i32 %1)#0       {
; Değişken : dönüş
  %3 = alloca i8*, align 8
...
; Değişken : boyut
  ...
  %7 = call i8* (%gt1e0t*,i64) @"hafıza::t.Dizi_ox107i" (
      %gt1e0t* %6, 
      i64 24)
; Konum çevirisi:
  %8 = bitcast i8* %7 to %st435_1i8*; 1

; pascal 'Dizi' örs::derleme::hafıza::dizi::k[%st435_1i8]
  %9 = alloca %st435_1i8*, align 8
  store 
    %st435_1i8* %8,
    %st435_1i8** %9,
    align 8
  %10 = load %st435_1i8*, %st435_1i8** %9, align 8; 2:0
; Tür sanal çağrı Yapılandır-> *örs::derleme::hafıza::dizi::k[%st435_1i8]
; Atama ifadesi
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1i8] : *örs::derleme::hafıza::t
  %11 = getelementptr inbounds 
    %st435_1i8, %st435_1i8* %10,
    i32 0, i32 0
...
; pascal 'tamlanmış' *t32
  ...
  store 
    ...
    align 4
; Atama ifadesi
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1i8] : *t32
...
;atama:
  store 
    ...
    align 4
; Atama ifadesi
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1i8] : **t8
  %21 = getelementptr inbounds 
    %st435_1i8, %st435_1i8* %10,
    i32 0, i32 3
  %22 = load %gt1e0t*, %gt1e0t** %4, align 8; 2:0
; Ikiz işlem '*'
  %23 = load i32, i32* %18, align 4; 1:0
  %24 = sext i32 %23 to i64;eie??
  %25 = mul i64 %24, 8
  %26 = call i8* (%gt1e0t*,i64) @"hafıza::t.Dizi_ox107i" (
      %gt1e0t* %22, 
      i64 %25)
; Konum çevirisi:
...
;;-> (nil) 3
  ...
  %5 = call %gt1e0t* @"hafıza::Yeni_ox107i" (
      %gtfet %4)
...
; Değer 'Metinler'
  %9 = alloca %st435_1metin, align 8
  %10 = bitcast %st435_1metin* %9 to i8*
  call void @llvm.memset.p0i8.i64(
    ...
    i1 false)
;;-> (nil) 4
  %11 = load %gt1e0t*, %gt1e0t** %6, align 8; 2:0
...
; Değer 'bellek'
  %12 = alloca %gt380t, align 4
  %13 = bitcast %gt380t* %12 to i8*
  call void @llvm.memset.p0i8.i64(
    i8* align 4 %13, 
    i8 0, 
    i64 4104, 
...
; tür konumu *örs::merkez::bellek::t : *t8[]
  %25 = getelementptr inbounds 
    ...
    i32 0, i32 2
;;-> 0x6247707a7838 14
  %26 = call %metin* (%gt1e0t*,i8*) @"hafıza::t.Harflerden_ox107i" (
      %gt1e0t* %24, 
      [4096 x i8]* %25)
...
her.son.ox0:
  %32 = call i32 @"iletişim::Yaz_ox136i" (
      %metin* getelementptr inbounds (%metin, %metin* @m.ox288.ox9, i64 0))
  %33 = call i32 @"iletişim::Yaz_ox136i" (
      %metin* getelementptr inbounds (%metin, %metin* @m.ox288.ox11, i64 0))
...
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *t32
  %36 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %9,
    i32 0, i32 1
...
; Tekil :
  ...
  store 
    ...
    i32* %34,
    align 4
  %42 = load i32, i32* %34, align 4; 1:0
  br label %her.kosul.ox4
her.beden.ox4:

; Değer 'Gelen'
  %43 = alloca %metin*, align 8
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : **örs::üzengi::metin
  %44 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %9,
    i32 0, i32 3
;dizi erişim2 Nesneler
  %45 = load %metin**, %metin*** %44, align 8; 3:0
;dizi erişim2 Nesneler
  %46 = load i32, i32* %34, align 4; 1:0
...
;tekil
  ...
  store 
    ...
    %metin** %43,
    align 8
  %50 = load %metin*, %metin** %43, align 8; 2:0
...
her.son.ox4:
 call void @"dizi::_metinler.Temizle_ox120i" (
      %st435_1metin* %9)
  %54 = load %gt1e0t*, %gt1e0t** %6, align 8; 2:0
 call void @"hafıza::t.Temizle_ox107i" (
      %gt1e0t* %54)
; Sil : 
  %55 = load %gt1e0t*, %gt1e0t** %6, align 8; 2:0
  call void @free(
    ptr %55)
...
define external 
%metin* @"dizi::_metinler.Son_ox120i"(%st435_1metin* %0)
#0       {
; Değişken : dönüş
  %2 = alloca %metin*, align 8
  store %metin* null, %metin** %2, align 8
; Değişken : Dizi
  %3 = alloca %st435_1metin*, align 8
  store %st435_1metin* %0, %st435_1metin** %3, align 8
; Eğer ardılsız:
  br label %egera.ox0
egera.ox0:
; Karşılaştırma
  %4 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *t32
  %5 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %4,
    i32 0, i32 1
...
egera.beden.ox0:
  %9 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : **örs::üzengi::metin
  %10 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %9,
    i32 0, i32 3
;dizi erişim2 Nesneler
  %11 = load %metin**, %metin*** %10, align 8; 3:0
;dizi erişim2 Nesneler
; Ikiz işlem '-'
  %12 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *t32
  %13 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %12,
    i32 0, i32 1
...
define external 
void @"dizi::_metinler.Ekle_ox120i"(%st435_1metin* %0, %metin* %1)
#0       {
; Değişken : Dizi
  %3 = alloca %st435_1metin*, align 8
  store %st435_1metin* %0, %st435_1metin** %3, align 8
...
egera.ox0:
; Karşılaştırma
  %5 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *t32
  %6 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %5,
    i32 0, i32 1
  %7 = load i32, i32* %6, align 4; 1:0
  %8 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *t32
  %9 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %8,
    i32 0, i32 2
...
egera.beden.ox0:
  %13 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *t32
  %14 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %13,
    i32 0, i32 2
...
; pascal 'eski' *t32
  ...
  store 
    ...
    i32* %16,
    align 4
  %17 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *t32
  %18 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %17,
    i32 0, i32 2
  ...
  store 
    ...
    i32* %18,
    align 4
  %21 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *örs::derleme::hafıza::t
  %22 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %21,
    i32 0, i32 0
  %23 = load %gt1e0t*, %gt1e0t** %22, align 8; 2:0
; Ikiz işlem '*'
  %24 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *t32
  %25 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %24,
    i32 0, i32 2
...
; Karşılaştırma
  ...
  %34 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *t32
  %35 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %34,
    i32 0, i32 1
...
; Dizi erişim Yeni
  ...
  %43 = load %metin***, %metin**** %31, align 8; 4:0
  %44 = sext i32 %42 to i64;eie??
;tekil
  %45 = getelementptr inbounds
     %metin**, %metin***  %43,
     i64 %44
  %46 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : **örs::üzengi::metin
  %47 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %46,
    i32 0, i32 3
;dizi erişim2 Nesneler
  %48 = load %metin**, %metin*** %47, align 8; 3:0
;dizi erişim2 Nesneler
...
;tekil
  %51 = getelementptr inbounds
     %metin*, %metin**  %48,
     i64 %50
  %52 = load %metin*, %metin** %51, align 8; 2:0
;atama:
  store 
    %metin* %52,
    %metin*** %45,
...
her.son.ox2:
  %53 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *örs::derleme::hafıza::t
  %54 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %53,
    i32 0, i32 0
  %55 = load %gt1e0t*, %gt1e0t** %54, align 8; 2:0
  %56 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : **örs::üzengi::metin
  %57 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %56,
    i32 0, i32 3
;;-> (nil) 14
  %58 = load %metin**, %metin*** %57, align 8; 3:0
; Konum çevirisi:
 ...
 call void @"hafıza::t.Bırak_ox107i" (
      ...
      i8* %59)
; Atama ifadesi
  %60 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : **örs::üzengi::metin
  %61 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %60,
    i32 0, i32 3
  %62 = load %metin***, %metin**** %31, align 8; 4:0
;atama:
  store 
    %metin*** %62,
    %metin*** %61,
...
egera.son.ox0:
; Atama ifadesi
  %63 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : **örs::üzengi::metin
  %64 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %63,
    i32 0, i32 3
;dizi erişim2 Nesneler
  %65 = load %metin**, %metin*** %64, align 8; 3:0
;dizi erişim2 Nesneler
  %66 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *t32
  %67 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %66,
    i32 0, i32 1
...
;tekil
  %70 = getelementptr inbounds
     %metin*, %metin**  %65,
     i64 %69
  %71 = load %metin*, %metin** %4, align 8; 2:0
;atama:
  store 
    %metin* %71,
    %metin** %70,
    align 8
; Tekil :
  %72 = load %st435_1metin*, %st435_1metin** %3, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *t32
  %73 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %72,
    i32 0, i32 1
...
define external 
void @"dizi::_metinler.Temizle_ox120i"(%st435_1metin* %0)
#0       {
; Değişken : Dizi
  %2 = alloca %st435_1metin*, align 8
  store %st435_1metin* %0, %st435_1metin** %2, align 8
  %3 = load %st435_1metin*, %st435_1metin** %2, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *örs::derleme::hafıza::t
  %4 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %3,
    i32 0, i32 0
...
; pascal 'Hafıza' *örs::derleme::hafıza::t
  ...
  store 
    ...
    align 8
  %7 = load %gt1e0t*, %gt1e0t** %6, align 8; 2:0
  %8 = load %st435_1metin*, %st435_1metin** %2, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : **örs::üzengi::metin
  %9 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %8,
    i32 0, i32 3
;;-> (nil) 14
  %10 = load %metin**, %metin*** %9, align 8; 3:0
; Konum çevirisi:
...
define external 
void @"dizi::_metinler.Sil_ox120i"(%st435_1metin* %0)
#0       {
; Değişken : Dizi
  %2 = alloca %st435_1metin*, align 8
  store %st435_1metin* %0, %st435_1metin** %2, align 8
...
;;-> (nil) 0
  %13 = load %st435_1metin*, %st435_1metin** %2, align 8; 2:0
; Konum çevirisi:
  %14 = bitcast %st435_1metin* %13 to i8*; 1
 call void @"hafıza::t.Bırak_ox107i" (
      %gt1e0t* %12, 
      i8* %14)
; Iç Dönüş :
...
define external 
void @"dizi::_metinler.Yapılandır_ox120i"(%st435_1metin* %0, %gt1e0t* %1, i32 %2)
#0       {
; Değişken : Dizi
  %4 = alloca %st435_1metin*, align 8
  store %st435_1metin* %0, %st435_1metin** %4, align 8
; Değişken : Hafıza
...
; Atama ifadesi
  %7 = load %st435_1metin*, %st435_1metin** %4, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *örs::derleme::hafıza::t
  %8 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %7,
    i32 0, i32 0
...
; pascal 'tamlanmış' *t32
  ...
  store 
    ...
    align 4
; Atama ifadesi
  %16 = load %st435_1metin*, %st435_1metin** %4, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *t32
  %17 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %16,
    i32 0, i32 2
...
;atama:
  store 
    ...
    align 4
; Atama ifadesi
  %19 = load %st435_1metin*, %st435_1metin** %4, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : **örs::üzengi::metin
  %20 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %19,
    i32 0, i32 3
...
define external 
void @"dizi::_metinler.Sıfırla_ox120i"(%st435_1metin* %0)
#0       {
; Değişken : Dizi
  %2 = alloca %st435_1metin*, align 8
  store %st435_1metin* %0, %st435_1metin** %2, align 8
...
; Karşılaştırma
  ...
  %5 = load %st435_1metin*, %st435_1metin** %2, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *t32
  %6 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %5,
    i32 0, i32 2
...
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : **örs::üzengi::metin
  %14 = getelementptr inbounds 
    ...
    i32 0, i32 3
;dizi erişim2 Nesneler
  %15 = load %metin**, %metin*** %14, align 8; 3:0
;dizi erişim2 Nesneler
...
her.son.ox0:
; Atama ifadesi
  %19 = load %st435_1metin*, %st435_1metin** %2, align 8; 2:0
; tür konumu *örs::derleme::hafıza::dizi::k[%st435_1metin] : *t32
  %20 = getelementptr inbounds 
    %st435_1metin, %st435_1metin* %19,
    i32 0, i32 1
