...
%gt2fct = type {%gt2c2t*, %gt2c2t*, %gt2f7t*, %gt2f7t*}
;örs::derleme::imge::kesit::koşulluGit
; ./denemeler/örs/kaynak/derleme/imge/kesit.örs:49:7 [845:856]
;siralama : 8, boyut :32, no: 764
...
define external 
%gt2f8t* @"kesit::_git.Yeni_i"(%gt263t* %0)
#0       !dbg !1154 {
; Değişken : dönüş
  %2 = alloca %gt2f8t*, align 8
  store %gt2f8t* null, %gt2f8t** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt263t*, align 8
  store %gt263t* %0, %gt263t** %3, align 8
  call void @llvm.dbg.declare(metadata %gt263t** %3, metadata !1158, metadata !DIExpression()), !dbg !1161
  %4 = load %gt263t*, %gt263t** %3, align 8, !dbg !1163; 2:0
  %5 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      %gt263t* %4, 
      i64 24, 
      i64 8), !dbg !1164
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt2f8t*; 1

; pascal 'Git' örs::derleme::imge::kesit::_git
  %7 = alloca %gt2f8t*, align 8
  store 
    %gt2f8t* %6,
    %gt2f8t** %7,
    align 8, !dbg !1165
  call void @llvm.dbg.declare(metadata %gt2f8t** %7, metadata !1167, metadata !DIExpression()), !dbg !1168
;;-> (nil) 0
  %8 = load %gt263t*, %gt263t** %3, align 8, !dbg !1169; 2:0
;;-> (nil) 0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt2c2t** %10,
    align 8, !dbg !1171
  call void @llvm.dbg.declare(metadata %gt2c2t** %10, metadata !1173, metadata !DIExpression()), !dbg !1174
; Atama ifadesi
  %11 = load %gt2c2t*, %gt2c2t** %10, align 8, !dbg !1175; 2:0
...
; Konum çevirisi:
  %13 = bitcast %gt2c1t* %12 to %gt2f8t**; 2
  %14 = load %gt2f8t*, %gt2f8t** %7, align 8, !dbg !1177; 2:0
  store 
    %gt2f8t* %14,
    %gt2f8t** %13,
    align 8, !dbg !1178
; Atama ifadesi
  %15 = load %gt2f8t*, %gt2f8t** %7, align 8, !dbg !1179; 2:0
; tür konumu *örs::derleme::imge::kesit::_git : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt2f8t, %gt2f8t* %15,
    i32 0, i32 0
  %17 = load %gt2c2t*, %gt2c2t** %10, align 8, !dbg !1181; 2:0
  store 
    %gt2c2t* %17,
    %gt2c2t** %16,
    align 8, !dbg !1182
  %18 = load %gt2f8t*, %gt2f8t** %7, align 8, !dbg !1183; 2:0
; Dönüş :
  ret %gt2f8t* %18
}

define external 
%gt2fat* @"kesit::içGit.Yeni_i"(%gt263t* %0, i32 %1)
#0       !dbg !1184 {
; Değişken : dönüş
  %3 = alloca %gt2fat*, align 8
  store %gt2fat* null, %gt2fat** %3, align 8
; Değişken : Hafıza
  %4 = alloca %gt263t*, align 8
  store %gt263t* %0, %gt263t** %4, align 8
  call void @llvm.dbg.declare(metadata %gt263t** %4, metadata !1188, metadata !DIExpression()), !dbg !1192
; Değişken : özellik
  %5 = alloca i32, align 4
  store i32 %1, i32* %5, align 4
  call void @llvm.dbg.declare(metadata i32* %5, metadata !1189, metadata !DIExpression()), !dbg !1193
  %6 = load %gt263t*, %gt263t** %4, align 8, !dbg !1195; 2:0
  %7 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      %gt263t* %6, 
      i64 16, 
      i64 8), !dbg !1196
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt2fat*; 1

; pascal 'Git' örs::derleme::imge::kesit::içGit
  %9 = alloca %gt2fat*, align 8
  store 
    %gt2fat* %8,
    %gt2fat** %9,
    align 8, !dbg !1197
  call void @llvm.dbg.declare(metadata %gt2fat** %9, metadata !1199, metadata !DIExpression()), !dbg !1200
;;-> (nil) 0
  %10 = load %gt263t*, %gt263t** %4, align 8, !dbg !1201; 2:0
;;-> (nil) 0
  %11 = load i32, i32* %5, align 4, !dbg !1202; 1:0
  %12 = call %gt2c2t* @"imge::Yeni_i" (
      %gt263t* %10, 
      i32 %11), !dbg !1203
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt2c2t** %13,
    align 8, !dbg !1204
  call void @llvm.dbg.declare(metadata %gt2c2t** %13, metadata !1206, metadata !DIExpression()), !dbg !1207
; Atama ifadesi
  %14 = load %gt2fat*, %gt2fat** %9, align 8, !dbg !1208; 2:0
; tür konumu *örs::derleme::imge::kesit::içGit : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt2fat, %gt2fat* %14,
    i32 0, i32 0
  %16 = load %gt2c2t*, %gt2c2t** %13, align 8, !dbg !1210; 2:0
  store 
    %gt2c2t* %16,
    %gt2c2t** %15,
    align 8, !dbg !1211
; Atama ifadesi
  %17 = load %gt2c2t*, %gt2c2t** %13, align 8, !dbg !1212; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
...
; Konum çevirisi:
  %19 = bitcast %gt2c1t* %18 to %gt2fat**; 2
  %20 = load %gt2fat*, %gt2fat** %9, align 8, !dbg !1214; 2:0
  store 
    %gt2fat* %20,
    %gt2fat** %19,
    align 8, !dbg !1215
  %21 = load %gt2fat*, %gt2fat** %9, align 8, !dbg !1216; 2:0
; Dönüş :
  ret %gt2fat* %21
}
...
!1144 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !852, size: 64)
!1146 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !852, size: 64)
!1141 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Öz",  scope: !1139,  file: !19, line: 51, baseType: !1140, size: 64)
!1143 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Koşul",  scope: !1139,  file: !19, line: 52, baseType: !1142, size: 64, offset: 64)
!1145 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Evet",  scope: !1139,  file: !19, line: 53, baseType: !1144, size: 64, offset: 128)
!1147 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Hayır",  scope: !1139,  file: !19, line: 54, baseType: !1146, size: 64, offset: 192)
!1148 = !{!1141,!1143,!1145,!1147}
!1139 = distinct !DICompositeType(tag: DW_TAG_structure_type, 
       name: "koşulluGit", file: !19, line: 49,  size: 256, elements: !1148)
!1149 = !DINamespace(name:"kök", scope: null)
!1150 = !DINamespace(name:"örs", scope: !1149)
!1151 = !DINamespace(name:"derleme", scope: !1150)
!1152 = !DINamespace(name:"imge", scope: !1151)
!1153 = !DINamespace(name:"kesit", scope: !1152)


!1155 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1073, size: 64)
!1156 = !DILocalVariable(name: "dönüş",
  scope: !1154, file: !9, line: 15, type: !1155)
!1157 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !88, size: 64)
!1158 = !DILocalVariable(name: "Hafıza",
  scope: !1154, file: !9, line: 21, type: !1157, arg: 1)
!1159 = !DISubroutineType(types: !1160)
!1160 = !{null, !1157 }
!1154 = distinct !DISubprogram( name: "kesit::_git.Yeni_i",
 scope: !1153,
 file: !9,
 line: 20,
 type: !1159, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1161 = !DILocation(line: 21, column: 5, scope: !1154)
!1162 = distinct !DILexicalBlock(
        scope: !1154, file: !9, line: 30, column: 3)
!1163 = !DILocation(line: 23, column: 19, scope: !1162)
!1164 = !DILocation(line: 23, column: 27, scope: !1162)
!1165 = !DILocation(line: 23, column: 5, scope: !1162)
!1166 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1073, size: 64)
!1167 = !DILocalVariable(name: "Git",
  scope: !1162, file: !9, line: 23, type: !1166)
!1168 = !DILocation(line: 23, column: 5, scope: !1162)
!1169 = !DILocation(line: 24, column: 24, scope: !1162)
!1170 = !DILocation(line: 24, column: 19, scope: !1162)
!1171 = !DILocation(line: 24, column: 5, scope: !1162)
!1172 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1173 = !DILocalVariable(name: "İmge",
  scope: !1162, file: !9, line: 24, type: !1172)
!1174 = !DILocation(line: 24, column: 5, scope: !1162)
!1175 = !DILocation(line: 25, column: 5, scope: !1162)
!1176 = !DILocation(line: 25, column: 5, scope: !1162)
!1177 = !DILocation(line: 25, column: 24, scope: !1162)
!1178 = !DILocation(line: 25, column: 5, scope: !1162)
!1179 = !DILocation(line: 26, column: 5, scope: !1162)
!1180 = !DILocation(line: 26, column: 5, scope: !1162)
!1181 = !DILocation(line: 26, column: 24, scope: !1162)
!1182 = !DILocation(line: 26, column: 5, scope: !1162)
!1183 = !DILocation(line: 27, column: 9, scope: !1162)


!1185 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1059, size: 64)
!1186 = !DILocalVariable(name: "dönüş",
  scope: !1184, file: !9, line: 15, type: !1185)
!1187 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !88, size: 64)
!1188 = !DILocalVariable(name: "Hafıza",
  scope: !1184, file: !9, line: 38, type: !1187, arg: 1)
!1189 = !DILocalVariable(name: "özellik",
  scope: !1184, file: !9, line: 39, type: !12, arg: 2)
!1190 = !DISubroutineType(types: !1191)
!1191 = !{null, !1187, !12 }
!1184 = distinct !DISubprogram( name: "kesit::içGit.Yeni_i",
 scope: !1153,
 file: !9,
 line: 37,
 type: !1190, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1192 = !DILocation(line: 38, column: 5, scope: !1184)
!1193 = !DILocation(line: 39, column: 5, scope: !1184)
!1194 = distinct !DILexicalBlock(
        scope: !1184, file: !9, line: 49, column: 3)
!1195 = !DILocation(line: 41, column: 21, scope: !1194)
!1196 = !DILocation(line: 41, column: 29, scope: !1194)
!1197 = !DILocation(line: 41, column: 5, scope: !1194)
!1198 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1059, size: 64)
!1199 = !DILocalVariable(name: "Git",
  scope: !1194, file: !9, line: 41, type: !1198)
!1200 = !DILocation(line: 41, column: 5, scope: !1194)
!1201 = !DILocation(line: 42, column: 24, scope: !1194)
!1202 = !DILocation(line: 42, column: 32, scope: !1194)
!1203 = !DILocation(line: 42, column: 19, scope: !1194)
!1204 = !DILocation(line: 42, column: 5, scope: !1194)
!1205 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1206 = !DILocalVariable(name: "İmge",
  scope: !1194, file: !9, line: 42, type: !1205)
!1207 = !DILocation(line: 42, column: 5, scope: !1194)
!1208 = !DILocation(line: 43, column: 5, scope: !1194)
!1209 = !DILocation(line: 43, column: 5, scope: !1194)
!1210 = !DILocation(line: 43, column: 26, scope: !1194)
!1211 = !DILocation(line: 43, column: 5, scope: !1194)
!1212 = !DILocation(line: 44, column: 5, scope: !1194)
!1213 = !DILocation(line: 44, column: 5, scope: !1194)
!1214 = !DILocation(line: 44, column: 26, scope: !1194)
!1215 = !DILocation(line: 44, column: 5, scope: !1194)
!1216 = !DILocation(line: 46, column: 9, scope: !1194)
