...
@"yönerge::YeniİçDönüş_ox141i"(%gt294t* %0)#0       !dbg !1736 {
; Değişken : dönüş
...
; Değişken : Hafıza
  ...
  call void @llvm.dbg.declare(metadata %gt294t** %3, metadata !1740, metadata !DIExpression()), !dbg !1743
;;-> (nil) 0
  %4 = load %gt294t*, %gt294t** %3, align 8, !dbg !1745; 2:0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt398t** %6,
    align 8, !dbg !1747
  call void @llvm.dbg.declare(metadata %gt398t** %6, metadata !1749, metadata !DIExpression()), !dbg !1750
  %7 = load %gt398t*, %gt398t** %6, align 8, !dbg !1751; 2:0
; Dönüş :
  ret %gt398t* %7
}
...
; Değişken : Hafıza
  %3 = alloca %gt294t*, align 8
  store %gt294t* %0, %gt294t** %3, align 8
  call void @llvm.dbg.declare(metadata %gt294t** %3, metadata !1756, metadata !DIExpression()), !dbg !1759
  %4 = load %gt294t*, %gt294t** %3, align 8, !dbg !1761; 2:0
...
; pascal 'Git' örs::derleme::imge::yönerge::_git
  ...
  store 
    ...
    %gt3adt** %7,
    align 8, !dbg !1763
  call void @llvm.dbg.declare(metadata %gt3adt** %7, metadata !1765, metadata !DIExpression()), !dbg !1766
;;-> (nil) 0
  %8 = load %gt294t*, %gt294t** %3, align 8, !dbg !1767; 2:0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt398t** %10,
    align 8, !dbg !1769
  call void @llvm.dbg.declare(metadata %gt398t** %10, metadata !1771, metadata !DIExpression()), !dbg !1772
; Atama ifadesi
  %11 = load %gt398t*, %gt398t** %10, align 8, !dbg !1773; 2:0
...
; Konum çevirisi:
  ...
  %14 = load %gt3adt*, %gt3adt** %7, align 8, !dbg !1775; 2:0
;atama:
  store 
    %gt3adt* %14,
    %gt3a4t** %13,
    align 8, !dbg !1776
; Atama ifadesi
  %15 = load %gt3adt*, %gt3adt** %7, align 8, !dbg !1777; 2:0
; tür konumu *örs::derleme::imge::yönerge::_git : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt3adt, %gt3adt* %15,
    i32 0, i32 0
  %17 = load %gt398t*, %gt398t** %10, align 8, !dbg !1779; 2:0
;atama:
  store 
    %gt398t* %17,
    %gt398t** %16,
    align 8, !dbg !1780
  %18 = load %gt3adt*, %gt3adt** %7, align 8, !dbg !1781; 2:0
; Dönüş :
  ret %gt3adt* %18
}
...
; Değişken : Hafıza
  ...
  call void @llvm.dbg.declare(metadata %gt294t** %4, metadata !1786, metadata !DIExpression()), !dbg !1790
; Değişken : özellik
  %5 = alloca i32, align 4
  store i32 %1, i32* %5, align 4
  call void @llvm.dbg.declare(metadata i32* %5, metadata !1787, metadata !DIExpression()), !dbg !1791
  %6 = load %gt294t*, %gt294t** %4, align 8, !dbg !1793; 2:0
...
; pascal 'Git' örs::derleme::imge::yönerge::içGit
  ...
  store 
    ...
    %gt3aft** %9,
    align 8, !dbg !1795
  call void @llvm.dbg.declare(metadata %gt3aft** %9, metadata !1797, metadata !DIExpression()), !dbg !1798
;;-> (nil) 0
  %10 = load %gt294t*, %gt294t** %4, align 8, !dbg !1799; 2:0
;;-> (nil) 0
  %11 = load i32, i32* %5, align 4, !dbg !1800; 1:0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt398t** %13,
    align 8, !dbg !1802
  call void @llvm.dbg.declare(metadata %gt398t** %13, metadata !1804, metadata !DIExpression()), !dbg !1805
; Atama ifadesi
  %14 = load %gt3aft*, %gt3aft** %9, align 8, !dbg !1806; 2:0
; tür konumu *örs::derleme::imge::yönerge::içGit : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt3aft, %gt3aft* %14,
    i32 0, i32 0
  %16 = load %gt398t*, %gt398t** %13, align 8, !dbg !1808; 2:0
;atama:
  store 
    %gt398t* %16,
    %gt398t** %15,
    align 8, !dbg !1809
; Atama ifadesi
  %17 = load %gt398t*, %gt398t** %13, align 8, !dbg !1810; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
...
; Konum çevirisi:
  ...
  %20 = load %gt3aft*, %gt3aft** %9, align 8, !dbg !1812; 2:0
;atama:
  store 
    %gt3aft* %20,
    %gt3a6t** %19,
    align 8, !dbg !1813
  %21 = load %gt3aft*, %gt3aft** %9, align 8, !dbg !1814; 2:0
; Dönüş :
  ret %gt3aft* %21
}
...
!1713 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Öz",  scope: !1711,  file: !19, line: 8, baseType: !1712, size: 64)
!1714 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Konum",  scope: !1711,  file: !19, line: 9, baseType: !415, size: 64, offset: 64)
!1716 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Gidilen",  scope: !1711,  file: !19, line: 10, baseType: !1715, size: 64, offset: 128)
!1717 = !{!1713,!1714,!1716}
!1711 = distinct !DICompositeType(tag: DW_TAG_structure_type, 
       name: "_git", file: !19, line: 6,  size: 192, elements: !1717)
!1719 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1720 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Öz",  scope: !1718,  file: !19, line: 26, baseType: !1719, size: 64)
!1721 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Konum",  scope: !1718,  file: !19, line: 27, baseType: !415, size: 64, offset: 64)
!1722 = !{!1720,!1721}
!1718 = distinct !DICompositeType(tag: DW_TAG_structure_type, 
       name: "içGit", file: !19, line: 24,  size: 128, elements: !1722)
...
!1725 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Öz",  scope: !1723,  file: !19, line: 51, baseType: !1724, size: 64)
!1727 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Koşul",  scope: !1723,  file: !19, line: 52, baseType: !1726, size: 64, offset: 64)
!1728 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Evet",  scope: !1723,  file: !19, line: 53, baseType: !415, size: 64, offset: 128)
!1729 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Hayır",  scope: !1723,  file: !19, line: 54, baseType: !415, size: 64, offset: 192)
!1730 = !{!1725,!1727,!1728,!1729}
!1723 = distinct !DICompositeType(tag: DW_TAG_structure_type, 
       name: "koşulluGit", file: !19, line: 49,  size: 256, elements: !1730)
!1731 = !DINamespace(name:"kök", scope: null)
!1732 = !DINamespace(name:"örs", scope: !1731)
!1733 = !DINamespace(name:"derleme", scope: !1732)
!1734 = !DINamespace(name:"imge", scope: !1733)
!1735 = !DINamespace(name:"yönerge", scope: !1734)


!1737 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1738 = !DILocalVariable(name: "dönüş",
  scope: !1736, file: !9, line: 15, type: !1737)
!1739 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1740 = !DILocalVariable(name: "Hafıza",
  scope: !1736, file: !9, line: 30, type: !1739, arg: 1)
!1741 = !DISubroutineType(types: !1742)
!1742 = !{null, !1739 }
!1736 = distinct !DISubprogram( name: "yönerge::YeniİçDönüş_ox141i",
 scope: !1735,
 file: !9,
 line: 30,
 type: !1741, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;YeniİçDönüş
!1743 = !DILocation(line: 30, column: 26, scope: !1736)
!1744 = distinct !DILexicalBlock(
        scope: !1736, file: !9, line: 31, column: 3)
!1745 = !DILocation(line: 32, column: 24, scope: !1744)
!1746 = !DILocation(line: 32, column: 19, scope: !1744)
!1747 = !DILocation(line: 32, column: 5, scope: !1744)
!1748 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1749 = !DILocalVariable(name: "İmge",
  scope: !1744, file: !9, line: 32, type: !1748)
!1750 = !DILocation(line: 32, column: 5, scope: !1744)
!1751 = !DILocation(line: 33, column: 9, scope: !1744)


!1753 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1711, size: 64)
...
!1756 = !DILocalVariable(name: "Hafıza",
  scope: !1752, file: !9, line: 15, type: !1755, arg: 1)
!1757 = !DISubroutineType(types: !1758)
!1758 = !{null, !1755 }
!1752 = distinct !DISubprogram( name: "yönerge::_git.Yeni_ox141i",
 scope: !1735,
 file: !9,
 line: 14,
 type: !1757, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1759 = !DILocation(line: 15, column: 5, scope: !1752)
!1760 = distinct !DILexicalBlock(
        scope: !1752, file: !9, line: 24, column: 3)
!1761 = !DILocation(line: 17, column: 19, scope: !1760)
!1762 = !DILocation(line: 17, column: 27, scope: !1760)
!1763 = !DILocation(line: 17, column: 5, scope: !1760)
!1764 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1711, size: 64)
!1765 = !DILocalVariable(name: "Git",
  scope: !1760, file: !9, line: 17, type: !1764)
!1766 = !DILocation(line: 17, column: 5, scope: !1760)
!1767 = !DILocation(line: 18, column: 24, scope: !1760)
!1768 = !DILocation(line: 18, column: 19, scope: !1760)
!1769 = !DILocation(line: 18, column: 5, scope: !1760)
!1770 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1771 = !DILocalVariable(name: "İmge",
  scope: !1760, file: !9, line: 18, type: !1770)
!1772 = !DILocation(line: 18, column: 5, scope: !1760)
!1773 = !DILocation(line: 19, column: 5, scope: !1760)
!1774 = !DILocation(line: 19, column: 5, scope: !1760)
!1775 = !DILocation(line: 19, column: 24, scope: !1760)
!1776 = !DILocation(line: 19, column: 5, scope: !1760)
!1777 = !DILocation(line: 20, column: 5, scope: !1760)
!1778 = !DILocation(line: 20, column: 5, scope: !1760)
!1779 = !DILocation(line: 20, column: 24, scope: !1760)
!1780 = !DILocation(line: 20, column: 5, scope: !1760)
!1781 = !DILocation(line: 21, column: 9, scope: !1760)


!1783 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1718, size: 64)
!1784 = !DILocalVariable(name: "dönüş",
  scope: !1782, file: !9, line: 15, type: !1783)
!1785 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1786 = !DILocalVariable(name: "Hafıza",
  scope: !1782, file: !9, line: 38, type: !1785, arg: 1)
!1787 = !DILocalVariable(name: "özellik",
  scope: !1782, file: !9, line: 39, type: !12, arg: 2)
!1788 = !DISubroutineType(types: !1789)
!1789 = !{null, !1785, !12 }
!1782 = distinct !DISubprogram( name: "yönerge::içGit.Yeni_ox141i",
 scope: !1735,
 file: !9,
 line: 37,
 type: !1788, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1790 = !DILocation(line: 38, column: 5, scope: !1782)
!1791 = !DILocation(line: 39, column: 5, scope: !1782)
!1792 = distinct !DILexicalBlock(
        scope: !1782, file: !9, line: 49, column: 3)
!1793 = !DILocation(line: 41, column: 21, scope: !1792)
!1794 = !DILocation(line: 41, column: 29, scope: !1792)
!1795 = !DILocation(line: 41, column: 5, scope: !1792)
!1796 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1718, size: 64)
!1797 = !DILocalVariable(name: "Git",
  scope: !1792, file: !9, line: 41, type: !1796)
!1798 = !DILocation(line: 41, column: 5, scope: !1792)
!1799 = !DILocation(line: 42, column: 24, scope: !1792)
!1800 = !DILocation(line: 42, column: 32, scope: !1792)
!1801 = !DILocation(line: 42, column: 19, scope: !1792)
!1802 = !DILocation(line: 42, column: 5, scope: !1792)
!1803 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1804 = !DILocalVariable(name: "İmge",
  scope: !1792, file: !9, line: 42, type: !1803)
!1805 = !DILocation(line: 42, column: 5, scope: !1792)
!1806 = !DILocation(line: 43, column: 5, scope: !1792)
!1807 = !DILocation(line: 43, column: 5, scope: !1792)
!1808 = !DILocation(line: 43, column: 26, scope: !1792)
!1809 = !DILocation(line: 43, column: 5, scope: !1792)
!1810 = !DILocation(line: 44, column: 5, scope: !1792)
!1811 = !DILocation(line: 44, column: 5, scope: !1792)
!1812 = !DILocation(line: 44, column: 26, scope: !1792)
!1813 = !DILocation(line: 44, column: 5, scope: !1792)
!1814 = !DILocation(line: 46, column: 9, scope: !1792)
