...
@"yönerge::YeniİçDönüş_ox141i"(%gt29at* %0)#0       !dbg !1841 {
; Değişken : dönüş
...
; Değişken : Hafıza
  ...
  call void @llvm.dbg.declare(metadata %gt29at** %3, metadata !1845, metadata !DIExpression()), !dbg !1848
;;-> (nil) 0
  %4 = load %gt29at*, %gt29at** %3, align 8, !dbg !1850; 2:0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3bft** %6,
    align 8, !dbg !1852
  call void @llvm.dbg.declare(metadata %gt3bft** %6, metadata !1854, metadata !DIExpression()), !dbg !1855
  %7 = load %gt3bft*, %gt3bft** %6, align 8, !dbg !1856; 2:0
; Dönüş :
  ret %gt3bft* %7
}
...
define external 
%gt3d5t* @"yönerge::_git.Yeni_ox141i"(%gt29at* %0)
#0       !dbg !1857 {
; Değişken : dönüş
...
; Değişken : Hafıza
  %3 = alloca %gt29at*, align 8
  store %gt29at* %0, %gt29at** %3, align 8
  call void @llvm.dbg.declare(metadata %gt29at** %3, metadata !1861, metadata !DIExpression()), !dbg !1864
  %4 = load %gt29at*, %gt29at** %3, align 8, !dbg !1866; 2:0
...
; pascal 'Git' örs::derleme::imge::yönerge::_git
  ...
  store 
    ...
    %gt3d5t** %7,
    align 8, !dbg !1868
  call void @llvm.dbg.declare(metadata %gt3d5t** %7, metadata !1870, metadata !DIExpression()), !dbg !1871
;;-> (nil) 0
  %8 = load %gt29at*, %gt29at** %3, align 8, !dbg !1872; 2:0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3bft** %10,
    align 8, !dbg !1874
  call void @llvm.dbg.declare(metadata %gt3bft** %10, metadata !1876, metadata !DIExpression()), !dbg !1877
; Atama ifadesi
  %11 = load %gt3bft*, %gt3bft** %10, align 8, !dbg !1878; 2:0
...
; Konum çevirisi:
  ...
  %14 = load %gt3d5t*, %gt3d5t** %7, align 8, !dbg !1880; 2:0
;atama:
  store 
    %gt3d5t* %14,
    %gt3cct** %13,
    align 8, !dbg !1881
; Atama ifadesi
  %15 = load %gt3d5t*, %gt3d5t** %7, align 8, !dbg !1882; 2:0
; tür konumu *örs::derleme::imge::yönerge::_git : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt3d5t, %gt3d5t* %15,
    i32 0, i32 0
  %17 = load %gt3bft*, %gt3bft** %10, align 8, !dbg !1884; 2:0
;atama:
  store 
    %gt3bft* %17,
    %gt3bft** %16,
    align 8, !dbg !1885
  %18 = load %gt3d5t*, %gt3d5t** %7, align 8, !dbg !1886; 2:0
; Dönüş :
  ret %gt3d5t* %18
}

define external 
%gt3d7t* @"yönerge::içGit.Yeni_ox141i"(%gt29at* %0, i32 %1)
#0       !dbg !1887 {
; Değişken : dönüş
...
; Değişken : Hafıza
  ...
  call void @llvm.dbg.declare(metadata %gt29at** %4, metadata !1891, metadata !DIExpression()), !dbg !1895
; Değişken : özellik
  %5 = alloca i32, align 4
  store i32 %1, i32* %5, align 4
  call void @llvm.dbg.declare(metadata i32* %5, metadata !1892, metadata !DIExpression()), !dbg !1896
  %6 = load %gt29at*, %gt29at** %4, align 8, !dbg !1898; 2:0
...
; pascal 'Git' örs::derleme::imge::yönerge::içGit
  ...
  store 
    ...
    %gt3d7t** %9,
    align 8, !dbg !1900
  call void @llvm.dbg.declare(metadata %gt3d7t** %9, metadata !1902, metadata !DIExpression()), !dbg !1903
;;-> (nil) 0
  %10 = load %gt29at*, %gt29at** %4, align 8, !dbg !1904; 2:0
;;-> (nil) 0
  %11 = load i32, i32* %5, align 4, !dbg !1905; 1:0
  %12 = call %gt3bft* @"imge::Yeni_ox110i" (
      %gt29at* %10, 
      i32 %11), !dbg !1906
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3bft** %13,
    align 8, !dbg !1907
  call void @llvm.dbg.declare(metadata %gt3bft** %13, metadata !1909, metadata !DIExpression()), !dbg !1910
; Atama ifadesi
  %14 = load %gt3d7t*, %gt3d7t** %9, align 8, !dbg !1911; 2:0
; tür konumu *örs::derleme::imge::yönerge::içGit : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt3d7t, %gt3d7t* %14,
    i32 0, i32 0
  %16 = load %gt3bft*, %gt3bft** %13, align 8, !dbg !1913; 2:0
;atama:
  store 
    %gt3bft* %16,
    %gt3bft** %15,
    align 8, !dbg !1914
; Atama ifadesi
  %17 = load %gt3bft*, %gt3bft** %13, align 8, !dbg !1915; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
...
; Konum çevirisi:
  %19 = bitcast %gt3bet* %18 to %gt3cet**; 2
  %20 = load %gt3d7t*, %gt3d7t** %9, align 8, !dbg !1917; 2:0
;atama:
  store 
    %gt3d7t* %20,
    %gt3cet** %19,
    align 8, !dbg !1918
  %21 = load %gt3d7t*, %gt3d7t** %9, align 8, !dbg !1919; 2:0
; Dönüş :
  ret %gt3d7t* %21
}
...
!1814 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Öz",  scope: !1812,  file: !19, line: 8, baseType: !1813, size: 64)
!1816 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Konum",  scope: !1812,  file: !19, line: 9, baseType: !1815, size: 64, offset: 64)
!1818 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Gidilen",  scope: !1812,  file: !19, line: 10, baseType: !1817, size: 64, offset: 128)
!1819 = !{!1814,!1816,!1818}
!1812 = distinct !DICompositeType(tag: DW_TAG_structure_type, 
       name: "_git", file: !19, line: 6,  size: 192, elements: !1819)
...
!1822 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Öz",  scope: !1820,  file: !19, line: 26, baseType: !1821, size: 64)
!1824 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Konum",  scope: !1820,  file: !19, line: 27, baseType: !1823, size: 64, offset: 64)
!1825 = !{!1822,!1824}
!1820 = distinct !DICompositeType(tag: DW_TAG_structure_type, 
       name: "içGit", file: !19, line: 24,  size: 128, elements: !1825)
!1827 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1829 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1831 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !500, size: 64)
!1833 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !500, size: 64)
!1828 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Öz",  scope: !1826,  file: !19, line: 51, baseType: !1827, size: 64)
!1830 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Koşul",  scope: !1826,  file: !19, line: 52, baseType: !1829, size: 64, offset: 64)
!1832 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Evet",  scope: !1826,  file: !19, line: 53, baseType: !1831, size: 64, offset: 128)
!1834 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Hayır",  scope: !1826,  file: !19, line: 54, baseType: !1833, size: 64, offset: 192)
!1835 = !{!1828,!1830,!1832,!1834}
!1826 = distinct !DICompositeType(tag: DW_TAG_structure_type, 
       name: "koşulluGit", file: !19, line: 49,  size: 256, elements: !1835)
!1836 = !DINamespace(name:"kök", scope: null)
!1837 = !DINamespace(name:"örs", scope: !1836)
!1838 = !DINamespace(name:"derleme", scope: !1837)
!1839 = !DINamespace(name:"imge", scope: !1838)
!1840 = !DINamespace(name:"yönerge", scope: !1839)
...
!1844 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1845 = !DILocalVariable(name: "Hafıza",
  scope: !1841, file: !9, line: 30, type: !1844, arg: 1)
!1846 = !DISubroutineType(types: !1847)
!1847 = !{null, !1844 }
!1841 = distinct !DISubprogram( name: "yönerge::YeniİçDönüş_ox141i",
 scope: !1840,
 file: !9,
 line: 30,
 type: !1846, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;YeniİçDönüş
!1848 = !DILocation(line: 30, column: 26, scope: !1841)
!1849 = distinct !DILexicalBlock(
        scope: !1841, file: !9, line: 31, column: 3)
!1850 = !DILocation(line: 32, column: 24, scope: !1849)
!1851 = !DILocation(line: 32, column: 19, scope: !1849)
!1852 = !DILocation(line: 32, column: 5, scope: !1849)
!1853 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1854 = !DILocalVariable(name: "İmge",
  scope: !1849, file: !9, line: 32, type: !1853)
!1855 = !DILocation(line: 32, column: 5, scope: !1849)
!1856 = !DILocation(line: 33, column: 9, scope: !1849)


!1858 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1812, size: 64)
...
!1861 = !DILocalVariable(name: "Hafıza",
  scope: !1857, file: !9, line: 15, type: !1860, arg: 1)
!1862 = !DISubroutineType(types: !1863)
!1863 = !{null, !1860 }
!1857 = distinct !DISubprogram( name: "yönerge::_git.Yeni_ox141i",
 scope: !1840,
 file: !9,
 line: 14,
 type: !1862, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1864 = !DILocation(line: 15, column: 5, scope: !1857)
!1865 = distinct !DILexicalBlock(
        scope: !1857, file: !9, line: 24, column: 3)
!1866 = !DILocation(line: 17, column: 19, scope: !1865)
!1867 = !DILocation(line: 17, column: 27, scope: !1865)
!1868 = !DILocation(line: 17, column: 5, scope: !1865)
!1869 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1812, size: 64)
!1870 = !DILocalVariable(name: "Git",
  scope: !1865, file: !9, line: 17, type: !1869)
!1871 = !DILocation(line: 17, column: 5, scope: !1865)
!1872 = !DILocation(line: 18, column: 24, scope: !1865)
!1873 = !DILocation(line: 18, column: 19, scope: !1865)
!1874 = !DILocation(line: 18, column: 5, scope: !1865)
!1875 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1876 = !DILocalVariable(name: "İmge",
  scope: !1865, file: !9, line: 18, type: !1875)
!1877 = !DILocation(line: 18, column: 5, scope: !1865)
!1878 = !DILocation(line: 19, column: 5, scope: !1865)
!1879 = !DILocation(line: 19, column: 5, scope: !1865)
!1880 = !DILocation(line: 19, column: 24, scope: !1865)
!1881 = !DILocation(line: 19, column: 5, scope: !1865)
!1882 = !DILocation(line: 20, column: 5, scope: !1865)
!1883 = !DILocation(line: 20, column: 5, scope: !1865)
!1884 = !DILocation(line: 20, column: 24, scope: !1865)
!1885 = !DILocation(line: 20, column: 5, scope: !1865)
!1886 = !DILocation(line: 21, column: 9, scope: !1865)


!1888 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1820, size: 64)
...
!1891 = !DILocalVariable(name: "Hafıza",
  scope: !1887, file: !9, line: 38, type: !1890, arg: 1)
!1892 = !DILocalVariable(name: "özellik",
  scope: !1887, file: !9, line: 39, type: !12, arg: 2)
!1893 = !DISubroutineType(types: !1894)
!1894 = !{null, !1890, !12 }
!1887 = distinct !DISubprogram( name: "yönerge::içGit.Yeni_ox141i",
 scope: !1840,
 file: !9,
 line: 37,
 type: !1893, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1895 = !DILocation(line: 38, column: 5, scope: !1887)
!1896 = !DILocation(line: 39, column: 5, scope: !1887)
!1897 = distinct !DILexicalBlock(
        scope: !1887, file: !9, line: 49, column: 3)
!1898 = !DILocation(line: 41, column: 21, scope: !1897)
!1899 = !DILocation(line: 41, column: 29, scope: !1897)
!1900 = !DILocation(line: 41, column: 5, scope: !1897)
!1901 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1820, size: 64)
!1902 = !DILocalVariable(name: "Git",
  scope: !1897, file: !9, line: 41, type: !1901)
!1903 = !DILocation(line: 41, column: 5, scope: !1897)
!1904 = !DILocation(line: 42, column: 24, scope: !1897)
!1905 = !DILocation(line: 42, column: 32, scope: !1897)
!1906 = !DILocation(line: 42, column: 19, scope: !1897)
!1907 = !DILocation(line: 42, column: 5, scope: !1897)
!1908 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1909 = !DILocalVariable(name: "İmge",
  scope: !1897, file: !9, line: 42, type: !1908)
!1910 = !DILocation(line: 42, column: 5, scope: !1897)
!1911 = !DILocation(line: 43, column: 5, scope: !1897)
!1912 = !DILocation(line: 43, column: 5, scope: !1897)
!1913 = !DILocation(line: 43, column: 26, scope: !1897)
!1914 = !DILocation(line: 43, column: 5, scope: !1897)
!1915 = !DILocation(line: 44, column: 5, scope: !1897)
!1916 = !DILocation(line: 44, column: 5, scope: !1897)
!1917 = !DILocation(line: 44, column: 26, scope: !1897)
!1918 = !DILocation(line: 44, column: 5, scope: !1897)
!1919 = !DILocation(line: 46, column: 9, scope: !1897)
