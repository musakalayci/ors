...
@"yönerge::YeniİçDönüş_ox141i"(%gt294t* %0)#0       !dbg !1788 {
; Değişken : dönüş
...
; Değişken : Hafıza
  ...
  call void @llvm.dbg.declare(metadata %gt294t** %3, metadata !1792, metadata !DIExpression()), !dbg !1795
;;-> (nil) 0
  %4 = load %gt294t*, %gt294t** %3, align 8, !dbg !1797; 2:0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3a2t** %6,
    align 8, !dbg !1799
  call void @llvm.dbg.declare(metadata %gt3a2t** %6, metadata !1801, metadata !DIExpression()), !dbg !1802
  %7 = load %gt3a2t*, %gt3a2t** %6, align 8, !dbg !1803; 2:0
; Dönüş :
  ret %gt3a2t* %7
}
...
define external 
%gt3b8t* @"yönerge::_git.Yeni_ox141i"(%gt294t* %0)
#0       !dbg !1804 {
; Değişken : dönüş
  %2 = alloca %gt3b8t*, align 8
  store %gt3b8t* null, %gt3b8t** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt294t*, align 8
  store %gt294t* %0, %gt294t** %3, align 8
  call void @llvm.dbg.declare(metadata %gt294t** %3, metadata !1807, metadata !DIExpression()), !dbg !1810
  %4 = load %gt294t*, %gt294t** %3, align 8, !dbg !1812; 2:0
  %5 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt294t* %4, 
      i64 24, 
      i64 8), !dbg !1813
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt3b8t*; 1
...
; pascal 'Git' örs::derleme::imge::yönerge::_git
  ...
  store 
    ...
    %gt3b8t** %7,
    align 8, !dbg !1814
  call void @llvm.dbg.declare(metadata %gt3b8t** %7, metadata !1815, metadata !DIExpression()), !dbg !1816
;;-> (nil) 0
  %8 = load %gt294t*, %gt294t** %3, align 8, !dbg !1817; 2:0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3a2t** %10,
    align 8, !dbg !1819
  call void @llvm.dbg.declare(metadata %gt3a2t** %10, metadata !1821, metadata !DIExpression()), !dbg !1822
; Atama ifadesi
  %11 = load %gt3a2t*, %gt3a2t** %10, align 8, !dbg !1823; 2:0
...
; Konum çevirisi:
  ...
  %14 = load %gt3b8t*, %gt3b8t** %7, align 8, !dbg !1825; 2:0
;atama:
  store 
    %gt3b8t* %14,
    %gt3aft** %13,
    align 8, !dbg !1826
; Atama ifadesi
  %15 = load %gt3b8t*, %gt3b8t** %7, align 8, !dbg !1827; 2:0
; tür konumu *örs::derleme::imge::yönerge::_git : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt3b8t, %gt3b8t* %15,
    i32 0, i32 0
  %17 = load %gt3a2t*, %gt3a2t** %10, align 8, !dbg !1829; 2:0
;atama:
  store 
    %gt3a2t* %17,
    %gt3a2t** %16,
    align 8, !dbg !1830
  %18 = load %gt3b8t*, %gt3b8t** %7, align 8, !dbg !1831; 2:0
; Dönüş :
  ret %gt3b8t* %18
}

define external 
%gt3bat* @"yönerge::içGit.Yeni_ox141i"(%gt294t* %0, i32 %1)
#0       !dbg !1832 {
; Değişken : dönüş
  %3 = alloca %gt3bat*, align 8
  store %gt3bat* null, %gt3bat** %3, align 8
; Değişken : Hafıza
  %4 = alloca %gt294t*, align 8
  store %gt294t* %0, %gt294t** %4, align 8
  call void @llvm.dbg.declare(metadata %gt294t** %4, metadata !1835, metadata !DIExpression()), !dbg !1839
; Değişken : özellik
  %5 = alloca i32, align 4
  store i32 %1, i32* %5, align 4
  call void @llvm.dbg.declare(metadata i32* %5, metadata !1836, metadata !DIExpression()), !dbg !1840
  ...
  %7 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1843
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt3bat*; 1

; pascal 'Git' örs::derleme::imge::yönerge::içGit
  %9 = alloca %gt3bat*, align 8
  store 
    %gt3bat* %8,
    %gt3bat** %9,
    align 8, !dbg !1844
  call void @llvm.dbg.declare(metadata %gt3bat** %9, metadata !1845, metadata !DIExpression()), !dbg !1846
;;-> (nil) 0
  %10 = load %gt294t*, %gt294t** %4, align 8, !dbg !1847; 2:0
;;-> (nil) 0
  %11 = load i32, i32* %5, align 4, !dbg !1848; 1:0
  %12 = call %gt3a2t* @"imge::Yeni_ox110i" (
      %gt294t* %10, 
      i32 %11), !dbg !1849
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3a2t** %13,
    align 8, !dbg !1850
  call void @llvm.dbg.declare(metadata %gt3a2t** %13, metadata !1852, metadata !DIExpression()), !dbg !1853
; Atama ifadesi
  %14 = load %gt3bat*, %gt3bat** %9, align 8, !dbg !1854; 2:0
; tür konumu *örs::derleme::imge::yönerge::içGit : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt3bat, %gt3bat* %14,
    i32 0, i32 0
  %16 = load %gt3a2t*, %gt3a2t** %13, align 8, !dbg !1856; 2:0
;atama:
  store 
    %gt3a2t* %16,
    %gt3a2t** %15,
    align 8, !dbg !1857
; Atama ifadesi
  %17 = load %gt3a2t*, %gt3a2t** %13, align 8, !dbg !1858; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
...
; Konum çevirisi:
  %19 = bitcast %gt3a1t* %18 to %gt3b1t**; 2
  %20 = load %gt3bat*, %gt3bat** %9, align 8, !dbg !1860; 2:0
;atama:
  store 
    %gt3bat* %20,
    %gt3b1t** %19,
    align 8, !dbg !1861
  %21 = load %gt3bat*, %gt3bat** %9, align 8, !dbg !1862; 2:0
; Dönüş :
  ret %gt3bat* %21
}
...
!1761 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Öz",  scope: !1759,  file: !19, line: 8, baseType: !1760, size: 64)
!1763 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Konum",  scope: !1759,  file: !19, line: 9, baseType: !1762, size: 64, offset: 64)
!1765 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Gidilen",  scope: !1759,  file: !19, line: 10, baseType: !1764, size: 64, offset: 128)
!1766 = !{!1761,!1763,!1765}
!1759 = distinct !DICompositeType(tag: DW_TAG_structure_type, 
       name: "_git", file: !19, line: 6,  size: 192, elements: !1766)
!1768 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1770 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !484, size: 64)
!1769 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Öz",  scope: !1767,  file: !19, line: 26, baseType: !1768, size: 64)
!1771 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Konum",  scope: !1767,  file: !19, line: 27, baseType: !1770, size: 64, offset: 64)
!1772 = !{!1769,!1771}
!1767 = distinct !DICompositeType(tag: DW_TAG_structure_type, 
       name: "içGit", file: !19, line: 24,  size: 128, elements: !1772)
...
!1778 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !484, size: 64)
!1780 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !484, size: 64)
!1775 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Öz",  scope: !1773,  file: !19, line: 51, baseType: !1774, size: 64)
!1777 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Koşul",  scope: !1773,  file: !19, line: 52, baseType: !1776, size: 64, offset: 64)
!1779 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Evet",  scope: !1773,  file: !19, line: 53, baseType: !1778, size: 64, offset: 128)
!1781 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Hayır",  scope: !1773,  file: !19, line: 54, baseType: !1780, size: 64, offset: 192)
!1782 = !{!1775,!1777,!1779,!1781}
!1773 = distinct !DICompositeType(tag: DW_TAG_structure_type, 
       name: "koşulluGit", file: !19, line: 49,  size: 256, elements: !1782)
...
!1787 = !DINamespace(name:"yönerge", scope: !1786)


!1789 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1790 = !DILocalVariable(name: "dönüş",
  scope: !1788, file: !9, line: 15, type: !1789)
!1791 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1792 = !DILocalVariable(name: "Hafıza",
  scope: !1788, file: !9, line: 30, type: !1791, arg: 1)
!1793 = !DISubroutineType(types: !1794)
!1794 = !{null, !1791 }
!1788 = distinct !DISubprogram( name: "yönerge::YeniİçDönüş_ox141i",
 scope: !1787,
 file: !9,
 line: 30,
 type: !1793, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;YeniİçDönüş
!1795 = !DILocation(line: 30, column: 26, scope: !1788)
!1796 = distinct !DILexicalBlock(
        scope: !1788, file: !9, line: 31, column: 3)
!1797 = !DILocation(line: 32, column: 24, scope: !1796)
!1798 = !DILocation(line: 32, column: 19, scope: !1796)
!1799 = !DILocation(line: 32, column: 5, scope: !1796)
!1800 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1801 = !DILocalVariable(name: "İmge",
  scope: !1796, file: !9, line: 32, type: !1800)
!1802 = !DILocation(line: 32, column: 5, scope: !1796)
!1803 = !DILocation(line: 33, column: 9, scope: !1796)


!1805 = !DILocalVariable(name: "dönüş",
  scope: !1804, file: !9, line: 15, type: !1759)
!1806 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1807 = !DILocalVariable(name: "Hafıza",
  scope: !1804, file: !9, line: 15, type: !1806, arg: 1)
!1808 = !DISubroutineType(types: !1809)
!1809 = !{null, !1806 }
!1804 = distinct !DISubprogram( name: "yönerge::_git.Yeni_ox141i",
 scope: !1787,
 file: !9,
 line: 14,
 type: !1808, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1810 = !DILocation(line: 15, column: 5, scope: !1804)
!1811 = distinct !DILexicalBlock(
        scope: !1804, file: !9, line: 24, column: 3)
!1812 = !DILocation(line: 17, column: 19, scope: !1811)
!1813 = !DILocation(line: 17, column: 27, scope: !1811)
!1814 = !DILocation(line: 17, column: 5, scope: !1811)
!1815 = !DILocalVariable(name: "Git",
  scope: !1811, file: !9, line: 17, type: !1759)
!1816 = !DILocation(line: 17, column: 5, scope: !1811)
!1817 = !DILocation(line: 18, column: 24, scope: !1811)
!1818 = !DILocation(line: 18, column: 19, scope: !1811)
!1819 = !DILocation(line: 18, column: 5, scope: !1811)
!1820 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1821 = !DILocalVariable(name: "İmge",
  scope: !1811, file: !9, line: 18, type: !1820)
!1822 = !DILocation(line: 18, column: 5, scope: !1811)
!1823 = !DILocation(line: 19, column: 5, scope: !1811)
!1824 = !DILocation(line: 19, column: 5, scope: !1811)
!1825 = !DILocation(line: 19, column: 24, scope: !1811)
!1826 = !DILocation(line: 19, column: 5, scope: !1811)
!1827 = !DILocation(line: 20, column: 5, scope: !1811)
!1828 = !DILocation(line: 20, column: 5, scope: !1811)
!1829 = !DILocation(line: 20, column: 24, scope: !1811)
!1830 = !DILocation(line: 20, column: 5, scope: !1811)
!1831 = !DILocation(line: 21, column: 9, scope: !1811)


!1833 = !DILocalVariable(name: "dönüş",
  scope: !1832, file: !9, line: 15, type: !1767)
!1834 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1835 = !DILocalVariable(name: "Hafıza",
  scope: !1832, file: !9, line: 38, type: !1834, arg: 1)
!1836 = !DILocalVariable(name: "özellik",
  scope: !1832, file: !9, line: 39, type: !12, arg: 2)
!1837 = !DISubroutineType(types: !1838)
!1838 = !{null, !1834, !12 }
!1832 = distinct !DISubprogram( name: "yönerge::içGit.Yeni_ox141i",
 scope: !1787,
 file: !9,
 line: 37,
 type: !1837, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1839 = !DILocation(line: 38, column: 5, scope: !1832)
!1840 = !DILocation(line: 39, column: 5, scope: !1832)
!1841 = distinct !DILexicalBlock(
        scope: !1832, file: !9, line: 49, column: 3)
!1842 = !DILocation(line: 41, column: 21, scope: !1841)
!1843 = !DILocation(line: 41, column: 29, scope: !1841)
!1844 = !DILocation(line: 41, column: 5, scope: !1841)
!1845 = !DILocalVariable(name: "Git",
  scope: !1841, file: !9, line: 41, type: !1767)
!1846 = !DILocation(line: 41, column: 5, scope: !1841)
!1847 = !DILocation(line: 42, column: 24, scope: !1841)
!1848 = !DILocation(line: 42, column: 32, scope: !1841)
!1849 = !DILocation(line: 42, column: 19, scope: !1841)
!1850 = !DILocation(line: 42, column: 5, scope: !1841)
!1851 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1852 = !DILocalVariable(name: "İmge",
  scope: !1841, file: !9, line: 42, type: !1851)
!1853 = !DILocation(line: 42, column: 5, scope: !1841)
!1854 = !DILocation(line: 43, column: 5, scope: !1841)
!1855 = !DILocation(line: 43, column: 5, scope: !1841)
!1856 = !DILocation(line: 43, column: 26, scope: !1841)
!1857 = !DILocation(line: 43, column: 5, scope: !1841)
!1858 = !DILocation(line: 44, column: 5, scope: !1841)
!1859 = !DILocation(line: 44, column: 5, scope: !1841)
!1860 = !DILocation(line: 44, column: 26, scope: !1841)
!1861 = !DILocation(line: 44, column: 5, scope: !1841)
!1862 = !DILocation(line: 46, column: 9, scope: !1841)
