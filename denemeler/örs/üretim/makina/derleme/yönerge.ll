...
@"yönerge::YeniİçDönüş_ox141i"(%gt296t* %0)#0       !dbg !1814 {
; Değişken : dönüş
...
; Değişken : Hafıza
  ...
  call void @llvm.dbg.declare(metadata %gt296t** %3, metadata !1818, metadata !DIExpression()), !dbg !1821
;;-> (nil) 0
  %4 = load %gt296t*, %gt296t** %3, align 8, !dbg !1823; 2:0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3a6t** %6,
    align 8, !dbg !1825
  call void @llvm.dbg.declare(metadata %gt3a6t** %6, metadata !1827, metadata !DIExpression()), !dbg !1828
  %7 = load %gt3a6t*, %gt3a6t** %6, align 8, !dbg !1829; 2:0
; Dönüş :
  ret %gt3a6t* %7
}
...
define external 
%gt3bct* @"yönerge::_git.Yeni_ox141i"(%gt296t* %0)
#0       !dbg !1830 {
; Değişken : dönüş
  %2 = alloca %gt3bct*, align 8
  store %gt3bct* null, %gt3bct** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt296t*, align 8
  store %gt296t* %0, %gt296t** %3, align 8
  call void @llvm.dbg.declare(metadata %gt296t** %3, metadata !1833, metadata !DIExpression()), !dbg !1836
  %4 = load %gt296t*, %gt296t** %3, align 8, !dbg !1838; 2:0
  %5 = call i8* (%gt296t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt296t* %4, 
      i64 24, 
      i64 8), !dbg !1839
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt3bct*; 1

; pascal 'Git' örs::derleme::imge::yönerge::_git
  %7 = alloca %gt3bct*, align 8
  store 
    %gt3bct* %6,
    %gt3bct** %7,
    align 8, !dbg !1840
  call void @llvm.dbg.declare(metadata %gt3bct** %7, metadata !1841, metadata !DIExpression()), !dbg !1842
;;-> (nil) 0
  %8 = load %gt296t*, %gt296t** %3, align 8, !dbg !1843; 2:0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3a6t** %10,
    align 8, !dbg !1845
  call void @llvm.dbg.declare(metadata %gt3a6t** %10, metadata !1847, metadata !DIExpression()), !dbg !1848
; Atama ifadesi
  %11 = load %gt3a6t*, %gt3a6t** %10, align 8, !dbg !1849; 2:0
...
; Konum çevirisi:
  ...
  %14 = load %gt3bct*, %gt3bct** %7, align 8, !dbg !1851; 2:0
;atama:
  store 
    %gt3bct* %14,
    %gt3b3t** %13,
    align 8, !dbg !1852
; Atama ifadesi
  %15 = load %gt3bct*, %gt3bct** %7, align 8, !dbg !1853; 2:0
; tür konumu *örs::derleme::imge::yönerge::_git : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt3bct, %gt3bct* %15,
    i32 0, i32 0
  %17 = load %gt3a6t*, %gt3a6t** %10, align 8, !dbg !1855; 2:0
;atama:
  store 
    %gt3a6t* %17,
    %gt3a6t** %16,
    align 8, !dbg !1856
  %18 = load %gt3bct*, %gt3bct** %7, align 8, !dbg !1857; 2:0
; Dönüş :
  ret %gt3bct* %18
}

define external 
%gt3bet* @"yönerge::içGit.Yeni_ox141i"(%gt296t* %0, i32 %1)
#0       !dbg !1858 {
; Değişken : dönüş
  %3 = alloca %gt3bet*, align 8
  store %gt3bet* null, %gt3bet** %3, align 8
; Değişken : Hafıza
  %4 = alloca %gt296t*, align 8
  store %gt296t* %0, %gt296t** %4, align 8
  call void @llvm.dbg.declare(metadata %gt296t** %4, metadata !1862, metadata !DIExpression()), !dbg !1866
; Değişken : özellik
  %5 = alloca i32, align 4
  store i32 %1, i32* %5, align 4
  call void @llvm.dbg.declare(metadata i32* %5, metadata !1863, metadata !DIExpression()), !dbg !1867
  ...
  %7 = call i8* (%gt296t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1870
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt3bet*; 1

; pascal 'Git' örs::derleme::imge::yönerge::içGit
  %9 = alloca %gt3bet*, align 8
  store 
    %gt3bet* %8,
    %gt3bet** %9,
    align 8, !dbg !1871
  call void @llvm.dbg.declare(metadata %gt3bet** %9, metadata !1873, metadata !DIExpression()), !dbg !1874
;;-> (nil) 0
  %10 = load %gt296t*, %gt296t** %4, align 8, !dbg !1875; 2:0
;;-> (nil) 0
  %11 = load i32, i32* %5, align 4, !dbg !1876; 1:0
  %12 = call %gt3a6t* @"imge::Yeni_ox110i" (
      %gt296t* %10, 
      i32 %11), !dbg !1877
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3a6t** %13,
    align 8, !dbg !1878
  call void @llvm.dbg.declare(metadata %gt3a6t** %13, metadata !1880, metadata !DIExpression()), !dbg !1881
; Atama ifadesi
  %14 = load %gt3bet*, %gt3bet** %9, align 8, !dbg !1882; 2:0
; tür konumu *örs::derleme::imge::yönerge::içGit : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt3bet, %gt3bet* %14,
    i32 0, i32 0
  %16 = load %gt3a6t*, %gt3a6t** %13, align 8, !dbg !1884; 2:0
;atama:
  store 
    %gt3a6t* %16,
    %gt3a6t** %15,
    align 8, !dbg !1885
; Atama ifadesi
  %17 = load %gt3a6t*, %gt3a6t** %13, align 8, !dbg !1886; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
...
; Konum çevirisi:
  %19 = bitcast %gt3a5t* %18 to %gt3b5t**; 2
  %20 = load %gt3bet*, %gt3bet** %9, align 8, !dbg !1888; 2:0
;atama:
  store 
    %gt3bet* %20,
    %gt3b5t** %19,
    align 8, !dbg !1889
  %21 = load %gt3bet*, %gt3bet** %9, align 8, !dbg !1890; 2:0
; Dönüş :
  ret %gt3bet* %21
}
...
!1787 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Öz",  scope: !1785,  file: !19, line: 8, baseType: !1786, size: 64)
!1789 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Konum",  scope: !1785,  file: !19, line: 9, baseType: !1788, size: 64, offset: 64)
!1791 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Gidilen",  scope: !1785,  file: !19, line: 10, baseType: !1790, size: 64, offset: 128)
!1792 = !{!1787,!1789,!1791}
!1785 = distinct !DICompositeType(tag: DW_TAG_structure_type, 
       name: "_git", file: !19, line: 6,  size: 192, elements: !1792)
!1794 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1796 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !501, size: 64)
!1795 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Öz",  scope: !1793,  file: !19, line: 26, baseType: !1794, size: 64)
!1797 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Konum",  scope: !1793,  file: !19, line: 27, baseType: !1796, size: 64, offset: 64)
!1798 = !{!1795,!1797}
!1793 = distinct !DICompositeType(tag: DW_TAG_structure_type, 
       name: "içGit", file: !19, line: 24,  size: 128, elements: !1798)
...
!1804 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !501, size: 64)
!1806 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !501, size: 64)
!1801 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Öz",  scope: !1799,  file: !19, line: 51, baseType: !1800, size: 64)
!1803 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Koşul",  scope: !1799,  file: !19, line: 52, baseType: !1802, size: 64, offset: 64)
!1805 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Evet",  scope: !1799,  file: !19, line: 53, baseType: !1804, size: 64, offset: 128)
!1807 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Hayır",  scope: !1799,  file: !19, line: 54, baseType: !1806, size: 64, offset: 192)
!1808 = !{!1801,!1803,!1805,!1807}
!1799 = distinct !DICompositeType(tag: DW_TAG_structure_type, 
       name: "koşulluGit", file: !19, line: 49,  size: 256, elements: !1808)
!1809 = !DINamespace(name:"kök", scope: null)
!1810 = !DINamespace(name:"örs", scope: !1809)
!1811 = !DINamespace(name:"derleme", scope: !1810)
!1812 = !DINamespace(name:"imge", scope: !1811)
!1813 = !DINamespace(name:"yönerge", scope: !1812)


!1815 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1816 = !DILocalVariable(name: "dönüş",
  scope: !1814, file: !9, line: 15, type: !1815)
!1817 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1818 = !DILocalVariable(name: "Hafıza",
  scope: !1814, file: !9, line: 30, type: !1817, arg: 1)
!1819 = !DISubroutineType(types: !1820)
!1820 = !{null, !1817 }
!1814 = distinct !DISubprogram( name: "yönerge::YeniİçDönüş_ox141i",
 scope: !1813,
 file: !9,
 line: 30,
 type: !1819, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;YeniİçDönüş
!1821 = !DILocation(line: 30, column: 26, scope: !1814)
!1822 = distinct !DILexicalBlock(
        scope: !1814, file: !9, line: 31, column: 3)
!1823 = !DILocation(line: 32, column: 24, scope: !1822)
!1824 = !DILocation(line: 32, column: 19, scope: !1822)
!1825 = !DILocation(line: 32, column: 5, scope: !1822)
!1826 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1827 = !DILocalVariable(name: "İmge",
  scope: !1822, file: !9, line: 32, type: !1826)
!1828 = !DILocation(line: 32, column: 5, scope: !1822)
!1829 = !DILocation(line: 33, column: 9, scope: !1822)


!1831 = !DILocalVariable(name: "dönüş",
  scope: !1830, file: !9, line: 15, type: !1785)
!1832 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1833 = !DILocalVariable(name: "Hafıza",
  scope: !1830, file: !9, line: 15, type: !1832, arg: 1)
!1834 = !DISubroutineType(types: !1835)
!1835 = !{null, !1832 }
!1830 = distinct !DISubprogram( name: "yönerge::_git.Yeni_ox141i",
 scope: !1813,
 file: !9,
 line: 14,
 type: !1834, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1836 = !DILocation(line: 15, column: 5, scope: !1830)
!1837 = distinct !DILexicalBlock(
        scope: !1830, file: !9, line: 24, column: 3)
!1838 = !DILocation(line: 17, column: 19, scope: !1837)
!1839 = !DILocation(line: 17, column: 27, scope: !1837)
!1840 = !DILocation(line: 17, column: 5, scope: !1837)
!1841 = !DILocalVariable(name: "Git",
  scope: !1837, file: !9, line: 17, type: !1785)
!1842 = !DILocation(line: 17, column: 5, scope: !1837)
!1843 = !DILocation(line: 18, column: 24, scope: !1837)
!1844 = !DILocation(line: 18, column: 19, scope: !1837)
!1845 = !DILocation(line: 18, column: 5, scope: !1837)
!1846 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1847 = !DILocalVariable(name: "İmge",
  scope: !1837, file: !9, line: 18, type: !1846)
!1848 = !DILocation(line: 18, column: 5, scope: !1837)
!1849 = !DILocation(line: 19, column: 5, scope: !1837)
!1850 = !DILocation(line: 19, column: 5, scope: !1837)
!1851 = !DILocation(line: 19, column: 24, scope: !1837)
!1852 = !DILocation(line: 19, column: 5, scope: !1837)
!1853 = !DILocation(line: 20, column: 5, scope: !1837)
!1854 = !DILocation(line: 20, column: 5, scope: !1837)
!1855 = !DILocation(line: 20, column: 24, scope: !1837)
!1856 = !DILocation(line: 20, column: 5, scope: !1837)
!1857 = !DILocation(line: 21, column: 9, scope: !1837)


!1859 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1793, size: 64)
!1860 = !DILocalVariable(name: "dönüş",
  scope: !1858, file: !9, line: 15, type: !1859)
!1861 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1862 = !DILocalVariable(name: "Hafıza",
  scope: !1858, file: !9, line: 38, type: !1861, arg: 1)
!1863 = !DILocalVariable(name: "özellik",
  scope: !1858, file: !9, line: 39, type: !12, arg: 2)
!1864 = !DISubroutineType(types: !1865)
!1865 = !{null, !1861, !12 }
!1858 = distinct !DISubprogram( name: "yönerge::içGit.Yeni_ox141i",
 scope: !1813,
 file: !9,
 line: 37,
 type: !1864, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1866 = !DILocation(line: 38, column: 5, scope: !1858)
!1867 = !DILocation(line: 39, column: 5, scope: !1858)
!1868 = distinct !DILexicalBlock(
        scope: !1858, file: !9, line: 49, column: 3)
!1869 = !DILocation(line: 41, column: 21, scope: !1868)
!1870 = !DILocation(line: 41, column: 29, scope: !1868)
!1871 = !DILocation(line: 41, column: 5, scope: !1868)
!1872 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1793, size: 64)
!1873 = !DILocalVariable(name: "Git",
  scope: !1868, file: !9, line: 41, type: !1872)
!1874 = !DILocation(line: 41, column: 5, scope: !1868)
!1875 = !DILocation(line: 42, column: 24, scope: !1868)
!1876 = !DILocation(line: 42, column: 32, scope: !1868)
!1877 = !DILocation(line: 42, column: 19, scope: !1868)
!1878 = !DILocation(line: 42, column: 5, scope: !1868)
!1879 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1880 = !DILocalVariable(name: "İmge",
  scope: !1868, file: !9, line: 42, type: !1879)
!1881 = !DILocation(line: 42, column: 5, scope: !1868)
!1882 = !DILocation(line: 43, column: 5, scope: !1868)
!1883 = !DILocation(line: 43, column: 5, scope: !1868)
!1884 = !DILocation(line: 43, column: 26, scope: !1868)
!1885 = !DILocation(line: 43, column: 5, scope: !1868)
!1886 = !DILocation(line: 44, column: 5, scope: !1868)
!1887 = !DILocation(line: 44, column: 5, scope: !1868)
!1888 = !DILocation(line: 44, column: 26, scope: !1868)
!1889 = !DILocation(line: 44, column: 5, scope: !1868)
!1890 = !DILocation(line: 46, column: 9, scope: !1868)
