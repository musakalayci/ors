...
@"yönerge::YeniİçDönüş_ox141i"(%gt294t* %0)#0       !dbg !1748 {
; Değişken : dönüş
...
; Değişken : Hafıza
  ...
  call void @llvm.dbg.declare(metadata %gt294t** %3, metadata !1752, metadata !DIExpression()), !dbg !1755
;;-> (nil) 0
  %4 = load %gt294t*, %gt294t** %3, align 8, !dbg !1757; 2:0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt398t** %6,
    align 8, !dbg !1759
  call void @llvm.dbg.declare(metadata %gt398t** %6, metadata !1761, metadata !DIExpression()), !dbg !1762
  %7 = load %gt398t*, %gt398t** %6, align 8, !dbg !1763; 2:0
; Dönüş :
  ret %gt398t* %7
}
...
define external 
%gt3adt* @"yönerge::_git.Yeni_ox141i"(%gt294t* %0)
#0       !dbg !1764 {
; Değişken : dönüş
...
; pascal 'Git' örs::derleme::imge::yönerge::_git
  ...
  store 
    ...
    %gt3adt** %7,
    align 8, !dbg !1775
  call void @llvm.dbg.declare(metadata %gt3adt** %7, metadata !1777, metadata !DIExpression()), !dbg !1778
;;-> (nil) 0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt398t** %10,
    align 8, !dbg !1781
  call void @llvm.dbg.declare(metadata %gt398t** %10, metadata !1783, metadata !DIExpression()), !dbg !1784
; Atama ifadesi
  %11 = load %gt398t*, %gt398t** %10, align 8, !dbg !1785; 2:0
...
; Konum çevirisi:
  ...
  %14 = load %gt3adt*, %gt3adt** %7, align 8, !dbg !1787; 2:0
;atama:
  store 
    %gt3adt* %14,
    %gt3a4t** %13,
    align 8, !dbg !1788
; Atama ifadesi
  %15 = load %gt3adt*, %gt3adt** %7, align 8, !dbg !1789; 2:0
; tür konumu *örs::derleme::imge::yönerge::_git : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt3adt, %gt3adt* %15,
    i32 0, i32 0
  %17 = load %gt398t*, %gt398t** %10, align 8, !dbg !1791; 2:0
;atama:
  store 
    %gt398t* %17,
    %gt398t** %16,
    align 8, !dbg !1792
  %18 = load %gt3adt*, %gt3adt** %7, align 8, !dbg !1793; 2:0
; Dönüş :
  ret %gt3adt* %18
}

define external 
%gt3aft* @"yönerge::içGit.Yeni_ox141i"(%gt294t* %0, i32 %1)
#0       !dbg !1794 {
; Değişken : dönüş
...
; Değişken : Hafıza
  ...
  call void @llvm.dbg.declare(metadata %gt294t** %4, metadata !1798, metadata !DIExpression()), !dbg !1802
; Değişken : özellik
  %5 = alloca i32, align 4
  store i32 %1, i32* %5, align 4
  call void @llvm.dbg.declare(metadata i32* %5, metadata !1799, metadata !DIExpression()), !dbg !1803
  %6 = load %gt294t*, %gt294t** %4, align 8, !dbg !1805; 2:0
  %7 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt294t* %6, 
      i64 16, 
      i64 8), !dbg !1806
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt3aft*; 1
...
; pascal 'Git' örs::derleme::imge::yönerge::içGit
  ...
  store 
    ...
    %gt3aft** %9,
    align 8, !dbg !1807
  call void @llvm.dbg.declare(metadata %gt3aft** %9, metadata !1809, metadata !DIExpression()), !dbg !1810
;;-> (nil) 0
  %10 = load %gt294t*, %gt294t** %4, align 8, !dbg !1811; 2:0
;;-> (nil) 0
  %11 = load i32, i32* %5, align 4, !dbg !1812; 1:0
  %12 = call %gt398t* @"imge::Yeni_ox110i" (
      %gt294t* %10, 
      i32 %11), !dbg !1813
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt398t** %13,
    align 8, !dbg !1814
  call void @llvm.dbg.declare(metadata %gt398t** %13, metadata !1816, metadata !DIExpression()), !dbg !1817
; Atama ifadesi
  %14 = load %gt3aft*, %gt3aft** %9, align 8, !dbg !1818; 2:0
; tür konumu *örs::derleme::imge::yönerge::içGit : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt3aft, %gt3aft* %14,
    i32 0, i32 0
  %16 = load %gt398t*, %gt398t** %13, align 8, !dbg !1820; 2:0
;atama:
  store 
    %gt398t* %16,
    %gt398t** %15,
    align 8, !dbg !1821
; Atama ifadesi
  %17 = load %gt398t*, %gt398t** %13, align 8, !dbg !1822; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
...
; Konum çevirisi:
  %19 = bitcast %gt397t* %18 to %gt3a6t**; 2
  %20 = load %gt3aft*, %gt3aft** %9, align 8, !dbg !1824; 2:0
;atama:
  store 
    %gt3aft* %20,
    %gt3a6t** %19,
    align 8, !dbg !1825
  %21 = load %gt3aft*, %gt3aft** %9, align 8, !dbg !1826; 2:0
; Dönüş :
  ret %gt3aft* %21
}
...
!1721 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Öz",  scope: !1719,  file: !19, line: 8, baseType: !1720, size: 64)
!1723 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Konum",  scope: !1719,  file: !19, line: 9, baseType: !1722, size: 64, offset: 64)
!1725 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Gidilen",  scope: !1719,  file: !19, line: 10, baseType: !1724, size: 64, offset: 128)
!1726 = !{!1721,!1723,!1725}
!1719 = distinct !DICompositeType(tag: DW_TAG_structure_type, 
       name: "_git", file: !19, line: 6,  size: 192, elements: !1726)
!1728 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1730 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !456, size: 64)
!1729 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Öz",  scope: !1727,  file: !19, line: 26, baseType: !1728, size: 64)
!1731 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Konum",  scope: !1727,  file: !19, line: 27, baseType: !1730, size: 64, offset: 64)
!1732 = !{!1729,!1731}
!1727 = distinct !DICompositeType(tag: DW_TAG_structure_type, 
       name: "içGit", file: !19, line: 24,  size: 128, elements: !1732)
...
!1738 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !456, size: 64)
!1740 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !456, size: 64)
!1735 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Öz",  scope: !1733,  file: !19, line: 51, baseType: !1734, size: 64)
!1737 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Koşul",  scope: !1733,  file: !19, line: 52, baseType: !1736, size: 64, offset: 64)
!1739 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Evet",  scope: !1733,  file: !19, line: 53, baseType: !1738, size: 64, offset: 128)
!1741 = !DIDerivedType(  tag: DW_TAG_member,
  name: "Hayır",  scope: !1733,  file: !19, line: 54, baseType: !1740, size: 64, offset: 192)
!1742 = !{!1735,!1737,!1739,!1741}
!1733 = distinct !DICompositeType(tag: DW_TAG_structure_type, 
       name: "koşulluGit", file: !19, line: 49,  size: 256, elements: !1742)
!1743 = !DINamespace(name:"kök", scope: null)
!1744 = !DINamespace(name:"örs", scope: !1743)
!1745 = !DINamespace(name:"derleme", scope: !1744)
!1746 = !DINamespace(name:"imge", scope: !1745)
!1747 = !DINamespace(name:"yönerge", scope: !1746)


!1749 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1750 = !DILocalVariable(name: "dönüş",
  scope: !1748, file: !9, line: 15, type: !1749)
!1751 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1752 = !DILocalVariable(name: "Hafıza",
  scope: !1748, file: !9, line: 30, type: !1751, arg: 1)
!1753 = !DISubroutineType(types: !1754)
!1754 = !{null, !1751 }
!1748 = distinct !DISubprogram( name: "yönerge::YeniİçDönüş_ox141i",
 scope: !1747,
 file: !9,
 line: 30,
 type: !1753, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;YeniİçDönüş
!1755 = !DILocation(line: 30, column: 26, scope: !1748)
!1756 = distinct !DILexicalBlock(
        scope: !1748, file: !9, line: 31, column: 3)
!1757 = !DILocation(line: 32, column: 24, scope: !1756)
!1758 = !DILocation(line: 32, column: 19, scope: !1756)
!1759 = !DILocation(line: 32, column: 5, scope: !1756)
!1760 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1761 = !DILocalVariable(name: "İmge",
  scope: !1756, file: !9, line: 32, type: !1760)
!1762 = !DILocation(line: 32, column: 5, scope: !1756)
!1763 = !DILocation(line: 33, column: 9, scope: !1756)


!1765 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1719, size: 64)
...
!1768 = !DILocalVariable(name: "Hafıza",
  scope: !1764, file: !9, line: 15, type: !1767, arg: 1)
!1769 = !DISubroutineType(types: !1770)
!1770 = !{null, !1767 }
!1764 = distinct !DISubprogram( name: "yönerge::_git.Yeni_ox141i",
 scope: !1747,
 file: !9,
 line: 14,
 type: !1769, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1771 = !DILocation(line: 15, column: 5, scope: !1764)
!1772 = distinct !DILexicalBlock(
        scope: !1764, file: !9, line: 24, column: 3)
!1773 = !DILocation(line: 17, column: 19, scope: !1772)
!1774 = !DILocation(line: 17, column: 27, scope: !1772)
!1775 = !DILocation(line: 17, column: 5, scope: !1772)
!1776 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1719, size: 64)
!1777 = !DILocalVariable(name: "Git",
  scope: !1772, file: !9, line: 17, type: !1776)
!1778 = !DILocation(line: 17, column: 5, scope: !1772)
!1779 = !DILocation(line: 18, column: 24, scope: !1772)
!1780 = !DILocation(line: 18, column: 19, scope: !1772)
!1781 = !DILocation(line: 18, column: 5, scope: !1772)
!1782 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1783 = !DILocalVariable(name: "İmge",
  scope: !1772, file: !9, line: 18, type: !1782)
!1784 = !DILocation(line: 18, column: 5, scope: !1772)
!1785 = !DILocation(line: 19, column: 5, scope: !1772)
!1786 = !DILocation(line: 19, column: 5, scope: !1772)
!1787 = !DILocation(line: 19, column: 24, scope: !1772)
!1788 = !DILocation(line: 19, column: 5, scope: !1772)
!1789 = !DILocation(line: 20, column: 5, scope: !1772)
!1790 = !DILocation(line: 20, column: 5, scope: !1772)
!1791 = !DILocation(line: 20, column: 24, scope: !1772)
!1792 = !DILocation(line: 20, column: 5, scope: !1772)
!1793 = !DILocation(line: 21, column: 9, scope: !1772)


!1795 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1727, size: 64)
...
!1798 = !DILocalVariable(name: "Hafıza",
  scope: !1794, file: !9, line: 38, type: !1797, arg: 1)
!1799 = !DILocalVariable(name: "özellik",
  scope: !1794, file: !9, line: 39, type: !12, arg: 2)
!1800 = !DISubroutineType(types: !1801)
!1801 = !{null, !1797, !12 }
!1794 = distinct !DISubprogram( name: "yönerge::içGit.Yeni_ox141i",
 scope: !1747,
 file: !9,
 line: 37,
 type: !1800, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1802 = !DILocation(line: 38, column: 5, scope: !1794)
!1803 = !DILocation(line: 39, column: 5, scope: !1794)
!1804 = distinct !DILexicalBlock(
        scope: !1794, file: !9, line: 49, column: 3)
!1805 = !DILocation(line: 41, column: 21, scope: !1804)
!1806 = !DILocation(line: 41, column: 29, scope: !1804)
!1807 = !DILocation(line: 41, column: 5, scope: !1804)
!1808 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1727, size: 64)
!1809 = !DILocalVariable(name: "Git",
  scope: !1804, file: !9, line: 41, type: !1808)
!1810 = !DILocation(line: 41, column: 5, scope: !1804)
!1811 = !DILocation(line: 42, column: 24, scope: !1804)
!1812 = !DILocation(line: 42, column: 32, scope: !1804)
!1813 = !DILocation(line: 42, column: 19, scope: !1804)
!1814 = !DILocation(line: 42, column: 5, scope: !1804)
!1815 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1816 = !DILocalVariable(name: "İmge",
  scope: !1804, file: !9, line: 42, type: !1815)
!1817 = !DILocation(line: 42, column: 5, scope: !1804)
!1818 = !DILocation(line: 43, column: 5, scope: !1804)
!1819 = !DILocation(line: 43, column: 5, scope: !1804)
!1820 = !DILocation(line: 43, column: 26, scope: !1804)
!1821 = !DILocation(line: 43, column: 5, scope: !1804)
!1822 = !DILocation(line: 44, column: 5, scope: !1804)
!1823 = !DILocation(line: 44, column: 5, scope: !1804)
!1824 = !DILocation(line: 44, column: 26, scope: !1804)
!1825 = !DILocation(line: 44, column: 5, scope: !1804)
!1826 = !DILocation(line: 46, column: 9, scope: !1804)
