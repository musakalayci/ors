...
define external 
%gt3d4t* @"ifade::hafıza.Yeni_ox14ai"(%gt294t* %0)
#0       !dbg !1724 {
; Değişken : dönüş
  %2 = alloca %gt3d4t*, align 8
  store %gt3d4t* null, %gt3d4t** %2, align 8
; Değişken : Hafıza
  ...
  %5 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1734
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt3d4t*; 1

; pascal 'Doldur' örs::derleme::imge::ifade::hafıza
  %7 = alloca %gt3d4t*, align 8
  store 
    %gt3d4t* %6,
    %gt3d4t** %7,
    align 8, !dbg !1735
  call void @llvm.dbg.declare(metadata %gt3d4t** %7, metadata !1737, metadata !DIExpression()), !dbg !1738
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt3d4t*, %gt3d4t** %7, align 8, !dbg !1745; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt397t* %15 to %gt3d4t**; 2
  %17 = load %gt3d4t*, %gt3d4t** %7, align 8, !dbg !1751; 2:0
;atama:
  store 
    %gt3d4t* %17,
    %gt3d4t** %16,
    align 8, !dbg !1752
  %18 = load %gt3d4t*, %gt3d4t** %7, align 8, !dbg !1753; 2:0
; Dönüş :
  ret %gt3d4t* %18
}
...
!1723 = !DINamespace(name:"ifade", scope: !1722)


!1725 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1695, size: 64)
...
!1728 = !DILocalVariable(name: "Hafıza",
  scope: !1724, file: !9, line: 68, type: !1727, arg: 1)
!1729 = !DISubroutineType(types: !1730)
!1730 = !{null, !1727 }
!1724 = distinct !DISubprogram( name: "ifade::hafıza.Yeni_ox14ai",
 scope: !1723,
 file: !9,
 line: 67,
 type: !1729, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1731 = !DILocation(line: 68, column: 5, scope: !1724)
!1732 = distinct !DILexicalBlock(
        scope: !1724, file: !9, line: 76, column: 1)
!1733 = !DILocation(line: 70, column: 24, scope: !1732)
!1734 = !DILocation(line: 70, column: 32, scope: !1732)
!1735 = !DILocation(line: 70, column: 5, scope: !1732)
!1736 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1695, size: 64)
!1737 = !DILocalVariable(name: "Doldur",
  scope: !1732, file: !9, line: 70, type: !1736)
!1738 = !DILocation(line: 70, column: 5, scope: !1732)
!1739 = !DILocation(line: 71, column: 26, scope: !1732)
!1740 = !DILocation(line: 71, column: 21, scope: !1732)
!1741 = !DILocation(line: 71, column: 5, scope: !1732)
!1742 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1743 = !DILocalVariable(name: "İmge",
  scope: !1732, file: !9, line: 71, type: !1742)
!1744 = !DILocation(line: 71, column: 5, scope: !1732)
!1745 = !DILocation(line: 72, column: 5, scope: !1732)
!1746 = !DILocation(line: 72, column: 5, scope: !1732)
!1747 = !DILocation(line: 72, column: 27, scope: !1732)
!1748 = !DILocation(line: 72, column: 5, scope: !1732)
!1749 = !DILocation(line: 73, column: 5, scope: !1732)
!1750 = !DILocation(line: 73, column: 5, scope: !1732)
!1751 = !DILocation(line: 73, column: 27, scope: !1732)
!1752 = !DILocation(line: 73, column: 5, scope: !1732)
!1753 = !DILocation(line: 74, column: 9, scope: !1732)
