...
define external 
%gt3fet* @"ifade::üçlü.Yeni_ox14ai"(%gt29at* %0)
#0       !dbg !1817 {
; Değişken : dönüş
  %2 = alloca %gt3fet*, align 8
  store %gt3fet* null, %gt3fet** %2, align 8
; Değişken : Hafıza
  ...
  %5 = call i8* (%gt29at*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1827
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt3fdt*; 1

; pascal 'Yeni' örs::derleme::imge::ifade::hafıza
  %7 = alloca %gt3fdt*, align 8
  store 
    %gt3fdt* %6,
    %gt3fdt** %7,
    align 8, !dbg !1828
  call void @llvm.dbg.declare(metadata %gt3fdt** %7, metadata !1830, metadata !DIExpression()), !dbg !1831
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt3fdt*, %gt3fdt** %7, align 8, !dbg !1838; 2:0
...
; Ortak çevirisi *örs::derleme::imge::içerik ==> *örs::derleme::imge::ifade::üçlü (1, 2)
; Konum çevirisi:
  %16 = bitcast %gt3bet* %15 to %gt3fet**; 2
  %17 = load %gt3fdt*, %gt3fdt** %7, align 8, !dbg !1844; 2:0
;atama:
  store 
    %gt3fdt* %17,
    %gt3fet** %16,
    align 8, !dbg !1845
  %18 = load %gt3fdt*, %gt3fdt** %7, align 8, !dbg !1846; 2:0
; Dönüş :
  ret %gt3fdt* %18
}

define external 
%gt3fdt* @"ifade::hafıza.Yeni_ox14ai"(%gt29at* %0)
#0       !dbg !1847 {
; Değişken : dönüş
...
; pascal 'Doldur' örs::derleme::imge::ifade::hafıza
  ...
  store 
    ...
    %gt3fdt** %7,
    align 8, !dbg !1858
  call void @llvm.dbg.declare(metadata %gt3fdt** %7, metadata !1860, metadata !DIExpression()), !dbg !1861
;;-> (nil) 0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3bft** %10,
    align 8, !dbg !1864
  call void @llvm.dbg.declare(metadata %gt3bft** %10, metadata !1866, metadata !DIExpression()), !dbg !1867
; Atama ifadesi
  %11 = load %gt3fdt*, %gt3fdt** %7, align 8, !dbg !1868; 2:0
; tür konumu *örs::derleme::imge::ifade::hafıza : *örs::derleme::imge::t
  %12 = getelementptr inbounds 
    %gt3fdt, %gt3fdt* %11,
    i32 0, i32 0
  %13 = load %gt3bft*, %gt3bft** %10, align 8, !dbg !1870; 2:0
;atama:
  store 
    %gt3bft* %13,
    %gt3bft** %12,
    align 8, !dbg !1871
; Atama ifadesi
  %14 = load %gt3bft*, %gt3bft** %10, align 8, !dbg !1872; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
  %15 = getelementptr inbounds 
    %gt3bft, %gt3bft* %14,
    i32 0, i32 5
...
; Konum çevirisi:
  %16 = bitcast %gt3bet* %15 to %gt3fdt**; 2
  %17 = load %gt3fdt*, %gt3fdt** %7, align 8, !dbg !1874; 2:0
;atama:
  store 
    %gt3fdt* %17,
    %gt3fdt** %16,
    align 8, !dbg !1875
  %18 = load %gt3fdt*, %gt3fdt** %7, align 8, !dbg !1876; 2:0
; Dönüş :
  ret %gt3fdt* %18
}
...
!1816 = !DINamespace(name:"ifade", scope: !1815)


!1818 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1777, size: 64)
...
!1821 = !DILocalVariable(name: "Hafıza",
  scope: !1817, file: !9, line: 74, type: !1820, arg: 1)
!1822 = !DISubroutineType(types: !1823)
!1823 = !{null, !1820 }
!1817 = distinct !DISubprogram( name: "ifade::üçlü.Yeni_ox14ai",
 scope: !1816,
 file: !9,
 line: 73,
 type: !1822, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1824 = !DILocation(line: 74, column: 5, scope: !1817)
!1825 = distinct !DILexicalBlock(
        scope: !1817, file: !9, line: 84, column: 3)
!1826 = !DILocation(line: 76, column: 22, scope: !1825)
!1827 = !DILocation(line: 76, column: 30, scope: !1825)
!1828 = !DILocation(line: 76, column: 5, scope: !1825)
!1829 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1765, size: 64)
!1830 = !DILocalVariable(name: "Yeni",
  scope: !1825, file: !9, line: 76, type: !1829)
!1831 = !DILocation(line: 76, column: 5, scope: !1825)
!1832 = !DILocation(line: 77, column: 26, scope: !1825)
!1833 = !DILocation(line: 77, column: 21, scope: !1825)
!1834 = !DILocation(line: 77, column: 5, scope: !1825)
!1835 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1836 = !DILocalVariable(name: "İmge",
  scope: !1825, file: !9, line: 77, type: !1835)
!1837 = !DILocation(line: 77, column: 5, scope: !1825)
!1838 = !DILocation(line: 78, column: 5, scope: !1825)
!1839 = !DILocation(line: 78, column: 5, scope: !1825)
!1840 = !DILocation(line: 78, column: 25, scope: !1825)
!1841 = !DILocation(line: 78, column: 5, scope: !1825)
!1842 = !DILocation(line: 79, column: 5, scope: !1825)
!1843 = !DILocation(line: 79, column: 5, scope: !1825)
!1844 = !DILocation(line: 79, column: 26, scope: !1825)
!1845 = !DILocation(line: 79, column: 5, scope: !1825)
!1846 = !DILocation(line: 80, column: 9, scope: !1825)


!1848 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1765, size: 64)
...
!1851 = !DILocalVariable(name: "Hafıza",
  scope: !1847, file: !9, line: 86, type: !1850, arg: 1)
!1852 = !DISubroutineType(types: !1853)
!1853 = !{null, !1850 }
!1847 = distinct !DISubprogram( name: "ifade::hafıza.Yeni_ox14ai",
 scope: !1816,
 file: !9,
 line: 85,
 type: !1852, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1854 = !DILocation(line: 86, column: 5, scope: !1847)
!1855 = distinct !DILexicalBlock(
        scope: !1847, file: !9, line: 94, column: 1)
!1856 = !DILocation(line: 88, column: 24, scope: !1855)
!1857 = !DILocation(line: 88, column: 32, scope: !1855)
!1858 = !DILocation(line: 88, column: 5, scope: !1855)
!1859 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1765, size: 64)
!1860 = !DILocalVariable(name: "Doldur",
  scope: !1855, file: !9, line: 88, type: !1859)
!1861 = !DILocation(line: 88, column: 5, scope: !1855)
!1862 = !DILocation(line: 89, column: 26, scope: !1855)
!1863 = !DILocation(line: 89, column: 21, scope: !1855)
!1864 = !DILocation(line: 89, column: 5, scope: !1855)
!1865 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1866 = !DILocalVariable(name: "İmge",
  scope: !1855, file: !9, line: 89, type: !1865)
!1867 = !DILocation(line: 89, column: 5, scope: !1855)
!1868 = !DILocation(line: 90, column: 5, scope: !1855)
!1869 = !DILocation(line: 90, column: 5, scope: !1855)
!1870 = !DILocation(line: 90, column: 27, scope: !1855)
!1871 = !DILocation(line: 90, column: 5, scope: !1855)
!1872 = !DILocation(line: 91, column: 5, scope: !1855)
!1873 = !DILocation(line: 91, column: 5, scope: !1855)
!1874 = !DILocation(line: 91, column: 27, scope: !1855)
!1875 = !DILocation(line: 91, column: 5, scope: !1855)
!1876 = !DILocation(line: 92, column: 9, scope: !1855)
