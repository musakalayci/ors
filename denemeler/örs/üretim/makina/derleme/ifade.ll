...
define external 
%gt3e0t* @"ifade::hafıza.Yeni_ox14ai"(%gt294t* %0)
#0       !dbg !1764 {
; Değişken : dönüş
...
; Değişken : Hafıza
  ...
  %5 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1774
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt3e0t*; 1

; pascal 'Doldur' örs::derleme::imge::ifade::hafıza
  %7 = alloca %gt3e0t*, align 8
  store 
    %gt3e0t* %6,
    %gt3e0t** %7,
    align 8, !dbg !1775
  call void @llvm.dbg.declare(metadata %gt3e0t** %7, metadata !1777, metadata !DIExpression()), !dbg !1778
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt3e0t*, %gt3e0t** %7, align 8, !dbg !1785; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt3a1t* %15 to %gt3e0t**; 2
  %17 = load %gt3e0t*, %gt3e0t** %7, align 8, !dbg !1791; 2:0
;atama:
  store 
    %gt3e0t* %17,
    %gt3e0t** %16,
    align 8, !dbg !1792
  %18 = load %gt3e0t*, %gt3e0t** %7, align 8, !dbg !1793; 2:0
; Dönüş :
  ret %gt3e0t* %18
}
...
!1763 = !DINamespace(name:"ifade", scope: !1762)


!1765 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1735, size: 64)
...
!1768 = !DILocalVariable(name: "Hafıza",
  scope: !1764, file: !9, line: 68, type: !1767, arg: 1)
!1769 = !DISubroutineType(types: !1770)
!1770 = !{null, !1767 }
!1764 = distinct !DISubprogram( name: "ifade::hafıza.Yeni_ox14ai",
 scope: !1763,
 file: !9,
 line: 67,
 type: !1769, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1771 = !DILocation(line: 68, column: 5, scope: !1764)
!1772 = distinct !DILexicalBlock(
        scope: !1764, file: !9, line: 76, column: 1)
!1773 = !DILocation(line: 70, column: 24, scope: !1772)
!1774 = !DILocation(line: 70, column: 32, scope: !1772)
!1775 = !DILocation(line: 70, column: 5, scope: !1772)
!1776 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1735, size: 64)
!1777 = !DILocalVariable(name: "Doldur",
  scope: !1772, file: !9, line: 70, type: !1776)
!1778 = !DILocation(line: 70, column: 5, scope: !1772)
!1779 = !DILocation(line: 71, column: 26, scope: !1772)
!1780 = !DILocation(line: 71, column: 21, scope: !1772)
!1781 = !DILocation(line: 71, column: 5, scope: !1772)
!1782 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1783 = !DILocalVariable(name: "İmge",
  scope: !1772, file: !9, line: 71, type: !1782)
!1784 = !DILocation(line: 71, column: 5, scope: !1772)
!1785 = !DILocation(line: 72, column: 5, scope: !1772)
!1786 = !DILocation(line: 72, column: 5, scope: !1772)
!1787 = !DILocation(line: 72, column: 27, scope: !1772)
!1788 = !DILocation(line: 72, column: 5, scope: !1772)
!1789 = !DILocation(line: 73, column: 5, scope: !1772)
!1790 = !DILocation(line: 73, column: 5, scope: !1772)
!1791 = !DILocation(line: 73, column: 27, scope: !1772)
!1792 = !DILocation(line: 73, column: 5, scope: !1772)
!1793 = !DILocation(line: 74, column: 9, scope: !1772)
