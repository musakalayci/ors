...
define external 
%gt22bt* @"ifade::hafıza.Yeni_ox126i"(%gt1e0t* %0)
#0       {
; Değişken : dönüş
...
; Değişken : Hafıza
  ...
  %5 = call i8* (%gt1e0t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      ...
      i64 8)
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt22bt*; 1

; pascal 'Doldur' örs::derleme::imge::ifade::hafıza
  %7 = alloca %gt22bt*, align 8
  store 
    %gt22bt* %6,
    %gt22bt** %7,
    align 8
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    align 8
; Atama ifadesi
  %11 = load %gt22bt*, %gt22bt** %7, align 8; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt230t* %15 to %gt22bt**; 2
  %17 = load %gt22bt*, %gt22bt** %7, align 8; 2:0
;atama:
  store 
    %gt22bt* %17,
    %gt22bt** %16,
    align 8
  %18 = load %gt22bt*, %gt22bt** %7, align 8; 2:0
; Dönüş :
  ret %gt22bt* %18
}
