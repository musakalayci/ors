...
define external 
%gt3e4t* @"ifade::hafıza.Yeni_ox14ai"(%gt296t* %0)
#0       !dbg !1790 {
; Değişken : dönüş
...
; pascal 'Doldur' örs::derleme::imge::ifade::hafıza
  ...
  store 
    ...
    %gt3e4t** %7,
    align 8, !dbg !1801
  call void @llvm.dbg.declare(metadata %gt3e4t** %7, metadata !1803, metadata !DIExpression()), !dbg !1804
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt3e4t*, %gt3e4t** %7, align 8, !dbg !1811; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt3a5t* %15 to %gt3e4t**; 2
  %17 = load %gt3e4t*, %gt3e4t** %7, align 8, !dbg !1817; 2:0
;atama:
  store 
    %gt3e4t* %17,
    %gt3e4t** %16,
    align 8, !dbg !1818
  %18 = load %gt3e4t*, %gt3e4t** %7, align 8, !dbg !1819; 2:0
; Dönüş :
  ret %gt3e4t* %18
}
...
!1789 = !DINamespace(name:"ifade", scope: !1788)


!1791 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1761, size: 64)
...
!1794 = !DILocalVariable(name: "Hafıza",
  scope: !1790, file: !9, line: 68, type: !1793, arg: 1)
!1795 = !DISubroutineType(types: !1796)
!1796 = !{null, !1793 }
!1790 = distinct !DISubprogram( name: "ifade::hafıza.Yeni_ox14ai",
 scope: !1789,
 file: !9,
 line: 67,
 type: !1795, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1797 = !DILocation(line: 68, column: 5, scope: !1790)
!1798 = distinct !DILexicalBlock(
        scope: !1790, file: !9, line: 76, column: 1)
!1799 = !DILocation(line: 70, column: 24, scope: !1798)
!1800 = !DILocation(line: 70, column: 32, scope: !1798)
!1801 = !DILocation(line: 70, column: 5, scope: !1798)
!1802 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1761, size: 64)
!1803 = !DILocalVariable(name: "Doldur",
  scope: !1798, file: !9, line: 70, type: !1802)
!1804 = !DILocation(line: 70, column: 5, scope: !1798)
!1805 = !DILocation(line: 71, column: 26, scope: !1798)
!1806 = !DILocation(line: 71, column: 21, scope: !1798)
!1807 = !DILocation(line: 71, column: 5, scope: !1798)
!1808 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1809 = !DILocalVariable(name: "İmge",
  scope: !1798, file: !9, line: 71, type: !1808)
!1810 = !DILocation(line: 71, column: 5, scope: !1798)
!1811 = !DILocation(line: 72, column: 5, scope: !1798)
!1812 = !DILocation(line: 72, column: 5, scope: !1798)
!1813 = !DILocation(line: 72, column: 27, scope: !1798)
!1814 = !DILocation(line: 72, column: 5, scope: !1798)
!1815 = !DILocation(line: 73, column: 5, scope: !1798)
!1816 = !DILocation(line: 73, column: 5, scope: !1798)
!1817 = !DILocation(line: 73, column: 27, scope: !1798)
!1818 = !DILocation(line: 73, column: 5, scope: !1798)
!1819 = !DILocation(line: 74, column: 9, scope: !1798)
