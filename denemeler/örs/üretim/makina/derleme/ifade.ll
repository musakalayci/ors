...
define external 
%gt2d6t* @"ifade::hafıza.Yeni_i"(%gt263t* %0)
#0       !dbg !1144 {
; Değişken : dönüş
  %2 = alloca %gt2d6t*, align 8
  store %gt2d6t* null, %gt2d6t** %2, align 8
; Değişken : Hafıza
  ...
  %5 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      ...
      i64 8), !dbg !1154
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt2d6t*; 1

; pascal 'Doldur' örs::derleme::imge::ifade::hafıza
  %7 = alloca %gt2d6t*, align 8
  store 
    %gt2d6t* %6,
    %gt2d6t** %7,
    align 8, !dbg !1155
  call void @llvm.dbg.declare(metadata %gt2d6t** %7, metadata !1157, metadata !DIExpression()), !dbg !1158
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt2d6t*, %gt2d6t** %7, align 8, !dbg !1165; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt2c1t* %15 to %gt2d6t**; 2
  %17 = load %gt2d6t*, %gt2d6t** %7, align 8, !dbg !1171; 2:0
  store 
    %gt2d6t* %17,
    %gt2d6t** %16,
    align 8, !dbg !1172
  %18 = load %gt2d6t*, %gt2d6t** %7, align 8, !dbg !1173; 2:0
; Dönüş :
  ret %gt2d6t* %18
}
...
!1143 = !DINamespace(name:"ifade", scope: !1142)


!1145 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1089, size: 64)
...
!1148 = !DILocalVariable(name: "Hafıza",
  scope: !1144, file: !9, line: 38, type: !1147, arg: 1)
!1149 = !DISubroutineType(types: !1150)
!1150 = !{null, !1147 }
!1144 = distinct !DISubprogram( name: "ifade::hafıza.Yeni_i",
 scope: !1143,
 file: !9,
 line: 37,
 type: !1149, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1151 = !DILocation(line: 38, column: 5, scope: !1144)
!1152 = distinct !DILexicalBlock(
        scope: !1144, file: !9, line: 46, column: 1)
!1153 = !DILocation(line: 40, column: 24, scope: !1152)
!1154 = !DILocation(line: 40, column: 32, scope: !1152)
!1155 = !DILocation(line: 40, column: 5, scope: !1152)
!1156 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1089, size: 64)
!1157 = !DILocalVariable(name: "Doldur",
  scope: !1152, file: !9, line: 40, type: !1156)
!1158 = !DILocation(line: 40, column: 5, scope: !1152)
!1159 = !DILocation(line: 41, column: 26, scope: !1152)
!1160 = !DILocation(line: 41, column: 21, scope: !1152)
!1161 = !DILocation(line: 41, column: 5, scope: !1152)
!1162 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1163 = !DILocalVariable(name: "İmge",
  scope: !1152, file: !9, line: 41, type: !1162)
!1164 = !DILocation(line: 41, column: 5, scope: !1152)
!1165 = !DILocation(line: 42, column: 5, scope: !1152)
!1166 = !DILocation(line: 42, column: 5, scope: !1152)
!1167 = !DILocation(line: 42, column: 27, scope: !1152)
!1168 = !DILocation(line: 42, column: 5, scope: !1152)
!1169 = !DILocation(line: 43, column: 5, scope: !1152)
!1170 = !DILocation(line: 43, column: 5, scope: !1152)
!1171 = !DILocation(line: 43, column: 27, scope: !1152)
!1172 = !DILocation(line: 43, column: 5, scope: !1152)
!1173 = !DILocation(line: 44, column: 9, scope: !1152)
