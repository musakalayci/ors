...
define external 
%gt22et* @"ifade::hafıza.Yeni_ox126i"(%gt1e2t* %0)
#0       !dbg !1580 {
; Değişken : dönüş
...
; pascal 'Doldur' örs::derleme::imge::ifade::hafıza
  ...
  store 
    ...
    %gt22et** %7,
    align 8, !dbg !1591
  call void @llvm.dbg.declare(metadata %gt22et** %7, metadata !1593, metadata !DIExpression()), !dbg !1594
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt22et*, %gt22et** %7, align 8, !dbg !1601; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt233t* %15 to %gt22et**; 2
  %17 = load %gt22et*, %gt22et** %7, align 8, !dbg !1607; 2:0
;atama:
  store 
    %gt22et* %17,
    %gt22et** %16,
    align 8, !dbg !1608
  %18 = load %gt22et*, %gt22et** %7, align 8, !dbg !1609; 2:0
; Dönüş :
  ret %gt22et* %18
}
...
!1579 = !DINamespace(name:"ifade", scope: !1578)


!1581 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1551, size: 64)
...
!1584 = !DILocalVariable(name: "Hafıza",
  scope: !1580, file: !9, line: 68, type: !1583, arg: 1)
!1585 = !DISubroutineType(types: !1586)
!1586 = !{null, !1583 }
!1580 = distinct !DISubprogram( name: "ifade::hafıza.Yeni_ox126i",
 scope: !1579,
 file: !9,
 line: 67,
 type: !1585, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1587 = !DILocation(line: 68, column: 5, scope: !1580)
!1588 = distinct !DILexicalBlock(
        scope: !1580, file: !9, line: 76, column: 1)
!1589 = !DILocation(line: 70, column: 24, scope: !1588)
!1590 = !DILocation(line: 70, column: 32, scope: !1588)
!1591 = !DILocation(line: 70, column: 5, scope: !1588)
!1592 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1551, size: 64)
!1593 = !DILocalVariable(name: "Doldur",
  scope: !1588, file: !9, line: 70, type: !1592)
!1594 = !DILocation(line: 70, column: 5, scope: !1588)
!1595 = !DILocation(line: 71, column: 26, scope: !1588)
!1596 = !DILocation(line: 71, column: 21, scope: !1588)
!1597 = !DILocation(line: 71, column: 5, scope: !1588)
!1598 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1599 = !DILocalVariable(name: "İmge",
  scope: !1588, file: !9, line: 71, type: !1598)
!1600 = !DILocation(line: 71, column: 5, scope: !1588)
!1601 = !DILocation(line: 72, column: 5, scope: !1588)
!1602 = !DILocation(line: 72, column: 5, scope: !1588)
!1603 = !DILocation(line: 72, column: 27, scope: !1588)
!1604 = !DILocation(line: 72, column: 5, scope: !1588)
!1605 = !DILocation(line: 73, column: 5, scope: !1588)
!1606 = !DILocation(line: 73, column: 5, scope: !1588)
!1607 = !DILocation(line: 73, column: 27, scope: !1588)
!1608 = !DILocation(line: 73, column: 5, scope: !1588)
!1609 = !DILocation(line: 74, column: 9, scope: !1588)
