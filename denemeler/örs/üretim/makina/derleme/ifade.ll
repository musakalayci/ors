...
define external 
%gt3f9t* @"ifade::hafıza.Yeni_ox14ai"(%gt29at* %0)
#0       !dbg !1807 {
; Değişken : dönüş
...
; Değişken : Hafıza
  ...
  %5 = call i8* (%gt29at*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1817
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt3f9t*; 1

; pascal 'Doldur' örs::derleme::imge::ifade::hafıza
  %7 = alloca %gt3f9t*, align 8
  store 
    %gt3f9t* %6,
    %gt3f9t** %7,
    align 8, !dbg !1818
  call void @llvm.dbg.declare(metadata %gt3f9t** %7, metadata !1820, metadata !DIExpression()), !dbg !1821
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt3f9t*, %gt3f9t** %7, align 8, !dbg !1828; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt3bat* %15 to %gt3f9t**; 2
  %17 = load %gt3f9t*, %gt3f9t** %7, align 8, !dbg !1834; 2:0
;atama:
  store 
    %gt3f9t* %17,
    %gt3f9t** %16,
    align 8, !dbg !1835
  %18 = load %gt3f9t*, %gt3f9t** %7, align 8, !dbg !1836; 2:0
; Dönüş :
  ret %gt3f9t* %18
}
...
!1806 = !DINamespace(name:"ifade", scope: !1805)


!1808 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1767, size: 64)
...
!1811 = !DILocalVariable(name: "Hafıza",
  scope: !1807, file: !9, line: 68, type: !1810, arg: 1)
!1812 = !DISubroutineType(types: !1813)
!1813 = !{null, !1810 }
!1807 = distinct !DISubprogram( name: "ifade::hafıza.Yeni_ox14ai",
 scope: !1806,
 file: !9,
 line: 67,
 type: !1812, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1814 = !DILocation(line: 68, column: 5, scope: !1807)
!1815 = distinct !DILexicalBlock(
        scope: !1807, file: !9, line: 76, column: 1)
!1816 = !DILocation(line: 70, column: 24, scope: !1815)
!1817 = !DILocation(line: 70, column: 32, scope: !1815)
!1818 = !DILocation(line: 70, column: 5, scope: !1815)
!1819 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1767, size: 64)
!1820 = !DILocalVariable(name: "Doldur",
  scope: !1815, file: !9, line: 70, type: !1819)
!1821 = !DILocation(line: 70, column: 5, scope: !1815)
!1822 = !DILocation(line: 71, column: 26, scope: !1815)
!1823 = !DILocation(line: 71, column: 21, scope: !1815)
!1824 = !DILocation(line: 71, column: 5, scope: !1815)
!1825 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1826 = !DILocalVariable(name: "İmge",
  scope: !1815, file: !9, line: 71, type: !1825)
!1827 = !DILocation(line: 71, column: 5, scope: !1815)
!1828 = !DILocation(line: 72, column: 5, scope: !1815)
!1829 = !DILocation(line: 72, column: 5, scope: !1815)
!1830 = !DILocation(line: 72, column: 27, scope: !1815)
!1831 = !DILocation(line: 72, column: 5, scope: !1815)
!1832 = !DILocation(line: 73, column: 5, scope: !1815)
!1833 = !DILocation(line: 73, column: 5, scope: !1815)
!1834 = !DILocation(line: 73, column: 27, scope: !1815)
!1835 = !DILocation(line: 73, column: 5, scope: !1815)
!1836 = !DILocation(line: 74, column: 9, scope: !1815)
