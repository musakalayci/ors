...
@"arama::_AramadanBelleğe_ox119i"(%gt398t* %0, %gtd9t* %1)#0       !dbg !1715 {
; Değişken : dönüş
...
; Değişken : Arama
  ...
  call void @llvm.dbg.declare(metadata %gt398t** %4, metadata !1719, metadata !DIExpression()), !dbg !1724
; Değişken : Bellek
  %5 = alloca %gtd9t*, align 8
  store %gtd9t* %1, %gtd9t** %5, align 8
  call void @llvm.dbg.declare(metadata %gtd9t** %5, metadata !1721, metadata !DIExpression()), !dbg !1725
; Durum 0
  br label %durum.ox0
durum.ox0:
  %6 = load %gt398t*, %gt398t** %4, align 8, !dbg !1727; 2:0
; tür konumu *örs::derleme::imge::t : *t32
  %7 = getelementptr inbounds 
    %gt398t, %gt398t* %6,
    i32 0, i32 0
  %8 = load i32, i32* %7, align 4, !dbg !1729; 1:0
...
secim.ox0.ox1:
  %10 = load %gt398t*, %gt398t** %4, align 8, !dbg !1732; 2:0
...
; Konum çevirisi:
  %12 = bitcast %gt397t* %11 to %gt3d0t**; 2
  %13 = load %gt3d0t*, %gt3d0t** %12, align 8, !dbg !1734; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %14 = getelementptr inbounds 
    %gt3d0t, %gt3d0t* %13,
    i32 0, i32 2
;;-> (nil) 14
  %15 = load %gt398t*, %gt398t** %14, align 8, !dbg !1736; 2:0
;;-> (nil) 0
  %16 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1737; 2:0
  %17 = call i32 @"arama::_AramadanBelleğe_ox119i" (
      %gt398t* %15, 
      %gtd9t* %16), !dbg !1738
  %18 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1739; 2:0
 call void @"bellek::t.Yaz_ox122i" (
      %gtd9t* %18, 
      i8* getelementptr inbounds ([8 x i8], [8 x i8]* @h.ox281.ox0, i64 0, i64 0)), !dbg !1740
  %19 = load %gt398t*, %gt398t** %4, align 8, !dbg !1741; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
...
; Ortak çevirisi *örs::derleme::imge::içerik ==> *örs::derleme::imge::temel::t (1, 2)
; Konum çevirisi:
  %21 = bitcast %gt397t* %20 to %gt3d0t**; 2
  %22 = load %gt3d0t*, %gt3d0t** %21, align 8, !dbg !1743; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %23 = getelementptr inbounds 
    %gt3d0t, %gt3d0t* %22,
    i32 0, i32 3
;;-> (nil) 14
  %24 = load %gt398t*, %gt398t** %23, align 8, !dbg !1745; 2:0
;;-> (nil) 0
  %25 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1746; 2:0
  %26 = call i32 @"arama::_AramadanBelleğe_ox119i" (
      %gt398t* %24, 
      %gtd9t* %25), !dbg !1747
  br label %durum.son.ox0
secim.ox0.ox2:
  %27 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1749; 2:0
  %28 = load %gt398t*, %gt398t** %4, align 8, !dbg !1750; 2:0
; tür konumu *örs::derleme::imge::t : *örs::üzengi::metin
  %29 = getelementptr inbounds 
    %gt398t, %gt398t* %28,
    i32 0, i32 2
  %30 = load %metin*, %metin** %29, align 8, !dbg !1752; 2:0
; tür konumu *örs::üzengi::metin : *t8
  %31 = getelementptr inbounds 
    %metin, %metin* %30,
    i32 0, i32 2
;;-> (nil) 14
  %32 = load i8*, i8** %31, align 8, !dbg !1754; 2:0
 call void @"bellek::t.Yaz_ox122i" (
      %gtd9t* %27, 
...
durum.varsayilan.ox0:
  %33 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1757; 2:0
 call void @"bellek::t.Yaz_ox122i" (
      %gtd9t* %33, 
      %metin* getelementptr inbounds (%metin, %metin* @m.ox281.ox2, i64 0)), !dbg !1758
  br label %durum.son.ox0
durum.son.ox0:
; Iç Dönüş :
  %34 = load i32, i32* %3, align 4, !dbg !1759; 1:0
  ret i32 %34
}

;örs::derleme::arama::AramadanBelleğe
define external i32 
@"arama::AramadanBelleğe_ox119i"(%gt398t* %0, %gtd9t* %1)#0       !dbg !1760 {
; Değişken : dönüş
  %3 = alloca i32, align 4
  store i32 0, i32* %3, align 4 ; 0 
; Değişken : Arama
  %4 = alloca %gt398t*, align 8
  store %gt398t* %0, %gt398t** %4, align 8
  call void @llvm.dbg.declare(metadata %gt398t** %4, metadata !1763, metadata !DIExpression()), !dbg !1768
; Değişken : Bellek
  %5 = alloca %gtd9t*, align 8
  store %gtd9t* %1, %gtd9t** %5, align 8
  call void @llvm.dbg.declare(metadata %gtd9t** %5, metadata !1765, metadata !DIExpression()), !dbg !1769
  %6 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1771; 2:0
...
; Sanal bitiş : Sıfırla
;;-> (nil) 0
  %10 = load %gt398t*, %gt398t** %4, align 8, !dbg !1778; 2:0
;;-> (nil) 0
  %11 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1779; 2:0
  %12 = call i32 @"arama::_AramadanBelleğe_ox119i" (
      %gt398t* %10, 
      %gtd9t* %11), !dbg !1780
; Iç Dönüş :
  %13 = load i32, i32* %3, align 4, !dbg !1781; 1:0
  ret i32 %13
}

;örs::derleme::arama::_safArama
define private dso_local %gt387t* 
@"arama::_safArama_ox119i"()#0       !dbg !1782 {
; Değişken : dönüş
  %1 = alloca %gt387t*, align 8
  store %gt387t* null, %gt387t** %1, align 8
; Iç Dönüş :
  %2 = load %gt387t*, %gt387t** %1, align 8, !dbg !1788; 2:0
  ret %gt387t* %2
}
...
!1714 = !DINamespace(name:"arama", scope: !1713)
...
!1717 = !DILocalVariable(name: "dönüş",
  scope: !1715, file: !1716, line: 15, type: !12)
!1718 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1720 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !99, size: 64)
!1719 = !DILocalVariable(name: "Arama",
  scope: !1715, file: !1716, line: 8, type: !1718, arg: 1)
!1721 = !DILocalVariable(name: "Bellek",
  scope: !1715, file: !1716, line: 9, type: !1720, arg: 2)
!1722 = !DISubroutineType(types: !1723)
!1723 = !{null, !1718, !1720 }
!1715 = distinct !DISubprogram( name: "arama::_AramadanBelleğe_ox119i",
 scope: !1714,
 file: !1716,
 line: 7,
 type: !1722, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;_AramadanBelleğe
!1724 = !DILocation(line: 8, column: 3, scope: !1715)
!1725 = !DILocation(line: 9, column: 3, scope: !1715)
!1726 = distinct !DILexicalBlock(
        scope: !1715, file: !1716, line: 10, column: 1)
!1727 = !DILocation(line: 13, column: 9, scope: !1726)
!1728 = !DILocation(line: 13, column: 9, scope: !1726)
!1729 = !DILocation(line: 13, column: 9, scope: !1726)
!1730 = distinct !DILexicalBlock(
        scope: !1726, file: !1716, line: 16, column: 5)
!1731 = distinct !DILexicalBlock(
        scope: !1730, file: !1716, line: 16, column: 5)
!1732 = !DILocation(line: 17, column: 24, scope: !1731)
!1733 = !DILocation(line: 17, column: 24, scope: !1731)
!1734 = !DILocation(line: 17, column: 24, scope: !1731)
!1735 = !DILocation(line: 17, column: 24, scope: !1731)
!1736 = !DILocation(line: 17, column: 24, scope: !1731)
!1737 = !DILocation(line: 17, column: 50, scope: !1731)
!1738 = !DILocation(line: 17, column: 7, scope: !1731)
!1739 = !DILocation(line: 18, column: 7, scope: !1731)
!1740 = !DILocation(line: 18, column: 15, scope: !1731)
!1741 = !DILocation(line: 19, column: 24, scope: !1731)
!1742 = !DILocation(line: 19, column: 24, scope: !1731)
!1743 = !DILocation(line: 19, column: 24, scope: !1731)
!1744 = !DILocation(line: 19, column: 24, scope: !1731)
!1745 = !DILocation(line: 19, column: 24, scope: !1731)
!1746 = !DILocation(line: 19, column: 50, scope: !1731)
!1747 = !DILocation(line: 19, column: 7, scope: !1731)
!1748 = distinct !DILexicalBlock(
        scope: !1726, file: !1716, line: 22, column: 3)
!1749 = !DILocation(line: 23, column: 7, scope: !1748)
!1750 = !DILocation(line: 23, column: 25, scope: !1748)
!1751 = !DILocation(line: 23, column: 25, scope: !1748)
!1752 = !DILocation(line: 23, column: 25, scope: !1748)
!1753 = !DILocation(line: 23, column: 25, scope: !1748)
!1754 = !DILocation(line: 23, column: 25, scope: !1748)
!1755 = !DILocation(line: 23, column: 15, scope: !1748)
!1756 = distinct !DILexicalBlock(
        scope: !1726, file: !1716, line: 24, column: 5)
!1757 = !DILocation(line: 26, column: 7, scope: !1756)
!1758 = !DILocation(line: 26, column: 15, scope: !1756)
!1759 = !DILocation(line: 9, column: 22, scope: !1715)


!1761 = !DILocalVariable(name: "dönüş",
  scope: !1760, file: !1716, line: 15, type: !12)
!1762 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1764 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !99, size: 64)
!1763 = !DILocalVariable(name: "Arama",
  scope: !1760, file: !1716, line: 31, type: !1762, arg: 1)
!1765 = !DILocalVariable(name: "Bellek",
  scope: !1760, file: !1716, line: 32, type: !1764, arg: 2)
!1766 = !DISubroutineType(types: !1767)
!1767 = !{null, !1762, !1764 }
!1760 = distinct !DISubprogram( name: "arama::AramadanBelleğe_ox119i",
 scope: !1714,
 file: !1716,
 line: 30,
 type: !1766, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;AramadanBelleğe
!1768 = !DILocation(line: 31, column: 3, scope: !1760)
!1769 = !DILocation(line: 32, column: 3, scope: !1760)
!1770 = distinct !DILexicalBlock(
        scope: !1760, file: !1716, line: 33, column: 1)
!1771 = !DILocation(line: 34, column: 3, scope: !1770)
!1772 = distinct !DILexicalBlock(
        scope: !1770, file: !1716, line: 34, column: 11)
!1773 = distinct !DILexicalBlock(
        scope: !1772, file: !1716, line: 21, column: 3)
...
!1778 = !DILocation(line: 35, column: 20, scope: !1770)
!1779 = !DILocation(line: 35, column: 27, scope: !1770)
!1780 = !DILocation(line: 35, column: 3, scope: !1770)
!1781 = !DILocation(line: 32, column: 22, scope: !1760)


!1783 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !57, size: 64)
!1784 = !DILocalVariable(name: "dönüş",
  scope: !1782, file: !1716, line: 15, type: !1783)
!1785 = !DISubroutineType(types: !1786)
!1786 = !{null }
!1782 = distinct !DISubprogram( name: "arama::_safArama_ox119i",
 scope: !1714,
 file: !1716,
 line: 38,
...
!1787 = distinct !DILexicalBlock(
        scope: !1782, file: !1716, line: 39, column: 1)
!1788 = !DILocation(line: 38, column: 15, scope: !1782)
