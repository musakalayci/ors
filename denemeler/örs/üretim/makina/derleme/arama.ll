...
@"arama::_AramadanBelleğe_ox119i"(%gt3a2t* %0, %gtd9t* %1)#0       !dbg !1763 {
; Değişken : dönüş
...
; Değişken : Arama
  ...
  call void @llvm.dbg.declare(metadata %gt3a2t** %4, metadata !1767, metadata !DIExpression()), !dbg !1772
; Değişken : Bellek
  %5 = alloca %gtd9t*, align 8
  store %gtd9t* %1, %gtd9t** %5, align 8
  call void @llvm.dbg.declare(metadata %gtd9t** %5, metadata !1769, metadata !DIExpression()), !dbg !1773
; Durum 0
  br label %durum.ox0
durum.ox0:
  %6 = load %gt3a2t*, %gt3a2t** %4, align 8, !dbg !1775; 2:0
; tür konumu *örs::derleme::imge::t : *t32
  %7 = getelementptr inbounds 
    %gt3a2t, %gt3a2t* %6,
    i32 0, i32 0
  %8 = load i32, i32* %7, align 4, !dbg !1777; 1:0
...
secim.ox0.ox1:
  %10 = load %gt3a2t*, %gt3a2t** %4, align 8, !dbg !1780; 2:0
...
; Konum çevirisi:
  %12 = bitcast %gt3a1t* %11 to %gt3det**; 2
  %13 = load %gt3det*, %gt3det** %12, align 8, !dbg !1782; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %14 = getelementptr inbounds 
    %gt3det, %gt3det* %13,
    i32 0, i32 2
;;-> (nil) 14
  %15 = load %gt3a2t*, %gt3a2t** %14, align 8, !dbg !1784; 2:0
;;-> (nil) 0
  %16 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1785; 2:0
  %17 = call i32 @"arama::_AramadanBelleğe_ox119i" (
      %gt3a2t* %15, 
      %gtd9t* %16), !dbg !1786
  %18 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1787; 2:0
 call void @"bellek::t.Yaz_ox122i" (
      %gtd9t* %18, 
      i8* getelementptr inbounds ([8 x i8], [8 x i8]* @h.ox281.ox0, i64 0, i64 0)), !dbg !1788
  %19 = load %gt3a2t*, %gt3a2t** %4, align 8, !dbg !1789; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
...
; Ortak çevirisi *örs::derleme::imge::içerik ==> *örs::derleme::imge::temel::t (1, 2)
; Konum çevirisi:
  %21 = bitcast %gt3a1t* %20 to %gt3det**; 2
  %22 = load %gt3det*, %gt3det** %21, align 8, !dbg !1791; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %23 = getelementptr inbounds 
    %gt3det, %gt3det* %22,
    i32 0, i32 3
;;-> (nil) 14
  %24 = load %gt3a2t*, %gt3a2t** %23, align 8, !dbg !1793; 2:0
;;-> (nil) 0
  %25 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1794; 2:0
  %26 = call i32 @"arama::_AramadanBelleğe_ox119i" (
      %gt3a2t* %24, 
      %gtd9t* %25), !dbg !1795
  br label %durum.son.ox0
secim.ox0.ox2:
  %27 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1797; 2:0
  %28 = load %gt3a2t*, %gt3a2t** %4, align 8, !dbg !1798; 2:0
; tür konumu *örs::derleme::imge::t : *örs::üzengi::metin
  %29 = getelementptr inbounds 
    %gt3a2t, %gt3a2t* %28,
    i32 0, i32 2
  %30 = load %metin*, %metin** %29, align 8, !dbg !1800; 2:0
; tür konumu *örs::üzengi::metin : *t8
  %31 = getelementptr inbounds 
    %metin, %metin* %30,
    i32 0, i32 2
;;-> (nil) 14
  %32 = load i8*, i8** %31, align 8, !dbg !1802; 2:0
 call void @"bellek::t.Yaz_ox122i" (
      %gtd9t* %27, 
...
durum.varsayilan.ox0:
  %33 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1805; 2:0
 call void @"bellek::t.Yaz_ox122i" (
      %gtd9t* %33, 
      %metin* getelementptr inbounds (%metin, %metin* @m.ox281.ox2, i64 0)), !dbg !1806
  br label %durum.son.ox0
durum.son.ox0:
; Iç Dönüş :
  %34 = load i32, i32* %3, align 4, !dbg !1807; 1:0
  ret i32 %34
}

;örs::derleme::arama::AramadanBelleğe
define external i32 
@"arama::AramadanBelleğe_ox119i"(%gt3a2t* %0, %gtd9t* %1)#0       !dbg !1808 {
; Değişken : dönüş
  %3 = alloca i32, align 4
  store i32 0, i32* %3, align 4 ; 0 
; Değişken : Arama
  %4 = alloca %gt3a2t*, align 8
  store %gt3a2t* %0, %gt3a2t** %4, align 8
  call void @llvm.dbg.declare(metadata %gt3a2t** %4, metadata !1811, metadata !DIExpression()), !dbg !1816
; Değişken : Bellek
  %5 = alloca %gtd9t*, align 8
  store %gtd9t* %1, %gtd9t** %5, align 8
  call void @llvm.dbg.declare(metadata %gtd9t** %5, metadata !1813, metadata !DIExpression()), !dbg !1817
  %6 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1819; 2:0
...
; Sanal bitiş : Sıfırla
;;-> (nil) 0
  %10 = load %gt3a2t*, %gt3a2t** %4, align 8, !dbg !1826; 2:0
;;-> (nil) 0
  %11 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1827; 2:0
  %12 = call i32 @"arama::_AramadanBelleğe_ox119i" (
      %gt3a2t* %10, 
      %gtd9t* %11), !dbg !1828
; Iç Dönüş :
  %13 = load i32, i32* %3, align 4, !dbg !1829; 1:0
  ret i32 %13
}

;örs::derleme::arama::_safArama
define private dso_local %gt391t* 
@"arama::_safArama_ox119i"()#0       !dbg !1830 {
; Değişken : dönüş
  %1 = alloca %gt391t*, align 8
  store %gt391t* null, %gt391t** %1, align 8
; Iç Dönüş :
  %2 = load %gt391t*, %gt391t** %1, align 8, !dbg !1836; 2:0
  ret %gt391t* %2
}
...
!1762 = !DINamespace(name:"arama", scope: !1761)
...
!1765 = !DILocalVariable(name: "dönüş",
  scope: !1763, file: !1764, line: 15, type: !12)
!1766 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1768 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !99, size: 64)
!1767 = !DILocalVariable(name: "Arama",
  scope: !1763, file: !1764, line: 8, type: !1766, arg: 1)
!1769 = !DILocalVariable(name: "Bellek",
  scope: !1763, file: !1764, line: 9, type: !1768, arg: 2)
!1770 = !DISubroutineType(types: !1771)
!1771 = !{null, !1766, !1768 }
!1763 = distinct !DISubprogram( name: "arama::_AramadanBelleğe_ox119i",
 scope: !1762,
 file: !1764,
 line: 7,
 type: !1770, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;_AramadanBelleğe
!1772 = !DILocation(line: 8, column: 3, scope: !1763)
!1773 = !DILocation(line: 9, column: 3, scope: !1763)
!1774 = distinct !DILexicalBlock(
        scope: !1763, file: !1764, line: 10, column: 1)
!1775 = !DILocation(line: 13, column: 9, scope: !1774)
!1776 = !DILocation(line: 13, column: 9, scope: !1774)
!1777 = !DILocation(line: 13, column: 9, scope: !1774)
!1778 = distinct !DILexicalBlock(
        scope: !1774, file: !1764, line: 16, column: 5)
!1779 = distinct !DILexicalBlock(
        scope: !1778, file: !1764, line: 16, column: 5)
!1780 = !DILocation(line: 17, column: 24, scope: !1779)
!1781 = !DILocation(line: 17, column: 24, scope: !1779)
!1782 = !DILocation(line: 17, column: 24, scope: !1779)
!1783 = !DILocation(line: 17, column: 24, scope: !1779)
!1784 = !DILocation(line: 17, column: 24, scope: !1779)
!1785 = !DILocation(line: 17, column: 50, scope: !1779)
!1786 = !DILocation(line: 17, column: 7, scope: !1779)
!1787 = !DILocation(line: 18, column: 7, scope: !1779)
!1788 = !DILocation(line: 18, column: 15, scope: !1779)
!1789 = !DILocation(line: 19, column: 24, scope: !1779)
!1790 = !DILocation(line: 19, column: 24, scope: !1779)
!1791 = !DILocation(line: 19, column: 24, scope: !1779)
!1792 = !DILocation(line: 19, column: 24, scope: !1779)
!1793 = !DILocation(line: 19, column: 24, scope: !1779)
!1794 = !DILocation(line: 19, column: 50, scope: !1779)
!1795 = !DILocation(line: 19, column: 7, scope: !1779)
!1796 = distinct !DILexicalBlock(
        scope: !1774, file: !1764, line: 22, column: 3)
!1797 = !DILocation(line: 23, column: 7, scope: !1796)
!1798 = !DILocation(line: 23, column: 25, scope: !1796)
!1799 = !DILocation(line: 23, column: 25, scope: !1796)
!1800 = !DILocation(line: 23, column: 25, scope: !1796)
!1801 = !DILocation(line: 23, column: 25, scope: !1796)
!1802 = !DILocation(line: 23, column: 25, scope: !1796)
!1803 = !DILocation(line: 23, column: 15, scope: !1796)
!1804 = distinct !DILexicalBlock(
        scope: !1774, file: !1764, line: 24, column: 5)
!1805 = !DILocation(line: 26, column: 7, scope: !1804)
!1806 = !DILocation(line: 26, column: 15, scope: !1804)
!1807 = !DILocation(line: 9, column: 22, scope: !1763)


!1809 = !DILocalVariable(name: "dönüş",
  scope: !1808, file: !1764, line: 15, type: !12)
...
!1811 = !DILocalVariable(name: "Arama",
  scope: !1808, file: !1764, line: 31, type: !1810, arg: 1)
!1813 = !DILocalVariable(name: "Bellek",
  scope: !1808, file: !1764, line: 32, type: !1812, arg: 2)
!1814 = !DISubroutineType(types: !1815)
!1815 = !{null, !1810, !1812 }
!1808 = distinct !DISubprogram( name: "arama::AramadanBelleğe_ox119i",
 scope: !1762,
 file: !1764,
 line: 30,
 type: !1814, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;AramadanBelleğe
!1816 = !DILocation(line: 31, column: 3, scope: !1808)
!1817 = !DILocation(line: 32, column: 3, scope: !1808)
!1818 = distinct !DILexicalBlock(
        scope: !1808, file: !1764, line: 33, column: 1)
!1819 = !DILocation(line: 34, column: 3, scope: !1818)
!1820 = distinct !DILexicalBlock(
        scope: !1818, file: !1764, line: 34, column: 11)
!1821 = distinct !DILexicalBlock(
        scope: !1820, file: !1764, line: 21, column: 3)
!1822 = !DILocation(line: 16, column: 5, scope: !1821)
!1823 = !DILocation(line: 16, column: 5, scope: !1821)
!1824 = !DILocation(line: 17, column: 5, scope: !1821)
!1825 = !DILocation(line: 17, column: 13, scope: !1821)
!1826 = !DILocation(line: 35, column: 20, scope: !1818)
!1827 = !DILocation(line: 35, column: 27, scope: !1818)
!1828 = !DILocation(line: 35, column: 3, scope: !1818)
!1829 = !DILocation(line: 32, column: 22, scope: !1808)


!1831 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !57, size: 64)
!1832 = !DILocalVariable(name: "dönüş",
  scope: !1830, file: !1764, line: 15, type: !1831)
!1833 = !DISubroutineType(types: !1834)
!1834 = !{null }
!1830 = distinct !DISubprogram( name: "arama::_safArama_ox119i",
 scope: !1762,
 file: !1764,
 line: 38,
...
!1835 = distinct !DILexicalBlock(
        scope: !1830, file: !1764, line: 39, column: 1)
!1836 = !DILocation(line: 38, column: 15, scope: !1830)
