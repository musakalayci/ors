...
; Tanımlı değerler:
@h.ox262.ox0 = private unnamed_addr constant [8 x i8] c"::\00\00\00\00\00\00", align 8
;2->1 : 8 : 8
@h.ox262.ox1 = private unnamed_addr constant [8 x i8] c"%s\00\00\00\00\00\00", align 8
;2->1 : 8 : 8
@h.ox262.ox3 = private unnamed_addr constant [16 x i8] c"bilinmiyor\00\00\00\00\00\00", align 8
;10->1 : 8 : 8
@m.ox262.ox2 = private unnamed_addr constant %metin {
  i32 10,
  i32 16,
  i8* getelementptr inbounds ([16 x i8], [16 x i8]* @h.ox262.ox3, i64 0, i64 0)
} 
; Genel:
...
@"arama::_AramadanBelleğe_ox106i"(%gt234t* %0, %gt390t* %1)#0       !dbg !1579 {
; Değişken : dönüş
...
; Değişken : Arama
  ...
  call void @llvm.dbg.declare(metadata %gt234t** %4, metadata !1583, metadata !DIExpression()), !dbg !1588
; Değişken : Bellek
  %5 = alloca %gt390t*, align 8
  store %gt390t* %1, %gt390t** %5, align 8
  call void @llvm.dbg.declare(metadata %gt390t** %5, metadata !1585, metadata !DIExpression()), !dbg !1589
; Durum 0
  br label %durum.ox0
durum.ox0:
  %6 = load %gt234t*, %gt234t** %4, align 8, !dbg !1591; 2:0
; tür konumu *örs::derleme::imge::t : *t32
  %7 = getelementptr inbounds 
    %gt234t, %gt234t* %6,
    i32 0, i32 0
  %8 = load i32, i32* %7, align 4, !dbg !1593; 1:0
...
secim.ox0.ox1:
  %10 = load %gt234t*, %gt234t** %4, align 8, !dbg !1596; 2:0
...
; Konum çevirisi:
  %12 = bitcast %gt233t* %11 to %gt22ct**; 2
  %13 = load %gt22ct*, %gt22ct** %12, align 8, !dbg !1598; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %14 = getelementptr inbounds 
    %gt22ct, %gt22ct* %13,
    i32 0, i32 2
;;-> (nil) 14
  %15 = load %gt234t*, %gt234t** %14, align 8, !dbg !1600; 2:0
;;-> (nil) 0
  %16 = load %gt390t*, %gt390t** %5, align 8, !dbg !1601; 2:0
  %17 = call i32 @"arama::_AramadanBelleğe_ox106i" (
      %gt234t* %15, 
      %gt390t* %16), !dbg !1602
  %18 = load %gt390t*, %gt390t** %5, align 8, !dbg !1603; 2:0
 call void @"bellek::t.Yaz_ox139i" (
      %gt390t* %18, 
      i8* getelementptr inbounds ([8 x i8], [8 x i8]* @h.ox262.ox0, i64 0, i64 0)), !dbg !1604
  %19 = load %gt234t*, %gt234t** %4, align 8, !dbg !1605; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
...
; Ortak çevirisi *örs::derleme::imge::içerik ==> *örs::derleme::imge::temel::t (1, 2)
; Konum çevirisi:
  %21 = bitcast %gt233t* %20 to %gt22ct**; 2
  %22 = load %gt22ct*, %gt22ct** %21, align 8, !dbg !1607; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %23 = getelementptr inbounds 
    %gt22ct, %gt22ct* %22,
    i32 0, i32 3
;;-> (nil) 14
  %24 = load %gt234t*, %gt234t** %23, align 8, !dbg !1609; 2:0
;;-> (nil) 0
  %25 = load %gt390t*, %gt390t** %5, align 8, !dbg !1610; 2:0
  %26 = call i32 @"arama::_AramadanBelleğe_ox106i" (
      %gt234t* %24, 
      %gt390t* %25), !dbg !1611
  br label %durum.son.ox0
secim.ox0.ox2:
  %27 = load %gt390t*, %gt390t** %5, align 8, !dbg !1613; 2:0
  %28 = load %gt234t*, %gt234t** %4, align 8, !dbg !1614; 2:0
; tür konumu *örs::derleme::imge::t : *örs::üzengi::metin
  %29 = getelementptr inbounds 
    %gt234t, %gt234t* %28,
    i32 0, i32 2
  %30 = load %metin*, %metin** %29, align 8, !dbg !1616; 2:0
; tür konumu *örs::üzengi::metin : *t8
  %31 = getelementptr inbounds 
    %metin, %metin* %30,
    i32 0, i32 2
;;-> (nil) 14
  %32 = load i8*, i8** %31, align 8, !dbg !1618; 2:0
 call void @"bellek::t.Yaz_ox139i" (
      %gt390t* %27, 
      i8* getelementptr inbounds ([8 x i8], [8 x i8]* @h.ox262.ox1, i64 0, i64 0), 
      i8* %32), !dbg !1619
  br label %durum.son.ox0
durum.varsayilan.ox0:
  %33 = load %gt390t*, %gt390t** %5, align 8, !dbg !1621; 2:0
 call void @"bellek::t.Yaz_ox139i" (
      %gt390t* %33, 
      %metin* getelementptr inbounds (%metin, %metin* @m.ox262.ox2, i64 0)), !dbg !1622
  br label %durum.son.ox0
durum.son.ox0:
; Iç Dönüş :
  %34 = load i32, i32* %3, align 4, !dbg !1623; 1:0
  ret i32 %34
}

;örs::derleme::arama::AramadanBelleğe
define external i32 
@"arama::AramadanBelleğe_ox106i"(%gt234t* %0, %gt390t* %1)#0       !dbg !1624 {
; Değişken : dönüş
  %3 = alloca i32, align 4
  store i32 0, i32* %3, align 4 ; 0 
; Değişken : Arama
  %4 = alloca %gt234t*, align 8
  store %gt234t* %0, %gt234t** %4, align 8
  call void @llvm.dbg.declare(metadata %gt234t** %4, metadata !1627, metadata !DIExpression()), !dbg !1632
; Değişken : Bellek
  %5 = alloca %gt390t*, align 8
  store %gt390t* %1, %gt390t** %5, align 8
  call void @llvm.dbg.declare(metadata %gt390t** %5, metadata !1629, metadata !DIExpression()), !dbg !1633
  %6 = load %gt390t*, %gt390t** %5, align 8, !dbg !1635; 2:0
...
; Sanal bitiş : Sıfırla
;;-> (nil) 0
  %10 = load %gt234t*, %gt234t** %4, align 8, !dbg !1642; 2:0
;;-> (nil) 0
  %11 = load %gt390t*, %gt390t** %5, align 8, !dbg !1643; 2:0
  %12 = call i32 @"arama::_AramadanBelleğe_ox106i" (
      %gt234t* %10, 
      %gt390t* %11), !dbg !1644
; Iç Dönüş :
  %13 = load i32, i32* %3, align 4, !dbg !1645; 1:0
  ret i32 %13
}

;örs::derleme::arama::_safArama
define private dso_local %gt21et* 
@"arama::_safArama_ox106i"()#0       !dbg !1646 {
; Değişken : dönüş
  %1 = alloca %gt21et*, align 8
  store %gt21et* null, %gt21et** %1, align 8
; Iç Dönüş :
  %2 = load %gt21et*, %gt21et** %1, align 8, !dbg !1652; 2:0
  ret %gt21et* %2
}
...
!1578 = !DINamespace(name:"arama", scope: !1577)
...
!1581 = !DILocalVariable(name: "dönüş",
  scope: !1579, file: !1580, line: 15, type: !12)
!1582 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1584 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !99, size: 64)
!1583 = !DILocalVariable(name: "Arama",
  scope: !1579, file: !1580, line: 8, type: !1582, arg: 1)
!1585 = !DILocalVariable(name: "Bellek",
  scope: !1579, file: !1580, line: 9, type: !1584, arg: 2)
!1586 = !DISubroutineType(types: !1587)
!1587 = !{null, !1582, !1584 }
!1579 = distinct !DISubprogram( name: "arama::_AramadanBelleğe_ox106i",
 scope: !1578,
 file: !1580,
 line: 7,
 type: !1586, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;_AramadanBelleğe
!1588 = !DILocation(line: 8, column: 3, scope: !1579)
!1589 = !DILocation(line: 9, column: 3, scope: !1579)
!1590 = distinct !DILexicalBlock(
        scope: !1579, file: !1580, line: 10, column: 1)
!1591 = !DILocation(line: 13, column: 9, scope: !1590)
!1592 = !DILocation(line: 13, column: 9, scope: !1590)
!1593 = !DILocation(line: 13, column: 9, scope: !1590)
!1594 = distinct !DILexicalBlock(
        scope: !1590, file: !1580, line: 16, column: 5)
!1595 = distinct !DILexicalBlock(
        scope: !1594, file: !1580, line: 16, column: 5)
!1596 = !DILocation(line: 17, column: 24, scope: !1595)
!1597 = !DILocation(line: 17, column: 24, scope: !1595)
!1598 = !DILocation(line: 17, column: 24, scope: !1595)
!1599 = !DILocation(line: 17, column: 24, scope: !1595)
!1600 = !DILocation(line: 17, column: 24, scope: !1595)
!1601 = !DILocation(line: 17, column: 50, scope: !1595)
!1602 = !DILocation(line: 17, column: 7, scope: !1595)
!1603 = !DILocation(line: 18, column: 7, scope: !1595)
!1604 = !DILocation(line: 18, column: 15, scope: !1595)
!1605 = !DILocation(line: 19, column: 24, scope: !1595)
!1606 = !DILocation(line: 19, column: 24, scope: !1595)
!1607 = !DILocation(line: 19, column: 24, scope: !1595)
!1608 = !DILocation(line: 19, column: 24, scope: !1595)
!1609 = !DILocation(line: 19, column: 24, scope: !1595)
!1610 = !DILocation(line: 19, column: 50, scope: !1595)
!1611 = !DILocation(line: 19, column: 7, scope: !1595)
!1612 = distinct !DILexicalBlock(
        scope: !1590, file: !1580, line: 22, column: 3)
!1613 = !DILocation(line: 23, column: 7, scope: !1612)
!1614 = !DILocation(line: 23, column: 25, scope: !1612)
!1615 = !DILocation(line: 23, column: 25, scope: !1612)
!1616 = !DILocation(line: 23, column: 25, scope: !1612)
!1617 = !DILocation(line: 23, column: 25, scope: !1612)
!1618 = !DILocation(line: 23, column: 25, scope: !1612)
!1619 = !DILocation(line: 23, column: 15, scope: !1612)
!1620 = distinct !DILexicalBlock(
        scope: !1590, file: !1580, line: 24, column: 5)
!1621 = !DILocation(line: 26, column: 7, scope: !1620)
!1622 = !DILocation(line: 26, column: 15, scope: !1620)
!1623 = !DILocation(line: 9, column: 22, scope: !1579)


!1625 = !DILocalVariable(name: "dönüş",
  scope: !1624, file: !1580, line: 15, type: !12)
!1626 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1628 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !99, size: 64)
!1627 = !DILocalVariable(name: "Arama",
  scope: !1624, file: !1580, line: 31, type: !1626, arg: 1)
!1629 = !DILocalVariable(name: "Bellek",
  scope: !1624, file: !1580, line: 32, type: !1628, arg: 2)
!1630 = !DISubroutineType(types: !1631)
!1631 = !{null, !1626, !1628 }
!1624 = distinct !DISubprogram( name: "arama::AramadanBelleğe_ox106i",
 scope: !1578,
 file: !1580,
 line: 30,
 type: !1630, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;AramadanBelleğe
!1632 = !DILocation(line: 31, column: 3, scope: !1624)
!1633 = !DILocation(line: 32, column: 3, scope: !1624)
!1634 = distinct !DILexicalBlock(
        scope: !1624, file: !1580, line: 33, column: 1)
!1635 = !DILocation(line: 34, column: 3, scope: !1634)
!1636 = distinct !DILexicalBlock(
        scope: !1634, file: !1580, line: 34, column: 11)
!1637 = distinct !DILexicalBlock(
        scope: !1636, file: !1580, line: 21, column: 3)
!1638 = !DILocation(line: 16, column: 5, scope: !1637)
!1639 = !DILocation(line: 16, column: 5, scope: !1637)
!1640 = !DILocation(line: 17, column: 5, scope: !1637)
!1641 = !DILocation(line: 17, column: 13, scope: !1637)
!1642 = !DILocation(line: 35, column: 20, scope: !1634)
!1643 = !DILocation(line: 35, column: 27, scope: !1634)
!1644 = !DILocation(line: 35, column: 3, scope: !1634)
!1645 = !DILocation(line: 32, column: 22, scope: !1624)


!1647 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !57, size: 64)
!1648 = !DILocalVariable(name: "dönüş",
  scope: !1646, file: !1580, line: 15, type: !1647)
!1649 = !DISubroutineType(types: !1650)
!1650 = !{null }
!1646 = distinct !DISubprogram( name: "arama::_safArama_ox106i",
 scope: !1578,
 file: !1580,
 line: 38,
 type: !1649, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;_safArama
!1651 = distinct !DILexicalBlock(
        scope: !1646, file: !1580, line: 39, column: 1)
!1652 = !DILocation(line: 38, column: 15, scope: !1646)
