...
@"arama::_AramadanBelleğe_ox119i"(%gt398t* %0, %gtd9t* %1)#0       !dbg !1723 {
; Değişken : dönüş
...
; Değişken : Arama
  ...
  call void @llvm.dbg.declare(metadata %gt398t** %4, metadata !1727, metadata !DIExpression()), !dbg !1732
; Değişken : Bellek
  %5 = alloca %gtd9t*, align 8
  store %gtd9t* %1, %gtd9t** %5, align 8
  call void @llvm.dbg.declare(metadata %gtd9t** %5, metadata !1729, metadata !DIExpression()), !dbg !1733
; Durum 0
  br label %durum.ox0
durum.ox0:
  %6 = load %gt398t*, %gt398t** %4, align 8, !dbg !1735; 2:0
; tür konumu *örs::derleme::imge::t : *t32
  %7 = getelementptr inbounds 
    %gt398t, %gt398t* %6,
    i32 0, i32 0
  %8 = load i32, i32* %7, align 4, !dbg !1737; 1:0
...
secim.ox0.ox1:
  %10 = load %gt398t*, %gt398t** %4, align 8, !dbg !1740; 2:0
...
; Konum çevirisi:
  %12 = bitcast %gt397t* %11 to %gt3d2t**; 2
  %13 = load %gt3d2t*, %gt3d2t** %12, align 8, !dbg !1742; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %14 = getelementptr inbounds 
    %gt3d2t, %gt3d2t* %13,
    i32 0, i32 2
;;-> (nil) 14
  %15 = load %gt398t*, %gt398t** %14, align 8, !dbg !1744; 2:0
;;-> (nil) 0
  %16 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1745; 2:0
  %17 = call i32 @"arama::_AramadanBelleğe_ox119i" (
      %gt398t* %15, 
      %gtd9t* %16), !dbg !1746
  %18 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1747; 2:0
 call void @"bellek::t.Yaz_ox122i" (
      %gtd9t* %18, 
      i8* getelementptr inbounds ([8 x i8], [8 x i8]* @h.ox281.ox0, i64 0, i64 0)), !dbg !1748
  %19 = load %gt398t*, %gt398t** %4, align 8, !dbg !1749; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
...
; Ortak çevirisi *örs::derleme::imge::içerik ==> *örs::derleme::imge::temel::t (1, 2)
; Konum çevirisi:
  %21 = bitcast %gt397t* %20 to %gt3d2t**; 2
  %22 = load %gt3d2t*, %gt3d2t** %21, align 8, !dbg !1751; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %23 = getelementptr inbounds 
    %gt3d2t, %gt3d2t* %22,
    i32 0, i32 3
;;-> (nil) 14
  %24 = load %gt398t*, %gt398t** %23, align 8, !dbg !1753; 2:0
;;-> (nil) 0
  %25 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1754; 2:0
  %26 = call i32 @"arama::_AramadanBelleğe_ox119i" (
      %gt398t* %24, 
      %gtd9t* %25), !dbg !1755
  br label %durum.son.ox0
secim.ox0.ox2:
  %27 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1757; 2:0
  %28 = load %gt398t*, %gt398t** %4, align 8, !dbg !1758; 2:0
; tür konumu *örs::derleme::imge::t : *örs::üzengi::metin
  %29 = getelementptr inbounds 
    %gt398t, %gt398t* %28,
    i32 0, i32 2
  %30 = load %metin*, %metin** %29, align 8, !dbg !1760; 2:0
; tür konumu *örs::üzengi::metin : *t8
  %31 = getelementptr inbounds 
    %metin, %metin* %30,
    i32 0, i32 2
;;-> (nil) 14
  %32 = load i8*, i8** %31, align 8, !dbg !1762; 2:0
 call void @"bellek::t.Yaz_ox122i" (
      %gtd9t* %27, 
...
durum.varsayilan.ox0:
  %33 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1765; 2:0
 call void @"bellek::t.Yaz_ox122i" (
      %gtd9t* %33, 
      %metin* getelementptr inbounds (%metin, %metin* @m.ox281.ox2, i64 0)), !dbg !1766
  br label %durum.son.ox0
durum.son.ox0:
; Iç Dönüş :
  %34 = load i32, i32* %3, align 4, !dbg !1767; 1:0
  ret i32 %34
}

;örs::derleme::arama::AramadanBelleğe
define external i32 
@"arama::AramadanBelleğe_ox119i"(%gt398t* %0, %gtd9t* %1)#0       !dbg !1768 {
; Değişken : dönüş
  %3 = alloca i32, align 4
  store i32 0, i32* %3, align 4 ; 0 
; Değişken : Arama
  %4 = alloca %gt398t*, align 8
  store %gt398t* %0, %gt398t** %4, align 8
  call void @llvm.dbg.declare(metadata %gt398t** %4, metadata !1771, metadata !DIExpression()), !dbg !1776
; Değişken : Bellek
  %5 = alloca %gtd9t*, align 8
  store %gtd9t* %1, %gtd9t** %5, align 8
  call void @llvm.dbg.declare(metadata %gtd9t** %5, metadata !1773, metadata !DIExpression()), !dbg !1777
  %6 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1779; 2:0
...
; Sanal bitiş : Sıfırla
;;-> (nil) 0
  %10 = load %gt398t*, %gt398t** %4, align 8, !dbg !1786; 2:0
;;-> (nil) 0
  %11 = load %gtd9t*, %gtd9t** %5, align 8, !dbg !1787; 2:0
  %12 = call i32 @"arama::_AramadanBelleğe_ox119i" (
      %gt398t* %10, 
      %gtd9t* %11), !dbg !1788
; Iç Dönüş :
  %13 = load i32, i32* %3, align 4, !dbg !1789; 1:0
  ret i32 %13
}

;örs::derleme::arama::_safArama
define private dso_local %gt387t* 
@"arama::_safArama_ox119i"()#0       !dbg !1790 {
; Değişken : dönüş
  %1 = alloca %gt387t*, align 8
  store %gt387t* null, %gt387t** %1, align 8
; Iç Dönüş :
  %2 = load %gt387t*, %gt387t** %1, align 8, !dbg !1796; 2:0
  ret %gt387t* %2
}
...
!1722 = !DINamespace(name:"arama", scope: !1721)
...
!1725 = !DILocalVariable(name: "dönüş",
  scope: !1723, file: !1724, line: 15, type: !12)
!1726 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1728 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !99, size: 64)
!1727 = !DILocalVariable(name: "Arama",
  scope: !1723, file: !1724, line: 8, type: !1726, arg: 1)
!1729 = !DILocalVariable(name: "Bellek",
  scope: !1723, file: !1724, line: 9, type: !1728, arg: 2)
!1730 = !DISubroutineType(types: !1731)
!1731 = !{null, !1726, !1728 }
!1723 = distinct !DISubprogram( name: "arama::_AramadanBelleğe_ox119i",
 scope: !1722,
 file: !1724,
 line: 7,
 type: !1730, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;_AramadanBelleğe
!1732 = !DILocation(line: 8, column: 3, scope: !1723)
!1733 = !DILocation(line: 9, column: 3, scope: !1723)
!1734 = distinct !DILexicalBlock(
        scope: !1723, file: !1724, line: 10, column: 1)
!1735 = !DILocation(line: 13, column: 9, scope: !1734)
!1736 = !DILocation(line: 13, column: 9, scope: !1734)
!1737 = !DILocation(line: 13, column: 9, scope: !1734)
!1738 = distinct !DILexicalBlock(
        scope: !1734, file: !1724, line: 16, column: 5)
!1739 = distinct !DILexicalBlock(
        scope: !1738, file: !1724, line: 16, column: 5)
!1740 = !DILocation(line: 17, column: 24, scope: !1739)
!1741 = !DILocation(line: 17, column: 24, scope: !1739)
!1742 = !DILocation(line: 17, column: 24, scope: !1739)
!1743 = !DILocation(line: 17, column: 24, scope: !1739)
!1744 = !DILocation(line: 17, column: 24, scope: !1739)
!1745 = !DILocation(line: 17, column: 50, scope: !1739)
!1746 = !DILocation(line: 17, column: 7, scope: !1739)
!1747 = !DILocation(line: 18, column: 7, scope: !1739)
!1748 = !DILocation(line: 18, column: 15, scope: !1739)
!1749 = !DILocation(line: 19, column: 24, scope: !1739)
!1750 = !DILocation(line: 19, column: 24, scope: !1739)
!1751 = !DILocation(line: 19, column: 24, scope: !1739)
!1752 = !DILocation(line: 19, column: 24, scope: !1739)
!1753 = !DILocation(line: 19, column: 24, scope: !1739)
!1754 = !DILocation(line: 19, column: 50, scope: !1739)
!1755 = !DILocation(line: 19, column: 7, scope: !1739)
!1756 = distinct !DILexicalBlock(
        scope: !1734, file: !1724, line: 22, column: 3)
!1757 = !DILocation(line: 23, column: 7, scope: !1756)
!1758 = !DILocation(line: 23, column: 25, scope: !1756)
!1759 = !DILocation(line: 23, column: 25, scope: !1756)
!1760 = !DILocation(line: 23, column: 25, scope: !1756)
!1761 = !DILocation(line: 23, column: 25, scope: !1756)
!1762 = !DILocation(line: 23, column: 25, scope: !1756)
!1763 = !DILocation(line: 23, column: 15, scope: !1756)
!1764 = distinct !DILexicalBlock(
        scope: !1734, file: !1724, line: 24, column: 5)
!1765 = !DILocation(line: 26, column: 7, scope: !1764)
!1766 = !DILocation(line: 26, column: 15, scope: !1764)
!1767 = !DILocation(line: 9, column: 22, scope: !1723)


!1769 = !DILocalVariable(name: "dönüş",
  scope: !1768, file: !1724, line: 15, type: !12)
!1770 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1772 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !99, size: 64)
!1771 = !DILocalVariable(name: "Arama",
  scope: !1768, file: !1724, line: 31, type: !1770, arg: 1)
!1773 = !DILocalVariable(name: "Bellek",
  scope: !1768, file: !1724, line: 32, type: !1772, arg: 2)
!1774 = !DISubroutineType(types: !1775)
!1775 = !{null, !1770, !1772 }
!1768 = distinct !DISubprogram( name: "arama::AramadanBelleğe_ox119i",
 scope: !1722,
 file: !1724,
 line: 30,
 type: !1774, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;AramadanBelleğe
!1776 = !DILocation(line: 31, column: 3, scope: !1768)
!1777 = !DILocation(line: 32, column: 3, scope: !1768)
!1778 = distinct !DILexicalBlock(
        scope: !1768, file: !1724, line: 33, column: 1)
!1779 = !DILocation(line: 34, column: 3, scope: !1778)
!1780 = distinct !DILexicalBlock(
        scope: !1778, file: !1724, line: 34, column: 11)
!1781 = distinct !DILexicalBlock(
        scope: !1780, file: !1724, line: 21, column: 3)
!1782 = !DILocation(line: 16, column: 5, scope: !1781)
!1783 = !DILocation(line: 16, column: 5, scope: !1781)
!1784 = !DILocation(line: 17, column: 5, scope: !1781)
!1785 = !DILocation(line: 17, column: 13, scope: !1781)
!1786 = !DILocation(line: 35, column: 20, scope: !1778)
!1787 = !DILocation(line: 35, column: 27, scope: !1778)
!1788 = !DILocation(line: 35, column: 3, scope: !1778)
!1789 = !DILocation(line: 32, column: 22, scope: !1768)


!1791 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !57, size: 64)
!1792 = !DILocalVariable(name: "dönüş",
  scope: !1790, file: !1724, line: 15, type: !1791)
!1793 = !DISubroutineType(types: !1794)
!1794 = !{null }
!1790 = distinct !DISubprogram( name: "arama::_safArama_ox119i",
 scope: !1722,
 file: !1724,
 line: 38,
...
!1795 = distinct !DILexicalBlock(
        scope: !1790, file: !1724, line: 39, column: 1)
!1796 = !DILocation(line: 38, column: 15, scope: !1790)
