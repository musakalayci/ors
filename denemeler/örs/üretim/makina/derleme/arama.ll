...
@"arama::_AramadanBelleğe_ox119i"(%gt3a6t* %0, %gtdbt* %1)#0       !dbg !1789 {
; Değişken : dönüş
...
; Değişken : Arama
  ...
  call void @llvm.dbg.declare(metadata %gt3a6t** %4, metadata !1793, metadata !DIExpression()), !dbg !1798
; Değişken : Bellek
  %5 = alloca %gtdbt*, align 8
  store %gtdbt* %1, %gtdbt** %5, align 8
  call void @llvm.dbg.declare(metadata %gtdbt** %5, metadata !1795, metadata !DIExpression()), !dbg !1799
; Durum 0
  br label %durum.ox0
durum.ox0:
  %6 = load %gt3a6t*, %gt3a6t** %4, align 8, !dbg !1801; 2:0
; tür konumu *örs::derleme::imge::t : *t32
  %7 = getelementptr inbounds 
    %gt3a6t, %gt3a6t* %6,
    i32 0, i32 0
  %8 = load i32, i32* %7, align 4, !dbg !1803; 1:0
...
secim.ox0.ox1:
  %10 = load %gt3a6t*, %gt3a6t** %4, align 8, !dbg !1806; 2:0
...
; Konum çevirisi:
  %12 = bitcast %gt3a5t* %11 to %gt3e2t**; 2
  %13 = load %gt3e2t*, %gt3e2t** %12, align 8, !dbg !1808; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %14 = getelementptr inbounds 
    %gt3e2t, %gt3e2t* %13,
    i32 0, i32 2
;;-> (nil) 14
  %15 = load %gt3a6t*, %gt3a6t** %14, align 8, !dbg !1810; 2:0
;;-> (nil) 0
  %16 = load %gtdbt*, %gtdbt** %5, align 8, !dbg !1811; 2:0
  %17 = call i32 @"arama::_AramadanBelleğe_ox119i" (
      %gt3a6t* %15, 
      %gtdbt* %16), !dbg !1812
  %18 = load %gtdbt*, %gtdbt** %5, align 8, !dbg !1813; 2:0
 call void @"bellek::t.Yaz_ox122i" (
      %gtdbt* %18, 
      i8* getelementptr inbounds ([8 x i8], [8 x i8]* @h.ox281.ox0, i64 0, i64 0)), !dbg !1814
  %19 = load %gt3a6t*, %gt3a6t** %4, align 8, !dbg !1815; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
...
; Ortak çevirisi *örs::derleme::imge::içerik ==> *örs::derleme::imge::temel::t (1, 2)
; Konum çevirisi:
  %21 = bitcast %gt3a5t* %20 to %gt3e2t**; 2
  %22 = load %gt3e2t*, %gt3e2t** %21, align 8, !dbg !1817; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %23 = getelementptr inbounds 
    %gt3e2t, %gt3e2t* %22,
    i32 0, i32 3
;;-> (nil) 14
  %24 = load %gt3a6t*, %gt3a6t** %23, align 8, !dbg !1819; 2:0
;;-> (nil) 0
  %25 = load %gtdbt*, %gtdbt** %5, align 8, !dbg !1820; 2:0
  %26 = call i32 @"arama::_AramadanBelleğe_ox119i" (
      %gt3a6t* %24, 
      %gtdbt* %25), !dbg !1821
  br label %durum.son.ox0
secim.ox0.ox2:
  %27 = load %gtdbt*, %gtdbt** %5, align 8, !dbg !1823; 2:0
  %28 = load %gt3a6t*, %gt3a6t** %4, align 8, !dbg !1824; 2:0
; tür konumu *örs::derleme::imge::t : *örs::üzengi::metin
  %29 = getelementptr inbounds 
    %gt3a6t, %gt3a6t* %28,
    i32 0, i32 2
  %30 = load %metin*, %metin** %29, align 8, !dbg !1826; 2:0
; tür konumu *örs::üzengi::metin : *t8
  %31 = getelementptr inbounds 
    %metin, %metin* %30,
    i32 0, i32 2
;;-> (nil) 14
  %32 = load i8*, i8** %31, align 8, !dbg !1828; 2:0
 call void @"bellek::t.Yaz_ox122i" (
      %gtdbt* %27, 
...
durum.varsayilan.ox0:
  %33 = load %gtdbt*, %gtdbt** %5, align 8, !dbg !1831; 2:0
 call void @"bellek::t.Yaz_ox122i" (
      %gtdbt* %33, 
      %metin* getelementptr inbounds (%metin, %metin* @m.ox281.ox2, i64 0)), !dbg !1832
  br label %durum.son.ox0
durum.son.ox0:
; Iç Dönüş :
  %34 = load i32, i32* %3, align 4, !dbg !1833; 1:0
  ret i32 %34
}

;örs::derleme::arama::AramadanBelleğe
define external i32 
@"arama::AramadanBelleğe_ox119i"(%gt3a6t* %0, %gtdbt* %1)#0       !dbg !1834 {
; Değişken : dönüş
  %3 = alloca i32, align 4
  store i32 0, i32* %3, align 4 ; 0 
; Değişken : Arama
  %4 = alloca %gt3a6t*, align 8
  store %gt3a6t* %0, %gt3a6t** %4, align 8
  call void @llvm.dbg.declare(metadata %gt3a6t** %4, metadata !1837, metadata !DIExpression()), !dbg !1842
; Değişken : Bellek
  %5 = alloca %gtdbt*, align 8
  store %gtdbt* %1, %gtdbt** %5, align 8
  call void @llvm.dbg.declare(metadata %gtdbt** %5, metadata !1839, metadata !DIExpression()), !dbg !1843
  %6 = load %gtdbt*, %gtdbt** %5, align 8, !dbg !1845; 2:0
...
; Sanal bitiş : Sıfırla
;;-> (nil) 0
  %10 = load %gt3a6t*, %gt3a6t** %4, align 8, !dbg !1852; 2:0
;;-> (nil) 0
  %11 = load %gtdbt*, %gtdbt** %5, align 8, !dbg !1853; 2:0
  %12 = call i32 @"arama::_AramadanBelleğe_ox119i" (
      %gt3a6t* %10, 
      %gtdbt* %11), !dbg !1854
; Iç Dönüş :
  %13 = load i32, i32* %3, align 4, !dbg !1855; 1:0
  ret i32 %13
}

;örs::derleme::arama::_safArama
define private dso_local %gt395t* 
@"arama::_safArama_ox119i"()#0       !dbg !1856 {
; Değişken : dönüş
  %1 = alloca %gt395t*, align 8
  store %gt395t* null, %gt395t** %1, align 8
; Iç Dönüş :
  %2 = load %gt395t*, %gt395t** %1, align 8, !dbg !1862; 2:0
  ret %gt395t* %2
}
...
!1788 = !DINamespace(name:"arama", scope: !1787)
...
!1791 = !DILocalVariable(name: "dönüş",
  scope: !1789, file: !1790, line: 15, type: !12)
!1792 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1794 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !99, size: 64)
!1793 = !DILocalVariable(name: "Arama",
  scope: !1789, file: !1790, line: 8, type: !1792, arg: 1)
!1795 = !DILocalVariable(name: "Bellek",
  scope: !1789, file: !1790, line: 9, type: !1794, arg: 2)
!1796 = !DISubroutineType(types: !1797)
!1797 = !{null, !1792, !1794 }
!1789 = distinct !DISubprogram( name: "arama::_AramadanBelleğe_ox119i",
 scope: !1788,
 file: !1790,
 line: 7,
 type: !1796, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;_AramadanBelleğe
!1798 = !DILocation(line: 8, column: 3, scope: !1789)
!1799 = !DILocation(line: 9, column: 3, scope: !1789)
!1800 = distinct !DILexicalBlock(
        scope: !1789, file: !1790, line: 10, column: 1)
!1801 = !DILocation(line: 13, column: 9, scope: !1800)
!1802 = !DILocation(line: 13, column: 9, scope: !1800)
!1803 = !DILocation(line: 13, column: 9, scope: !1800)
!1804 = distinct !DILexicalBlock(
        scope: !1800, file: !1790, line: 16, column: 5)
!1805 = distinct !DILexicalBlock(
        scope: !1804, file: !1790, line: 16, column: 5)
!1806 = !DILocation(line: 17, column: 24, scope: !1805)
!1807 = !DILocation(line: 17, column: 24, scope: !1805)
!1808 = !DILocation(line: 17, column: 24, scope: !1805)
!1809 = !DILocation(line: 17, column: 24, scope: !1805)
!1810 = !DILocation(line: 17, column: 24, scope: !1805)
!1811 = !DILocation(line: 17, column: 50, scope: !1805)
!1812 = !DILocation(line: 17, column: 7, scope: !1805)
!1813 = !DILocation(line: 18, column: 7, scope: !1805)
!1814 = !DILocation(line: 18, column: 15, scope: !1805)
!1815 = !DILocation(line: 19, column: 24, scope: !1805)
!1816 = !DILocation(line: 19, column: 24, scope: !1805)
!1817 = !DILocation(line: 19, column: 24, scope: !1805)
!1818 = !DILocation(line: 19, column: 24, scope: !1805)
!1819 = !DILocation(line: 19, column: 24, scope: !1805)
!1820 = !DILocation(line: 19, column: 50, scope: !1805)
!1821 = !DILocation(line: 19, column: 7, scope: !1805)
!1822 = distinct !DILexicalBlock(
        scope: !1800, file: !1790, line: 22, column: 3)
!1823 = !DILocation(line: 23, column: 7, scope: !1822)
!1824 = !DILocation(line: 23, column: 25, scope: !1822)
!1825 = !DILocation(line: 23, column: 25, scope: !1822)
!1826 = !DILocation(line: 23, column: 25, scope: !1822)
!1827 = !DILocation(line: 23, column: 25, scope: !1822)
!1828 = !DILocation(line: 23, column: 25, scope: !1822)
!1829 = !DILocation(line: 23, column: 15, scope: !1822)
!1830 = distinct !DILexicalBlock(
        scope: !1800, file: !1790, line: 24, column: 5)
!1831 = !DILocation(line: 26, column: 7, scope: !1830)
!1832 = !DILocation(line: 26, column: 15, scope: !1830)
!1833 = !DILocation(line: 9, column: 22, scope: !1789)


!1835 = !DILocalVariable(name: "dönüş",
  scope: !1834, file: !1790, line: 15, type: !12)
!1836 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1838 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !99, size: 64)
!1837 = !DILocalVariable(name: "Arama",
  scope: !1834, file: !1790, line: 31, type: !1836, arg: 1)
!1839 = !DILocalVariable(name: "Bellek",
  scope: !1834, file: !1790, line: 32, type: !1838, arg: 2)
!1840 = !DISubroutineType(types: !1841)
!1841 = !{null, !1836, !1838 }
!1834 = distinct !DISubprogram( name: "arama::AramadanBelleğe_ox119i",
 scope: !1788,
 file: !1790,
 line: 30,
 type: !1840, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;AramadanBelleğe
!1842 = !DILocation(line: 31, column: 3, scope: !1834)
!1843 = !DILocation(line: 32, column: 3, scope: !1834)
!1844 = distinct !DILexicalBlock(
        scope: !1834, file: !1790, line: 33, column: 1)
!1845 = !DILocation(line: 34, column: 3, scope: !1844)
!1846 = distinct !DILexicalBlock(
        scope: !1844, file: !1790, line: 34, column: 11)
!1847 = distinct !DILexicalBlock(
        scope: !1846, file: !1790, line: 21, column: 3)
!1848 = !DILocation(line: 16, column: 5, scope: !1847)
!1849 = !DILocation(line: 16, column: 5, scope: !1847)
!1850 = !DILocation(line: 17, column: 5, scope: !1847)
!1851 = !DILocation(line: 17, column: 13, scope: !1847)
!1852 = !DILocation(line: 35, column: 20, scope: !1844)
!1853 = !DILocation(line: 35, column: 27, scope: !1844)
!1854 = !DILocation(line: 35, column: 3, scope: !1844)
!1855 = !DILocation(line: 32, column: 22, scope: !1834)


!1857 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !57, size: 64)
!1858 = !DILocalVariable(name: "dönüş",
  scope: !1856, file: !1790, line: 15, type: !1857)
!1859 = !DISubroutineType(types: !1860)
!1860 = !{null }
!1856 = distinct !DISubprogram( name: "arama::_safArama_ox119i",
 scope: !1788,
 file: !1790,
 line: 38,
...
!1861 = distinct !DILexicalBlock(
        scope: !1856, file: !1790, line: 39, column: 1)
!1862 = !DILocation(line: 38, column: 15, scope: !1856)
