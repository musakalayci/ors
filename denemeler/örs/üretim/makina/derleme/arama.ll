...
@"arama::_AramadanBelleğe_ox106i"(%gt231t* %0, %gt380t* %1)#0       {
; Değişken : dönüş
...
; Durum 0
  br label %durum.ox0
durum.ox0:
  %6 = load %gt231t*, %gt231t** %4, align 8; 2:0
...
secim.ox0.ox1:
  %10 = load %gt231t*, %gt231t** %4, align 8; 2:0
...
; Konum çevirisi:
  %12 = bitcast %gt230t* %11 to %gt229t**; 2
  %13 = load %gt229t*, %gt229t** %12, align 8; 2:0
...
;;-> (nil) 0
  %16 = load %gt380t*, %gt380t** %5, align 8; 2:0
  %17 = call i32 @"arama::_AramadanBelleğe_ox106i" (
      %gt231t* %15, 
      %gt380t* %16)
  %18 = load %gt380t*, %gt380t** %5, align 8; 2:0
 call void @"bellek::t.Yaz_ox139i" (
      %gt380t* %18, 
      i8* getelementptr inbounds ([8 x i8], [8 x i8]* @h.ox262.ox0, i64 0, i64 0))
...
; Ortak çevirisi *örs::derleme::imge::içerik ==> *örs::derleme::imge::temel::t (1, 2)
; Konum çevirisi:
  %21 = bitcast %gt230t* %20 to %gt229t**; 2
  %22 = load %gt229t*, %gt229t** %21, align 8; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
...
;;-> (nil) 0
  %25 = load %gt380t*, %gt380t** %5, align 8; 2:0
  %26 = call i32 @"arama::_AramadanBelleğe_ox106i" (
      %gt231t* %24, 
      %gt380t* %25)
  br label %durum.son.ox0
secim.ox0.ox2:
  %27 = load %gt380t*, %gt380t** %5, align 8; 2:0
  %28 = load %gt231t*, %gt231t** %4, align 8; 2:0
...
durum.varsayilan.ox0:
  %33 = load %gt380t*, %gt380t** %5, align 8; 2:0
 call void @"bellek::t.Yaz_ox139i" (
      %gt380t* %33, 
      %metin* getelementptr inbounds (%metin, %metin* @m.ox262.ox2, i64 0))
  br label %durum.son.ox0
durum.son.ox0:
; Iç Dönüş :
  %34 = load i32, i32* %3, align 4; 1:0
  ret i32 %34
}

;örs::derleme::arama::AramadanBelleğe
define external i32 
@"arama::AramadanBelleğe_ox106i"(%gt231t* %0, %gt380t* %1)#0       {
; Değişken : dönüş
  %3 = alloca i32, align 4
  store i32 0, i32* %3, align 4 ; 0 
; Değişken : Arama
...
@"arama::_safArama_ox106i"()#0       {
; Değişken : dönüş
  %1 = alloca %gt21ct*, align 8
  store %gt21ct* null, %gt21ct** %1, align 8
; Iç Dönüş :
  %2 = load %gt21ct*, %gt21ct** %1, align 8; 2:0
  ret %gt21ct* %2
}
