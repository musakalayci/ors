...
@"arama::_AramadanBelleğe_ox119i"(%gt3bbt* %0, %gtdbt* %1)#0       !dbg !1806 {
; Değişken : dönüş
...
; Değişken : Arama
  ...
  call void @llvm.dbg.declare(metadata %gt3bbt** %4, metadata !1810, metadata !DIExpression()), !dbg !1815
; Değişken : Bellek
  %5 = alloca %gtdbt*, align 8
  store %gtdbt* %1, %gtdbt** %5, align 8
  call void @llvm.dbg.declare(metadata %gtdbt** %5, metadata !1812, metadata !DIExpression()), !dbg !1816
; Durum 0
  br label %durum.ox0
durum.ox0:
  %6 = load %gt3bbt*, %gt3bbt** %4, align 8, !dbg !1818; 2:0
; tür konumu *örs::derleme::imge::t : *t32
  %7 = getelementptr inbounds 
    %gt3bbt, %gt3bbt* %6,
    i32 0, i32 0
  %8 = load i32, i32* %7, align 4, !dbg !1820; 1:0
...
secim.ox0.ox1:
  %10 = load %gt3bbt*, %gt3bbt** %4, align 8, !dbg !1823; 2:0
...
; Konum çevirisi:
  %12 = bitcast %gt3bat* %11 to %gt3f7t**; 2
  %13 = load %gt3f7t*, %gt3f7t** %12, align 8, !dbg !1825; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %14 = getelementptr inbounds 
    %gt3f7t, %gt3f7t* %13,
    i32 0, i32 2
;;-> (nil) 14
  %15 = load %gt3bbt*, %gt3bbt** %14, align 8, !dbg !1827; 2:0
;;-> (nil) 0
  %16 = load %gtdbt*, %gtdbt** %5, align 8, !dbg !1828; 2:0
  %17 = call i32 @"arama::_AramadanBelleğe_ox119i" (
      %gt3bbt* %15, 
      %gtdbt* %16), !dbg !1829
  %18 = load %gtdbt*, %gtdbt** %5, align 8, !dbg !1830; 2:0
 call void @"bellek::t.Yaz_ox122i" (
      %gtdbt* %18, 
      i8* getelementptr inbounds ([8 x i8], [8 x i8]* @h.ox281.ox0, i64 0, i64 0)), !dbg !1831
  %19 = load %gt3bbt*, %gt3bbt** %4, align 8, !dbg !1832; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
...
; Ortak çevirisi *örs::derleme::imge::içerik ==> *örs::derleme::imge::temel::t (1, 2)
; Konum çevirisi:
  %21 = bitcast %gt3bat* %20 to %gt3f7t**; 2
  %22 = load %gt3f7t*, %gt3f7t** %21, align 8, !dbg !1834; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %23 = getelementptr inbounds 
    %gt3f7t, %gt3f7t* %22,
    i32 0, i32 3
;;-> (nil) 14
  %24 = load %gt3bbt*, %gt3bbt** %23, align 8, !dbg !1836; 2:0
;;-> (nil) 0
  %25 = load %gtdbt*, %gtdbt** %5, align 8, !dbg !1837; 2:0
  %26 = call i32 @"arama::_AramadanBelleğe_ox119i" (
      %gt3bbt* %24, 
      %gtdbt* %25), !dbg !1838
  br label %durum.son.ox0
secim.ox0.ox2:
  %27 = load %gtdbt*, %gtdbt** %5, align 8, !dbg !1840; 2:0
  %28 = load %gt3bbt*, %gt3bbt** %4, align 8, !dbg !1841; 2:0
; tür konumu *örs::derleme::imge::t : *örs::üzengi::metin
  %29 = getelementptr inbounds 
    %gt3bbt, %gt3bbt* %28,
    i32 0, i32 2
  %30 = load %metin*, %metin** %29, align 8, !dbg !1843; 2:0
; tür konumu *örs::üzengi::metin : *t8
  %31 = getelementptr inbounds 
    %metin, %metin* %30,
    i32 0, i32 2
;;-> (nil) 14
  %32 = load i8*, i8** %31, align 8, !dbg !1845; 2:0
 call void @"bellek::t.Yaz_ox122i" (
      %gtdbt* %27, 
...
durum.varsayilan.ox0:
  %33 = load %gtdbt*, %gtdbt** %5, align 8, !dbg !1848; 2:0
 call void @"bellek::t.Yaz_ox122i" (
      %gtdbt* %33, 
      %metin* getelementptr inbounds (%metin, %metin* @m.ox281.ox2, i64 0)), !dbg !1849
  br label %durum.son.ox0
durum.son.ox0:
; Iç Dönüş :
  %34 = load i32, i32* %3, align 4, !dbg !1850; 1:0
  ret i32 %34
}

;örs::derleme::arama::AramadanBelleğe
define external i32 
@"arama::AramadanBelleğe_ox119i"(%gt3bbt* %0, %gtdbt* %1)#0       !dbg !1851 {
; Değişken : dönüş
  %3 = alloca i32, align 4
  store i32 0, i32* %3, align 4 ; 0 
; Değişken : Arama
  %4 = alloca %gt3bbt*, align 8
  store %gt3bbt* %0, %gt3bbt** %4, align 8
  call void @llvm.dbg.declare(metadata %gt3bbt** %4, metadata !1854, metadata !DIExpression()), !dbg !1859
; Değişken : Bellek
  %5 = alloca %gtdbt*, align 8
  store %gtdbt* %1, %gtdbt** %5, align 8
  call void @llvm.dbg.declare(metadata %gtdbt** %5, metadata !1856, metadata !DIExpression()), !dbg !1860
  %6 = load %gtdbt*, %gtdbt** %5, align 8, !dbg !1862; 2:0
...
; Sanal bitiş : Sıfırla
;;-> (nil) 0
  %10 = load %gt3bbt*, %gt3bbt** %4, align 8, !dbg !1869; 2:0
;;-> (nil) 0
  %11 = load %gtdbt*, %gtdbt** %5, align 8, !dbg !1870; 2:0
  %12 = call i32 @"arama::_AramadanBelleğe_ox119i" (
      %gt3bbt* %10, 
      %gtdbt* %11), !dbg !1871
; Iç Dönüş :
  %13 = load i32, i32* %3, align 4, !dbg !1872; 1:0
  ret i32 %13
}

;örs::derleme::arama::_safArama
define private dso_local %gt3aat* 
@"arama::_safArama_ox119i"()#0       !dbg !1873 {
; Değişken : dönüş
  %1 = alloca %gt3aat*, align 8
  store %gt3aat* null, %gt3aat** %1, align 8
; Iç Dönüş :
  %2 = load %gt3aat*, %gt3aat** %1, align 8, !dbg !1879; 2:0
  ret %gt3aat* %2
}
...
!1805 = !DINamespace(name:"arama", scope: !1804)
...
!1808 = !DILocalVariable(name: "dönüş",
  scope: !1806, file: !1807, line: 15, type: !12)
!1809 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1811 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !99, size: 64)
!1810 = !DILocalVariable(name: "Arama",
  scope: !1806, file: !1807, line: 8, type: !1809, arg: 1)
!1812 = !DILocalVariable(name: "Bellek",
  scope: !1806, file: !1807, line: 9, type: !1811, arg: 2)
!1813 = !DISubroutineType(types: !1814)
!1814 = !{null, !1809, !1811 }
!1806 = distinct !DISubprogram( name: "arama::_AramadanBelleğe_ox119i",
 scope: !1805,
 file: !1807,
 line: 7,
 type: !1813, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;_AramadanBelleğe
!1815 = !DILocation(line: 8, column: 3, scope: !1806)
!1816 = !DILocation(line: 9, column: 3, scope: !1806)
!1817 = distinct !DILexicalBlock(
        scope: !1806, file: !1807, line: 10, column: 1)
!1818 = !DILocation(line: 13, column: 9, scope: !1817)
!1819 = !DILocation(line: 13, column: 9, scope: !1817)
!1820 = !DILocation(line: 13, column: 9, scope: !1817)
!1821 = distinct !DILexicalBlock(
        scope: !1817, file: !1807, line: 16, column: 5)
!1822 = distinct !DILexicalBlock(
        scope: !1821, file: !1807, line: 16, column: 5)
!1823 = !DILocation(line: 17, column: 24, scope: !1822)
!1824 = !DILocation(line: 17, column: 24, scope: !1822)
!1825 = !DILocation(line: 17, column: 24, scope: !1822)
!1826 = !DILocation(line: 17, column: 24, scope: !1822)
!1827 = !DILocation(line: 17, column: 24, scope: !1822)
!1828 = !DILocation(line: 17, column: 50, scope: !1822)
!1829 = !DILocation(line: 17, column: 7, scope: !1822)
!1830 = !DILocation(line: 18, column: 7, scope: !1822)
!1831 = !DILocation(line: 18, column: 15, scope: !1822)
!1832 = !DILocation(line: 19, column: 24, scope: !1822)
!1833 = !DILocation(line: 19, column: 24, scope: !1822)
!1834 = !DILocation(line: 19, column: 24, scope: !1822)
!1835 = !DILocation(line: 19, column: 24, scope: !1822)
!1836 = !DILocation(line: 19, column: 24, scope: !1822)
!1837 = !DILocation(line: 19, column: 50, scope: !1822)
!1838 = !DILocation(line: 19, column: 7, scope: !1822)
!1839 = distinct !DILexicalBlock(
        scope: !1817, file: !1807, line: 22, column: 3)
!1840 = !DILocation(line: 23, column: 7, scope: !1839)
!1841 = !DILocation(line: 23, column: 25, scope: !1839)
!1842 = !DILocation(line: 23, column: 25, scope: !1839)
!1843 = !DILocation(line: 23, column: 25, scope: !1839)
!1844 = !DILocation(line: 23, column: 25, scope: !1839)
!1845 = !DILocation(line: 23, column: 25, scope: !1839)
!1846 = !DILocation(line: 23, column: 15, scope: !1839)
!1847 = distinct !DILexicalBlock(
        scope: !1817, file: !1807, line: 24, column: 5)
!1848 = !DILocation(line: 26, column: 7, scope: !1847)
!1849 = !DILocation(line: 26, column: 15, scope: !1847)
!1850 = !DILocation(line: 9, column: 22, scope: !1806)


!1852 = !DILocalVariable(name: "dönüş",
  scope: !1851, file: !1807, line: 15, type: !12)
!1853 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1855 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !99, size: 64)
!1854 = !DILocalVariable(name: "Arama",
  scope: !1851, file: !1807, line: 31, type: !1853, arg: 1)
!1856 = !DILocalVariable(name: "Bellek",
  scope: !1851, file: !1807, line: 32, type: !1855, arg: 2)
!1857 = !DISubroutineType(types: !1858)
!1858 = !{null, !1853, !1855 }
!1851 = distinct !DISubprogram( name: "arama::AramadanBelleğe_ox119i",
 scope: !1805,
 file: !1807,
 line: 30,
 type: !1857, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;AramadanBelleğe
!1859 = !DILocation(line: 31, column: 3, scope: !1851)
!1860 = !DILocation(line: 32, column: 3, scope: !1851)
!1861 = distinct !DILexicalBlock(
        scope: !1851, file: !1807, line: 33, column: 1)
!1862 = !DILocation(line: 34, column: 3, scope: !1861)
!1863 = distinct !DILexicalBlock(
        scope: !1861, file: !1807, line: 34, column: 11)
!1864 = distinct !DILexicalBlock(
        scope: !1863, file: !1807, line: 21, column: 3)
!1865 = !DILocation(line: 16, column: 5, scope: !1864)
!1866 = !DILocation(line: 16, column: 5, scope: !1864)
!1867 = !DILocation(line: 17, column: 5, scope: !1864)
!1868 = !DILocation(line: 17, column: 13, scope: !1864)
!1869 = !DILocation(line: 35, column: 20, scope: !1861)
!1870 = !DILocation(line: 35, column: 27, scope: !1861)
!1871 = !DILocation(line: 35, column: 3, scope: !1861)
!1872 = !DILocation(line: 32, column: 22, scope: !1851)


!1874 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !57, size: 64)
!1875 = !DILocalVariable(name: "dönüş",
  scope: !1873, file: !1807, line: 15, type: !1874)
!1876 = !DISubroutineType(types: !1877)
!1877 = !{null }
!1873 = distinct !DISubprogram( name: "arama::_safArama_ox119i",
 scope: !1805,
 file: !1807,
 line: 38,
...
!1878 = distinct !DILexicalBlock(
        scope: !1873, file: !1807, line: 39, column: 1)
!1879 = !DILocation(line: 38, column: 15, scope: !1873)
