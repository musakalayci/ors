...
define external %gt3c1t* 
@"_değer::Yeni_ox142i"(%gt294t* %0, %metin* %1, i32 %2)#0       !dbg !1764 {
; Değişken : dönüş
  %4 = alloca %gt3c1t*, align 8
  store %gt3c1t* null, %gt3c1t** %4, align 8
; Değişken : Hafıza
...
;;-> (nil) 0
  %10 = load i32, i32* %7, align 4, !dbg !1780; 1:0
  %11 = call %gt3a2t* @"imge::Adlı_ox110i" (
      %gt294t* %8, 
      %metin* %9, 
      i32 %10), !dbg !1781
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  %13 = load %gt294t*, %gt294t** %5, align 8, !dbg !1786; 2:0
  %14 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt294t* %13, 
      i64 32, 
      i64 8), !dbg !1787
; Konum çevirisi:
  %15 = bitcast i8* %14 to %gt3c1t*; 1

; pascal 'Değer' örs::derleme::imge::_değer::t
  %16 = alloca %gt3c1t*, align 8
  store 
    %gt3c1t* %15,
    %gt3c1t** %16,
    align 8, !dbg !1788
  call void @llvm.dbg.declare(metadata %gt3c1t** %16, metadata !1790, metadata !DIExpression()), !dbg !1791
; Atama ifadesi
  %17 = load %gt3a2t*, %gt3a2t** %12, align 8, !dbg !1792; 2:0
...
; Konum çevirisi:
  %19 = bitcast %gt3a1t* %18 to %gt3c1t**; 2
  %20 = load %gt3c1t*, %gt3c1t** %16, align 8, !dbg !1794; 2:0
;atama:
  store 
    %gt3c1t* %20,
    %gt3c1t** %19,
    align 8, !dbg !1795
; Atama ifadesi
  %21 = load %gt3c1t*, %gt3c1t** %16, align 8, !dbg !1796; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::t
  %22 = getelementptr inbounds 
    %gt3c1t, %gt3c1t* %21,
    i32 0, i32 0
  %23 = load %gt3a2t*, %gt3a2t** %12, align 8, !dbg !1798; 2:0
;atama:
  store 
    %gt3a2t* %23,
    %gt3a2t** %22,
    align 8, !dbg !1799
; Atama ifadesi
  %24 = load %gt3c1t*, %gt3c1t** %16, align 8, !dbg !1800; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::cins::özet
  %25 = getelementptr inbounds 
    %gt3c1t, %gt3c1t* %24,
    i32 0, i32 1
;;-> (nil) 0
  %26 = load %gt294t*, %gt294t** %5, align 8, !dbg !1802; 2:0
  %27 = call %gt431t* @"cins::YeniÖzet_ox111i" (
      %gt294t* %26, 
      ptr null), !dbg !1803
;atama:
  store 
    ...
    %gt431t** %25,
    align 8, !dbg !1804
  %28 = load %gt3c1t*, %gt3c1t** %16, align 8, !dbg !1805; 2:0
; Dönüş :
  ret %gt3c1t* %28
}
...
!1763 = !DINamespace(name:"_değer", scope: !1762)


!1765 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1536, size: 64)
...
!1770 = !DILocalVariable(name: "Ad",
  scope: !1764, file: !9, line: 12, type: !1769, arg: 2)
!1771 = !DILocalVariable(name: "özellik",
  scope: !1764, file: !9, line: 12, type: !12, arg: 3)
!1772 = !DISubroutineType(types: !1773)
!1773 = !{null, !1767, !1769, !12 }
!1764 = distinct !DISubprogram( name: "_değer::Yeni_ox142i",
 scope: !1763,
 file: !9,
 line: 12,
 type: !1772, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1774 = !DILocation(line: 12, column: 19, scope: !1764)
!1775 = !DILocation(line: 12, column: 38, scope: !1764)
!1776 = !DILocation(line: 12, column: 49, scope: !1764)
!1777 = distinct !DILexicalBlock(
        scope: !1764, file: !9, line: 13, column: 3)
!1778 = !DILocation(line: 14, column: 24, scope: !1777)
!1779 = !DILocation(line: 14, column: 32, scope: !1777)
!1780 = !DILocation(line: 14, column: 36, scope: !1777)
!1781 = !DILocation(line: 14, column: 19, scope: !1777)
!1782 = !DILocation(line: 14, column: 5, scope: !1777)
!1783 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1784 = !DILocalVariable(name: "İmge",
  scope: !1777, file: !9, line: 14, type: !1783)
!1785 = !DILocation(line: 14, column: 5, scope: !1777)
!1786 = !DILocation(line: 15, column: 18, scope: !1777)
!1787 = !DILocation(line: 15, column: 26, scope: !1777)
!1788 = !DILocation(line: 15, column: 5, scope: !1777)
!1789 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1536, size: 64)
!1790 = !DILocalVariable(name: "Değer",
  scope: !1777, file: !9, line: 15, type: !1789)
!1791 = !DILocation(line: 15, column: 5, scope: !1777)
!1792 = !DILocation(line: 16, column: 5, scope: !1777)
!1793 = !DILocation(line: 16, column: 5, scope: !1777)
!1794 = !DILocation(line: 16, column: 26, scope: !1777)
!1795 = !DILocation(line: 16, column: 5, scope: !1777)
!1796 = !DILocation(line: 17, column: 5, scope: !1777)
!1797 = !DILocation(line: 17, column: 5, scope: !1777)
!1798 = !DILocation(line: 17, column: 26, scope: !1777)
!1799 = !DILocation(line: 17, column: 5, scope: !1777)
!1800 = !DILocation(line: 18, column: 5, scope: !1777)
!1801 = !DILocation(line: 18, column: 5, scope: !1777)
!1802 = !DILocation(line: 18, column: 43, scope: !1777)
!1803 = !DILocation(line: 18, column: 34, scope: !1777)
!1804 = !DILocation(line: 18, column: 5, scope: !1777)
!1805 = !DILocation(line: 19, column: 9, scope: !1777)
