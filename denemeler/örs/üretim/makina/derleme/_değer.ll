...
define external %gt3dat* 
@"_değer::Yeni_ox142i"(%gt29at* %0, %metin* %1, i32 %2)#0       !dbg !1807 {
; Değişken : dönüş
  %4 = alloca %gt3dat*, align 8
  store %gt3dat* null, %gt3dat** %4, align 8
; Değişken : Hafıza
...
;;-> (nil) 0
  ...
  %11 = call %gt3bbt* @"imge::Adlı_ox110i" (
      %gt29at* %8, 
      %metin* %9, 
      i32 %10), !dbg !1824
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3bbt** %12,
    align 8, !dbg !1825
  call void @llvm.dbg.declare(metadata %gt3bbt** %12, metadata !1827, metadata !DIExpression()), !dbg !1828
  %13 = load %gt29at*, %gt29at** %5, align 8, !dbg !1829; 2:0
  %14 = call i8* (%gt29at*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt29at* %13, 
      i64 32, 
      i64 8), !dbg !1830
; Konum çevirisi:
  %15 = bitcast i8* %14 to %gt3dat*; 1

; pascal 'Değer' örs::derleme::imge::_değer::t
  %16 = alloca %gt3dat*, align 8
  store 
    %gt3dat* %15,
    %gt3dat** %16,
    align 8, !dbg !1831
  call void @llvm.dbg.declare(metadata %gt3dat** %16, metadata !1833, metadata !DIExpression()), !dbg !1834
; Atama ifadesi
  %17 = load %gt3bbt*, %gt3bbt** %12, align 8, !dbg !1835; 2:0
...
; Konum çevirisi:
  %19 = bitcast %gt3bat* %18 to %gt3dat**; 2
  %20 = load %gt3dat*, %gt3dat** %16, align 8, !dbg !1837; 2:0
;atama:
  store 
    %gt3dat* %20,
    %gt3dat** %19,
    align 8, !dbg !1838
; Atama ifadesi
  %21 = load %gt3dat*, %gt3dat** %16, align 8, !dbg !1839; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::t
  %22 = getelementptr inbounds 
    %gt3dat, %gt3dat* %21,
    i32 0, i32 0
  %23 = load %gt3bbt*, %gt3bbt** %12, align 8, !dbg !1841; 2:0
;atama:
  store 
    %gt3bbt* %23,
    %gt3bbt** %22,
    align 8, !dbg !1842
; Atama ifadesi
  %24 = load %gt3dat*, %gt3dat** %16, align 8, !dbg !1843; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::cins::özet
  %25 = getelementptr inbounds 
    %gt3dat, %gt3dat* %24,
    i32 0, i32 1
;;-> (nil) 0
  %26 = load %gt29at*, %gt29at** %5, align 8, !dbg !1845; 2:0
  %27 = call %gt44ft* @"cins::YeniÖzet_ox111i" (
      %gt29at* %26, 
      ptr null), !dbg !1846
;atama:
  store 
    ...
    %gt44ft** %25,
    align 8, !dbg !1847
  %28 = load %gt3dat*, %gt3dat** %16, align 8, !dbg !1848; 2:0
; Dönüş :
  ret %gt3dat* %28
}
...
!1806 = !DINamespace(name:"_değer", scope: !1805)


!1808 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1558, size: 64)
...
!1813 = !DILocalVariable(name: "Ad",
  scope: !1807, file: !9, line: 12, type: !1812, arg: 2)
!1814 = !DILocalVariable(name: "özellik",
  scope: !1807, file: !9, line: 12, type: !12, arg: 3)
!1815 = !DISubroutineType(types: !1816)
!1816 = !{null, !1810, !1812, !12 }
!1807 = distinct !DISubprogram( name: "_değer::Yeni_ox142i",
 scope: !1806,
 file: !9,
 line: 12,
 type: !1815, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1817 = !DILocation(line: 12, column: 19, scope: !1807)
!1818 = !DILocation(line: 12, column: 38, scope: !1807)
!1819 = !DILocation(line: 12, column: 49, scope: !1807)
!1820 = distinct !DILexicalBlock(
        scope: !1807, file: !9, line: 13, column: 3)
!1821 = !DILocation(line: 14, column: 24, scope: !1820)
!1822 = !DILocation(line: 14, column: 32, scope: !1820)
!1823 = !DILocation(line: 14, column: 36, scope: !1820)
!1824 = !DILocation(line: 14, column: 19, scope: !1820)
!1825 = !DILocation(line: 14, column: 5, scope: !1820)
!1826 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1827 = !DILocalVariable(name: "İmge",
  scope: !1820, file: !9, line: 14, type: !1826)
!1828 = !DILocation(line: 14, column: 5, scope: !1820)
!1829 = !DILocation(line: 15, column: 18, scope: !1820)
!1830 = !DILocation(line: 15, column: 26, scope: !1820)
!1831 = !DILocation(line: 15, column: 5, scope: !1820)
!1832 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1558, size: 64)
!1833 = !DILocalVariable(name: "Değer",
  scope: !1820, file: !9, line: 15, type: !1832)
!1834 = !DILocation(line: 15, column: 5, scope: !1820)
!1835 = !DILocation(line: 16, column: 5, scope: !1820)
!1836 = !DILocation(line: 16, column: 5, scope: !1820)
!1837 = !DILocation(line: 16, column: 26, scope: !1820)
!1838 = !DILocation(line: 16, column: 5, scope: !1820)
!1839 = !DILocation(line: 17, column: 5, scope: !1820)
!1840 = !DILocation(line: 17, column: 5, scope: !1820)
!1841 = !DILocation(line: 17, column: 26, scope: !1820)
!1842 = !DILocation(line: 17, column: 5, scope: !1820)
!1843 = !DILocation(line: 18, column: 5, scope: !1820)
!1844 = !DILocation(line: 18, column: 5, scope: !1820)
!1845 = !DILocation(line: 18, column: 43, scope: !1820)
!1846 = !DILocation(line: 18, column: 34, scope: !1820)
!1847 = !DILocation(line: 18, column: 5, scope: !1820)
!1848 = !DILocation(line: 19, column: 9, scope: !1820)
