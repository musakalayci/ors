...
define external %gt3det* 
@"_değer::Yeni_ox142i"(%gt29at* %0, %metin* %1, i32 %2)#0       !dbg !1817 {
; Değişken : dönüş
  %4 = alloca %gt3det*, align 8
  store %gt3det* null, %gt3det** %4, align 8
; Değişken : Hafıza
...
; Değişken : Ad
  ...
  call void @llvm.dbg.declare(metadata %metin** %6, metadata !1823, metadata !DIExpression()), !dbg !1828
; Değişken : özellik
...
;;-> (nil) 0
  %9 = load %metin*, %metin** %6, align 8, !dbg !1832; 2:0
;;-> (nil) 0
  %10 = load i32, i32* %7, align 4, !dbg !1833; 1:0
  %11 = call %gt3bft* @"imge::Adlı_ox110i" (
      %gt29at* %8, 
      %metin* %9, 
      i32 %10), !dbg !1834
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3bft** %12,
    align 8, !dbg !1835
  call void @llvm.dbg.declare(metadata %gt3bft** %12, metadata !1837, metadata !DIExpression()), !dbg !1838
  %13 = load %gt29at*, %gt29at** %5, align 8, !dbg !1839; 2:0
  %14 = call i8* (%gt29at*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt29at* %13, 
      i64 32, 
      i64 8), !dbg !1840
; Konum çevirisi:
  %15 = bitcast i8* %14 to %gt3det*; 1

; pascal 'Değer' örs::derleme::imge::_değer::t
  %16 = alloca %gt3det*, align 8
  store 
    %gt3det* %15,
    %gt3det** %16,
    align 8, !dbg !1841
  call void @llvm.dbg.declare(metadata %gt3det** %16, metadata !1843, metadata !DIExpression()), !dbg !1844
; Atama ifadesi
  %17 = load %gt3bft*, %gt3bft** %12, align 8, !dbg !1845; 2:0
...
; Konum çevirisi:
  %19 = bitcast %gt3bet* %18 to %gt3det**; 2
  %20 = load %gt3det*, %gt3det** %16, align 8, !dbg !1847; 2:0
;atama:
  store 
    %gt3det* %20,
    %gt3det** %19,
    align 8, !dbg !1848
; Atama ifadesi
  %21 = load %gt3det*, %gt3det** %16, align 8, !dbg !1849; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::t
  %22 = getelementptr inbounds 
    %gt3det, %gt3det* %21,
    i32 0, i32 0
  %23 = load %gt3bft*, %gt3bft** %12, align 8, !dbg !1851; 2:0
;atama:
  store 
    %gt3bft* %23,
    %gt3bft** %22,
    align 8, !dbg !1852
; Atama ifadesi
  %24 = load %gt3det*, %gt3det** %16, align 8, !dbg !1853; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::cins::özet
  %25 = getelementptr inbounds 
    %gt3det, %gt3det* %24,
    i32 0, i32 1
;;-> (nil) 0
  %26 = load %gt29at*, %gt29at** %5, align 8, !dbg !1855; 2:0
  %27 = call %gt455t* @"cins::YeniÖzet_ox111i" (
      %gt29at* %26, 
      ptr null), !dbg !1856
;atama:
  store 
    ...
    %gt455t** %25,
    align 8, !dbg !1857
  %28 = load %gt3det*, %gt3det** %16, align 8, !dbg !1858; 2:0
; Dönüş :
  ret %gt3det* %28
}
...
!1816 = !DINamespace(name:"_değer", scope: !1815)


!1818 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1556, size: 64)
...
!1823 = !DILocalVariable(name: "Ad",
  scope: !1817, file: !9, line: 12, type: !1822, arg: 2)
!1824 = !DILocalVariable(name: "özellik",
  scope: !1817, file: !9, line: 12, type: !12, arg: 3)
!1825 = !DISubroutineType(types: !1826)
!1826 = !{null, !1820, !1822, !12 }
!1817 = distinct !DISubprogram( name: "_değer::Yeni_ox142i",
 scope: !1816,
 file: !9,
 line: 12,
 type: !1825, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1827 = !DILocation(line: 12, column: 19, scope: !1817)
!1828 = !DILocation(line: 12, column: 38, scope: !1817)
!1829 = !DILocation(line: 12, column: 49, scope: !1817)
!1830 = distinct !DILexicalBlock(
        scope: !1817, file: !9, line: 13, column: 3)
!1831 = !DILocation(line: 14, column: 24, scope: !1830)
!1832 = !DILocation(line: 14, column: 32, scope: !1830)
!1833 = !DILocation(line: 14, column: 36, scope: !1830)
!1834 = !DILocation(line: 14, column: 19, scope: !1830)
!1835 = !DILocation(line: 14, column: 5, scope: !1830)
!1836 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1837 = !DILocalVariable(name: "İmge",
  scope: !1830, file: !9, line: 14, type: !1836)
!1838 = !DILocation(line: 14, column: 5, scope: !1830)
!1839 = !DILocation(line: 15, column: 18, scope: !1830)
!1840 = !DILocation(line: 15, column: 26, scope: !1830)
!1841 = !DILocation(line: 15, column: 5, scope: !1830)
!1842 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1556, size: 64)
!1843 = !DILocalVariable(name: "Değer",
  scope: !1830, file: !9, line: 15, type: !1842)
!1844 = !DILocation(line: 15, column: 5, scope: !1830)
!1845 = !DILocation(line: 16, column: 5, scope: !1830)
!1846 = !DILocation(line: 16, column: 5, scope: !1830)
!1847 = !DILocation(line: 16, column: 26, scope: !1830)
!1848 = !DILocation(line: 16, column: 5, scope: !1830)
!1849 = !DILocation(line: 17, column: 5, scope: !1830)
!1850 = !DILocation(line: 17, column: 5, scope: !1830)
!1851 = !DILocation(line: 17, column: 26, scope: !1830)
!1852 = !DILocation(line: 17, column: 5, scope: !1830)
!1853 = !DILocation(line: 18, column: 5, scope: !1830)
!1854 = !DILocation(line: 18, column: 5, scope: !1830)
!1855 = !DILocation(line: 18, column: 43, scope: !1830)
!1856 = !DILocation(line: 18, column: 34, scope: !1830)
!1857 = !DILocation(line: 18, column: 5, scope: !1830)
!1858 = !DILocation(line: 19, column: 9, scope: !1830)
