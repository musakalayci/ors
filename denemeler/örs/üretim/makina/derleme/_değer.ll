; ModuleID = 'örs::derleme::imge::_değer'
; Ürün adı : derleme
; Birim adı : örs::derleme::imge::_değer
; Yol: ./denemeler/örs/üretim/makina/derleme/
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"
source_filename = "./denemeler/örs/üretim/makina/derleme/_değer.ll"
...
define external %gt3b6t* 
@"_değer::Yeni_ox142i"(%gt294t* %0, %metin* %1, i32 %2)#0       !dbg !1716 {
; Değişken : dönüş
  %4 = alloca %gt3b6t*, align 8
  store %gt3b6t* null, %gt3b6t** %4, align 8
; Değişken : Hafıza
  %5 = alloca %gt294t*, align 8
  store %gt294t* %0, %gt294t** %5, align 8
  call void @llvm.dbg.declare(metadata %gt294t** %5, metadata !1720, metadata !DIExpression()), !dbg !1726
; Değişken : Ad
  %6 = alloca %metin*, align 8
  store %metin* %1, %metin** %6, align 8
  call void @llvm.dbg.declare(metadata %metin** %6, metadata !1722, metadata !DIExpression()), !dbg !1727
; Değişken : özellik
  %7 = alloca i32, align 4
  store i32 %2, i32* %7, align 4
  call void @llvm.dbg.declare(metadata i32* %7, metadata !1723, metadata !DIExpression()), !dbg !1728
;;-> (nil) 0
  %8 = load %gt294t*, %gt294t** %5, align 8, !dbg !1730; 2:0
;;-> (nil) 0
  %9 = load %metin*, %metin** %6, align 8, !dbg !1731; 2:0
;;-> (nil) 0
  %10 = load i32, i32* %7, align 4, !dbg !1732; 1:0
  %11 = call %gt398t* @"imge::Adlı_ox110i" (
      %gt294t* %8, 
      %metin* %9, 
      i32 %10), !dbg !1733
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt398t** %12,
    align 8, !dbg !1734
  call void @llvm.dbg.declare(metadata %gt398t** %12, metadata !1736, metadata !DIExpression()), !dbg !1737
  %13 = load %gt294t*, %gt294t** %5, align 8, !dbg !1738; 2:0
  %14 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt294t* %13, 
      i64 32, 
      i64 8), !dbg !1739
; Konum çevirisi:
  %15 = bitcast i8* %14 to %gt3b6t*; 1

; pascal 'Değer' örs::derleme::imge::_değer::t
  %16 = alloca %gt3b6t*, align 8
  store 
    %gt3b6t* %15,
    %gt3b6t** %16,
    align 8, !dbg !1740
  call void @llvm.dbg.declare(metadata %gt3b6t** %16, metadata !1742, metadata !DIExpression()), !dbg !1743
; Atama ifadesi
  %17 = load %gt398t*, %gt398t** %12, align 8, !dbg !1744; 2:0
...
; Konum çevirisi:
  %19 = bitcast %gt397t* %18 to %gt3b6t**; 2
  %20 = load %gt3b6t*, %gt3b6t** %16, align 8, !dbg !1746; 2:0
;atama:
  store 
    %gt3b6t* %20,
    %gt3b6t** %19,
    align 8, !dbg !1747
; Atama ifadesi
  %21 = load %gt3b6t*, %gt3b6t** %16, align 8, !dbg !1748; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::t
  %22 = getelementptr inbounds 
    %gt3b6t, %gt3b6t* %21,
    i32 0, i32 0
  %23 = load %gt398t*, %gt398t** %12, align 8, !dbg !1750; 2:0
;atama:
  store 
    %gt398t* %23,
    %gt398t** %22,
    align 8, !dbg !1751
; Atama ifadesi
  %24 = load %gt3b6t*, %gt3b6t** %16, align 8, !dbg !1752; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::cins::özet
  %25 = getelementptr inbounds 
    %gt3b6t, %gt3b6t* %24,
    i32 0, i32 1
;;-> (nil) 0
  %26 = load %gt294t*, %gt294t** %5, align 8, !dbg !1754; 2:0
  %27 = call %gt41et* @"cins::YeniÖzet_ox111i" (
      %gt294t* %26, 
      ptr null), !dbg !1755
;atama:
  store 
    ...
    %gt41et** %25,
    align 8, !dbg !1756
  %28 = load %gt3b6t*, %gt3b6t** %16, align 8, !dbg !1757; 2:0
; Dönüş :
  ret %gt3b6t* %28
}
...
!llvm.dbg.cu = !{!8}
!9 = !DIFile(
  filename: "./denemeler/\C3\B6rs/kaynak/derleme/imge/de\C4\9Fer.\C3\B6rs",
...
!1715 = !DINamespace(name:"_değer", scope: !1714)


!1717 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1491, size: 64)
...
!1722 = !DILocalVariable(name: "Ad",
  scope: !1716, file: !9, line: 12, type: !1721, arg: 2)
!1723 = !DILocalVariable(name: "özellik",
  scope: !1716, file: !9, line: 12, type: !12, arg: 3)
!1724 = !DISubroutineType(types: !1725)
!1725 = !{null, !1719, !1721, !12 }
!1716 = distinct !DISubprogram( name: "_değer::Yeni_ox142i",
 scope: !1715,
 file: !9,
 line: 12,
 type: !1724, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1726 = !DILocation(line: 12, column: 19, scope: !1716)
!1727 = !DILocation(line: 12, column: 38, scope: !1716)
!1728 = !DILocation(line: 12, column: 49, scope: !1716)
!1729 = distinct !DILexicalBlock(
        scope: !1716, file: !9, line: 13, column: 3)
!1730 = !DILocation(line: 14, column: 24, scope: !1729)
!1731 = !DILocation(line: 14, column: 32, scope: !1729)
!1732 = !DILocation(line: 14, column: 36, scope: !1729)
!1733 = !DILocation(line: 14, column: 19, scope: !1729)
!1734 = !DILocation(line: 14, column: 5, scope: !1729)
!1735 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1736 = !DILocalVariable(name: "İmge",
  scope: !1729, file: !9, line: 14, type: !1735)
!1737 = !DILocation(line: 14, column: 5, scope: !1729)
!1738 = !DILocation(line: 15, column: 18, scope: !1729)
!1739 = !DILocation(line: 15, column: 26, scope: !1729)
!1740 = !DILocation(line: 15, column: 5, scope: !1729)
!1741 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1491, size: 64)
!1742 = !DILocalVariable(name: "Değer",
  scope: !1729, file: !9, line: 15, type: !1741)
!1743 = !DILocation(line: 15, column: 5, scope: !1729)
!1744 = !DILocation(line: 16, column: 5, scope: !1729)
!1745 = !DILocation(line: 16, column: 5, scope: !1729)
!1746 = !DILocation(line: 16, column: 26, scope: !1729)
!1747 = !DILocation(line: 16, column: 5, scope: !1729)
!1748 = !DILocation(line: 17, column: 5, scope: !1729)
!1749 = !DILocation(line: 17, column: 5, scope: !1729)
!1750 = !DILocation(line: 17, column: 26, scope: !1729)
!1751 = !DILocation(line: 17, column: 5, scope: !1729)
!1752 = !DILocation(line: 18, column: 5, scope: !1729)
!1753 = !DILocation(line: 18, column: 5, scope: !1729)
!1754 = !DILocation(line: 18, column: 43, scope: !1729)
!1755 = !DILocation(line: 18, column: 34, scope: !1729)
!1756 = !DILocation(line: 18, column: 5, scope: !1729)
!1757 = !DILocation(line: 19, column: 9, scope: !1729)
