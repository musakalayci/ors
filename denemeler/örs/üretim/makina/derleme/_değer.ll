...
define external %gt24ft* 
@"_değer::Yeni_ox12Bi"(%gt1e0t* %0, %metin* %1, i32 %2)#0       {
; Değişken : dönüş
  %4 = alloca %gt24ft*, align 8
  store %gt24ft* null, %gt24ft** %4, align 8
; Değişken : Hafıza
...
;;-> (nil) 0
  ...
  %11 = call %gt231t* @"imge::Adlı_ox10Ai" (
      %gt1e0t* %8, 
      %metin* %9, 
      i32 %10)
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt231t** %12,
    align 8
  %13 = load %gt1e0t*, %gt1e0t** %5, align 8; 2:0
  %14 = call i8* (%gt1e0t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      %gt1e0t* %13, 
      i64 32, 
      i64 8)
; Konum çevirisi:
  %15 = bitcast i8* %14 to %gt24ft*; 1

; pascal 'Değer' örs::derleme::imge::_değer::t
  %16 = alloca %gt24ft*, align 8
  store 
    %gt24ft* %15,
    %gt24ft** %16,
    align 8
; Atama ifadesi
  %17 = load %gt231t*, %gt231t** %12, align 8; 2:0
...
; Konum çevirisi:
  %19 = bitcast %gt230t* %18 to %gt24ft**; 2
  %20 = load %gt24ft*, %gt24ft** %16, align 8; 2:0
;atama:
  store 
    %gt24ft* %20,
    %gt24ft** %19,
    align 8
; Atama ifadesi
  %21 = load %gt24ft*, %gt24ft** %16, align 8; 2:0
...
;atama:
  store 
    ...
    align 8
; Atama ifadesi
  %24 = load %gt24ft*, %gt24ft** %16, align 8; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::cins::özet
  %25 = getelementptr inbounds 
    %gt24ft, %gt24ft* %24,
    i32 0, i32 1
;;-> (nil) 0
  %26 = load %gt1e0t*, %gt1e0t** %5, align 8; 2:0
  %27 = call %gt26ft* @"cins::YeniÖzet_ox10Bi" (
      %gt1e0t* %26, 
      ptr null)
;atama:
  store 
    ...
    %gt26ft** %25,
    align 8
  %28 = load %gt24ft*, %gt24ft** %16, align 8; 2:0
; Dönüş :
  ret %gt24ft* %28
}
