...
define external %gt2edt* 
@"_değer::Yeni_i"(%gt263t* %0, %metin* %1, i32 %2)#0       !dbg !1144 {
; Değişken : dönüş
  %4 = alloca %gt2edt*, align 8
  store %gt2edt* null, %gt2edt** %4, align 8
; Değişken : Hafıza
...
;;-> (nil) 0
  %10 = load i32, i32* %7, align 4, !dbg !1160; 1:0
  %11 = call %gt2c2t* @"imge::Adlı_i" (
      %gt263t* %8, 
      %metin* %9, 
      i32 %10), !dbg !1161
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt2c2t** %12,
    align 8, !dbg !1162
  call void @llvm.dbg.declare(metadata %gt2c2t** %12, metadata !1164, metadata !DIExpression()), !dbg !1165
  %13 = load %gt263t*, %gt263t** %5, align 8, !dbg !1166; 2:0
  %14 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      %gt263t* %13, 
      i64 32, 
      i64 8), !dbg !1167
; Konum çevirisi:
  %15 = bitcast i8* %14 to %gt2edt*; 1

; pascal 'Değer' örs::derleme::imge::_değer::t
  %16 = alloca %gt2edt*, align 8
  store 
    %gt2edt* %15,
    %gt2edt** %16,
    align 8, !dbg !1168
  call void @llvm.dbg.declare(metadata %gt2edt** %16, metadata !1170, metadata !DIExpression()), !dbg !1171
; Atama ifadesi
  %17 = load %gt2c2t*, %gt2c2t** %12, align 8, !dbg !1172; 2:0
...
; Konum çevirisi:
  %19 = bitcast %gt2c1t* %18 to %gt2edt**; 2
  %20 = load %gt2edt*, %gt2edt** %16, align 8, !dbg !1174; 2:0
  store 
    %gt2edt* %20,
    %gt2edt** %19,
    align 8, !dbg !1175
; Atama ifadesi
  %21 = load %gt2edt*, %gt2edt** %16, align 8, !dbg !1176; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::t
  %22 = getelementptr inbounds 
    %gt2edt, %gt2edt* %21,
    i32 0, i32 0
  %23 = load %gt2c2t*, %gt2c2t** %12, align 8, !dbg !1178; 2:0
  store 
    %gt2c2t* %23,
    %gt2c2t** %22,
    align 8, !dbg !1179
; Atama ifadesi
  %24 = load %gt2edt*, %gt2edt** %16, align 8, !dbg !1180; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::cins::özet
  %25 = getelementptr inbounds 
    %gt2edt, %gt2edt* %24,
    i32 0, i32 1
;;-> (nil) 0
  %26 = load %gt263t*, %gt263t** %5, align 8, !dbg !1182; 2:0
  %27 = call %gt2fet* @"cins::YeniÖzet_i" (
      %gt263t* %26, 
      ptr null), !dbg !1183
  store 
    %gt2fet* %27,
    %gt2fet** %25,
    align 8, !dbg !1184
  %28 = load %gt2edt*, %gt2edt** %16, align 8, !dbg !1185; 2:0
; Dönüş :
  ret %gt2edt* %28
}
...
!1143 = !DINamespace(name:"_değer", scope: !1142)


!1145 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !925, size: 64)
...
!1148 = !DILocalVariable(name: "Hafıza",
  scope: !1144, file: !9, line: 12, type: !1147, arg: 1)
!1150 = !DILocalVariable(name: "Ad",
  scope: !1144, file: !9, line: 12, type: !1149, arg: 2)
!1151 = !DILocalVariable(name: "özellik",
  scope: !1144, file: !9, line: 12, type: !12, arg: 3)
!1152 = !DISubroutineType(types: !1153)
!1153 = !{null, !1147, !1149, !12 }
!1144 = distinct !DISubprogram( name: "_değer::Yeni_i",
 scope: !1143,
 file: !9,
 line: 12,
 type: !1152, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1154 = !DILocation(line: 12, column: 19, scope: !1144)
!1155 = !DILocation(line: 12, column: 38, scope: !1144)
!1156 = !DILocation(line: 12, column: 49, scope: !1144)
!1157 = distinct !DILexicalBlock(
        scope: !1144, file: !9, line: 13, column: 3)
!1158 = !DILocation(line: 14, column: 24, scope: !1157)
!1159 = !DILocation(line: 14, column: 32, scope: !1157)
!1160 = !DILocation(line: 14, column: 36, scope: !1157)
!1161 = !DILocation(line: 14, column: 19, scope: !1157)
!1162 = !DILocation(line: 14, column: 5, scope: !1157)
!1163 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1164 = !DILocalVariable(name: "İmge",
  scope: !1157, file: !9, line: 14, type: !1163)
!1165 = !DILocation(line: 14, column: 5, scope: !1157)
!1166 = !DILocation(line: 15, column: 18, scope: !1157)
!1167 = !DILocation(line: 15, column: 26, scope: !1157)
!1168 = !DILocation(line: 15, column: 5, scope: !1157)
!1169 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !925, size: 64)
!1170 = !DILocalVariable(name: "Değer",
  scope: !1157, file: !9, line: 15, type: !1169)
!1171 = !DILocation(line: 15, column: 5, scope: !1157)
!1172 = !DILocation(line: 16, column: 5, scope: !1157)
!1173 = !DILocation(line: 16, column: 5, scope: !1157)
!1174 = !DILocation(line: 16, column: 26, scope: !1157)
!1175 = !DILocation(line: 16, column: 5, scope: !1157)
!1176 = !DILocation(line: 17, column: 5, scope: !1157)
!1177 = !DILocation(line: 17, column: 5, scope: !1157)
!1178 = !DILocation(line: 17, column: 26, scope: !1157)
!1179 = !DILocation(line: 17, column: 5, scope: !1157)
!1180 = !DILocation(line: 18, column: 5, scope: !1157)
!1181 = !DILocation(line: 18, column: 5, scope: !1157)
!1182 = !DILocation(line: 18, column: 43, scope: !1157)
!1183 = !DILocation(line: 18, column: 34, scope: !1157)
!1184 = !DILocation(line: 18, column: 5, scope: !1157)
!1185 = !DILocation(line: 19, column: 9, scope: !1157)
