...
@"_değer::Yeni_ox142i"(%gt296t* %0, %metin* %1, i32 %2)#0       !dbg !1790 {
; Değişken : dönüş
  %4 = alloca %gt3c5t*, align 8
  store %gt3c5t* null, %gt3c5t** %4, align 8
; Değişken : Hafıza
  %5 = alloca %gt296t*, align 8
  store %gt296t* %0, %gt296t** %5, align 8
  call void @llvm.dbg.declare(metadata %gt296t** %5, metadata !1794, metadata !DIExpression()), !dbg !1800
; Değişken : Ad
  %6 = alloca %metin*, align 8
  store %metin* %1, %metin** %6, align 8
  call void @llvm.dbg.declare(metadata %metin** %6, metadata !1796, metadata !DIExpression()), !dbg !1801
; Değişken : özellik
  %7 = alloca i32, align 4
  store i32 %2, i32* %7, align 4
  call void @llvm.dbg.declare(metadata i32* %7, metadata !1797, metadata !DIExpression()), !dbg !1802
;;-> (nil) 0
  %8 = load %gt296t*, %gt296t** %5, align 8, !dbg !1804; 2:0
;;-> (nil) 0
  %9 = load %metin*, %metin** %6, align 8, !dbg !1805; 2:0
;;-> (nil) 0
  %10 = load i32, i32* %7, align 4, !dbg !1806; 1:0
  %11 = call %gt3a6t* @"imge::Adlı_ox110i" (
      %gt296t* %8, 
      %metin* %9, 
      i32 %10), !dbg !1807
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3a6t** %12,
    align 8, !dbg !1808
  call void @llvm.dbg.declare(metadata %gt3a6t** %12, metadata !1810, metadata !DIExpression()), !dbg !1811
  %13 = load %gt296t*, %gt296t** %5, align 8, !dbg !1812; 2:0
  %14 = call i8* (%gt296t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt296t* %13, 
      i64 32, 
      i64 8), !dbg !1813
; Konum çevirisi:
  %15 = bitcast i8* %14 to %gt3c5t*; 1

; pascal 'Değer' örs::derleme::imge::_değer::t
  %16 = alloca %gt3c5t*, align 8
  store 
    %gt3c5t* %15,
    %gt3c5t** %16,
    align 8, !dbg !1814
  call void @llvm.dbg.declare(metadata %gt3c5t** %16, metadata !1816, metadata !DIExpression()), !dbg !1817
; Atama ifadesi
  %17 = load %gt3a6t*, %gt3a6t** %12, align 8, !dbg !1818; 2:0
...
; Konum çevirisi:
  %19 = bitcast %gt3a5t* %18 to %gt3c5t**; 2
  %20 = load %gt3c5t*, %gt3c5t** %16, align 8, !dbg !1820; 2:0
;atama:
  store 
    %gt3c5t* %20,
    %gt3c5t** %19,
    align 8, !dbg !1821
; Atama ifadesi
  %21 = load %gt3c5t*, %gt3c5t** %16, align 8, !dbg !1822; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::t
  %22 = getelementptr inbounds 
    %gt3c5t, %gt3c5t* %21,
    i32 0, i32 0
  %23 = load %gt3a6t*, %gt3a6t** %12, align 8, !dbg !1824; 2:0
;atama:
  store 
    %gt3a6t* %23,
    %gt3a6t** %22,
    align 8, !dbg !1825
; Atama ifadesi
  %24 = load %gt3c5t*, %gt3c5t** %16, align 8, !dbg !1826; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::cins::özet
  %25 = getelementptr inbounds 
    %gt3c5t, %gt3c5t* %24,
    i32 0, i32 1
;;-> (nil) 0
  %26 = load %gt296t*, %gt296t** %5, align 8, !dbg !1828; 2:0
  %27 = call %gt439t* @"cins::YeniÖzet_ox111i" (
      %gt296t* %26, 
      ptr null), !dbg !1829
;atama:
  store 
    ...
    %gt439t** %25,
    align 8, !dbg !1830
  %28 = load %gt3c5t*, %gt3c5t** %16, align 8, !dbg !1831; 2:0
; Dönüş :
  ret %gt3c5t* %28
}
...
!1789 = !DINamespace(name:"_değer", scope: !1788)


!1791 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1559, size: 64)
...
!1796 = !DILocalVariable(name: "Ad",
  scope: !1790, file: !9, line: 12, type: !1795, arg: 2)
!1797 = !DILocalVariable(name: "özellik",
  scope: !1790, file: !9, line: 12, type: !12, arg: 3)
!1798 = !DISubroutineType(types: !1799)
!1799 = !{null, !1793, !1795, !12 }
!1790 = distinct !DISubprogram( name: "_değer::Yeni_ox142i",
 scope: !1789,
 file: !9,
 line: 12,
 type: !1798, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1800 = !DILocation(line: 12, column: 19, scope: !1790)
!1801 = !DILocation(line: 12, column: 38, scope: !1790)
!1802 = !DILocation(line: 12, column: 49, scope: !1790)
!1803 = distinct !DILexicalBlock(
        scope: !1790, file: !9, line: 13, column: 3)
!1804 = !DILocation(line: 14, column: 24, scope: !1803)
!1805 = !DILocation(line: 14, column: 32, scope: !1803)
!1806 = !DILocation(line: 14, column: 36, scope: !1803)
!1807 = !DILocation(line: 14, column: 19, scope: !1803)
!1808 = !DILocation(line: 14, column: 5, scope: !1803)
!1809 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1810 = !DILocalVariable(name: "İmge",
  scope: !1803, file: !9, line: 14, type: !1809)
!1811 = !DILocation(line: 14, column: 5, scope: !1803)
!1812 = !DILocation(line: 15, column: 18, scope: !1803)
!1813 = !DILocation(line: 15, column: 26, scope: !1803)
!1814 = !DILocation(line: 15, column: 5, scope: !1803)
!1815 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1559, size: 64)
!1816 = !DILocalVariable(name: "Değer",
  scope: !1803, file: !9, line: 15, type: !1815)
!1817 = !DILocation(line: 15, column: 5, scope: !1803)
!1818 = !DILocation(line: 16, column: 5, scope: !1803)
!1819 = !DILocation(line: 16, column: 5, scope: !1803)
!1820 = !DILocation(line: 16, column: 26, scope: !1803)
!1821 = !DILocation(line: 16, column: 5, scope: !1803)
!1822 = !DILocation(line: 17, column: 5, scope: !1803)
!1823 = !DILocation(line: 17, column: 5, scope: !1803)
!1824 = !DILocation(line: 17, column: 26, scope: !1803)
!1825 = !DILocation(line: 17, column: 5, scope: !1803)
!1826 = !DILocation(line: 18, column: 5, scope: !1803)
!1827 = !DILocation(line: 18, column: 5, scope: !1803)
!1828 = !DILocation(line: 18, column: 43, scope: !1803)
!1829 = !DILocation(line: 18, column: 34, scope: !1803)
!1830 = !DILocation(line: 18, column: 5, scope: !1803)
!1831 = !DILocation(line: 19, column: 9, scope: !1803)
