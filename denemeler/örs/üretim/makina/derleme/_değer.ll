...
define external %gt252t* 
@"_değer::Yeni_ox12Bi"(%gt1e2t* %0, %metin* %1, i32 %2)#0       !dbg !1580 {
; Değişken : dönüş
  %4 = alloca %gt252t*, align 8
  store %gt252t* null, %gt252t** %4, align 8
; Değişken : Hafıza
...
;;-> (nil) 0
  %10 = load i32, i32* %7, align 4, !dbg !1596; 1:0
  %11 = call %gt234t* @"imge::Adlı_ox10Ai" (
      %gt1e2t* %8, 
      %metin* %9, 
      i32 %10), !dbg !1597
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt234t** %12,
    align 8, !dbg !1598
  call void @llvm.dbg.declare(metadata %gt234t** %12, metadata !1600, metadata !DIExpression()), !dbg !1601
  %13 = load %gt1e2t*, %gt1e2t** %5, align 8, !dbg !1602; 2:0
  %14 = call i8* (%gt1e2t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      %gt1e2t* %13, 
      i64 32, 
      i64 8), !dbg !1603
; Konum çevirisi:
  %15 = bitcast i8* %14 to %gt252t*; 1

; pascal 'Değer' örs::derleme::imge::_değer::t
  %16 = alloca %gt252t*, align 8
  store 
    %gt252t* %15,
    %gt252t** %16,
    align 8, !dbg !1604
  call void @llvm.dbg.declare(metadata %gt252t** %16, metadata !1606, metadata !DIExpression()), !dbg !1607
; Atama ifadesi
  %17 = load %gt234t*, %gt234t** %12, align 8, !dbg !1608; 2:0
...
; Konum çevirisi:
  %19 = bitcast %gt233t* %18 to %gt252t**; 2
  %20 = load %gt252t*, %gt252t** %16, align 8, !dbg !1610; 2:0
;atama:
  store 
    %gt252t* %20,
    %gt252t** %19,
    align 8, !dbg !1611
; Atama ifadesi
  %21 = load %gt252t*, %gt252t** %16, align 8, !dbg !1612; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::t
  %22 = getelementptr inbounds 
    %gt252t, %gt252t* %21,
    i32 0, i32 0
  %23 = load %gt234t*, %gt234t** %12, align 8, !dbg !1614; 2:0
;atama:
  store 
    %gt234t* %23,
    %gt234t** %22,
    align 8, !dbg !1615
; Atama ifadesi
  %24 = load %gt252t*, %gt252t** %16, align 8, !dbg !1616; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::cins::özet
  %25 = getelementptr inbounds 
    %gt252t, %gt252t* %24,
    i32 0, i32 1
;;-> (nil) 0
  %26 = load %gt1e2t*, %gt1e2t** %5, align 8, !dbg !1618; 2:0
  %27 = call %gt273t* @"cins::YeniÖzet_ox10Bi" (
      %gt1e2t* %26, 
      ptr null), !dbg !1619
;atama:
  store 
    ...
    %gt273t** %25,
    align 8, !dbg !1620
  %28 = load %gt252t*, %gt252t** %16, align 8, !dbg !1621; 2:0
; Dönüş :
  ret %gt252t* %28
}
...
!1579 = !DINamespace(name:"_değer", scope: !1578)


!1581 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1388, size: 64)
...
!1584 = !DILocalVariable(name: "Hafıza",
  scope: !1580, file: !9, line: 12, type: !1583, arg: 1)
!1586 = !DILocalVariable(name: "Ad",
  scope: !1580, file: !9, line: 12, type: !1585, arg: 2)
!1587 = !DILocalVariable(name: "özellik",
  scope: !1580, file: !9, line: 12, type: !12, arg: 3)
!1588 = !DISubroutineType(types: !1589)
!1589 = !{null, !1583, !1585, !12 }
!1580 = distinct !DISubprogram( name: "_değer::Yeni_ox12Bi",
 scope: !1579,
 file: !9,
 line: 12,
 type: !1588, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1590 = !DILocation(line: 12, column: 19, scope: !1580)
!1591 = !DILocation(line: 12, column: 38, scope: !1580)
!1592 = !DILocation(line: 12, column: 49, scope: !1580)
!1593 = distinct !DILexicalBlock(
        scope: !1580, file: !9, line: 13, column: 3)
!1594 = !DILocation(line: 14, column: 24, scope: !1593)
!1595 = !DILocation(line: 14, column: 32, scope: !1593)
!1596 = !DILocation(line: 14, column: 36, scope: !1593)
!1597 = !DILocation(line: 14, column: 19, scope: !1593)
!1598 = !DILocation(line: 14, column: 5, scope: !1593)
!1599 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1600 = !DILocalVariable(name: "İmge",
  scope: !1593, file: !9, line: 14, type: !1599)
!1601 = !DILocation(line: 14, column: 5, scope: !1593)
!1602 = !DILocation(line: 15, column: 18, scope: !1593)
!1603 = !DILocation(line: 15, column: 26, scope: !1593)
!1604 = !DILocation(line: 15, column: 5, scope: !1593)
!1605 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1388, size: 64)
!1606 = !DILocalVariable(name: "Değer",
  scope: !1593, file: !9, line: 15, type: !1605)
!1607 = !DILocation(line: 15, column: 5, scope: !1593)
!1608 = !DILocation(line: 16, column: 5, scope: !1593)
!1609 = !DILocation(line: 16, column: 5, scope: !1593)
!1610 = !DILocation(line: 16, column: 26, scope: !1593)
!1611 = !DILocation(line: 16, column: 5, scope: !1593)
!1612 = !DILocation(line: 17, column: 5, scope: !1593)
!1613 = !DILocation(line: 17, column: 5, scope: !1593)
!1614 = !DILocation(line: 17, column: 26, scope: !1593)
!1615 = !DILocation(line: 17, column: 5, scope: !1593)
!1616 = !DILocation(line: 18, column: 5, scope: !1593)
!1617 = !DILocation(line: 18, column: 5, scope: !1593)
!1618 = !DILocation(line: 18, column: 43, scope: !1593)
!1619 = !DILocation(line: 18, column: 34, scope: !1593)
!1620 = !DILocation(line: 18, column: 5, scope: !1593)
!1621 = !DILocation(line: 19, column: 9, scope: !1593)
