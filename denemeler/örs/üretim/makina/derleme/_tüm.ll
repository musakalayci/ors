...
@"_tüm::Yeni_ox150i"(%gt294t* %0)#0       !dbg !1764 {
; Değişken : dönüş
...
; Değişken : Hafıza
  ...
  call void @llvm.dbg.declare(metadata %gt294t** %3, metadata !1767, metadata !DIExpression()), !dbg !1770
  %4 = load %gt294t*, %gt294t** %3, align 8, !dbg !1772; 2:0
...
; pascal 'Tüm' örs::derleme::imge::_tüm::t
  ...
  store 
    ...
    %gt3fct** %7,
    align 8, !dbg !1774
  call void @llvm.dbg.declare(metadata %gt3fct** %7, metadata !1775, metadata !DIExpression()), !dbg !1776
;;-> (nil) 0
  %8 = load %gt294t*, %gt294t** %3, align 8, !dbg !1777; 2:0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3a2t** %10,
    align 8, !dbg !1779
  call void @llvm.dbg.declare(metadata %gt3a2t** %10, metadata !1781, metadata !DIExpression()), !dbg !1782
; Atama ifadesi
  %11 = load %gt3a2t*, %gt3a2t** %10, align 8, !dbg !1783; 2:0
...
; Konum çevirisi:
  %13 = bitcast %gt3a1t* %12 to %gt3fct**; 2
  %14 = load %gt3fct*, %gt3fct** %7, align 8, !dbg !1785; 2:0
;atama:
  store 
    %gt3fct* %14,
    %gt3fct** %13,
    align 8, !dbg !1786
; Atama ifadesi
  %15 = load %gt3a2t*, %gt3a2t** %10, align 8, !dbg !1787; 2:0
...
; tür konumu *örs::derleme::nesne::t : *örs::derleme::imge::t
  %17 = getelementptr inbounds 
    %gt58dt, %gt58dt* %16,
    i32 0, i32 6
  %18 = load %gt3a2t*, %gt3a2t** %10, align 8, !dbg !1790; 2:0
;atama:
  store 
    %gt3a2t* %18,
    %gt3a2t** %17,
    align 8, !dbg !1791
; Atama ifadesi
  %19 = load %gt3fct*, %gt3fct** %7, align 8, !dbg !1792; 2:0
; tür konumu *örs::derleme::imge::_tüm::t : *örs::derleme::imge::t
  %20 = getelementptr inbounds 
    %gt3fct, %gt3fct* %19,
    i32 0, i32 0
  %21 = load %gt3a2t*, %gt3a2t** %10, align 8, !dbg !1794; 2:0
;atama:
  store 
    %gt3a2t* %21,
    %gt3a2t** %20,
    align 8, !dbg !1795
  %22 = load %gt3a2t*, %gt3a2t** %10, align 8, !dbg !1796; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::nesne::t
...
; Sanal bitiş : Anlamlandır
  %26 = load %gt3fct*, %gt3fct** %7, align 8, !dbg !1803; 2:0
; Dönüş :
  ret %gt3fct* %26
}
...
!1763 = !DINamespace(name:"_tüm", scope: !1762)


!1765 = !DILocalVariable(name: "dönüş",
  scope: !1764, file: !9, line: 15, type: !1658)
!1766 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1767 = !DILocalVariable(name: "Hafıza",
  scope: !1764, file: !9, line: 13, type: !1766, arg: 1)
!1768 = !DISubroutineType(types: !1769)
!1769 = !{null, !1766 }
!1764 = distinct !DISubprogram( name: "_tüm::Yeni_ox150i",
 scope: !1763,
 file: !9,
 line: 12,
 type: !1768, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1770 = !DILocation(line: 13, column: 5, scope: !1764)
!1771 = distinct !DILexicalBlock(
        scope: !1764, file: !9, line: 14, column: 3)
!1772 = !DILocation(line: 15, column: 16, scope: !1771)
!1773 = !DILocation(line: 15, column: 24, scope: !1771)
!1774 = !DILocation(line: 15, column: 5, scope: !1771)
!1775 = !DILocalVariable(name: "Tüm",
  scope: !1771, file: !9, line: 15, type: !1658)
!1776 = !DILocation(line: 15, column: 5, scope: !1771)
!1777 = !DILocation(line: 16, column: 24, scope: !1771)
!1778 = !DILocation(line: 16, column: 19, scope: !1771)
!1779 = !DILocation(line: 16, column: 5, scope: !1771)
!1780 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1781 = !DILocalVariable(name: "İmge",
  scope: !1771, file: !9, line: 16, type: !1780)
!1782 = !DILocation(line: 16, column: 5, scope: !1771)
!1783 = !DILocation(line: 17, column: 5, scope: !1771)
!1784 = !DILocation(line: 17, column: 5, scope: !1771)
!1785 = !DILocation(line: 17, column: 24, scope: !1771)
!1786 = !DILocation(line: 17, column: 5, scope: !1771)
!1787 = !DILocation(line: 18, column: 5, scope: !1771)
!1788 = !DILocation(line: 18, column: 5, scope: !1771)
!1789 = !DILocation(line: 18, column: 5, scope: !1771)
!1790 = !DILocation(line: 18, column: 24, scope: !1771)
!1791 = !DILocation(line: 18, column: 5, scope: !1771)
!1792 = !DILocation(line: 19, column: 5, scope: !1771)
!1793 = !DILocation(line: 19, column: 5, scope: !1771)
!1794 = !DILocation(line: 19, column: 24, scope: !1771)
!1795 = !DILocation(line: 19, column: 5, scope: !1771)
!1796 = !DILocation(line: 20, column: 5, scope: !1771)
!1797 = !DILocation(line: 20, column: 5, scope: !1771)
!1798 = distinct !DILexicalBlock(
        scope: !1771, file: !9, line: 20, column: 17)
!1799 = distinct !DILexicalBlock(
        scope: !1798, file: !9, line: 254, column: 1)
!1800 = !DILocation(line: 251, column: 3, scope: !1799)
!1801 = !DILocation(line: 251, column: 3, scope: !1799)
!1802 = !DILocation(line: 251, column: 3, scope: !1799)
!1803 = !DILocation(line: 21, column: 9, scope: !1771)
