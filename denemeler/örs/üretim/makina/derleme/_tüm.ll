...
define external %gt260t* 
@"_tüm::Yeni_ox12Fi"(%gt1e2t* %0)#0       !dbg !1580 {
; Değişken : dönüş
  %2 = alloca %gt260t*, align 8
  store %gt260t* null, %gt260t** %2, align 8
; Değişken : Hafıza
...
; pascal 'Tüm' örs::derleme::imge::_tüm::t
  ...
  store 
    ...
    %gt260t** %7,
    align 8, !dbg !1591
  call void @llvm.dbg.declare(metadata %gt260t** %7, metadata !1593, metadata !DIExpression()), !dbg !1594
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt234t*, %gt234t** %10, align 8, !dbg !1601; 2:0
...
; Konum çevirisi:
  %13 = bitcast %gt233t* %12 to %gt260t**; 2
  %14 = load %gt260t*, %gt260t** %7, align 8, !dbg !1603; 2:0
;atama:
  store 
    %gt260t* %14,
    %gt260t** %13,
    align 8, !dbg !1604
; Atama ifadesi
  %15 = load %gt260t*, %gt260t** %7, align 8, !dbg !1605; 2:0
; tür konumu *örs::derleme::imge::_tüm::t : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt260t, %gt260t* %15,
    i32 0, i32 0
  %17 = load %gt234t*, %gt234t** %10, align 8, !dbg !1607; 2:0
;atama:
  store 
    %gt234t* %17,
    %gt234t** %16,
    align 8, !dbg !1608
  %18 = load %gt260t*, %gt260t** %7, align 8, !dbg !1609; 2:0
; Dönüş :
  ret %gt260t* %18
}
...
!1579 = !DINamespace(name:"_tüm", scope: !1578)


!1581 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1469, size: 64)
...
!1586 = !{null, !1583 }
!1580 = distinct !DISubprogram( name: "_tüm::Yeni_ox12Fi",
 scope: !1579,
 file: !9,
 line: 11,
 type: !1585, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1587 = !DILocation(line: 12, column: 5, scope: !1580)
!1588 = distinct !DILexicalBlock(
        scope: !1580, file: !9, line: 13, column: 3)
!1589 = !DILocation(line: 14, column: 16, scope: !1588)
!1590 = !DILocation(line: 14, column: 24, scope: !1588)
!1591 = !DILocation(line: 14, column: 5, scope: !1588)
!1592 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1469, size: 64)
!1593 = !DILocalVariable(name: "Tüm",
  scope: !1588, file: !9, line: 14, type: !1592)
!1594 = !DILocation(line: 14, column: 5, scope: !1588)
!1595 = !DILocation(line: 15, column: 24, scope: !1588)
!1596 = !DILocation(line: 15, column: 19, scope: !1588)
!1597 = !DILocation(line: 15, column: 5, scope: !1588)
!1598 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1599 = !DILocalVariable(name: "İmge",
  scope: !1588, file: !9, line: 15, type: !1598)
!1600 = !DILocation(line: 15, column: 5, scope: !1588)
!1601 = !DILocation(line: 16, column: 5, scope: !1588)
!1602 = !DILocation(line: 16, column: 5, scope: !1588)
!1603 = !DILocation(line: 16, column: 24, scope: !1588)
!1604 = !DILocation(line: 16, column: 5, scope: !1588)
!1605 = !DILocation(line: 17, column: 5, scope: !1588)
!1606 = !DILocation(line: 17, column: 5, scope: !1588)
!1607 = !DILocation(line: 17, column: 24, scope: !1588)
!1608 = !DILocation(line: 17, column: 5, scope: !1588)
!1609 = !DILocation(line: 18, column: 9, scope: !1588)
