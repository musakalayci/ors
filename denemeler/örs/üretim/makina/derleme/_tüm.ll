...
define external %gt2e3t* 
@"_tüm::Yeni_i"(%gt263t* %0)#0       !dbg !1144 {
; Değişken : dönüş
  %2 = alloca %gt2e3t*, align 8
  store %gt2e3t* null, %gt2e3t** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt263t*, align 8
  store %gt263t* %0, %gt263t** %3, align 8
  call void @llvm.dbg.declare(metadata %gt263t** %3, metadata !1147, metadata !DIExpression()), !dbg !1150
  %4 = load %gt263t*, %gt263t** %3, align 8, !dbg !1152; 2:0
  %5 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      %gt263t* %4, 
      i64 24, 
      i64 8), !dbg !1153
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt2e3t*; 1

; pascal 'Tüm' örs::derleme::imge::_tüm::t
  %7 = alloca %gt2e3t*, align 8
  store 
    %gt2e3t* %6,
    %gt2e3t** %7,
    align 8, !dbg !1154
  call void @llvm.dbg.declare(metadata %gt2e3t** %7, metadata !1155, metadata !DIExpression()), !dbg !1156
;;-> (nil) 0
  %8 = load %gt263t*, %gt263t** %3, align 8, !dbg !1157; 2:0
;;-> (nil) 0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt2c2t** %10,
    align 8, !dbg !1159
  call void @llvm.dbg.declare(metadata %gt2c2t** %10, metadata !1161, metadata !DIExpression()), !dbg !1162
; Atama ifadesi
  %11 = load %gt2c2t*, %gt2c2t** %10, align 8, !dbg !1163; 2:0
...
; Konum çevirisi:
  %13 = bitcast %gt2c1t* %12 to %gt2e3t**; 2
  %14 = load %gt2e3t*, %gt2e3t** %7, align 8, !dbg !1165; 2:0
  store 
    %gt2e3t* %14,
    %gt2e3t** %13,
    align 8, !dbg !1166
; Atama ifadesi
  %15 = load %gt2e3t*, %gt2e3t** %7, align 8, !dbg !1167; 2:0
; tür konumu *örs::derleme::imge::_tüm::t : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt2e3t, %gt2e3t* %15,
    i32 0, i32 0
  %17 = load %gt2c2t*, %gt2c2t** %10, align 8, !dbg !1169; 2:0
  store 
    %gt2c2t* %17,
    %gt2c2t** %16,
    align 8, !dbg !1170
  %18 = load %gt2e3t*, %gt2e3t** %7, align 8, !dbg !1171; 2:0
; Dönüş :
  ret %gt2e3t* %18
}
...
!1143 = !DINamespace(name:"_tüm", scope: !1142)


!1145 = !DILocalVariable(name: "dönüş",
  scope: !1144, file: !9, line: 15, type: !1008)
!1146 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !88, size: 64)
!1147 = !DILocalVariable(name: "Hafıza",
  scope: !1144, file: !9, line: 12, type: !1146, arg: 1)
!1148 = !DISubroutineType(types: !1149)
!1149 = !{null, !1146 }
!1144 = distinct !DISubprogram( name: "_tüm::Yeni_i",
 scope: !1143,
 file: !9,
 line: 11,
 type: !1148, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1150 = !DILocation(line: 12, column: 5, scope: !1144)
!1151 = distinct !DILexicalBlock(
        scope: !1144, file: !9, line: 13, column: 3)
!1152 = !DILocation(line: 14, column: 16, scope: !1151)
!1153 = !DILocation(line: 14, column: 24, scope: !1151)
!1154 = !DILocation(line: 14, column: 5, scope: !1151)
!1155 = !DILocalVariable(name: "Tüm",
  scope: !1151, file: !9, line: 14, type: !1008)
!1156 = !DILocation(line: 14, column: 5, scope: !1151)
!1157 = !DILocation(line: 15, column: 24, scope: !1151)
!1158 = !DILocation(line: 15, column: 19, scope: !1151)
!1159 = !DILocation(line: 15, column: 5, scope: !1151)
!1160 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1161 = !DILocalVariable(name: "İmge",
  scope: !1151, file: !9, line: 15, type: !1160)
!1162 = !DILocation(line: 15, column: 5, scope: !1151)
!1163 = !DILocation(line: 16, column: 5, scope: !1151)
!1164 = !DILocation(line: 16, column: 5, scope: !1151)
!1165 = !DILocation(line: 16, column: 24, scope: !1151)
!1166 = !DILocation(line: 16, column: 5, scope: !1151)
!1167 = !DILocation(line: 17, column: 5, scope: !1151)
!1168 = !DILocation(line: 17, column: 5, scope: !1151)
!1169 = !DILocation(line: 17, column: 24, scope: !1151)
!1170 = !DILocation(line: 17, column: 5, scope: !1151)
!1171 = !DILocation(line: 18, column: 9, scope: !1151)
