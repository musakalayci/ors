...
define external %gt25dt* 
@"_tüm::Yeni_ox12Fi"(%gt1e0t* %0)#0       {
; Değişken : dönüş
  %2 = alloca %gt25dt*, align 8
  store %gt25dt* null, %gt25dt** %2, align 8
; Değişken : Hafıza
...
; Konum çevirisi:
  %13 = bitcast %gt230t* %12 to %gt25dt**; 2
  %14 = load %gt25dt*, %gt25dt** %7, align 8; 2:0
;atama:
  store 
    %gt25dt* %14,
    %gt25dt** %13,
    align 8
; Atama ifadesi
  %15 = load %gt25dt*, %gt25dt** %7, align 8; 2:0
...
;atama:
  store 
    ...
    %gt231t** %16,
    align 8
  %18 = load %gt25dt*, %gt25dt** %7, align 8; 2:0
; Dönüş :
  ret %gt25dt* %18
}
