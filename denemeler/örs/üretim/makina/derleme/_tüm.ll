...
define external %gt400t* 
@"_tüm::Yeni_ox150i"(%gt296t* %0)#0       !dbg !1790 {
; Değişken : dönüş
  %2 = alloca %gt400t*, align 8
  store %gt400t* null, %gt400t** %2, align 8
; Değişken : Hafıza
  ...
  %5 = call i8* (%gt296t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1799
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt400t*; 1

; pascal 'Tüm' örs::derleme::imge::_tüm::t
  %7 = alloca %gt400t*, align 8
  store 
    %gt400t* %6,
    %gt400t** %7,
    align 8, !dbg !1800
  call void @llvm.dbg.declare(metadata %gt400t** %7, metadata !1801, metadata !DIExpression()), !dbg !1802
;;-> (nil) 0
  %8 = load %gt296t*, %gt296t** %3, align 8, !dbg !1803; 2:0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3a6t** %10,
    align 8, !dbg !1805
  call void @llvm.dbg.declare(metadata %gt3a6t** %10, metadata !1807, metadata !DIExpression()), !dbg !1808
; Atama ifadesi
  %11 = load %gt3a6t*, %gt3a6t** %10, align 8, !dbg !1809; 2:0
...
; Konum çevirisi:
  %13 = bitcast %gt3a5t* %12 to %gt400t**; 2
  %14 = load %gt400t*, %gt400t** %7, align 8, !dbg !1811; 2:0
;atama:
  store 
    %gt400t* %14,
    %gt400t** %13,
    align 8, !dbg !1812
; Atama ifadesi
  %15 = load %gt3a6t*, %gt3a6t** %10, align 8, !dbg !1813; 2:0
...
; tür konumu *örs::derleme::nesne::t : *örs::derleme::imge::t
  %17 = getelementptr inbounds 
    %gt5a6t, %gt5a6t* %16,
    i32 0, i32 6
  %18 = load %gt3a6t*, %gt3a6t** %10, align 8, !dbg !1816; 2:0
;atama:
  store 
    %gt3a6t* %18,
    %gt3a6t** %17,
    align 8, !dbg !1817
; Atama ifadesi
  %19 = load %gt400t*, %gt400t** %7, align 8, !dbg !1818; 2:0
; tür konumu *örs::derleme::imge::_tüm::t : *örs::derleme::imge::t
  %20 = getelementptr inbounds 
    %gt400t, %gt400t* %19,
    i32 0, i32 0
  %21 = load %gt3a6t*, %gt3a6t** %10, align 8, !dbg !1820; 2:0
;atama:
  store 
    %gt3a6t* %21,
    %gt3a6t** %20,
    align 8, !dbg !1821
  %22 = load %gt3a6t*, %gt3a6t** %10, align 8, !dbg !1822; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::nesne::t
...
; Sanal bitiş : Anlamlandır
  %26 = load %gt400t*, %gt400t** %7, align 8, !dbg !1829; 2:0
; Dönüş :
  ret %gt400t* %26
}
...
!1789 = !DINamespace(name:"_tüm", scope: !1788)


!1791 = !DILocalVariable(name: "dönüş",
  scope: !1790, file: !9, line: 15, type: !1681)
!1792 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1793 = !DILocalVariable(name: "Hafıza",
  scope: !1790, file: !9, line: 13, type: !1792, arg: 1)
!1794 = !DISubroutineType(types: !1795)
!1795 = !{null, !1792 }
!1790 = distinct !DISubprogram( name: "_tüm::Yeni_ox150i",
 scope: !1789,
 file: !9,
 line: 12,
 type: !1794, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1796 = !DILocation(line: 13, column: 5, scope: !1790)
!1797 = distinct !DILexicalBlock(
        scope: !1790, file: !9, line: 14, column: 3)
!1798 = !DILocation(line: 15, column: 16, scope: !1797)
!1799 = !DILocation(line: 15, column: 24, scope: !1797)
!1800 = !DILocation(line: 15, column: 5, scope: !1797)
!1801 = !DILocalVariable(name: "Tüm",
  scope: !1797, file: !9, line: 15, type: !1681)
!1802 = !DILocation(line: 15, column: 5, scope: !1797)
!1803 = !DILocation(line: 16, column: 24, scope: !1797)
!1804 = !DILocation(line: 16, column: 19, scope: !1797)
!1805 = !DILocation(line: 16, column: 5, scope: !1797)
!1806 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1807 = !DILocalVariable(name: "İmge",
  scope: !1797, file: !9, line: 16, type: !1806)
!1808 = !DILocation(line: 16, column: 5, scope: !1797)
!1809 = !DILocation(line: 17, column: 5, scope: !1797)
!1810 = !DILocation(line: 17, column: 5, scope: !1797)
!1811 = !DILocation(line: 17, column: 24, scope: !1797)
!1812 = !DILocation(line: 17, column: 5, scope: !1797)
!1813 = !DILocation(line: 18, column: 5, scope: !1797)
!1814 = !DILocation(line: 18, column: 5, scope: !1797)
!1815 = !DILocation(line: 18, column: 5, scope: !1797)
!1816 = !DILocation(line: 18, column: 24, scope: !1797)
!1817 = !DILocation(line: 18, column: 5, scope: !1797)
!1818 = !DILocation(line: 19, column: 5, scope: !1797)
!1819 = !DILocation(line: 19, column: 5, scope: !1797)
!1820 = !DILocation(line: 19, column: 24, scope: !1797)
!1821 = !DILocation(line: 19, column: 5, scope: !1797)
!1822 = !DILocation(line: 20, column: 5, scope: !1797)
!1823 = !DILocation(line: 20, column: 5, scope: !1797)
!1824 = distinct !DILexicalBlock(
        scope: !1797, file: !9, line: 20, column: 17)
!1825 = distinct !DILexicalBlock(
        scope: !1824, file: !9, line: 255, column: 1)
!1826 = !DILocation(line: 251, column: 3, scope: !1825)
!1827 = !DILocation(line: 251, column: 3, scope: !1825)
!1828 = !DILocation(line: 251, column: 3, scope: !1825)
!1829 = !DILocation(line: 21, column: 9, scope: !1797)
