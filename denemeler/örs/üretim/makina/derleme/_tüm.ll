...
@"_tüm::Yeni_ox150i"(%gt294t* %0)#0       !dbg !1716 {
; Değişken : dönüş
  %2 = alloca %gt3eet*, align 8
  store %gt3eet* null, %gt3eet** %2, align 8
; Değişken : Hafıza
  ...
  %5 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1726
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt3eet*; 1

; pascal 'Tüm' örs::derleme::imge::_tüm::t
  %7 = alloca %gt3eet*, align 8
  store 
    %gt3eet* %6,
    %gt3eet** %7,
    align 8, !dbg !1727
  call void @llvm.dbg.declare(metadata %gt3eet** %7, metadata !1729, metadata !DIExpression()), !dbg !1730
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt398t*, %gt398t** %10, align 8, !dbg !1737; 2:0
...
; Konum çevirisi:
  %13 = bitcast %gt397t* %12 to %gt3eet**; 2
  %14 = load %gt3eet*, %gt3eet** %7, align 8, !dbg !1739; 2:0
;atama:
  store 
    %gt3eet* %14,
    %gt3eet** %13,
    align 8, !dbg !1740
; Atama ifadesi
  %15 = load %gt398t*, %gt398t** %10, align 8, !dbg !1741; 2:0
...
; tür konumu *örs::derleme::nesne::t : *örs::derleme::imge::t
  %17 = getelementptr inbounds 
    %gt570t, %gt570t* %16,
    i32 0, i32 6
  %18 = load %gt398t*, %gt398t** %10, align 8, !dbg !1744; 2:0
;atama:
  store 
    %gt398t* %18,
    %gt398t** %17,
    align 8, !dbg !1745
; Atama ifadesi
  %19 = load %gt3eet*, %gt3eet** %7, align 8, !dbg !1746; 2:0
; tür konumu *örs::derleme::imge::_tüm::t : *örs::derleme::imge::t
  %20 = getelementptr inbounds 
    %gt3eet, %gt3eet* %19,
    i32 0, i32 0
  %21 = load %gt398t*, %gt398t** %10, align 8, !dbg !1748; 2:0
;atama:
  store 
    %gt398t* %21,
    %gt398t** %20,
    align 8, !dbg !1749
  %22 = load %gt398t*, %gt398t** %10, align 8, !dbg !1750; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::nesne::t
...
; Sanal bitiş : Anlamlandır
  %26 = load %gt3eet*, %gt3eet** %7, align 8, !dbg !1757; 2:0
; Dönüş :
  ret %gt3eet* %26
}
...
!1715 = !DINamespace(name:"_tüm", scope: !1714)


!1717 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1610, size: 64)
...
!1720 = !DILocalVariable(name: "Hafıza",
  scope: !1716, file: !9, line: 13, type: !1719, arg: 1)
!1721 = !DISubroutineType(types: !1722)
!1722 = !{null, !1719 }
!1716 = distinct !DISubprogram( name: "_tüm::Yeni_ox150i",
 scope: !1715,
 file: !9,
 line: 12,
 type: !1721, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1723 = !DILocation(line: 13, column: 5, scope: !1716)
!1724 = distinct !DILexicalBlock(
        scope: !1716, file: !9, line: 14, column: 3)
!1725 = !DILocation(line: 15, column: 16, scope: !1724)
!1726 = !DILocation(line: 15, column: 24, scope: !1724)
!1727 = !DILocation(line: 15, column: 5, scope: !1724)
!1728 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1610, size: 64)
!1729 = !DILocalVariable(name: "Tüm",
  scope: !1724, file: !9, line: 15, type: !1728)
!1730 = !DILocation(line: 15, column: 5, scope: !1724)
!1731 = !DILocation(line: 16, column: 24, scope: !1724)
!1732 = !DILocation(line: 16, column: 19, scope: !1724)
!1733 = !DILocation(line: 16, column: 5, scope: !1724)
!1734 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1735 = !DILocalVariable(name: "İmge",
  scope: !1724, file: !9, line: 16, type: !1734)
!1736 = !DILocation(line: 16, column: 5, scope: !1724)
!1737 = !DILocation(line: 17, column: 5, scope: !1724)
!1738 = !DILocation(line: 17, column: 5, scope: !1724)
!1739 = !DILocation(line: 17, column: 24, scope: !1724)
!1740 = !DILocation(line: 17, column: 5, scope: !1724)
!1741 = !DILocation(line: 18, column: 5, scope: !1724)
!1742 = !DILocation(line: 18, column: 5, scope: !1724)
!1743 = !DILocation(line: 18, column: 5, scope: !1724)
!1744 = !DILocation(line: 18, column: 24, scope: !1724)
!1745 = !DILocation(line: 18, column: 5, scope: !1724)
!1746 = !DILocation(line: 19, column: 5, scope: !1724)
!1747 = !DILocation(line: 19, column: 5, scope: !1724)
!1748 = !DILocation(line: 19, column: 24, scope: !1724)
!1749 = !DILocation(line: 19, column: 5, scope: !1724)
!1750 = !DILocation(line: 20, column: 5, scope: !1724)
!1751 = !DILocation(line: 20, column: 5, scope: !1724)
!1752 = distinct !DILexicalBlock(
        scope: !1724, file: !9, line: 20, column: 17)
!1753 = distinct !DILexicalBlock(
        scope: !1752, file: !9, line: 254, column: 1)
!1754 = !DILocation(line: 251, column: 3, scope: !1753)
!1755 = !DILocation(line: 251, column: 3, scope: !1753)
!1756 = !DILocation(line: 251, column: 3, scope: !1753)
!1757 = !DILocation(line: 21, column: 9, scope: !1724)
