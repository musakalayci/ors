...
define external %gt24dt* 
@"hazne::Yeni_ox12Ai"(%gt1e0t* %0, %gt231t* %1)#0       {
; Değişken : dönüş
  %3 = alloca %gt24dt*, align 8
  store %gt24dt* null, %gt24dt** %3, align 8
; Değişken : Hafıza
...
; Değişken : İmge
  ...
  %7 = call i8* (%gt1e0t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      ...
      i64 8)
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt24dt*; 1

; pascal 'Hazne' örs::derleme::imge::hazne::t
  %9 = alloca %gt24dt*, align 8
  store 
    %gt24dt* %8,
    %gt24dt** %9,
    align 8
; Atama ifadesi
  %10 = load %gt24dt*, %gt24dt** %9, align 8; 2:0
...
;atama:
  store 
    ...
    align 8
; Atama ifadesi
  %13 = load %gt231t*, %gt231t** %5, align 8; 2:0
...
; Konum çevirisi:
  %15 = bitcast %gt230t* %14 to %gt24dt**; 2
  %16 = load %gt24dt*, %gt24dt** %9, align 8; 2:0
;atama:
  store 
    %gt24dt* %16,
    %gt24dt** %15,
...
;atama:
  store 
    ...
    align 4
; Atama ifadesi
  %19 = load %gt24dt*, %gt24dt** %9, align 8; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::k[%st435_1gt231t]
  ...
  %22 = call i8* (%gt1e0t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      ...
      i64 8)
; Konum çevirisi:
  %23 = bitcast i8* %22 to %st435_1gt231t*; 1
;atama:
  store 
    %st435_1gt231t* %23,
    %st435_1gt231t** %20,
    align 8
  %24 = load %gt24dt*, %gt24dt** %9, align 8; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::k[%st435_1gt231t]
  %25 = getelementptr inbounds 
    %gt24dt, %gt24dt* %24,
    i32 0, i32 2
  %26 = load %st435_1gt231t*, %st435_1gt231t** %25, align 8; 2:0
;;-> (nil) 0
 ...
 call void @"imge::imgeler.Yapılandır_ox10ai" (
      ...
      %gt1e0t* %27, 
      i32 16)
  %28 = load %gt24dt*, %gt24dt** %9, align 8; 2:0
; Dönüş :
  ret %gt24dt* %28
}
