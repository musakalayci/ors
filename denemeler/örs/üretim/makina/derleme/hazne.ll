...
define external %gt2d2t* 
@"hazne::Yeni_i"(%gt263t* %0, %gt2c2t* %1)#0       !dbg !1144 {
; Değişken : dönüş
  %3 = alloca %gt2d2t*, align 8
  store %gt2d2t* null, %gt2d2t** %3, align 8
; Değişken : Hafıza
...
; Değişken : İmge
  ...
  %7 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      ...
      i64 8), !dbg !1157
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt2d2t*; 1

; pascal 'Hazne' örs::derleme::imge::hazne::t
  %9 = alloca %gt2d2t*, align 8
  store 
    %gt2d2t* %8,
    %gt2d2t** %9,
    align 8, !dbg !1158
  call void @llvm.dbg.declare(metadata %gt2d2t** %9, metadata !1160, metadata !DIExpression()), !dbg !1161
; Atama ifadesi
  %10 = load %gt2d2t*, %gt2d2t** %9, align 8, !dbg !1162; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::t
  %11 = getelementptr inbounds 
    %gt2d2t, %gt2d2t* %10,
    i32 0, i32 0
  %12 = load %gt2c2t*, %gt2c2t** %5, align 8, !dbg !1164; 2:0
  store 
    %gt2c2t* %12,
    %gt2c2t** %11,
    align 8, !dbg !1165
; Atama ifadesi
  %13 = load %gt2c2t*, %gt2c2t** %5, align 8, !dbg !1166; 2:0
...
; Konum çevirisi:
  %15 = bitcast %gt2c1t* %14 to %gt2d2t**; 2
  %16 = load %gt2d2t*, %gt2d2t** %9, align 8, !dbg !1168; 2:0
  store 
    %gt2d2t* %16,
    %gt2d2t** %15,
    align 8, !dbg !1169
; Atama ifadesi
  %17 = load %gt2c2t*, %gt2c2t** %5, align 8, !dbg !1170; 2:0
; tür konumu *örs::derleme::imge::t : *t32
  ...
  store 
    ...
    align 4, !dbg !1172
; Atama ifadesi
  %19 = load %gt2d2t*, %gt2d2t** %9, align 8, !dbg !1173; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::k[%st586_1gt2c2t]
  %20 = getelementptr inbounds 
    %gt2d2t, %gt2d2t* %19,
    i32 0, i32 2
  %21 = load %gt263t*, %gt263t** %4, align 8, !dbg !1175; 2:0
  %22 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      %gt263t* %21, 
      i64 24, 
      i64 8), !dbg !1176
; Konum çevirisi:
  %23 = bitcast i8* %22 to %st586_1gt2c2t*; 1
  store 
    %st586_1gt2c2t* %23,
    %st586_1gt2c2t** %20,
    align 8, !dbg !1177
  %24 = load %gt2d2t*, %gt2d2t** %9, align 8, !dbg !1178; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::k[%st586_1gt2c2t]
  %25 = getelementptr inbounds 
    %gt2d2t, %gt2d2t* %24,
    i32 0, i32 2
  %26 = load %st586_1gt2c2t*, %st586_1gt2c2t** %25, align 8, !dbg !1180; 2:0
;;-> (nil) 0
  %27 = load %gt263t*, %gt263t** %4, align 8, !dbg !1181; 2:0
 call void @"imge::imgeler.Yapılandır_i" (
      %st586_1gt2c2t* %26, 
      %gt263t* %27, 
      i32 16), !dbg !1182
  %28 = load %gt2d2t*, %gt2d2t** %9, align 8, !dbg !1183; 2:0
; Dönüş :
  ret %gt2d2t* %28
}
...
!1143 = !DINamespace(name:"hazne", scope: !1142)


!1145 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !950, size: 64)
...
!1150 = !DILocalVariable(name: "İmge",
  scope: !1144, file: !9, line: 13, type: !1149, arg: 2)
!1151 = !DISubroutineType(types: !1152)
!1152 = !{null, !1147, !1149 }
!1144 = distinct !DISubprogram( name: "hazne::Yeni_i",
 scope: !1143,
 file: !9,
 line: 11,
 type: !1151, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1153 = !DILocation(line: 12, column: 5, scope: !1144)
!1154 = !DILocation(line: 13, column: 5, scope: !1144)
!1155 = distinct !DILexicalBlock(
        scope: !1144, file: !9, line: 14, column: 3)
!1156 = !DILocation(line: 15, column: 30, scope: !1155)
!1157 = !DILocation(line: 15, column: 38, scope: !1155)
!1158 = !DILocation(line: 15, column: 5, scope: !1155)
!1159 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !950, size: 64)
!1160 = !DILocalVariable(name: "Hazne",
  scope: !1155, file: !9, line: 15, type: !1159)
!1161 = !DILocation(line: 15, column: 5, scope: !1155)
!1162 = !DILocation(line: 16, column: 5, scope: !1155)
!1163 = !DILocation(line: 16, column: 5, scope: !1155)
!1164 = !DILocation(line: 16, column: 26, scope: !1155)
!1165 = !DILocation(line: 16, column: 5, scope: !1155)
!1166 = !DILocation(line: 17, column: 5, scope: !1155)
!1167 = !DILocation(line: 17, column: 5, scope: !1155)
!1168 = !DILocation(line: 17, column: 26, scope: !1155)
!1169 = !DILocation(line: 17, column: 5, scope: !1155)
!1170 = !DILocation(line: 18, column: 5, scope: !1155)
!1171 = !DILocation(line: 18, column: 5, scope: !1155)
!1172 = !DILocation(line: 18, column: 5, scope: !1155)
!1173 = !DILocation(line: 19, column: 5, scope: !1155)
!1174 = !DILocation(line: 19, column: 5, scope: !1155)
!1175 = !DILocation(line: 19, column: 47, scope: !1155)
!1176 = !DILocation(line: 19, column: 55, scope: !1155)
!1177 = !DILocation(line: 19, column: 5, scope: !1155)
!1178 = !DILocation(line: 20, column: 5, scope: !1155)
!1179 = !DILocation(line: 20, column: 5, scope: !1155)
!1180 = !DILocation(line: 20, column: 5, scope: !1155)
!1181 = !DILocation(line: 20, column: 33, scope: !1155)
!1182 = !DILocation(line: 20, column: 22, scope: !1155)
!1183 = !DILocation(line: 23, column: 9, scope: !1155)
