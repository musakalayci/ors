; ModuleID = 'örs::derleme::imge::hazne'
; Ürün adı : derleme
; Birim adı : örs::derleme::imge::hazne
; Yol: ./denemeler/örs/üretim/makina/derleme/
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"
source_filename = "./denemeler/örs/üretim/makina/derleme/hazne.ll"
...
; Tanımlı değerler:
@h.ox337.ox148 = private unnamed_addr constant [24 x i8] c"@sh.ox%x.ox%x.%d\00\00\00\00\00\00\00\00", align 8
;16->1 : 8 : 8
@m.ox337.ox147 = private unnamed_addr constant %metin {
  i32 16,
  i32 24,
  i8* getelementptr inbounds ([24 x i8], [24 x i8]* @h.ox337.ox148, i64 0, i64 0)
} 
; Genel:
...
define external %gt417t* 
@"hazne::Yeni_ox151i"(%gt29at* %0, %gt3bbt* %1)#0       !dbg !1807 {
; Değişken : dönüş
  %3 = alloca %gt417t*, align 8
  store %gt417t* null, %gt417t** %3, align 8
; Değişken : Hafıza
...
; Değişken : İmge
  ...
  call void @llvm.dbg.declare(metadata %gt3bbt** %5, metadata !1813, metadata !DIExpression()), !dbg !1817
  ...
  %7 = call i8* (%gt29at*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1820
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt417t*; 1

; pascal 'Hazne' örs::derleme::imge::hazne::t
  %9 = alloca %gt417t*, align 8
  store 
    %gt417t* %8,
    %gt417t** %9,
    align 8, !dbg !1821
  call void @llvm.dbg.declare(metadata %gt417t** %9, metadata !1823, metadata !DIExpression()), !dbg !1824
; Atama ifadesi
  %10 = load %gt417t*, %gt417t** %9, align 8, !dbg !1825; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::t
  %11 = getelementptr inbounds 
    %gt417t, %gt417t* %10,
    i32 0, i32 0
  %12 = load %gt3bbt*, %gt3bbt** %5, align 8, !dbg !1827; 2:0
;atama:
  store 
    %gt3bbt* %12,
    %gt3bbt** %11,
    align 8, !dbg !1828
; Atama ifadesi
  %13 = load %gt3bbt*, %gt3bbt** %5, align 8, !dbg !1829; 2:0
...
; Konum çevirisi:
  %15 = bitcast %gt3bat* %14 to %gt417t**; 2
  %16 = load %gt417t*, %gt417t** %9, align 8, !dbg !1831; 2:0
;atama:
  store 
    %gt417t* %16,
    %gt417t** %15,
    align 8, !dbg !1832
; Atama ifadesi
  %17 = load %gt3bbt*, %gt3bbt** %5, align 8, !dbg !1833; 2:0
...
;atama:
  store 
    ...
    align 4, !dbg !1835
; Atama ifadesi
  %19 = load %gt417t*, %gt417t** %9, align 8, !dbg !1836; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::k[%st687_1gt3bbt]
  %20 = getelementptr inbounds 
    %gt417t, %gt417t* %19,
    i32 0, i32 3
  %21 = load %gt29at*, %gt29at** %4, align 8, !dbg !1838; 2:0
  %22 = call i8* (%gt29at*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt29at* %21, 
      i64 24, 
      i64 8), !dbg !1839
; Konum çevirisi:
  %23 = bitcast i8* %22 to %st687_1gt3bbt*; 1
;atama:
  store 
    %st687_1gt3bbt* %23,
    %st687_1gt3bbt** %20,
    align 8, !dbg !1840
  %24 = load %gt417t*, %gt417t** %9, align 8, !dbg !1841; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::k[%st687_1gt3bbt]
  %25 = getelementptr inbounds 
    %gt417t, %gt417t* %24,
    i32 0, i32 3
  %26 = load %st687_1gt3bbt*, %st687_1gt3bbt** %25, align 8, !dbg !1843; 2:0
;;-> (nil) 0
  %27 = load %gt29at*, %gt29at** %4, align 8, !dbg !1844; 2:0
 call void @"imge::imgeler.Yapılandır_ox110i" (
      %st687_1gt3bbt* %26, 
      %gt29at* %27, 
      i32 16), !dbg !1845
; Atama ifadesi
  %28 = load %gt3bbt*, %gt3bbt** %5, align 8, !dbg !1846; 2:0
...
; tür konumu *örs::derleme::nesne::t : *örs::derleme::imge::t
  %30 = getelementptr inbounds 
    %gt5cdt, %gt5cdt* %29,
    i32 0, i32 5
  %31 = load %gt3bbt*, %gt3bbt** %5, align 8, !dbg !1849; 2:0
;atama:
  store 
    %gt3bbt* %31,
    %gt3bbt** %30,
    align 8, !dbg !1850
  %32 = load %gt417t*, %gt417t** %9, align 8, !dbg !1851; 2:0
; Dönüş :
  ret %gt417t* %32
}
...
define external 
%gt3bbt* @"hazne::t.Yapılandır_ox151i"(%gt417t* %0, %gt304t* %1, %gt3dat* %2)
#0       !dbg !1852 {
; Değişken : dönüş
  %4 = alloca %gt3bbt*, align 8
  store %gt3bbt* null, %gt3bbt** %4, align 8
; Değişken : Hazne
  %5 = alloca %gt417t*, align 8
  store %gt417t* %0, %gt417t** %5, align 8
  call void @llvm.dbg.declare(metadata %gt417t** %5, metadata !1856, metadata !DIExpression()), !dbg !1863
; Değişken : Bölüm
  %6 = alloca %gt304t*, align 8
  store %gt304t* %1, %gt304t** %6, align 8
  call void @llvm.dbg.declare(metadata %gt304t** %6, metadata !1858, metadata !DIExpression()), !dbg !1864
; Değişken : Değer
  %7 = alloca %gt3dat*, align 8
  store %gt3dat* %2, %gt3dat** %7, align 8
  call void @llvm.dbg.declare(metadata %gt3dat** %7, metadata !1860, metadata !DIExpression()), !dbg !1865
  %8 = load %gt304t*, %gt304t** %6, align 8, !dbg !1867; 2:0
; tür konumu *örs::derleme::bölüm::t : *örs::derleme::hafıza::t
  %9 = getelementptr inbounds 
    %gt304t, %gt304t* %8,
    i32 0, i32 5
  %10 = load %gt29at*, %gt29at** %9, align 8, !dbg !1869; 2:0

; pascal 'Hafıza' örs::derleme::hafıza::t
  %11 = alloca %gt29at*, align 8
  store 
    %gt29at* %10,
    %gt29at** %11,
    align 8, !dbg !1870
  call void @llvm.dbg.declare(metadata %gt29at** %11, metadata !1872, metadata !DIExpression()), !dbg !1873
  %12 = load %gt417t*, %gt417t** %5, align 8, !dbg !1874; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::t
  %13 = getelementptr inbounds 
    %gt417t, %gt417t* %12,
    i32 0, i32 0
  %14 = load %gt3bbt*, %gt3bbt** %13, align 8, !dbg !1876; 2:0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3bbt** %15,
    align 8, !dbg !1877
  call void @llvm.dbg.declare(metadata %gt3bbt** %15, metadata !1879, metadata !DIExpression()), !dbg !1880
  %16 = load %gt3bbt*, %gt3bbt** %15, align 8, !dbg !1881; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::nesne::t
  %17 = getelementptr inbounds 
    %gt3bbt, %gt3bbt* %16,
    i32 0, i32 6
;;-> (nil) 4
  %18 = load %gt29at*, %gt29at** %11, align 8, !dbg !1883; 2:0
;;-> (nil) 4
  %19 = load %gt3bbt*, %gt3bbt** %15, align 8, !dbg !1884; 2:0
  %20 = load %gt3dat*, %gt3dat** %7, align 8, !dbg !1885; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::cins::özet
  %21 = getelementptr inbounds 
    %gt3dat, %gt3dat* %20,
    i32 0, i32 1
;;-> (nil) 14
  %22 = load %gt44ft*, %gt44ft** %21, align 8, !dbg !1887; 2:0
 call void @"nesne::t.Yapılandır_ox11ci" (
      ...
      i32 1), !dbg !1888
; Atama ifadesi
  %23 = load %gt3bbt*, %gt3bbt** %15, align 8, !dbg !1889; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::nesne::t
...
; tür konumu *örs::derleme::nesne::t : *örs::derleme::imge::t
  %25 = getelementptr inbounds 
    %gt5cdt, %gt5cdt* %24,
    i32 0, i32 6
  %26 = load %gt3bbt*, %gt3bbt** %15, align 8, !dbg !1892; 2:0
;atama:
  store 
    %gt3bbt* %26,
    %gt3bbt** %25,
    align 8, !dbg !1893
  %27 = load %gt3bbt*, %gt3bbt** %15, align 8, !dbg !1894; 2:0
  %28 = load %gt304t*, %gt304t** %6, align 8, !dbg !1895; 2:0
; tür konumu *örs::derleme::bölüm::t : *örs::derleme::kütüphane::t
  %29 = getelementptr inbounds 
    %gt304t, %gt304t* %28,
    i32 0, i32 11
  %30 = load %gt3aat*, %gt3aat** %29, align 8, !dbg !1897; 2:0
; tür konumu *örs::derleme::kütüphane::t : *d32
  %31 = getelementptr inbounds 
    %gt3aat, %gt3aat* %30,
    i32 0, i32 1
;;-> (nil) 14
  %32 = load i32, i32* %31, align 4, !dbg !1899; 1:0
  %33 = load %gt29at*, %gt29at** %11, align 8, !dbg !1900; 2:0
; tür konumu *örs::derleme::hafıza::t : *örs::derleme::t
  %34 = getelementptr inbounds 
    %gt29at, %gt29at* %33,
    i32 0, i32 3
  %35 = load %gt260t*, %gt260t** %34, align 8, !dbg !1902; 2:0
; tür konumu *örs::derleme::t : *örs::derleme::sayaçlar
  %36 = getelementptr inbounds 
    %gt260t, %gt260t* %35,
    i32 0, i32 16
  %37 = call i32 (%gt274t*) @"derleme::sayaçlar.Hazne_ox107i" (
      %gt274t* %36), !dbg !1904
  %38 = load %gt3bbt*, %gt3bbt** %15, align 8, !dbg !1905; 2:0
; tür konumu *örs::derleme::imge::t : *t32
  %39 = getelementptr inbounds 
    %gt3bbt, %gt3bbt* %38,
    i32 0, i32 0
;;-> (nil) 14
  %40 = load i32, i32* %39, align 4, !dbg !1907; 1:0
  %41 = call %gt3bbt* (%gt3bbt*,%metin*,...) @"imge::t.Yaz_ox110i" (
      %gt3bbt* %27, 
      %metin* getelementptr inbounds (%metin, %metin* @m.ox337.ox147, i64 0), 
      i32 %32, 
      i32 %37, 
      i32 %40), !dbg !1908
  %42 = load %gt304t*, %gt304t** %6, align 8, !dbg !1909; 2:0
;;-> (nil) 4
  %43 = load %gt3bbt*, %gt3bbt** %15, align 8, !dbg !1910; 2:0
 call void @"bölüm::t.SıralamayaEkle_ox10ai" (
      %gt304t* %42, 
      %gt3bbt* %43), !dbg !1911
  %44 = load %gt3bbt*, %gt3bbt** %15, align 8, !dbg !1912; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::nesne::t
...
; tür konumu *örs::derleme::nesne::kesitler : *t8
  %48 = getelementptr inbounds 
    %gt5cct, %gt5cct* %47,
    i32 0, i32 0
  %49 = load i8, i8* %48, align 1, !dbg !1918; 1:0
  %50 = add i8 %49, 1
  store 
    i8 %50,
    i8* %48,
    align 1, !dbg !1919
  %51 = load i8, i8* %48, align 1, !dbg !1920; 1:0
; Sanal Donus : Yükselt
; tür konumu *örs::derleme::nesne::t : *örs::derleme::nesne::kesitler
...
; tür konumu *örs::derleme::nesne::kesitler : *t8
  %53 = getelementptr inbounds 
    %gt5cct, %gt5cct* %52,
    i32 0, i32 0
  %54 = load i8, i8* %53, align 1, !dbg !1923; 1:0
...
sanal.son.ox1:
  %56 = load i32, i32* %46, align 4, !dbg !1925; 1:0
; Sanal bitiş : Yükselt
  %57 = load %gt417t*, %gt417t** %5, align 8, !dbg !1926; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::t
  %58 = getelementptr inbounds 
    %gt417t, %gt417t* %57,
    i32 0, i32 0
  %59 = load %gt3bbt*, %gt3bbt** %58, align 8, !dbg !1928; 2:0
; Dönüş :
  ret %gt3bbt* %59
}
...
;örs::derleme::Hazne
  declare i32 @"derleme::sayaçlar.Hazne_ox107i"(%gt274t*) #0
...
!llvm.dbg.cu = !{!8}
!9 = !DIFile(
  filename: "./denemeler/\C3\B6rs/kaynak/derleme/imge/hazne.\C3\B6rs",
...
!1806 = !DINamespace(name:"hazne", scope: !1805)


!1808 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1599, size: 64)
...
!1811 = !DILocalVariable(name: "Hafıza",
  scope: !1807, file: !9, line: 25, type: !1810, arg: 1)
!1813 = !DILocalVariable(name: "İmge",
  scope: !1807, file: !9, line: 26, type: !1812, arg: 2)
!1814 = !DISubroutineType(types: !1815)
!1815 = !{null, !1810, !1812 }
!1807 = distinct !DISubprogram( name: "hazne::Yeni_ox151i",
 scope: !1806,
 file: !9,
 line: 24,
 type: !1814, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1816 = !DILocation(line: 25, column: 5, scope: !1807)
!1817 = !DILocation(line: 26, column: 5, scope: !1807)
!1818 = distinct !DILexicalBlock(
        scope: !1807, file: !9, line: 27, column: 3)
!1819 = !DILocation(line: 28, column: 30, scope: !1818)
!1820 = !DILocation(line: 28, column: 38, scope: !1818)
!1821 = !DILocation(line: 28, column: 5, scope: !1818)
!1822 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1599, size: 64)
!1823 = !DILocalVariable(name: "Hazne",
  scope: !1818, file: !9, line: 28, type: !1822)
!1824 = !DILocation(line: 28, column: 5, scope: !1818)
!1825 = !DILocation(line: 29, column: 5, scope: !1818)
!1826 = !DILocation(line: 29, column: 5, scope: !1818)
!1827 = !DILocation(line: 29, column: 26, scope: !1818)
!1828 = !DILocation(line: 29, column: 5, scope: !1818)
!1829 = !DILocation(line: 30, column: 5, scope: !1818)
!1830 = !DILocation(line: 30, column: 5, scope: !1818)
!1831 = !DILocation(line: 30, column: 26, scope: !1818)
!1832 = !DILocation(line: 30, column: 5, scope: !1818)
!1833 = !DILocation(line: 31, column: 5, scope: !1818)
!1834 = !DILocation(line: 31, column: 5, scope: !1818)
!1835 = !DILocation(line: 31, column: 5, scope: !1818)
!1836 = !DILocation(line: 32, column: 5, scope: !1818)
!1837 = !DILocation(line: 32, column: 5, scope: !1818)
!1838 = !DILocation(line: 32, column: 47, scope: !1818)
!1839 = !DILocation(line: 32, column: 55, scope: !1818)
!1840 = !DILocation(line: 32, column: 5, scope: !1818)
!1841 = !DILocation(line: 33, column: 5, scope: !1818)
!1842 = !DILocation(line: 33, column: 5, scope: !1818)
!1843 = !DILocation(line: 33, column: 5, scope: !1818)
!1844 = !DILocation(line: 33, column: 33, scope: !1818)
!1845 = !DILocation(line: 33, column: 22, scope: !1818)
!1846 = !DILocation(line: 34, column: 5, scope: !1818)
!1847 = !DILocation(line: 34, column: 5, scope: !1818)
!1848 = !DILocation(line: 34, column: 5, scope: !1818)
!1849 = !DILocation(line: 34, column: 22, scope: !1818)
!1850 = !DILocation(line: 34, column: 5, scope: !1818)
!1851 = !DILocation(line: 37, column: 9, scope: !1818)


!1853 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1854 = !DILocalVariable(name: "dönüş",
  scope: !1852, file: !9, line: 15, type: !1853)
!1855 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1599, size: 64)
!1857 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !174, size: 64)
!1859 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1558, size: 64)
!1856 = !DILocalVariable(name: "Hazne",
  scope: !1852, file: !9, line: 40, type: !1855, arg: 1)
!1858 = !DILocalVariable(name: "Bölüm",
  scope: !1852, file: !9, line: 41, type: !1857, arg: 2)
!1860 = !DILocalVariable(name: "Değer",
  scope: !1852, file: !9, line: 41, type: !1859, arg: 3)
!1861 = !DISubroutineType(types: !1862)
!1862 = !{null, !1855, !1857, !1859 }
!1852 = distinct !DISubprogram( name: "hazne::t.Yapılandır_ox151i",
 scope: !1806,
 file: !9,
 line: 41,
 type: !1861, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yapılandır
!1863 = !DILocation(line: 40, column: 3, scope: !1852)
!1864 = !DILocation(line: 41, column: 25, scope: !1852)
!1865 = !DILocation(line: 41, column: 42, scope: !1852)
!1866 = distinct !DILexicalBlock(
        scope: !1852, file: !9, line: 54, column: 1)
!1867 = !DILocation(line: 44, column: 15, scope: !1866)
!1868 = !DILocation(line: 44, column: 15, scope: !1866)
!1869 = !DILocation(line: 44, column: 15, scope: !1866)
!1870 = !DILocation(line: 44, column: 5, scope: !1866)
!1871 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1872 = !DILocalVariable(name: "Hafıza",
  scope: !1866, file: !9, line: 44, type: !1871)
!1873 = !DILocation(line: 44, column: 5, scope: !1866)
!1874 = !DILocation(line: 45, column: 15, scope: !1866)
!1875 = !DILocation(line: 45, column: 15, scope: !1866)
!1876 = !DILocation(line: 45, column: 15, scope: !1866)
!1877 = !DILocation(line: 45, column: 5, scope: !1866)
!1878 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1879 = !DILocalVariable(name: "İmge",
  scope: !1866, file: !9, line: 45, type: !1878)
!1880 = !DILocation(line: 45, column: 5, scope: !1866)
!1881 = !DILocation(line: 46, column: 5, scope: !1866)
!1882 = !DILocation(line: 46, column: 5, scope: !1866)
!1883 = !DILocation(line: 46, column: 28, scope: !1866)
!1884 = !DILocation(line: 46, column: 36, scope: !1866)
!1885 = !DILocation(line: 46, column: 42, scope: !1866)
!1886 = !DILocation(line: 46, column: 42, scope: !1866)
!1887 = !DILocation(line: 46, column: 42, scope: !1866)
!1888 = !DILocation(line: 46, column: 17, scope: !1866)
!1889 = !DILocation(line: 47, column: 5, scope: !1866)
!1890 = !DILocation(line: 47, column: 5, scope: !1866)
!1891 = !DILocation(line: 47, column: 5, scope: !1866)
!1892 = !DILocation(line: 47, column: 24, scope: !1866)
!1893 = !DILocation(line: 47, column: 5, scope: !1866)
!1894 = !DILocation(line: 48, column: 5, scope: !1866)
!1895 = !DILocation(line: 49, column: 7, scope: !1866)
!1896 = !DILocation(line: 49, column: 7, scope: !1866)
!1897 = !DILocation(line: 49, column: 7, scope: !1866)
!1898 = !DILocation(line: 49, column: 7, scope: !1866)
!1899 = !DILocation(line: 49, column: 7, scope: !1866)
!1900 = !DILocation(line: 49, column: 29, scope: !1866)
!1901 = !DILocation(line: 49, column: 29, scope: !1866)
!1902 = !DILocation(line: 49, column: 29, scope: !1866)
!1903 = !DILocation(line: 49, column: 29, scope: !1866)
!1904 = !DILocation(line: 49, column: 56, scope: !1866)
!1905 = !DILocation(line: 49, column: 65, scope: !1866)
!1906 = !DILocation(line: 49, column: 65, scope: !1866)
!1907 = !DILocation(line: 49, column: 65, scope: !1866)
!1908 = !DILocation(line: 48, column: 11, scope: !1866)
!1909 = !DILocation(line: 50, column: 5, scope: !1866)
!1910 = !DILocation(line: 50, column: 27, scope: !1866)
!1911 = !DILocation(line: 50, column: 12, scope: !1866)
!1912 = !DILocation(line: 51, column: 5, scope: !1866)
!1913 = !DILocation(line: 51, column: 5, scope: !1866)
!1914 = distinct !DILexicalBlock(
        scope: !1866, file: !9, line: 51, column: 17)
!1915 = distinct !DILexicalBlock(
        scope: !1914, file: !9, line: 179, column: 1)
!1916 = !DILocation(line: 175, column: 3, scope: !1915)
!1917 = !DILocation(line: 175, column: 3, scope: !1915)
!1918 = !DILocation(line: 175, column: 3, scope: !1915)
!1919 = !DILocation(line: 175, column: 3, scope: !1915)
!1920 = !DILocation(line: 175, column: 25, scope: !1915)
!1921 = !DILocation(line: 176, column: 12, scope: !1915)
!1922 = !DILocation(line: 176, column: 12, scope: !1915)
!1923 = !DILocation(line: 176, column: 12, scope: !1915)
!1924 = !DILocation(line: 173, column: 28, scope: !1915)
!1925 = !DILocation(line: 51, column: 17, scope: !1914)
!1926 = !DILocation(line: 52, column: 9, scope: !1866)
!1927 = !DILocation(line: 52, column: 9, scope: !1866)
!1928 = !DILocation(line: 52, column: 9, scope: !1866)
