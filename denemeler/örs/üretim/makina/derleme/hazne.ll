...
define external %gt250t* 
@"hazne::Yeni_ox12Ai"(%gt1e2t* %0, %gt234t* %1)#0       !dbg !1580 {
; Değişken : dönüş
  %3 = alloca %gt250t*, align 8
  store %gt250t* null, %gt250t** %3, align 8
; Değişken : Hafıza
...
; Değişken : İmge
  ...
  %7 = call i8* (%gt1e2t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      ...
      i64 8), !dbg !1593
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt250t*; 1

; pascal 'Hazne' örs::derleme::imge::hazne::t
  %9 = alloca %gt250t*, align 8
  store 
    %gt250t* %8,
    %gt250t** %9,
    align 8, !dbg !1594
  call void @llvm.dbg.declare(metadata %gt250t** %9, metadata !1596, metadata !DIExpression()), !dbg !1597
; Atama ifadesi
  %10 = load %gt250t*, %gt250t** %9, align 8, !dbg !1598; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::t
  %11 = getelementptr inbounds 
    %gt250t, %gt250t* %10,
    i32 0, i32 0
  %12 = load %gt234t*, %gt234t** %5, align 8, !dbg !1600; 2:0
;atama:
  store 
    %gt234t* %12,
    %gt234t** %11,
    align 8, !dbg !1601
; Atama ifadesi
  %13 = load %gt234t*, %gt234t** %5, align 8, !dbg !1602; 2:0
...
; Konum çevirisi:
  %15 = bitcast %gt233t* %14 to %gt250t**; 2
  %16 = load %gt250t*, %gt250t** %9, align 8, !dbg !1604; 2:0
;atama:
  store 
    %gt250t* %16,
    %gt250t** %15,
    align 8, !dbg !1605
; Atama ifadesi
  %17 = load %gt234t*, %gt234t** %5, align 8, !dbg !1606; 2:0
...
;atama:
  store 
    ...
    align 4, !dbg !1608
; Atama ifadesi
  %19 = load %gt250t*, %gt250t** %9, align 8, !dbg !1609; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::k[%st437_1gt234t]
  %20 = getelementptr inbounds 
    %gt250t, %gt250t* %19,
    i32 0, i32 2
  %21 = load %gt1e2t*, %gt1e2t** %4, align 8, !dbg !1611; 2:0
  %22 = call i8* (%gt1e2t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      %gt1e2t* %21, 
      i64 24, 
      i64 8), !dbg !1612
; Konum çevirisi:
  %23 = bitcast i8* %22 to %st437_1gt234t*; 1
;atama:
  store 
    %st437_1gt234t* %23,
    %st437_1gt234t** %20,
    align 8, !dbg !1613
  %24 = load %gt250t*, %gt250t** %9, align 8, !dbg !1614; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::k[%st437_1gt234t]
  %25 = getelementptr inbounds 
    %gt250t, %gt250t* %24,
    i32 0, i32 2
  %26 = load %st437_1gt234t*, %st437_1gt234t** %25, align 8, !dbg !1616; 2:0
;;-> (nil) 0
  %27 = load %gt1e2t*, %gt1e2t** %4, align 8, !dbg !1617; 2:0
 call void @"imge::imgeler.Yapılandır_ox10ai" (
      %st437_1gt234t* %26, 
      %gt1e2t* %27, 
      i32 16), !dbg !1618
  %28 = load %gt250t*, %gt250t** %9, align 8, !dbg !1619; 2:0
; Dönüş :
  ret %gt250t* %28
}
...
!1579 = !DINamespace(name:"hazne", scope: !1578)


!1581 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1412, size: 64)
...
!1586 = !DILocalVariable(name: "İmge",
  scope: !1580, file: !9, line: 13, type: !1585, arg: 2)
!1587 = !DISubroutineType(types: !1588)
!1588 = !{null, !1583, !1585 }
!1580 = distinct !DISubprogram( name: "hazne::Yeni_ox12Ai",
 scope: !1579,
 file: !9,
 line: 11,
 type: !1587, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1589 = !DILocation(line: 12, column: 5, scope: !1580)
!1590 = !DILocation(line: 13, column: 5, scope: !1580)
!1591 = distinct !DILexicalBlock(
        scope: !1580, file: !9, line: 14, column: 3)
!1592 = !DILocation(line: 15, column: 30, scope: !1591)
!1593 = !DILocation(line: 15, column: 38, scope: !1591)
!1594 = !DILocation(line: 15, column: 5, scope: !1591)
!1595 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1412, size: 64)
!1596 = !DILocalVariable(name: "Hazne",
  scope: !1591, file: !9, line: 15, type: !1595)
!1597 = !DILocation(line: 15, column: 5, scope: !1591)
!1598 = !DILocation(line: 16, column: 5, scope: !1591)
!1599 = !DILocation(line: 16, column: 5, scope: !1591)
!1600 = !DILocation(line: 16, column: 26, scope: !1591)
!1601 = !DILocation(line: 16, column: 5, scope: !1591)
!1602 = !DILocation(line: 17, column: 5, scope: !1591)
!1603 = !DILocation(line: 17, column: 5, scope: !1591)
!1604 = !DILocation(line: 17, column: 26, scope: !1591)
!1605 = !DILocation(line: 17, column: 5, scope: !1591)
!1606 = !DILocation(line: 18, column: 5, scope: !1591)
!1607 = !DILocation(line: 18, column: 5, scope: !1591)
!1608 = !DILocation(line: 18, column: 5, scope: !1591)
!1609 = !DILocation(line: 19, column: 5, scope: !1591)
!1610 = !DILocation(line: 19, column: 5, scope: !1591)
!1611 = !DILocation(line: 19, column: 47, scope: !1591)
!1612 = !DILocation(line: 19, column: 55, scope: !1591)
!1613 = !DILocation(line: 19, column: 5, scope: !1591)
!1614 = !DILocation(line: 20, column: 5, scope: !1591)
!1615 = !DILocation(line: 20, column: 5, scope: !1591)
!1616 = !DILocation(line: 20, column: 5, scope: !1591)
!1617 = !DILocation(line: 20, column: 33, scope: !1591)
!1618 = !DILocation(line: 20, column: 22, scope: !1591)
!1619 = !DILocation(line: 23, column: 9, scope: !1591)
