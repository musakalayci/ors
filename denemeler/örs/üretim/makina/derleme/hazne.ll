...
; Tanımlı değerler:
@h.ox337.ox144 = private unnamed_addr constant [24 x i8] c"@sh.ox%x.ox%x.%d\00\00\00\00\00\00\00\00", align 8
;16->1 : 8 : 8
@m.ox337.ox143 = private unnamed_addr constant %metin {
  i32 16,
  i32 24,
  i8* getelementptr inbounds ([24 x i8], [24 x i8]* @h.ox337.ox144, i64 0, i64 0)
} 
; Genel:
...
define external %gt3f0t* 
@"hazne::Yeni_ox151i"(%gt294t* %0, %gt398t* %1)#0       !dbg !1716 {
; Değişken : dönüş
  %3 = alloca %gt3f0t*, align 8
  store %gt3f0t* null, %gt3f0t** %3, align 8
; Değişken : Hafıza
...
; Değişken : İmge
  ...
  call void @llvm.dbg.declare(metadata %gt398t** %5, metadata !1722, metadata !DIExpression()), !dbg !1726
  ...
  %7 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1729
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt3f0t*; 1

; pascal 'Hazne' örs::derleme::imge::hazne::t
  %9 = alloca %gt3f0t*, align 8
  store 
    %gt3f0t* %8,
    %gt3f0t** %9,
    align 8, !dbg !1730
  call void @llvm.dbg.declare(metadata %gt3f0t** %9, metadata !1732, metadata !DIExpression()), !dbg !1733
; Atama ifadesi
  %10 = load %gt3f0t*, %gt3f0t** %9, align 8, !dbg !1734; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::t
  %11 = getelementptr inbounds 
    %gt3f0t, %gt3f0t* %10,
    i32 0, i32 0
  %12 = load %gt398t*, %gt398t** %5, align 8, !dbg !1736; 2:0
;atama:
  store 
    %gt398t* %12,
    %gt398t** %11,
    align 8, !dbg !1737
; Atama ifadesi
  %13 = load %gt398t*, %gt398t** %5, align 8, !dbg !1738; 2:0
...
; Konum çevirisi:
  %15 = bitcast %gt397t* %14 to %gt3f0t**; 2
  %16 = load %gt3f0t*, %gt3f0t** %9, align 8, !dbg !1740; 2:0
;atama:
  store 
    %gt3f0t* %16,
    %gt3f0t** %15,
    align 8, !dbg !1741
; Atama ifadesi
  %17 = load %gt398t*, %gt398t** %5, align 8, !dbg !1742; 2:0
...
;atama:
  store 
    ...
    align 4, !dbg !1744
; Atama ifadesi
  %19 = load %gt3f0t*, %gt3f0t** %9, align 8, !dbg !1745; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::k[%st681_1gt398t]
  %20 = getelementptr inbounds 
    %gt3f0t, %gt3f0t* %19,
    i32 0, i32 3
  %21 = load %gt294t*, %gt294t** %4, align 8, !dbg !1747; 2:0
  %22 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt294t* %21, 
      i64 24, 
      i64 8), !dbg !1748
; Konum çevirisi:
  %23 = bitcast i8* %22 to %st681_1gt398t*; 1
;atama:
  store 
    %st681_1gt398t* %23,
    %st681_1gt398t** %20,
    align 8, !dbg !1749
  %24 = load %gt3f0t*, %gt3f0t** %9, align 8, !dbg !1750; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::k[%st681_1gt398t]
  %25 = getelementptr inbounds 
    %gt3f0t, %gt3f0t* %24,
    i32 0, i32 3
  %26 = load %st681_1gt398t*, %st681_1gt398t** %25, align 8, !dbg !1752; 2:0
;;-> (nil) 0
  %27 = load %gt294t*, %gt294t** %4, align 8, !dbg !1753; 2:0
 call void @"imge::imgeler.Yapılandır_ox110i" (
      %st681_1gt398t* %26, 
      %gt294t* %27, 
      i32 16), !dbg !1754
; Atama ifadesi
  %28 = load %gt398t*, %gt398t** %5, align 8, !dbg !1755; 2:0
...
; tür konumu *örs::derleme::nesne::t : *örs::derleme::imge::t
  %30 = getelementptr inbounds 
    %gt570t, %gt570t* %29,
    i32 0, i32 5
  %31 = load %gt398t*, %gt398t** %5, align 8, !dbg !1758; 2:0
;atama:
  store 
    %gt398t* %31,
    %gt398t** %30,
    align 8, !dbg !1759
  %32 = load %gt3f0t*, %gt3f0t** %9, align 8, !dbg !1760; 2:0
; Dönüş :
  ret %gt3f0t* %32
}
...
define external 
%gt398t* @"hazne::t.Yapılandır_ox151i"(%gt3f0t* %0, %gt2fdt* %1, %gt3b6t* %2)
#0       !dbg !1761 {
; Değişken : dönüş
  %4 = alloca %gt398t*, align 8
  store %gt398t* null, %gt398t** %4, align 8
; Değişken : Hazne
  %5 = alloca %gt3f0t*, align 8
  store %gt3f0t* %0, %gt3f0t** %5, align 8
  call void @llvm.dbg.declare(metadata %gt3f0t** %5, metadata !1765, metadata !DIExpression()), !dbg !1772
; Değişken : Bölüm
  %6 = alloca %gt2fdt*, align 8
  store %gt2fdt* %1, %gt2fdt** %6, align 8
  call void @llvm.dbg.declare(metadata %gt2fdt** %6, metadata !1767, metadata !DIExpression()), !dbg !1773
; Değişken : Değer
  %7 = alloca %gt3b6t*, align 8
  store %gt3b6t* %2, %gt3b6t** %7, align 8
  call void @llvm.dbg.declare(metadata %gt3b6t** %7, metadata !1769, metadata !DIExpression()), !dbg !1774
  %8 = load %gt2fdt*, %gt2fdt** %6, align 8, !dbg !1776; 2:0
; tür konumu *örs::derleme::bölüm::t : *örs::derleme::hafıza::t
  %9 = getelementptr inbounds 
    %gt2fdt, %gt2fdt* %8,
    i32 0, i32 5
  %10 = load %gt294t*, %gt294t** %9, align 8, !dbg !1778; 2:0

; pascal 'Hafıza' örs::derleme::hafıza::t
  %11 = alloca %gt294t*, align 8
  store 
    %gt294t* %10,
    %gt294t** %11,
    align 8, !dbg !1779
  call void @llvm.dbg.declare(metadata %gt294t** %11, metadata !1781, metadata !DIExpression()), !dbg !1782
  %12 = load %gt3f0t*, %gt3f0t** %5, align 8, !dbg !1783; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::t
  %13 = getelementptr inbounds 
    %gt3f0t, %gt3f0t* %12,
    i32 0, i32 0
  %14 = load %gt398t*, %gt398t** %13, align 8, !dbg !1785; 2:0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt398t** %15,
    align 8, !dbg !1786
  call void @llvm.dbg.declare(metadata %gt398t** %15, metadata !1788, metadata !DIExpression()), !dbg !1789
  %16 = load %gt398t*, %gt398t** %15, align 8, !dbg !1790; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::nesne::t
  %17 = getelementptr inbounds 
    %gt398t, %gt398t* %16,
    i32 0, i32 6
;;-> (nil) 4
  %18 = load %gt294t*, %gt294t** %11, align 8, !dbg !1792; 2:0
;;-> (nil) 4
  %19 = load %gt398t*, %gt398t** %15, align 8, !dbg !1793; 2:0
  %20 = load %gt3b6t*, %gt3b6t** %7, align 8, !dbg !1794; 2:0
; tür konumu *örs::derleme::imge::_değer::t : *örs::derleme::imge::cins::özet
  %21 = getelementptr inbounds 
    %gt3b6t, %gt3b6t* %20,
    i32 0, i32 1
;;-> (nil) 14
  %22 = load %gt41et*, %gt41et** %21, align 8, !dbg !1796; 2:0
 call void @"nesne::t.Yapılandır_ox11ci" (
      ...
      i32 1), !dbg !1797
; Atama ifadesi
  %23 = load %gt398t*, %gt398t** %15, align 8, !dbg !1798; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::nesne::t
...
; tür konumu *örs::derleme::nesne::t : *örs::derleme::imge::t
  %25 = getelementptr inbounds 
    %gt570t, %gt570t* %24,
    i32 0, i32 6
  %26 = load %gt398t*, %gt398t** %15, align 8, !dbg !1801; 2:0
;atama:
  store 
    %gt398t* %26,
    %gt398t** %25,
    align 8, !dbg !1802
  %27 = load %gt398t*, %gt398t** %15, align 8, !dbg !1803; 2:0
  %28 = load %gt2fdt*, %gt2fdt** %6, align 8, !dbg !1804; 2:0
; tür konumu *örs::derleme::bölüm::t : *örs::derleme::kütüphane::t
  %29 = getelementptr inbounds 
    %gt2fdt, %gt2fdt* %28,
    i32 0, i32 11
  %30 = load %gt387t*, %gt387t** %29, align 8, !dbg !1806; 2:0
; tür konumu *örs::derleme::kütüphane::t : *d32
  %31 = getelementptr inbounds 
    %gt387t, %gt387t* %30,
    i32 0, i32 1
;;-> (nil) 14
  %32 = load i32, i32* %31, align 4, !dbg !1808; 1:0
  %33 = load %gt294t*, %gt294t** %11, align 8, !dbg !1809; 2:0
; tür konumu *örs::derleme::hafıza::t : *örs::derleme::t
  %34 = getelementptr inbounds 
    %gt294t, %gt294t* %33,
    i32 0, i32 3
  %35 = load %gt25dt*, %gt25dt** %34, align 8, !dbg !1811; 2:0
; tür konumu *örs::derleme::t : *örs::derleme::sayaçlar
  %36 = getelementptr inbounds 
    %gt25dt, %gt25dt* %35,
    i32 0, i32 15
  %37 = call i32 (%gt26et*) @"derleme::sayaçlar.Hazne_ox107i" (
      %gt26et* %36), !dbg !1813
  %38 = load %gt398t*, %gt398t** %15, align 8, !dbg !1814; 2:0
; tür konumu *örs::derleme::imge::t : *t32
  %39 = getelementptr inbounds 
    %gt398t, %gt398t* %38,
    i32 0, i32 0
;;-> (nil) 14
  %40 = load i32, i32* %39, align 4, !dbg !1816; 1:0
  %41 = call %gt398t* (%gt398t*,%metin*,...) @"imge::t.Yaz_ox110i" (
      %gt398t* %27, 
      %metin* getelementptr inbounds (%metin, %metin* @m.ox337.ox143, i64 0), 
      i32 %32, 
      i32 %37, 
      i32 %40), !dbg !1817
  %42 = load %gt2fdt*, %gt2fdt** %6, align 8, !dbg !1818; 2:0
;;-> (nil) 4
  %43 = load %gt398t*, %gt398t** %15, align 8, !dbg !1819; 2:0
 call void @"bölüm::t.SıralamayaEkle_ox10ai" (
      %gt2fdt* %42, 
      %gt398t* %43), !dbg !1820
  %44 = load %gt398t*, %gt398t** %15, align 8, !dbg !1821; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::nesne::t
...
; tür konumu *örs::derleme::nesne::kesitler : *t8
  %48 = getelementptr inbounds 
    %gt56ft, %gt56ft* %47,
    i32 0, i32 0
  %49 = load i8, i8* %48, align 1, !dbg !1827; 1:0
  %50 = add i8 %49, 1
  store 
    i8 %50,
    i8* %48,
    align 1, !dbg !1828
  %51 = load i8, i8* %48, align 1, !dbg !1829; 1:0
; Sanal Donus : Yükselt
; tür konumu *örs::derleme::nesne::t : *örs::derleme::nesne::kesitler
...
; tür konumu *örs::derleme::nesne::kesitler : *t8
  %53 = getelementptr inbounds 
    %gt56ft, %gt56ft* %52,
    i32 0, i32 0
  %54 = load i8, i8* %53, align 1, !dbg !1832; 1:0
...
sanal.son.ox1:
  %56 = load i32, i32* %46, align 4, !dbg !1834; 1:0
; Sanal bitiş : Yükselt
  %57 = load %gt3f0t*, %gt3f0t** %5, align 8, !dbg !1835; 2:0
; tür konumu *örs::derleme::imge::hazne::t : *örs::derleme::imge::t
  %58 = getelementptr inbounds 
    %gt3f0t, %gt3f0t* %57,
    i32 0, i32 0
  %59 = load %gt398t*, %gt398t** %58, align 8, !dbg !1837; 2:0
; Dönüş :
  ret %gt398t* %59
}
...
;örs::derleme::Hazne
  declare i32 @"derleme::sayaçlar.Hazne_ox107i"(%gt26et*) #0
...
!1715 = !DINamespace(name:"hazne", scope: !1714)


!1717 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1525, size: 64)
...
!1721 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1720 = !DILocalVariable(name: "Hafıza",
  scope: !1716, file: !9, line: 25, type: !1719, arg: 1)
!1722 = !DILocalVariable(name: "İmge",
  scope: !1716, file: !9, line: 26, type: !1721, arg: 2)
!1723 = !DISubroutineType(types: !1724)
!1724 = !{null, !1719, !1721 }
!1716 = distinct !DISubprogram( name: "hazne::Yeni_ox151i",
 scope: !1715,
 file: !9,
 line: 24,
 type: !1723, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1725 = !DILocation(line: 25, column: 5, scope: !1716)
!1726 = !DILocation(line: 26, column: 5, scope: !1716)
!1727 = distinct !DILexicalBlock(
        scope: !1716, file: !9, line: 27, column: 3)
!1728 = !DILocation(line: 28, column: 30, scope: !1727)
!1729 = !DILocation(line: 28, column: 38, scope: !1727)
!1730 = !DILocation(line: 28, column: 5, scope: !1727)
!1731 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1525, size: 64)
!1732 = !DILocalVariable(name: "Hazne",
  scope: !1727, file: !9, line: 28, type: !1731)
!1733 = !DILocation(line: 28, column: 5, scope: !1727)
!1734 = !DILocation(line: 29, column: 5, scope: !1727)
!1735 = !DILocation(line: 29, column: 5, scope: !1727)
!1736 = !DILocation(line: 29, column: 26, scope: !1727)
!1737 = !DILocation(line: 29, column: 5, scope: !1727)
!1738 = !DILocation(line: 30, column: 5, scope: !1727)
!1739 = !DILocation(line: 30, column: 5, scope: !1727)
!1740 = !DILocation(line: 30, column: 26, scope: !1727)
!1741 = !DILocation(line: 30, column: 5, scope: !1727)
!1742 = !DILocation(line: 31, column: 5, scope: !1727)
!1743 = !DILocation(line: 31, column: 5, scope: !1727)
!1744 = !DILocation(line: 31, column: 5, scope: !1727)
!1745 = !DILocation(line: 32, column: 5, scope: !1727)
!1746 = !DILocation(line: 32, column: 5, scope: !1727)
!1747 = !DILocation(line: 32, column: 47, scope: !1727)
!1748 = !DILocation(line: 32, column: 55, scope: !1727)
!1749 = !DILocation(line: 32, column: 5, scope: !1727)
!1750 = !DILocation(line: 33, column: 5, scope: !1727)
!1751 = !DILocation(line: 33, column: 5, scope: !1727)
!1752 = !DILocation(line: 33, column: 5, scope: !1727)
!1753 = !DILocation(line: 33, column: 33, scope: !1727)
!1754 = !DILocation(line: 33, column: 22, scope: !1727)
!1755 = !DILocation(line: 34, column: 5, scope: !1727)
!1756 = !DILocation(line: 34, column: 5, scope: !1727)
!1757 = !DILocation(line: 34, column: 5, scope: !1727)
!1758 = !DILocation(line: 34, column: 22, scope: !1727)
!1759 = !DILocation(line: 34, column: 5, scope: !1727)
!1760 = !DILocation(line: 37, column: 9, scope: !1727)


!1762 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1763 = !DILocalVariable(name: "dönüş",
  scope: !1761, file: !9, line: 15, type: !1762)
!1764 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1525, size: 64)
!1766 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !171, size: 64)
!1768 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1491, size: 64)
!1765 = !DILocalVariable(name: "Hazne",
  scope: !1761, file: !9, line: 40, type: !1764, arg: 1)
!1767 = !DILocalVariable(name: "Bölüm",
  scope: !1761, file: !9, line: 41, type: !1766, arg: 2)
!1769 = !DILocalVariable(name: "Değer",
  scope: !1761, file: !9, line: 41, type: !1768, arg: 3)
!1770 = !DISubroutineType(types: !1771)
!1771 = !{null, !1764, !1766, !1768 }
!1761 = distinct !DISubprogram( name: "hazne::t.Yapılandır_ox151i",
 scope: !1715,
 file: !9,
 line: 41,
 type: !1770, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yapılandır
!1772 = !DILocation(line: 40, column: 3, scope: !1761)
!1773 = !DILocation(line: 41, column: 25, scope: !1761)
!1774 = !DILocation(line: 41, column: 42, scope: !1761)
!1775 = distinct !DILexicalBlock(
        scope: !1761, file: !9, line: 54, column: 1)
!1776 = !DILocation(line: 44, column: 15, scope: !1775)
!1777 = !DILocation(line: 44, column: 15, scope: !1775)
!1778 = !DILocation(line: 44, column: 15, scope: !1775)
!1779 = !DILocation(line: 44, column: 5, scope: !1775)
!1780 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1781 = !DILocalVariable(name: "Hafıza",
  scope: !1775, file: !9, line: 44, type: !1780)
!1782 = !DILocation(line: 44, column: 5, scope: !1775)
!1783 = !DILocation(line: 45, column: 15, scope: !1775)
!1784 = !DILocation(line: 45, column: 15, scope: !1775)
!1785 = !DILocation(line: 45, column: 15, scope: !1775)
!1786 = !DILocation(line: 45, column: 5, scope: !1775)
!1787 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1788 = !DILocalVariable(name: "İmge",
  scope: !1775, file: !9, line: 45, type: !1787)
!1789 = !DILocation(line: 45, column: 5, scope: !1775)
!1790 = !DILocation(line: 46, column: 5, scope: !1775)
!1791 = !DILocation(line: 46, column: 5, scope: !1775)
!1792 = !DILocation(line: 46, column: 28, scope: !1775)
!1793 = !DILocation(line: 46, column: 36, scope: !1775)
!1794 = !DILocation(line: 46, column: 42, scope: !1775)
!1795 = !DILocation(line: 46, column: 42, scope: !1775)
!1796 = !DILocation(line: 46, column: 42, scope: !1775)
!1797 = !DILocation(line: 46, column: 17, scope: !1775)
!1798 = !DILocation(line: 47, column: 5, scope: !1775)
!1799 = !DILocation(line: 47, column: 5, scope: !1775)
!1800 = !DILocation(line: 47, column: 5, scope: !1775)
!1801 = !DILocation(line: 47, column: 24, scope: !1775)
!1802 = !DILocation(line: 47, column: 5, scope: !1775)
!1803 = !DILocation(line: 48, column: 5, scope: !1775)
!1804 = !DILocation(line: 49, column: 7, scope: !1775)
!1805 = !DILocation(line: 49, column: 7, scope: !1775)
!1806 = !DILocation(line: 49, column: 7, scope: !1775)
!1807 = !DILocation(line: 49, column: 7, scope: !1775)
!1808 = !DILocation(line: 49, column: 7, scope: !1775)
!1809 = !DILocation(line: 49, column: 29, scope: !1775)
!1810 = !DILocation(line: 49, column: 29, scope: !1775)
!1811 = !DILocation(line: 49, column: 29, scope: !1775)
!1812 = !DILocation(line: 49, column: 29, scope: !1775)
!1813 = !DILocation(line: 49, column: 56, scope: !1775)
!1814 = !DILocation(line: 49, column: 65, scope: !1775)
!1815 = !DILocation(line: 49, column: 65, scope: !1775)
!1816 = !DILocation(line: 49, column: 65, scope: !1775)
!1817 = !DILocation(line: 48, column: 11, scope: !1775)
!1818 = !DILocation(line: 50, column: 5, scope: !1775)
!1819 = !DILocation(line: 50, column: 27, scope: !1775)
!1820 = !DILocation(line: 50, column: 12, scope: !1775)
!1821 = !DILocation(line: 51, column: 5, scope: !1775)
!1822 = !DILocation(line: 51, column: 5, scope: !1775)
!1823 = distinct !DILexicalBlock(
        scope: !1775, file: !9, line: 51, column: 17)
!1824 = distinct !DILexicalBlock(
        scope: !1823, file: !9, line: 225, column: 1)
!1825 = !DILocation(line: 221, column: 3, scope: !1824)
!1826 = !DILocation(line: 221, column: 3, scope: !1824)
!1827 = !DILocation(line: 221, column: 3, scope: !1824)
!1828 = !DILocation(line: 221, column: 3, scope: !1824)
!1829 = !DILocation(line: 221, column: 25, scope: !1824)
!1830 = !DILocation(line: 222, column: 12, scope: !1824)
!1831 = !DILocation(line: 222, column: 12, scope: !1824)
!1832 = !DILocation(line: 222, column: 12, scope: !1824)
!1833 = !DILocation(line: 219, column: 28, scope: !1824)
!1834 = !DILocation(line: 51, column: 17, scope: !1823)
!1835 = !DILocation(line: 52, column: 9, scope: !1775)
!1836 = !DILocation(line: 52, column: 9, scope: !1775)
!1837 = !DILocation(line: 52, column: 9, scope: !1775)
