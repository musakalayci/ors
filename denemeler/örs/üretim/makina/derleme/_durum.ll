...
define external %gt2det* 
@"_durum::Yeni_i"(%gt263t* %0)#0       !dbg !1144 {
; Değişken : dönüş
  %2 = alloca %gt2det*, align 8
  store %gt2det* null, %gt2det** %2, align 8
; Değişken : Hafıza
  ...
  %5 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      ...
      i64 8), !dbg !1154
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt2det*; 1

; pascal 'Durum' örs::derleme::imge::_durum::t
  %7 = alloca %gt2det*, align 8
  store 
    %gt2det* %6,
    %gt2det** %7,
    align 8, !dbg !1155
  call void @llvm.dbg.declare(metadata %gt2det** %7, metadata !1157, metadata !DIExpression()), !dbg !1158
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt2det*, %gt2det** %7, align 8, !dbg !1165; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt2c1t* %15 to %gt2det**; 2
  %17 = load %gt2det*, %gt2det** %7, align 8, !dbg !1171; 2:0
  store 
    %gt2det* %17,
    %gt2det** %16,
    align 8, !dbg !1172
  %18 = load %gt2det*, %gt2det** %7, align 8, !dbg !1173; 2:0
; Dönüş :
  ret %gt2det* %18
}
...
define external 
%gt2ddt* @"_durum::_seçim.Yeni_i"(%gt263t* %0)
#0       !dbg !1174 {
; Değişken : dönüş
  %2 = alloca %gt2ddt*, align 8
  store %gt2ddt* null, %gt2ddt** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt263t*, align 8
  store %gt263t* %0, %gt263t** %3, align 8
  call void @llvm.dbg.declare(metadata %gt263t** %3, metadata !1178, metadata !DIExpression()), !dbg !1181
  %4 = load %gt263t*, %gt263t** %3, align 8, !dbg !1183; 2:0
  %5 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      %gt263t* %4, 
      i64 64, 
      i64 8), !dbg !1184
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt2ddt*; 1

; pascal 'Seçim' örs::derleme::imge::_durum::_seçim
  %7 = alloca %gt2ddt*, align 8
  store 
    %gt2ddt* %6,
    %gt2ddt** %7,
    align 8, !dbg !1185
  call void @llvm.dbg.declare(metadata %gt2ddt** %7, metadata !1187, metadata !DIExpression()), !dbg !1188
;;-> (nil) 0
  %8 = load %gt263t*, %gt263t** %3, align 8, !dbg !1189; 2:0
;;-> (nil) 0
  %9 = call %gt2c2t* @"imge::Yeni_i" (
      %gt263t* %8, 
      i32 349), !dbg !1190
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt2c2t** %10,
    align 8, !dbg !1191
  call void @llvm.dbg.declare(metadata %gt2c2t** %10, metadata !1193, metadata !DIExpression()), !dbg !1194
; Atama ifadesi
  %11 = load %gt2ddt*, %gt2ddt** %7, align 8, !dbg !1195; 2:0
; tür konumu *örs::derleme::imge::_durum::_seçim : *örs::derleme::imge::t
  %12 = getelementptr inbounds 
    %gt2ddt, %gt2ddt* %11,
    i32 0, i32 0
  %13 = load %gt2c2t*, %gt2c2t** %10, align 8, !dbg !1197; 2:0
  store 
    %gt2c2t* %13,
    %gt2c2t** %12,
    align 8, !dbg !1198
; Atama ifadesi
  %14 = load %gt2c2t*, %gt2c2t** %10, align 8, !dbg !1199; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
  %15 = getelementptr inbounds 
    %gt2c2t, %gt2c2t* %14,
    i32 0, i32 5
...
; Konum çevirisi:
  %16 = bitcast %gt2c1t* %15 to %gt2ddt**; 2
  %17 = load %gt2ddt*, %gt2ddt** %7, align 8, !dbg !1201; 2:0
  store 
    %gt2ddt* %17,
    %gt2ddt** %16,
    align 8, !dbg !1202
  %18 = load %gt2ddt*, %gt2ddt** %7, align 8, !dbg !1203; 2:0
; tür konumu *örs::derleme::imge::_durum::_seçim : *örs::derleme::imge::k[%st561_1gt2c2t]
  %19 = getelementptr inbounds 
    %gt2ddt, %gt2ddt* %18,
    i32 0, i32 4
;;-> (nil) 0
  %20 = load %gt263t*, %gt263t** %3, align 8, !dbg !1205; 2:0
 call void @"imge::zincir.Yapılandır_i" (
      %st561_1gt2c2t* %19, 
      %gt263t* %20), !dbg !1206
  %21 = load %gt2ddt*, %gt2ddt** %7, align 8, !dbg !1207; 2:0
; Dönüş :
  ret %gt2ddt* %21
}
...
!1143 = !DINamespace(name:"_durum", scope: !1142)


!1145 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1045, size: 64)
...
!1148 = !DILocalVariable(name: "Hafıza",
  scope: !1144, file: !9, line: 34, type: !1147, arg: 1)
!1149 = !DISubroutineType(types: !1150)
!1150 = !{null, !1147 }
!1144 = distinct !DISubprogram( name: "_durum::Yeni_i",
 scope: !1143,
 file: !9,
 line: 33,
 type: !1149, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1151 = !DILocation(line: 34, column: 5, scope: !1144)
!1152 = distinct !DILexicalBlock(
        scope: !1144, file: !9, line: 35, column: 3)
!1153 = !DILocation(line: 36, column: 18, scope: !1152)
!1154 = !DILocation(line: 36, column: 26, scope: !1152)
!1155 = !DILocation(line: 36, column: 5, scope: !1152)
!1156 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1045, size: 64)
!1157 = !DILocalVariable(name: "Durum",
  scope: !1152, file: !9, line: 36, type: !1156)
!1158 = !DILocation(line: 36, column: 5, scope: !1152)
!1159 = !DILocation(line: 37, column: 25, scope: !1152)
!1160 = !DILocation(line: 37, column: 20, scope: !1152)
!1161 = !DILocation(line: 37, column: 5, scope: !1152)
!1162 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1163 = !DILocalVariable(name: "İmge",
  scope: !1152, file: !9, line: 37, type: !1162)
!1164 = !DILocation(line: 37, column: 5, scope: !1152)
!1165 = !DILocation(line: 38, column: 5, scope: !1152)
!1166 = !DILocation(line: 38, column: 5, scope: !1152)
!1167 = !DILocation(line: 38, column: 26, scope: !1152)
!1168 = !DILocation(line: 38, column: 5, scope: !1152)
!1169 = !DILocation(line: 39, column: 5, scope: !1152)
!1170 = !DILocation(line: 39, column: 5, scope: !1152)
!1171 = !DILocation(line: 39, column: 26, scope: !1152)
!1172 = !DILocation(line: 39, column: 5, scope: !1152)
!1173 = !DILocation(line: 40, column: 9, scope: !1152)


!1175 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1032, size: 64)
!1176 = !DILocalVariable(name: "dönüş",
  scope: !1174, file: !9, line: 15, type: !1175)
!1177 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !88, size: 64)
!1178 = !DILocalVariable(name: "Hafıza",
  scope: !1174, file: !9, line: 23, type: !1177, arg: 1)
!1179 = !DISubroutineType(types: !1180)
!1180 = !{null, !1177 }
!1174 = distinct !DISubprogram( name: "_durum::_seçim.Yeni_i",
 scope: !1143,
 file: !9,
 line: 22,
 type: !1179, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1181 = !DILocation(line: 23, column: 5, scope: !1174)
!1182 = distinct !DILexicalBlock(
        scope: !1174, file: !9, line: 33, column: 3)
!1183 = !DILocation(line: 25, column: 23, scope: !1182)
!1184 = !DILocation(line: 25, column: 31, scope: !1182)
!1185 = !DILocation(line: 25, column: 5, scope: !1182)
!1186 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1032, size: 64)
!1187 = !DILocalVariable(name: "Seçim",
  scope: !1182, file: !9, line: 25, type: !1186)
!1188 = !DILocation(line: 25, column: 5, scope: !1182)
!1189 = !DILocation(line: 26, column: 25, scope: !1182)
!1190 = !DILocation(line: 26, column: 20, scope: !1182)
!1191 = !DILocation(line: 26, column: 5, scope: !1182)
!1192 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1193 = !DILocalVariable(name: "İmge",
  scope: !1182, file: !9, line: 26, type: !1192)
!1194 = !DILocation(line: 26, column: 5, scope: !1182)
!1195 = !DILocation(line: 27, column: 5, scope: !1182)
!1196 = !DILocation(line: 27, column: 5, scope: !1182)
!1197 = !DILocation(line: 27, column: 26, scope: !1182)
!1198 = !DILocation(line: 27, column: 5, scope: !1182)
!1199 = !DILocation(line: 28, column: 5, scope: !1182)
!1200 = !DILocation(line: 28, column: 5, scope: !1182)
!1201 = !DILocation(line: 28, column: 26, scope: !1182)
!1202 = !DILocation(line: 28, column: 5, scope: !1182)
!1203 = !DILocation(line: 29, column: 5, scope: !1182)
!1204 = !DILocation(line: 29, column: 5, scope: !1182)
!1205 = !DILocation(line: 29, column: 32, scope: !1182)
!1206 = !DILocation(line: 29, column: 21, scope: !1182)
!1207 = !DILocation(line: 30, column: 9, scope: !1182)
