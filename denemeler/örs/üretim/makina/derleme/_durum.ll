...
define external %gt247t* 
@"_durum::Yeni_ox128i"(%gt1e0t* %0)#0       {
; Değişken : dönüş
  %2 = alloca %gt247t*, align 8
  store %gt247t* null, %gt247t** %2, align 8
; Değişken : Hafıza
  ...
  %5 = call i8* (%gt1e0t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      ...
      i64 8)
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt247t*; 1

; pascal 'Durum' örs::derleme::imge::_durum::t
  %7 = alloca %gt247t*, align 8
  store 
    %gt247t* %6,
    %gt247t** %7,
    align 8
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    align 8
; Atama ifadesi
  %11 = load %gt247t*, %gt247t** %7, align 8; 2:0
; tür konumu *örs::derleme::imge::_durum::t : *örs::derleme::imge::t
  %12 = getelementptr inbounds 
    %gt247t, %gt247t* %11,
    i32 0, i32 0
  %13 = load %gt231t*, %gt231t** %10, align 8; 2:0
;atama:
  store 
    %gt231t* %13,
    %gt231t** %12,
    align 8
; Atama ifadesi
  %14 = load %gt231t*, %gt231t** %10, align 8; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt230t* %15 to %gt247t**; 2
  %17 = load %gt247t*, %gt247t** %7, align 8; 2:0
;atama:
  store 
    %gt247t* %17,
    %gt247t** %16,
    align 8
  %18 = load %gt247t*, %gt247t** %7, align 8; 2:0
; Dönüş :
  ret %gt247t* %18
}
...
define external 
%gt246t* @"_durum::_seçim.Yeni_ox128i"(%gt1e0t* %0)
#0       {
; Değişken : dönüş
  %2 = alloca %gt246t*, align 8
  store %gt246t* null, %gt246t** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt1e0t*, align 8
  store %gt1e0t* %0, %gt1e0t** %3, align 8
  %4 = load %gt1e0t*, %gt1e0t** %3, align 8; 2:0
  %5 = call i8* (%gt1e0t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      ...
      i64 8)
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt246t*; 1

; pascal 'Seçim' örs::derleme::imge::_durum::_seçim
  %7 = alloca %gt246t*, align 8
  store 
    %gt246t* %6,
    %gt246t** %7,
    align 8
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    align 8
; Atama ifadesi
  %11 = load %gt246t*, %gt246t** %7, align 8; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt230t* %15 to %gt246t**; 2
  %17 = load %gt246t*, %gt246t** %7, align 8; 2:0
;atama:
  store 
    %gt246t* %17,
    %gt246t** %16,
    align 8
  %18 = load %gt246t*, %gt246t** %7, align 8; 2:0
...
;;-> (nil) 0
 ...
 call void @"imge::zincir.Yapılandır_ox10ai" (
      %st429_1gt231t* %19, 
      %gt1e0t* %20)
  %21 = load %gt246t*, %gt246t** %7, align 8; 2:0
; Dönüş :
  ret %gt246t* %21
}
