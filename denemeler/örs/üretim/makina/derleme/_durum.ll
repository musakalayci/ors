...
define external %gt24at* 
@"_durum::Yeni_ox128i"(%gt1e2t* %0)#0       !dbg !1580 {
; Değişken : dönüş
  %2 = alloca %gt24at*, align 8
  store %gt24at* null, %gt24at** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt1e2t*, align 8
  store %gt1e2t* %0, %gt1e2t** %3, align 8
  call void @llvm.dbg.declare(metadata %gt1e2t** %3, metadata !1584, metadata !DIExpression()), !dbg !1587
  %4 = load %gt1e2t*, %gt1e2t** %3, align 8, !dbg !1589; 2:0
  %5 = call i8* (%gt1e2t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      %gt1e2t* %4, 
      i64 40, 
      i64 8), !dbg !1590
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt24at*; 1

; pascal 'Durum' örs::derleme::imge::_durum::t
  %7 = alloca %gt24at*, align 8
  store 
    %gt24at* %6,
    %gt24at** %7,
    align 8, !dbg !1591
  call void @llvm.dbg.declare(metadata %gt24at** %7, metadata !1593, metadata !DIExpression()), !dbg !1594
;;-> (nil) 0
  %8 = load %gt1e2t*, %gt1e2t** %3, align 8, !dbg !1595; 2:0
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt24at*, %gt24at** %7, align 8, !dbg !1601; 2:0
; tür konumu *örs::derleme::imge::_durum::t : *örs::derleme::imge::t
  %12 = getelementptr inbounds 
    %gt24at, %gt24at* %11,
    i32 0, i32 0
  %13 = load %gt234t*, %gt234t** %10, align 8, !dbg !1603; 2:0
;atama:
  store 
    %gt234t* %13,
    %gt234t** %12,
    align 8, !dbg !1604
; Atama ifadesi
  %14 = load %gt234t*, %gt234t** %10, align 8, !dbg !1605; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt233t* %15 to %gt24at**; 2
  %17 = load %gt24at*, %gt24at** %7, align 8, !dbg !1607; 2:0
;atama:
  store 
    %gt24at* %17,
    %gt24at** %16,
    align 8, !dbg !1608
  %18 = load %gt24at*, %gt24at** %7, align 8, !dbg !1609; 2:0
; Dönüş :
  ret %gt24at* %18
}
...
define external 
%gt249t* @"_durum::_seçim.Yeni_ox128i"(%gt1e2t* %0)
#0       !dbg !1610 {
; Değişken : dönüş
  %2 = alloca %gt249t*, align 8
  store %gt249t* null, %gt249t** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt1e2t*, align 8
  store %gt1e2t* %0, %gt1e2t** %3, align 8
  call void @llvm.dbg.declare(metadata %gt1e2t** %3, metadata !1614, metadata !DIExpression()), !dbg !1617
  %4 = load %gt1e2t*, %gt1e2t** %3, align 8, !dbg !1619; 2:0
  %5 = call i8* (%gt1e2t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      %gt1e2t* %4, 
      i64 64, 
      i64 8), !dbg !1620
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt249t*; 1

; pascal 'Seçim' örs::derleme::imge::_durum::_seçim
  %7 = alloca %gt249t*, align 8
  store 
    %gt249t* %6,
    %gt249t** %7,
    align 8, !dbg !1621
  call void @llvm.dbg.declare(metadata %gt249t** %7, metadata !1623, metadata !DIExpression()), !dbg !1624
;;-> (nil) 0
  %8 = load %gt1e2t*, %gt1e2t** %3, align 8, !dbg !1625; 2:0
;;-> (nil) 0
  %9 = call %gt234t* @"imge::Yeni_ox10Ai" (
      %gt1e2t* %8, 
      i32 349), !dbg !1626
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt234t** %10,
    align 8, !dbg !1627
  call void @llvm.dbg.declare(metadata %gt234t** %10, metadata !1629, metadata !DIExpression()), !dbg !1630
; Atama ifadesi
  %11 = load %gt249t*, %gt249t** %7, align 8, !dbg !1631; 2:0
; tür konumu *örs::derleme::imge::_durum::_seçim : *örs::derleme::imge::t
  %12 = getelementptr inbounds 
    %gt249t, %gt249t* %11,
    i32 0, i32 0
  %13 = load %gt234t*, %gt234t** %10, align 8, !dbg !1633; 2:0
;atama:
  store 
    %gt234t* %13,
    %gt234t** %12,
    align 8, !dbg !1634
; Atama ifadesi
  %14 = load %gt234t*, %gt234t** %10, align 8, !dbg !1635; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
  %15 = getelementptr inbounds 
    %gt234t, %gt234t* %14,
    i32 0, i32 5
...
; Konum çevirisi:
  %16 = bitcast %gt233t* %15 to %gt249t**; 2
  %17 = load %gt249t*, %gt249t** %7, align 8, !dbg !1637; 2:0
;atama:
  store 
    %gt249t* %17,
    %gt249t** %16,
    align 8, !dbg !1638
  %18 = load %gt249t*, %gt249t** %7, align 8, !dbg !1639; 2:0
; tür konumu *örs::derleme::imge::_durum::_seçim : *örs::derleme::imge::k[%st431_1gt234t]
  %19 = getelementptr inbounds 
    %gt249t, %gt249t* %18,
    i32 0, i32 4
;;-> (nil) 0
  %20 = load %gt1e2t*, %gt1e2t** %3, align 8, !dbg !1641; 2:0
 call void @"imge::zincir.Yapılandır_ox10ai" (
      %st431_1gt234t* %19, 
      %gt1e2t* %20), !dbg !1642
  %21 = load %gt249t*, %gt249t** %7, align 8, !dbg !1643; 2:0
; Dönüş :
  ret %gt249t* %21
}
...
!1579 = !DINamespace(name:"_durum", scope: !1578)


!1581 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1507, size: 64)
...
!1584 = !DILocalVariable(name: "Hafıza",
  scope: !1580, file: !9, line: 34, type: !1583, arg: 1)
!1585 = !DISubroutineType(types: !1586)
!1586 = !{null, !1583 }
!1580 = distinct !DISubprogram( name: "_durum::Yeni_ox128i",
 scope: !1579,
 file: !9,
 line: 33,
 type: !1585, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1587 = !DILocation(line: 34, column: 5, scope: !1580)
!1588 = distinct !DILexicalBlock(
        scope: !1580, file: !9, line: 35, column: 3)
!1589 = !DILocation(line: 36, column: 18, scope: !1588)
!1590 = !DILocation(line: 36, column: 26, scope: !1588)
!1591 = !DILocation(line: 36, column: 5, scope: !1588)
!1592 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1507, size: 64)
!1593 = !DILocalVariable(name: "Durum",
  scope: !1588, file: !9, line: 36, type: !1592)
!1594 = !DILocation(line: 36, column: 5, scope: !1588)
!1595 = !DILocation(line: 37, column: 25, scope: !1588)
!1596 = !DILocation(line: 37, column: 20, scope: !1588)
!1597 = !DILocation(line: 37, column: 5, scope: !1588)
!1598 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1599 = !DILocalVariable(name: "İmge",
  scope: !1588, file: !9, line: 37, type: !1598)
!1600 = !DILocation(line: 37, column: 5, scope: !1588)
!1601 = !DILocation(line: 38, column: 5, scope: !1588)
!1602 = !DILocation(line: 38, column: 5, scope: !1588)
!1603 = !DILocation(line: 38, column: 26, scope: !1588)
!1604 = !DILocation(line: 38, column: 5, scope: !1588)
!1605 = !DILocation(line: 39, column: 5, scope: !1588)
!1606 = !DILocation(line: 39, column: 5, scope: !1588)
!1607 = !DILocation(line: 39, column: 26, scope: !1588)
!1608 = !DILocation(line: 39, column: 5, scope: !1588)
!1609 = !DILocation(line: 40, column: 9, scope: !1588)


!1611 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1494, size: 64)
!1612 = !DILocalVariable(name: "dönüş",
  scope: !1610, file: !9, line: 15, type: !1611)
!1613 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1614 = !DILocalVariable(name: "Hafıza",
  scope: !1610, file: !9, line: 23, type: !1613, arg: 1)
!1615 = !DISubroutineType(types: !1616)
!1616 = !{null, !1613 }
!1610 = distinct !DISubprogram( name: "_durum::_seçim.Yeni_ox128i",
 scope: !1579,
 file: !9,
 line: 22,
 type: !1615, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1617 = !DILocation(line: 23, column: 5, scope: !1610)
!1618 = distinct !DILexicalBlock(
        scope: !1610, file: !9, line: 33, column: 3)
!1619 = !DILocation(line: 25, column: 23, scope: !1618)
!1620 = !DILocation(line: 25, column: 31, scope: !1618)
!1621 = !DILocation(line: 25, column: 5, scope: !1618)
!1622 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1494, size: 64)
!1623 = !DILocalVariable(name: "Seçim",
  scope: !1618, file: !9, line: 25, type: !1622)
!1624 = !DILocation(line: 25, column: 5, scope: !1618)
!1625 = !DILocation(line: 26, column: 25, scope: !1618)
!1626 = !DILocation(line: 26, column: 20, scope: !1618)
!1627 = !DILocation(line: 26, column: 5, scope: !1618)
!1628 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1629 = !DILocalVariable(name: "İmge",
  scope: !1618, file: !9, line: 26, type: !1628)
!1630 = !DILocation(line: 26, column: 5, scope: !1618)
!1631 = !DILocation(line: 27, column: 5, scope: !1618)
!1632 = !DILocation(line: 27, column: 5, scope: !1618)
!1633 = !DILocation(line: 27, column: 26, scope: !1618)
!1634 = !DILocation(line: 27, column: 5, scope: !1618)
!1635 = !DILocation(line: 28, column: 5, scope: !1618)
!1636 = !DILocation(line: 28, column: 5, scope: !1618)
!1637 = !DILocation(line: 28, column: 26, scope: !1618)
!1638 = !DILocation(line: 28, column: 5, scope: !1618)
!1639 = !DILocation(line: 29, column: 5, scope: !1618)
!1640 = !DILocation(line: 29, column: 5, scope: !1618)
!1641 = !DILocation(line: 29, column: 32, scope: !1618)
!1642 = !DILocation(line: 29, column: 21, scope: !1618)
!1643 = !DILocation(line: 30, column: 9, scope: !1618)
