...
@"tekil::Yeni_ox148i"(%gt296t* %0, %gt3a6t* %1, i32 %2)#0       !dbg !1790 {
; Değişken : dönüş
...
; Değişken : İfade
  ...
  call void @llvm.dbg.declare(metadata %gt3a6t** %6, metadata !1796, metadata !DIExpression()), !dbg !1801
; Değişken : özellik
  ...
  %9 = call i8* (%gt296t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1805
; Konum çevirisi:
  %10 = bitcast i8* %9 to %gt3e0t*; 1

; pascal 'Tekil' örs::derleme::imge::tekil::t
  %11 = alloca %gt3e0t*, align 8
  store 
    %gt3e0t* %10,
    %gt3e0t** %11,
    align 8, !dbg !1806
  call void @llvm.dbg.declare(metadata %gt3e0t** %11, metadata !1808, metadata !DIExpression()), !dbg !1809
; Atama ifadesi
  %12 = load %gt3a6t*, %gt3a6t** %6, align 8, !dbg !1810; 2:0
; tür konumu *örs::derleme::imge::t : *t32
  %13 = getelementptr inbounds 
    %gt3a6t, %gt3a6t* %12,
    i32 0, i32 0
  %14 = load i32, i32* %7, align 4, !dbg !1812; 1:0
;atama:
  store 
    i32 %14,
    i32* %13,
    align 4, !dbg !1813
; Atama ifadesi
  %15 = load %gt3a6t*, %gt3a6t** %6, align 8, !dbg !1814; 2:0
...
; Konum çevirisi:
  %17 = bitcast %gt3a5t* %16 to %gt3e0t**; 2
  %18 = load %gt3e0t*, %gt3e0t** %11, align 8, !dbg !1816; 2:0
;atama:
  store 
    %gt3e0t* %18,
    %gt3e0t** %17,
    align 8, !dbg !1817
; Atama ifadesi
  %19 = load %gt3e0t*, %gt3e0t** %11, align 8, !dbg !1818; 2:0
; tür konumu *örs::derleme::imge::tekil::t : *örs::derleme::imge::t
  %20 = getelementptr inbounds 
    %gt3e0t, %gt3e0t* %19,
    i32 0, i32 1
  %21 = load %gt3a6t*, %gt3a6t** %6, align 8, !dbg !1820; 2:0
;atama:
  store 
    %gt3a6t* %21,
    %gt3a6t** %20,
    align 8, !dbg !1821
  %22 = load %gt3e0t*, %gt3e0t** %11, align 8, !dbg !1822; 2:0
; Dönüş :
  ret %gt3e0t* %22
}
...
!1789 = !DINamespace(name:"tekil", scope: !1788)


!1791 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1488, size: 64)
...
!1794 = !DILocalVariable(name: "Hafıza",
  scope: !1790, file: !9, line: 14, type: !1793, arg: 1)
!1796 = !DILocalVariable(name: "İfade",
  scope: !1790, file: !9, line: 15, type: !1795, arg: 2)
!1797 = !DILocalVariable(name: "özellik",
  scope: !1790, file: !9, line: 16, type: !12, arg: 3)
!1798 = !DISubroutineType(types: !1799)
!1799 = !{null, !1793, !1795, !12 }
!1790 = distinct !DISubprogram( name: "tekil::Yeni_ox148i",
 scope: !1789,
 file: !9,
 line: 13,
 type: !1798, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1800 = !DILocation(line: 14, column: 5, scope: !1790)
!1801 = !DILocation(line: 15, column: 5, scope: !1790)
!1802 = !DILocation(line: 16, column: 5, scope: !1790)
!1803 = distinct !DILexicalBlock(
        scope: !1790, file: !9, line: 17, column: 5)
!1804 = !DILocation(line: 18, column: 33, scope: !1803)
!1805 = !DILocation(line: 18, column: 41, scope: !1803)
!1806 = !DILocation(line: 18, column: 7, scope: !1803)
!1807 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1488, size: 64)
!1808 = !DILocalVariable(name: "Tekil",
  scope: !1803, file: !9, line: 18, type: !1807)
!1809 = !DILocation(line: 18, column: 7, scope: !1803)
!1810 = !DILocation(line: 19, column: 7, scope: !1803)
!1811 = !DILocation(line: 19, column: 7, scope: !1803)
!1812 = !DILocation(line: 19, column: 29, scope: !1803)
!1813 = !DILocation(line: 19, column: 7, scope: !1803)
!1814 = !DILocation(line: 20, column: 7, scope: !1803)
!1815 = !DILocation(line: 20, column: 7, scope: !1803)
!1816 = !DILocation(line: 20, column: 29, scope: !1803)
!1817 = !DILocation(line: 20, column: 7, scope: !1803)
!1818 = !DILocation(line: 21, column: 7, scope: !1803)
!1819 = !DILocation(line: 21, column: 7, scope: !1803)
!1820 = !DILocation(line: 21, column: 29, scope: !1803)
!1821 = !DILocation(line: 21, column: 7, scope: !1803)
!1822 = !DILocation(line: 22, column: 11, scope: !1803)
