...
@"tekil::Yeni_ox148i"(%gt294t* %0, %gt398t* %1, i32 %2)#0       !dbg !1716 {
; Değişken : dönüş
...
; Değişken : İfade
  ...
  call void @llvm.dbg.declare(metadata %gt398t** %6, metadata !1722, metadata !DIExpression()), !dbg !1727
; Değişken : özellik
...
; pascal 'Tekil' örs::derleme::imge::tekil::t
  ...
  store 
    ...
    %gt3cet** %11,
    align 8, !dbg !1732
  call void @llvm.dbg.declare(metadata %gt3cet** %11, metadata !1734, metadata !DIExpression()), !dbg !1735
; Atama ifadesi
  %12 = load %gt398t*, %gt398t** %6, align 8, !dbg !1736; 2:0
; tür konumu *örs::derleme::imge::t : *t32
  %13 = getelementptr inbounds 
    %gt398t, %gt398t* %12,
    i32 0, i32 0
  %14 = load i32, i32* %7, align 4, !dbg !1738; 1:0
;atama:
  store 
    i32 %14,
    i32* %13,
    align 4, !dbg !1739
; Atama ifadesi
  %15 = load %gt398t*, %gt398t** %6, align 8, !dbg !1740; 2:0
...
; Konum çevirisi:
  %17 = bitcast %gt397t* %16 to %gt3cet**; 2
  %18 = load %gt3cet*, %gt3cet** %11, align 8, !dbg !1742; 2:0
;atama:
  store 
    %gt3cet* %18,
    %gt3cet** %17,
    align 8, !dbg !1743
; Atama ifadesi
  %19 = load %gt3cet*, %gt3cet** %11, align 8, !dbg !1744; 2:0
; tür konumu *örs::derleme::imge::tekil::t : *örs::derleme::imge::t
  %20 = getelementptr inbounds 
    %gt3cet, %gt3cet* %19,
    i32 0, i32 1
  %21 = load %gt398t*, %gt398t** %6, align 8, !dbg !1746; 2:0
;atama:
  store 
    %gt398t* %21,
    %gt398t** %20,
    align 8, !dbg !1747
  %22 = load %gt3cet*, %gt3cet** %11, align 8, !dbg !1748; 2:0
; Dönüş :
  ret %gt3cet* %22
}
...
!1715 = !DINamespace(name:"tekil", scope: !1714)


!1717 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1420, size: 64)
...
!1722 = !DILocalVariable(name: "İfade",
  scope: !1716, file: !9, line: 15, type: !1721, arg: 2)
!1723 = !DILocalVariable(name: "özellik",
  scope: !1716, file: !9, line: 16, type: !12, arg: 3)
!1724 = !DISubroutineType(types: !1725)
!1725 = !{null, !1719, !1721, !12 }
!1716 = distinct !DISubprogram( name: "tekil::Yeni_ox148i",
 scope: !1715,
 file: !9,
 line: 13,
 type: !1724, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1726 = !DILocation(line: 14, column: 5, scope: !1716)
!1727 = !DILocation(line: 15, column: 5, scope: !1716)
!1728 = !DILocation(line: 16, column: 5, scope: !1716)
!1729 = distinct !DILexicalBlock(
        scope: !1716, file: !9, line: 17, column: 5)
!1730 = !DILocation(line: 18, column: 33, scope: !1729)
!1731 = !DILocation(line: 18, column: 41, scope: !1729)
!1732 = !DILocation(line: 18, column: 7, scope: !1729)
!1733 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1420, size: 64)
!1734 = !DILocalVariable(name: "Tekil",
  scope: !1729, file: !9, line: 18, type: !1733)
!1735 = !DILocation(line: 18, column: 7, scope: !1729)
!1736 = !DILocation(line: 19, column: 7, scope: !1729)
!1737 = !DILocation(line: 19, column: 7, scope: !1729)
!1738 = !DILocation(line: 19, column: 29, scope: !1729)
!1739 = !DILocation(line: 19, column: 7, scope: !1729)
!1740 = !DILocation(line: 20, column: 7, scope: !1729)
!1741 = !DILocation(line: 20, column: 7, scope: !1729)
!1742 = !DILocation(line: 20, column: 29, scope: !1729)
!1743 = !DILocation(line: 20, column: 7, scope: !1729)
!1744 = !DILocation(line: 21, column: 7, scope: !1729)
!1745 = !DILocation(line: 21, column: 7, scope: !1729)
!1746 = !DILocation(line: 21, column: 29, scope: !1729)
!1747 = !DILocation(line: 21, column: 7, scope: !1729)
!1748 = !DILocation(line: 22, column: 11, scope: !1729)
