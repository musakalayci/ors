...
@"tekil::Yeni_i"(%gt263t* %0, %gt2c2t* %1, i32 %2)#0       !dbg !1144 {
; Değişken : dönüş
...
; Değişken : İfade
  ...
  call void @llvm.dbg.declare(metadata %gt2c2t** %6, metadata !1150, metadata !DIExpression()), !dbg !1155
; Değişken : özellik
  ...
  %9 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      ...
      i64 8), !dbg !1159
; Konum çevirisi:
  %10 = bitcast i8* %9 to %gt2d4t*; 1

; pascal 'Tekil' örs::derleme::imge::tekil::t
  %11 = alloca %gt2d4t*, align 8
  store 
    %gt2d4t* %10,
    %gt2d4t** %11,
    align 8, !dbg !1160
  call void @llvm.dbg.declare(metadata %gt2d4t** %11, metadata !1162, metadata !DIExpression()), !dbg !1163
; Atama ifadesi
  %12 = load %gt2c2t*, %gt2c2t** %6, align 8, !dbg !1164; 2:0
; tür konumu *örs::derleme::imge::t : *t32
  %13 = getelementptr inbounds 
    %gt2c2t, %gt2c2t* %12,
    i32 0, i32 0
  %14 = load i32, i32* %7, align 4, !dbg !1166; 1:0
  store 
    i32 %14,
    i32* %13,
    align 4, !dbg !1167
; Atama ifadesi
  %15 = load %gt2c2t*, %gt2c2t** %6, align 8, !dbg !1168; 2:0
...
; Konum çevirisi:
  %17 = bitcast %gt2c1t* %16 to %gt2d4t**; 2
  %18 = load %gt2d4t*, %gt2d4t** %11, align 8, !dbg !1170; 2:0
  store 
    %gt2d4t* %18,
    %gt2d4t** %17,
    align 8, !dbg !1171
; Atama ifadesi
  %19 = load %gt2d4t*, %gt2d4t** %11, align 8, !dbg !1172; 2:0
; tür konumu *örs::derleme::imge::tekil::t : *örs::derleme::imge::t
  %20 = getelementptr inbounds 
    %gt2d4t, %gt2d4t* %19,
    i32 0, i32 1
  %21 = load %gt2c2t*, %gt2c2t** %6, align 8, !dbg !1174; 2:0
  store 
    %gt2c2t* %21,
    %gt2c2t** %20,
    align 8, !dbg !1175
  %22 = load %gt2d4t*, %gt2d4t** %11, align 8, !dbg !1176; 2:0
; Dönüş :
  ret %gt2d4t* %22
}
...
!1143 = !DINamespace(name:"tekil", scope: !1142)


!1145 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !879, size: 64)
...
!1150 = !DILocalVariable(name: "İfade",
  scope: !1144, file: !9, line: 15, type: !1149, arg: 2)
!1151 = !DILocalVariable(name: "özellik",
  scope: !1144, file: !9, line: 16, type: !12, arg: 3)
!1152 = !DISubroutineType(types: !1153)
!1153 = !{null, !1147, !1149, !12 }
!1144 = distinct !DISubprogram( name: "tekil::Yeni_i",
 scope: !1143,
 file: !9,
 line: 13,
 type: !1152, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1154 = !DILocation(line: 14, column: 5, scope: !1144)
!1155 = !DILocation(line: 15, column: 5, scope: !1144)
!1156 = !DILocation(line: 16, column: 5, scope: !1144)
!1157 = distinct !DILexicalBlock(
        scope: !1144, file: !9, line: 17, column: 5)
!1158 = !DILocation(line: 18, column: 33, scope: !1157)
!1159 = !DILocation(line: 18, column: 41, scope: !1157)
!1160 = !DILocation(line: 18, column: 7, scope: !1157)
!1161 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !879, size: 64)
!1162 = !DILocalVariable(name: "Tekil",
  scope: !1157, file: !9, line: 18, type: !1161)
!1163 = !DILocation(line: 18, column: 7, scope: !1157)
!1164 = !DILocation(line: 19, column: 7, scope: !1157)
!1165 = !DILocation(line: 19, column: 7, scope: !1157)
!1166 = !DILocation(line: 19, column: 29, scope: !1157)
!1167 = !DILocation(line: 19, column: 7, scope: !1157)
!1168 = !DILocation(line: 20, column: 7, scope: !1157)
!1169 = !DILocation(line: 20, column: 7, scope: !1157)
!1170 = !DILocation(line: 20, column: 29, scope: !1157)
!1171 = !DILocation(line: 20, column: 7, scope: !1157)
!1172 = !DILocation(line: 21, column: 7, scope: !1157)
!1173 = !DILocation(line: 21, column: 7, scope: !1157)
!1174 = !DILocation(line: 21, column: 29, scope: !1157)
!1175 = !DILocation(line: 21, column: 7, scope: !1157)
!1176 = !DILocation(line: 22, column: 11, scope: !1157)
