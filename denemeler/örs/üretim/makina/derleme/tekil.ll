...
define external %gt3f9t* 
@"tekil::Yeni_ox148i"(%gt29at* %0, %gt3bft* %1, i32 %2)#0       !dbg !1817 {
; Değişken : dönüş
  %4 = alloca %gt3f9t*, align 8
  store %gt3f9t* null, %gt3f9t** %4, align 8
; Değişken : Hafıza
...
; Değişken : İfade
  ...
  call void @llvm.dbg.declare(metadata %gt3bft** %6, metadata !1823, metadata !DIExpression()), !dbg !1828
; Değişken : özellik
  ...
  %9 = call i8* (%gt29at*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1832
; Konum çevirisi:
  %10 = bitcast i8* %9 to %gt3f9t*; 1

; pascal 'Tekil' örs::derleme::imge::tekil::t
  %11 = alloca %gt3f9t*, align 8
  store 
    %gt3f9t* %10,
    %gt3f9t** %11,
    align 8, !dbg !1833
  call void @llvm.dbg.declare(metadata %gt3f9t** %11, metadata !1835, metadata !DIExpression()), !dbg !1836
; Atama ifadesi
  %12 = load %gt3bft*, %gt3bft** %6, align 8, !dbg !1837; 2:0
; tür konumu *örs::derleme::imge::t : *t32
  %13 = getelementptr inbounds 
    %gt3bft, %gt3bft* %12,
    i32 0, i32 0
  %14 = load i32, i32* %7, align 4, !dbg !1839; 1:0
;atama:
  store 
    i32 %14,
    i32* %13,
    align 4, !dbg !1840
; Atama ifadesi
  %15 = load %gt3bft*, %gt3bft** %6, align 8, !dbg !1841; 2:0
...
; Konum çevirisi:
  %17 = bitcast %gt3bet* %16 to %gt3f9t**; 2
  %18 = load %gt3f9t*, %gt3f9t** %11, align 8, !dbg !1843; 2:0
;atama:
  store 
    %gt3f9t* %18,
    %gt3f9t** %17,
    align 8, !dbg !1844
; Atama ifadesi
  %19 = load %gt3f9t*, %gt3f9t** %11, align 8, !dbg !1845; 2:0
; tür konumu *örs::derleme::imge::tekil::t : *örs::derleme::imge::t
  %20 = getelementptr inbounds 
    %gt3f9t, %gt3f9t* %19,
    i32 0, i32 1
  %21 = load %gt3bft*, %gt3bft** %6, align 8, !dbg !1847; 2:0
;atama:
  store 
    %gt3bft* %21,
    %gt3bft** %20,
    align 8, !dbg !1848
  %22 = load %gt3f9t*, %gt3f9t** %11, align 8, !dbg !1849; 2:0
; Dönüş :
  ret %gt3f9t* %22
}
...
!1816 = !DINamespace(name:"tekil", scope: !1815)


!1818 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1483, size: 64)
...
!1823 = !DILocalVariable(name: "İfade",
  scope: !1817, file: !9, line: 15, type: !1822, arg: 2)
!1824 = !DILocalVariable(name: "özellik",
  scope: !1817, file: !9, line: 16, type: !12, arg: 3)
!1825 = !DISubroutineType(types: !1826)
!1826 = !{null, !1820, !1822, !12 }
!1817 = distinct !DISubprogram( name: "tekil::Yeni_ox148i",
 scope: !1816,
 file: !9,
 line: 13,
 type: !1825, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1827 = !DILocation(line: 14, column: 5, scope: !1817)
!1828 = !DILocation(line: 15, column: 5, scope: !1817)
!1829 = !DILocation(line: 16, column: 5, scope: !1817)
!1830 = distinct !DILexicalBlock(
        scope: !1817, file: !9, line: 17, column: 5)
!1831 = !DILocation(line: 18, column: 33, scope: !1830)
!1832 = !DILocation(line: 18, column: 41, scope: !1830)
!1833 = !DILocation(line: 18, column: 7, scope: !1830)
!1834 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1483, size: 64)
!1835 = !DILocalVariable(name: "Tekil",
  scope: !1830, file: !9, line: 18, type: !1834)
!1836 = !DILocation(line: 18, column: 7, scope: !1830)
!1837 = !DILocation(line: 19, column: 7, scope: !1830)
!1838 = !DILocation(line: 19, column: 7, scope: !1830)
!1839 = !DILocation(line: 19, column: 29, scope: !1830)
!1840 = !DILocation(line: 19, column: 7, scope: !1830)
!1841 = !DILocation(line: 20, column: 7, scope: !1830)
!1842 = !DILocation(line: 20, column: 7, scope: !1830)
!1843 = !DILocation(line: 20, column: 29, scope: !1830)
!1844 = !DILocation(line: 20, column: 7, scope: !1830)
!1845 = !DILocation(line: 21, column: 7, scope: !1830)
!1846 = !DILocation(line: 21, column: 7, scope: !1830)
!1847 = !DILocation(line: 21, column: 29, scope: !1830)
!1848 = !DILocation(line: 21, column: 7, scope: !1830)
!1849 = !DILocation(line: 22, column: 11, scope: !1830)
