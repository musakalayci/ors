...
define external %gt227t* 
@"tekil::Yeni_ox124i"(%gt1e0t* %0, %gt231t* %1, i32 %2)#0       {
; Değişken : dönüş
  %4 = alloca %gt227t*, align 8
  store %gt227t* null, %gt227t** %4, align 8
; Değişken : Hafıza
...
; Değişken : özellik
  ...
  %9 = call i8* (%gt1e0t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      ...
      i64 8)
; Konum çevirisi:
  %10 = bitcast i8* %9 to %gt227t*; 1

; pascal 'Tekil' örs::derleme::imge::tekil::t
  %11 = alloca %gt227t*, align 8
  store 
    %gt227t* %10,
    %gt227t** %11,
    align 8
...
; Konum çevirisi:
  %17 = bitcast %gt230t* %16 to %gt227t**; 2
  %18 = load %gt227t*, %gt227t** %11, align 8; 2:0
;atama:
  store 
    %gt227t* %18,
    %gt227t** %17,
    align 8
; Atama ifadesi
  %19 = load %gt227t*, %gt227t** %11, align 8; 2:0
; tür konumu *örs::derleme::imge::tekil::t : *örs::derleme::imge::t
  %20 = getelementptr inbounds 
    %gt227t, %gt227t* %19,
    i32 0, i32 1
  %21 = load %gt231t*, %gt231t** %6, align 8; 2:0
;atama:
  store 
    %gt231t* %21,
    %gt231t** %20,
    align 8
  %22 = load %gt227t*, %gt227t** %11, align 8; 2:0
; Dönüş :
  ret %gt227t* %22
}
