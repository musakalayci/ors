...
define external %gt2bdt* 
@"tekil::Yeni_i"(%gt259t* %0, %gt2b8t* %1, i32 %2)#0       !dbg !915 {
; Değişken : dönüş
  %4 = alloca %gt2bdt*, align 8
  store %gt2bdt* null, %gt2bdt** %4, align 8
; Değişken : Hafıza
...
; Değişken : İfade
  ...
  call void @llvm.dbg.declare(metadata %gt2b8t** %6, metadata !920, metadata !DIExpression()), !dbg !925
; Değişken : özellik
  ...
  %9 = call i8* (%gt259t*,i64,i64) @"hafıza::t.Yeni_i" (
      ...
      i64 8), !dbg !929
; Konum çevirisi:
  %10 = bitcast i8* %9 to %gt2bdt*; 1

; pascal 'Tekil' örs::derleme::imge::tekil::t
  %11 = alloca %gt2bdt*, align 8
  store 
    %gt2bdt* %10,
    %gt2bdt** %11,
    align 8, !dbg !930
  call void @llvm.dbg.declare(metadata %gt2bdt** %11, metadata !931, metadata !DIExpression()), !dbg !932
; Atama ifadesi
  %12 = load %gt2b8t*, %gt2b8t** %6, align 8, !dbg !933; 2:0
; tür konumu *örs::derleme::imge::t : *t32
  %13 = getelementptr inbounds 
    %gt2b8t, %gt2b8t* %12,
    i32 0, i32 0
  %14 = load i32, i32* %7, align 4, !dbg !935; 1:0
  store 
    i32 %14,
    i32* %13,
    align 4, !dbg !936
; Atama ifadesi
  %15 = load %gt2b8t*, %gt2b8t** %6, align 8, !dbg !937; 2:0
...
; Konum çevirisi:
  %17 = bitcast %gt2b7t* %16 to %gt2bdt**; 2
  %18 = load %gt2bdt*, %gt2bdt** %11, align 8, !dbg !939; 2:0
  store 
    %gt2bdt* %18,
    %gt2bdt** %17,
    align 8, !dbg !940
; Atama ifadesi
  %19 = load %gt2bdt*, %gt2bdt** %11, align 8, !dbg !941; 2:0
; tür konumu *örs::derleme::imge::tekil::t : *örs::derleme::imge::t
  %20 = getelementptr inbounds 
    %gt2bdt, %gt2bdt* %19,
    i32 0, i32 1
  %21 = load %gt2b8t*, %gt2b8t** %6, align 8, !dbg !943; 2:0
  store 
    %gt2b8t* %21,
    %gt2b8t** %20,
    align 8, !dbg !944
  %22 = load %gt2bdt*, %gt2bdt** %11, align 8, !dbg !945; 2:0
; Dönüş :
  ret %gt2bdt* %22
}
...
!914 = !DINamespace(name:"tekil", scope: !913)


!916 = !DILocalVariable(name: "dönüş",
  scope: !915, file: !9, line: 15, type: !846)
!917 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !87, size: 64)
...
!920 = !DILocalVariable(name: "İfade",
  scope: !915, file: !9, line: 15, type: !919, arg: 2)
!921 = !DILocalVariable(name: "özellik",
  scope: !915, file: !9, line: 16, type: !12, arg: 3)
!922 = !DISubroutineType(types: !923)
!923 = !{null, !917, !919, !12 }
!915 = distinct !DISubprogram( name: "tekil::Yeni_i",
 scope: !914,
 file: !9,
 line: 13,
 type: !922, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!924 = !DILocation(line: 14, column: 5, scope: !915)
!925 = !DILocation(line: 15, column: 5, scope: !915)
!926 = !DILocation(line: 16, column: 5, scope: !915)
!927 = distinct !DILexicalBlock(
        scope: !915, file: !9, line: 17, column: 5)
!928 = !DILocation(line: 18, column: 33, scope: !927)
!929 = !DILocation(line: 18, column: 41, scope: !927)
!930 = !DILocation(line: 18, column: 7, scope: !927)
!931 = !DILocalVariable(name: "Tekil",
  scope: !927, file: !9, line: 18, type: !846)
!932 = !DILocation(line: 18, column: 7, scope: !927)
!933 = !DILocation(line: 19, column: 7, scope: !927)
!934 = !DILocation(line: 19, column: 7, scope: !927)
!935 = !DILocation(line: 19, column: 29, scope: !927)
!936 = !DILocation(line: 19, column: 7, scope: !927)
!937 = !DILocation(line: 20, column: 7, scope: !927)
!938 = !DILocation(line: 20, column: 7, scope: !927)
!939 = !DILocation(line: 20, column: 29, scope: !927)
!940 = !DILocation(line: 20, column: 7, scope: !927)
!941 = !DILocation(line: 21, column: 7, scope: !927)
!942 = !DILocation(line: 21, column: 7, scope: !927)
!943 = !DILocation(line: 21, column: 29, scope: !927)
!944 = !DILocation(line: 21, column: 7, scope: !927)
!945 = !DILocation(line: 22, column: 11, scope: !927)
