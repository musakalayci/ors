...
define external %gt24et* 
@"_her::Yeni_ox129i"(%gt1e2t* %0)#0       !dbg !1580 {
; Değişken : dönüş
  %2 = alloca %gt24et*, align 8
  store %gt24et* null, %gt24et** %2, align 8
; Değişken : Hafıza
  ...
  %5 = call i8* (%gt1e2t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      ...
      i64 8), !dbg !1590
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt24et*; 1

; pascal 'Her' örs::derleme::imge::_her::t
  %7 = alloca %gt24et*, align 8
  store 
    %gt24et* %6,
    %gt24et** %7,
    align 8, !dbg !1591
  call void @llvm.dbg.declare(metadata %gt24et** %7, metadata !1593, metadata !DIExpression()), !dbg !1594
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt24et*, %gt24et** %7, align 8, !dbg !1601; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt233t* %15 to %gt24et**; 2
  %17 = load %gt24et*, %gt24et** %7, align 8, !dbg !1607; 2:0
;atama:
  store 
    %gt24et* %17,
    %gt24et** %16,
    align 8, !dbg !1608
  %18 = load %gt24et*, %gt24et** %7, align 8, !dbg !1609; 2:0
; Dönüş :
  ret %gt24et* %18
}
...
!1579 = !DINamespace(name:"_her", scope: !1578)


!1581 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1479, size: 64)
...
!1584 = !DILocalVariable(name: "Hafıza",
  scope: !1580, file: !9, line: 14, type: !1583, arg: 1)
!1585 = !DISubroutineType(types: !1586)
!1586 = !{null, !1583 }
!1580 = distinct !DISubprogram( name: "_her::Yeni_ox129i",
 scope: !1579,
 file: !9,
 line: 13,
 type: !1585, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1587 = !DILocation(line: 14, column: 5, scope: !1580)
!1588 = distinct !DILexicalBlock(
        scope: !1580, file: !9, line: 15, column: 3)
!1589 = !DILocation(line: 16, column: 17, scope: !1588)
!1590 = !DILocation(line: 16, column: 25, scope: !1588)
!1591 = !DILocation(line: 16, column: 5, scope: !1588)
!1592 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1479, size: 64)
!1593 = !DILocalVariable(name: "Her",
  scope: !1588, file: !9, line: 16, type: !1592)
!1594 = !DILocation(line: 16, column: 5, scope: !1588)
!1595 = !DILocation(line: 17, column: 24, scope: !1588)
!1596 = !DILocation(line: 17, column: 19, scope: !1588)
!1597 = !DILocation(line: 17, column: 5, scope: !1588)
!1598 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1599 = !DILocalVariable(name: "İmge",
  scope: !1588, file: !9, line: 17, type: !1598)
!1600 = !DILocation(line: 17, column: 5, scope: !1588)
!1601 = !DILocation(line: 18, column: 5, scope: !1588)
!1602 = !DILocation(line: 18, column: 5, scope: !1588)
!1603 = !DILocation(line: 18, column: 15, scope: !1588)
!1604 = !DILocation(line: 18, column: 5, scope: !1588)
!1605 = !DILocation(line: 19, column: 5, scope: !1588)
!1606 = !DILocation(line: 19, column: 5, scope: !1588)
!1607 = !DILocation(line: 19, column: 24, scope: !1588)
!1608 = !DILocation(line: 19, column: 5, scope: !1588)
!1609 = !DILocation(line: 20, column: 9, scope: !1588)
