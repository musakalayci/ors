...
@"_her::Yeni_ox146i"(%gt294t* %0)#0       !dbg !1724 {
; Değişken : dönüş
...
; pascal 'Her' örs::derleme::imge::_her::t
  ...
  store 
    ...
    %gt3cat** %7,
    align 8, !dbg !1735
  call void @llvm.dbg.declare(metadata %gt3cat** %7, metadata !1737, metadata !DIExpression()), !dbg !1738
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt3cat*, %gt3cat** %7, align 8, !dbg !1745; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt397t* %15 to %gt3cat**; 2
  %17 = load %gt3cat*, %gt3cat** %7, align 8, !dbg !1751; 2:0
;atama:
  store 
    %gt3cat* %17,
    %gt3cat** %16,
    align 8, !dbg !1752
  %18 = load %gt3cat*, %gt3cat** %7, align 8, !dbg !1753; 2:0
; Dönüş :
  ret %gt3cat* %18
}
...
!1723 = !DINamespace(name:"_her", scope: !1722)


!1725 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1629, size: 64)
...
!1730 = !{null, !1727 }
!1724 = distinct !DISubprogram( name: "_her::Yeni_ox146i",
 scope: !1723,
 file: !9,
 line: 13,
 type: !1729, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1731 = !DILocation(line: 14, column: 5, scope: !1724)
!1732 = distinct !DILexicalBlock(
        scope: !1724, file: !9, line: 15, column: 3)
!1733 = !DILocation(line: 16, column: 17, scope: !1732)
!1734 = !DILocation(line: 16, column: 25, scope: !1732)
!1735 = !DILocation(line: 16, column: 5, scope: !1732)
!1736 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1629, size: 64)
!1737 = !DILocalVariable(name: "Her",
  scope: !1732, file: !9, line: 16, type: !1736)
!1738 = !DILocation(line: 16, column: 5, scope: !1732)
!1739 = !DILocation(line: 17, column: 24, scope: !1732)
!1740 = !DILocation(line: 17, column: 19, scope: !1732)
!1741 = !DILocation(line: 17, column: 5, scope: !1732)
!1742 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1743 = !DILocalVariable(name: "İmge",
  scope: !1732, file: !9, line: 17, type: !1742)
!1744 = !DILocation(line: 17, column: 5, scope: !1732)
!1745 = !DILocation(line: 18, column: 5, scope: !1732)
!1746 = !DILocation(line: 18, column: 5, scope: !1732)
!1747 = !DILocation(line: 18, column: 15, scope: !1732)
!1748 = !DILocation(line: 18, column: 5, scope: !1732)
!1749 = !DILocation(line: 19, column: 5, scope: !1732)
!1750 = !DILocation(line: 19, column: 5, scope: !1732)
!1751 = !DILocation(line: 19, column: 24, scope: !1732)
!1752 = !DILocation(line: 19, column: 5, scope: !1732)
!1753 = !DILocation(line: 20, column: 9, scope: !1732)
