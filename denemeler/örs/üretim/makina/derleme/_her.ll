...
@"_her::Yeni_ox146i"(%gt29at* %0)#0       !dbg !1807 {
; Değişken : dönüş
  %2 = alloca %gt3eft*, align 8
  store %gt3eft* null, %gt3eft** %2, align 8
; Değişken : Hafıza
  ...
  %5 = call i8* (%gt29at*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1817
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt3eft*; 1

; pascal 'Her' örs::derleme::imge::_her::t
  %7 = alloca %gt3eft*, align 8
  store 
    %gt3eft* %6,
    %gt3eft** %7,
    align 8, !dbg !1818
  call void @llvm.dbg.declare(metadata %gt3eft** %7, metadata !1820, metadata !DIExpression()), !dbg !1821
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt3eft*, %gt3eft** %7, align 8, !dbg !1828; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt3bat* %15 to %gt3eft**; 2
  %17 = load %gt3eft*, %gt3eft** %7, align 8, !dbg !1834; 2:0
;atama:
  store 
    %gt3eft* %17,
    %gt3eft** %16,
    align 8, !dbg !1835
  %18 = load %gt3eft*, %gt3eft** %7, align 8, !dbg !1836; 2:0
; Dönüş :
  ret %gt3eft* %18
}
...
!1806 = !DINamespace(name:"_her", scope: !1805)


!1808 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1696, size: 64)
...
!1813 = !{null, !1810 }
!1807 = distinct !DISubprogram( name: "_her::Yeni_ox146i",
 scope: !1806,
 file: !9,
 line: 13,
 type: !1812, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1814 = !DILocation(line: 14, column: 5, scope: !1807)
!1815 = distinct !DILexicalBlock(
        scope: !1807, file: !9, line: 15, column: 3)
!1816 = !DILocation(line: 16, column: 17, scope: !1815)
!1817 = !DILocation(line: 16, column: 25, scope: !1815)
!1818 = !DILocation(line: 16, column: 5, scope: !1815)
!1819 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1696, size: 64)
!1820 = !DILocalVariable(name: "Her",
  scope: !1815, file: !9, line: 16, type: !1819)
!1821 = !DILocation(line: 16, column: 5, scope: !1815)
!1822 = !DILocation(line: 17, column: 24, scope: !1815)
!1823 = !DILocation(line: 17, column: 19, scope: !1815)
!1824 = !DILocation(line: 17, column: 5, scope: !1815)
!1825 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1826 = !DILocalVariable(name: "İmge",
  scope: !1815, file: !9, line: 17, type: !1825)
!1827 = !DILocation(line: 17, column: 5, scope: !1815)
!1828 = !DILocation(line: 18, column: 5, scope: !1815)
!1829 = !DILocation(line: 18, column: 5, scope: !1815)
!1830 = !DILocation(line: 18, column: 15, scope: !1815)
!1831 = !DILocation(line: 18, column: 5, scope: !1815)
!1832 = !DILocation(line: 19, column: 5, scope: !1815)
!1833 = !DILocation(line: 19, column: 5, scope: !1815)
!1834 = !DILocation(line: 19, column: 24, scope: !1815)
!1835 = !DILocation(line: 19, column: 5, scope: !1815)
!1836 = !DILocation(line: 20, column: 9, scope: !1815)
