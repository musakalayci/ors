...
@"_her::Yeni_ox146i"(%gt294t* %0)#0       !dbg !1716 {
; Değişken : dönüş
...
; pascal 'Her' örs::derleme::imge::_her::t
  ...
  store 
    ...
    %gt3cat** %7,
    align 8, !dbg !1727
  call void @llvm.dbg.declare(metadata %gt3cat** %7, metadata !1729, metadata !DIExpression()), !dbg !1730
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt3cat*, %gt3cat** %7, align 8, !dbg !1737; 2:0
...
; Konum çevirisi:
  ...
  %17 = load %gt3cat*, %gt3cat** %7, align 8, !dbg !1743; 2:0
;atama:
  store 
    %gt3cat* %17,
    %gt3cat** %16,
    align 8, !dbg !1744
  %18 = load %gt3cat*, %gt3cat** %7, align 8, !dbg !1745; 2:0
; Dönüş :
  ret %gt3cat* %18
}
...
!1715 = !DINamespace(name:"_her", scope: !1714)


!1717 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1620, size: 64)
...
!1722 = !{null, !1719 }
!1716 = distinct !DISubprogram( name: "_her::Yeni_ox146i",
 scope: !1715,
 file: !9,
 line: 13,
 type: !1721, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1723 = !DILocation(line: 14, column: 5, scope: !1716)
!1724 = distinct !DILexicalBlock(
        scope: !1716, file: !9, line: 15, column: 3)
!1725 = !DILocation(line: 16, column: 17, scope: !1724)
!1726 = !DILocation(line: 16, column: 25, scope: !1724)
!1727 = !DILocation(line: 16, column: 5, scope: !1724)
!1728 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1620, size: 64)
!1729 = !DILocalVariable(name: "Her",
  scope: !1724, file: !9, line: 16, type: !1728)
!1730 = !DILocation(line: 16, column: 5, scope: !1724)
!1731 = !DILocation(line: 17, column: 24, scope: !1724)
!1732 = !DILocation(line: 17, column: 19, scope: !1724)
!1733 = !DILocation(line: 17, column: 5, scope: !1724)
!1734 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1735 = !DILocalVariable(name: "İmge",
  scope: !1724, file: !9, line: 17, type: !1734)
!1736 = !DILocation(line: 17, column: 5, scope: !1724)
!1737 = !DILocation(line: 18, column: 5, scope: !1724)
!1738 = !DILocation(line: 18, column: 5, scope: !1724)
!1739 = !DILocation(line: 18, column: 15, scope: !1724)
!1740 = !DILocation(line: 18, column: 5, scope: !1724)
!1741 = !DILocation(line: 19, column: 5, scope: !1724)
!1742 = !DILocation(line: 19, column: 5, scope: !1724)
!1743 = !DILocation(line: 19, column: 24, scope: !1724)
!1744 = !DILocation(line: 19, column: 5, scope: !1724)
!1745 = !DILocation(line: 20, column: 9, scope: !1724)
