...
@"_her::Yeni_ox146i"(%gt294t* %0)#0       !dbg !1764 {
; Değişken : dönüş
  %2 = alloca %gt3d6t*, align 8
  store %gt3d6t* null, %gt3d6t** %2, align 8
; Değişken : Hafıza
  ...
  %5 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1774
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt3d6t*; 1

; pascal 'Her' örs::derleme::imge::_her::t
  %7 = alloca %gt3d6t*, align 8
  store 
    %gt3d6t* %6,
    %gt3d6t** %7,
    align 8, !dbg !1775
  call void @llvm.dbg.declare(metadata %gt3d6t** %7, metadata !1777, metadata !DIExpression()), !dbg !1778
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt3d6t*, %gt3d6t** %7, align 8, !dbg !1785; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt3a1t* %15 to %gt3d6t**; 2
  %17 = load %gt3d6t*, %gt3d6t** %7, align 8, !dbg !1791; 2:0
;atama:
  store 
    %gt3d6t* %17,
    %gt3d6t** %16,
    align 8, !dbg !1792
  %18 = load %gt3d6t*, %gt3d6t** %7, align 8, !dbg !1793; 2:0
; Dönüş :
  ret %gt3d6t* %18
}
...
!1763 = !DINamespace(name:"_her", scope: !1762)


!1765 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1667, size: 64)
...
!1770 = !{null, !1767 }
!1764 = distinct !DISubprogram( name: "_her::Yeni_ox146i",
 scope: !1763,
 file: !9,
 line: 13,
 type: !1769, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1771 = !DILocation(line: 14, column: 5, scope: !1764)
!1772 = distinct !DILexicalBlock(
        scope: !1764, file: !9, line: 15, column: 3)
!1773 = !DILocation(line: 16, column: 17, scope: !1772)
!1774 = !DILocation(line: 16, column: 25, scope: !1772)
!1775 = !DILocation(line: 16, column: 5, scope: !1772)
!1776 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1667, size: 64)
!1777 = !DILocalVariable(name: "Her",
  scope: !1772, file: !9, line: 16, type: !1776)
!1778 = !DILocation(line: 16, column: 5, scope: !1772)
!1779 = !DILocation(line: 17, column: 24, scope: !1772)
!1780 = !DILocation(line: 17, column: 19, scope: !1772)
!1781 = !DILocation(line: 17, column: 5, scope: !1772)
!1782 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1783 = !DILocalVariable(name: "İmge",
  scope: !1772, file: !9, line: 17, type: !1782)
!1784 = !DILocation(line: 17, column: 5, scope: !1772)
!1785 = !DILocation(line: 18, column: 5, scope: !1772)
!1786 = !DILocation(line: 18, column: 5, scope: !1772)
!1787 = !DILocation(line: 18, column: 15, scope: !1772)
!1788 = !DILocation(line: 18, column: 5, scope: !1772)
!1789 = !DILocation(line: 19, column: 5, scope: !1772)
!1790 = !DILocation(line: 19, column: 5, scope: !1772)
!1791 = !DILocation(line: 19, column: 24, scope: !1772)
!1792 = !DILocation(line: 19, column: 5, scope: !1772)
!1793 = !DILocation(line: 20, column: 9, scope: !1772)
