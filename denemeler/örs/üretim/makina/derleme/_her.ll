...
@"_her::Yeni_ox146i"(%gt296t* %0)#0       !dbg !1790 {
; Değişken : dönüş
  %2 = alloca %gt3dat*, align 8
  store %gt3dat* null, %gt3dat** %2, align 8
; Değişken : Hafıza
...
; pascal 'Her' örs::derleme::imge::_her::t
  ...
  store 
    ...
    %gt3dat** %7,
    align 8, !dbg !1801
  call void @llvm.dbg.declare(metadata %gt3dat** %7, metadata !1803, metadata !DIExpression()), !dbg !1804
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt3dat*, %gt3dat** %7, align 8, !dbg !1811; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt3a5t* %15 to %gt3dat**; 2
  %17 = load %gt3dat*, %gt3dat** %7, align 8, !dbg !1817; 2:0
;atama:
  store 
    %gt3dat* %17,
    %gt3dat** %16,
    align 8, !dbg !1818
  %18 = load %gt3dat*, %gt3dat** %7, align 8, !dbg !1819; 2:0
; Dönüş :
  ret %gt3dat* %18
}
...
!1789 = !DINamespace(name:"_her", scope: !1788)


!1791 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1690, size: 64)
...
!1796 = !{null, !1793 }
!1790 = distinct !DISubprogram( name: "_her::Yeni_ox146i",
 scope: !1789,
 file: !9,
 line: 13,
 type: !1795, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1797 = !DILocation(line: 14, column: 5, scope: !1790)
!1798 = distinct !DILexicalBlock(
        scope: !1790, file: !9, line: 15, column: 3)
!1799 = !DILocation(line: 16, column: 17, scope: !1798)
!1800 = !DILocation(line: 16, column: 25, scope: !1798)
!1801 = !DILocation(line: 16, column: 5, scope: !1798)
!1802 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1690, size: 64)
!1803 = !DILocalVariable(name: "Her",
  scope: !1798, file: !9, line: 16, type: !1802)
!1804 = !DILocation(line: 16, column: 5, scope: !1798)
!1805 = !DILocation(line: 17, column: 24, scope: !1798)
!1806 = !DILocation(line: 17, column: 19, scope: !1798)
!1807 = !DILocation(line: 17, column: 5, scope: !1798)
!1808 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1809 = !DILocalVariable(name: "İmge",
  scope: !1798, file: !9, line: 17, type: !1808)
!1810 = !DILocation(line: 17, column: 5, scope: !1798)
!1811 = !DILocation(line: 18, column: 5, scope: !1798)
!1812 = !DILocation(line: 18, column: 5, scope: !1798)
!1813 = !DILocation(line: 18, column: 15, scope: !1798)
!1814 = !DILocation(line: 18, column: 5, scope: !1798)
!1815 = !DILocation(line: 19, column: 5, scope: !1798)
!1816 = !DILocation(line: 19, column: 5, scope: !1798)
!1817 = !DILocation(line: 19, column: 24, scope: !1798)
!1818 = !DILocation(line: 19, column: 5, scope: !1798)
!1819 = !DILocation(line: 20, column: 9, scope: !1798)
