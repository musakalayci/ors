...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    align 8
; Atama ifadesi
  %11 = load %gt24bt*, %gt24bt** %7, align 8; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt230t* %15 to %gt24bt**; 2
  %17 = load %gt24bt*, %gt24bt** %7, align 8; 2:0
;atama:
  store 
    %gt24bt* %17,
    %gt24bt** %16,
    align 8
  %18 = load %gt24bt*, %gt24bt** %7, align 8; 2:0
; Dönüş :
  ret %gt24bt* %18
}
