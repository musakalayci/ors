...
define external %gt25at* 
@"çağrı::Yeni_ox12Di"(%gt1e2t* %0, %metin* %1)#0       !dbg !1580 {
; Değişken : dönüş
  %3 = alloca %gt25at*, align 8
  store %gt25at* null, %gt25at** %3, align 8
; Değişken : Hafıza
  %4 = alloca %gt1e2t*, align 8
  store %gt1e2t* %0, %gt1e2t** %4, align 8
  call void @llvm.dbg.declare(metadata %gt1e2t** %4, metadata !1583, metadata !DIExpression()), !dbg !1588
; Değişken : Ad
  %5 = alloca %metin*, align 8
  store %metin* %1, %metin** %5, align 8
  call void @llvm.dbg.declare(metadata %metin** %5, metadata !1585, metadata !DIExpression()), !dbg !1589
;;-> (nil) 0
  %6 = load %gt1e2t*, %gt1e2t** %4, align 8, !dbg !1591; 2:0
;;-> (nil) 0
  %7 = load %metin*, %metin** %5, align 8, !dbg !1592; 2:0
;;-> (nil) 0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt234t** %9,
    align 8, !dbg !1594
  call void @llvm.dbg.declare(metadata %gt234t** %9, metadata !1596, metadata !DIExpression()), !dbg !1597
  %10 = load %gt1e2t*, %gt1e2t** %4, align 8, !dbg !1598; 2:0
  %11 = call i8* (%gt1e2t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      %gt1e2t* %10, 
      i64 24, 
      i64 8), !dbg !1599
; Konum çevirisi:
  %12 = bitcast i8* %11 to %gt25at*; 1
...
; pascal 'Çağrı' örs::derleme::imge::çağrı::t
  ...
  store 
    ...
    %gt25at** %13,
    align 8, !dbg !1600
  call void @llvm.dbg.declare(metadata %gt25at** %13, metadata !1601, metadata !DIExpression()), !dbg !1602
; Atama ifadesi
  %14 = load %gt234t*, %gt234t** %9, align 8, !dbg !1603; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt233t* %15 to %gt25at**; 2
  %17 = load %gt25at*, %gt25at** %13, align 8, !dbg !1605; 2:0
;atama:
  store 
    %gt25at* %17,
    %gt25at** %16,
    align 8, !dbg !1606
; Atama ifadesi
  %18 = load %gt25at*, %gt25at** %13, align 8, !dbg !1607; 2:0
; tür konumu *örs::derleme::imge::çağrı::t : *örs::derleme::imge::t
  %19 = getelementptr inbounds 
    %gt25at, %gt25at* %18,
    i32 0, i32 0
  %20 = load %gt234t*, %gt234t** %9, align 8, !dbg !1609; 2:0
;atama:
  store 
    %gt234t* %20,
    %gt234t** %19,
    align 8, !dbg !1610
; Atama ifadesi
  %21 = load %gt25at*, %gt25at** %13, align 8, !dbg !1611; 2:0
; tür konumu *örs::derleme::imge::çağrı::t : *örs::derleme::imge::k[%st437_1gt234t]
  %22 = getelementptr inbounds 
    %gt25at, %gt25at* %21,
    i32 0, i32 2
  %23 = load %gt1e2t*, %gt1e2t** %4, align 8, !dbg !1613; 2:0
  %24 = call i8* (%gt1e2t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      %gt1e2t* %23, 
      i64 24, 
      i64 8), !dbg !1614
; Konum çevirisi:
  %25 = bitcast i8* %24 to %st437_1gt234t*; 1
;atama:
  store 
    %st437_1gt234t* %25,
    %st437_1gt234t** %22,
    align 8, !dbg !1615
  %26 = load %gt25at*, %gt25at** %13, align 8, !dbg !1616; 2:0
; tür konumu *örs::derleme::imge::çağrı::t : *örs::derleme::imge::k[%st437_1gt234t]
  %27 = getelementptr inbounds 
    %gt25at, %gt25at* %26,
    i32 0, i32 2
  %28 = load %st437_1gt234t*, %st437_1gt234t** %27, align 8, !dbg !1618; 2:0
;;-> (nil) 0
  %29 = load %gt1e2t*, %gt1e2t** %4, align 8, !dbg !1619; 2:0
 call void @"imge::imgeler.Yapılandır_ox10ai" (
      %st437_1gt234t* %28, 
      %gt1e2t* %29, 
      i32 32), !dbg !1620
  %30 = load %gt25at*, %gt25at** %13, align 8, !dbg !1621; 2:0
; Dönüş :
  ret %gt25at* %30
}
...
!1579 = !DINamespace(name:"çağrı", scope: !1578)


!1581 = !DILocalVariable(name: "dönüş",
  scope: !1580, file: !9, line: 15, type: !1399)
...
!1583 = !DILocalVariable(name: "Hafıza",
  scope: !1580, file: !9, line: 11, type: !1582, arg: 1)
!1585 = !DILocalVariable(name: "Ad",
  scope: !1580, file: !9, line: 11, type: !1584, arg: 2)
!1586 = !DISubroutineType(types: !1587)
!1587 = !{null, !1582, !1584 }
!1580 = distinct !DISubprogram( name: "çağrı::Yeni_ox12Di",
 scope: !1579,
 file: !9,
 line: 11,
 type: !1586, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1588 = !DILocation(line: 11, column: 19, scope: !1580)
!1589 = !DILocation(line: 11, column: 38, scope: !1580)
!1590 = distinct !DILexicalBlock(
        scope: !1580, file: !9, line: 12, column: 3)
!1591 = !DILocation(line: 13, column: 24, scope: !1590)
!1592 = !DILocation(line: 13, column: 32, scope: !1590)
!1593 = !DILocation(line: 13, column: 19, scope: !1590)
!1594 = !DILocation(line: 13, column: 5, scope: !1590)
!1595 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1596 = !DILocalVariable(name: "İmge",
  scope: !1590, file: !9, line: 13, type: !1595)
!1597 = !DILocation(line: 13, column: 5, scope: !1590)
!1598 = !DILocation(line: 14, column: 18, scope: !1590)
!1599 = !DILocation(line: 14, column: 26, scope: !1590)
!1600 = !DILocation(line: 14, column: 5, scope: !1590)
!1601 = !DILocalVariable(name: "Çağrı",
  scope: !1590, file: !9, line: 14, type: !1399)
!1602 = !DILocation(line: 14, column: 5, scope: !1590)
!1603 = !DILocation(line: 15, column: 5, scope: !1590)
!1604 = !DILocation(line: 15, column: 5, scope: !1590)
!1605 = !DILocation(line: 15, column: 26, scope: !1590)
!1606 = !DILocation(line: 15, column: 5, scope: !1590)
!1607 = !DILocation(line: 16, column: 5, scope: !1590)
!1608 = !DILocation(line: 16, column: 5, scope: !1590)
!1609 = !DILocation(line: 16, column: 26, scope: !1590)
!1610 = !DILocation(line: 16, column: 5, scope: !1590)
!1611 = !DILocation(line: 17, column: 5, scope: !1590)
!1612 = !DILocation(line: 17, column: 5, scope: !1590)
!1613 = !DILocation(line: 17, column: 42, scope: !1590)
!1614 = !DILocation(line: 17, column: 50, scope: !1590)
!1615 = !DILocation(line: 17, column: 5, scope: !1590)
!1616 = !DILocation(line: 18, column: 5, scope: !1590)
!1617 = !DILocation(line: 18, column: 5, scope: !1590)
!1618 = !DILocation(line: 18, column: 5, scope: !1590)
!1619 = !DILocation(line: 18, column: 35, scope: !1590)
!1620 = !DILocation(line: 18, column: 24, scope: !1590)
!1621 = !DILocation(line: 19, column: 9, scope: !1590)
