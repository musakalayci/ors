...
define external %gt257t* 
@"çağrı::Yeni_ox12Di"(%gt1e0t* %0, %metin* %1)#0       {
; Değişken : dönüş
  %3 = alloca %gt257t*, align 8
  store %gt257t* null, %gt257t** %3, align 8
; Değişken : Hafıza
...
; Konum çevirisi:
  %16 = bitcast %gt230t* %15 to %gt257t**; 2
  %17 = load %gt257t*, %gt257t** %13, align 8; 2:0
;atama:
  store 
    %gt257t* %17,
    %gt257t** %16,
    align 8
; Atama ifadesi
  %18 = load %gt257t*, %gt257t** %13, align 8; 2:0
...
;atama:
  store 
    ...
    align 8
; Atama ifadesi
  %21 = load %gt257t*, %gt257t** %13, align 8; 2:0
; tür konumu *örs::derleme::imge::çağrı::t : *örs::derleme::imge::k[%st435_1gt231t]
  ...
  %24 = call i8* (%gt1e0t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      ...
      i64 8)
; Konum çevirisi:
  %25 = bitcast i8* %24 to %st435_1gt231t*; 1
;atama:
  store 
    %st435_1gt231t* %25,
    %st435_1gt231t** %22,
    align 8
  %26 = load %gt257t*, %gt257t** %13, align 8; 2:0
; tür konumu *örs::derleme::imge::çağrı::t : *örs::derleme::imge::k[%st435_1gt231t]
  %27 = getelementptr inbounds 
    %gt257t, %gt257t* %26,
    i32 0, i32 2
  %28 = load %st435_1gt231t*, %st435_1gt231t** %27, align 8; 2:0
;;-> (nil) 0
  %29 = load %gt1e0t*, %gt1e0t** %4, align 8; 2:0
 call void @"imge::imgeler.Yapılandır_ox10ai" (
      %st435_1gt231t* %28, 
      %gt1e0t* %29, 
      i32 32)
  %30 = load %gt257t*, %gt257t** %13, align 8; 2:0
; Dönüş :
  ret %gt257t* %30
}
