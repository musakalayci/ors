...
define external %gt2e9t* 
@"çağrı::Yeni_i"(%gt263t* %0, %metin* %1)#0       !dbg !1144 {
; Değişken : dönüş
  %3 = alloca %gt2e9t*, align 8
  store %gt2e9t* null, %gt2e9t** %3, align 8
; Değişken : Hafıza
...
; pascal 'Çağrı' örs::derleme::imge::çağrı::t
  ...
  store 
    ...
    %gt2e9t** %13,
    align 8, !dbg !1165
  call void @llvm.dbg.declare(metadata %gt2e9t** %13, metadata !1167, metadata !DIExpression()), !dbg !1168
; Atama ifadesi
  %14 = load %gt2c2t*, %gt2c2t** %9, align 8, !dbg !1169; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt2c1t* %15 to %gt2e9t**; 2
  %17 = load %gt2e9t*, %gt2e9t** %13, align 8, !dbg !1171; 2:0
  store 
    %gt2e9t* %17,
    %gt2e9t** %16,
    align 8, !dbg !1172
; Atama ifadesi
  %18 = load %gt2e9t*, %gt2e9t** %13, align 8, !dbg !1173; 2:0
; tür konumu *örs::derleme::imge::çağrı::t : *örs::derleme::imge::t
  %19 = getelementptr inbounds 
    %gt2e9t, %gt2e9t* %18,
    i32 0, i32 0
  %20 = load %gt2c2t*, %gt2c2t** %9, align 8, !dbg !1175; 2:0
  store 
    %gt2c2t* %20,
    %gt2c2t** %19,
    align 8, !dbg !1176
; Atama ifadesi
  %21 = load %gt2e9t*, %gt2e9t** %13, align 8, !dbg !1177; 2:0
; tür konumu *örs::derleme::imge::çağrı::t : *örs::derleme::imge::k[%st586_1gt2c2t]
  ...
  %24 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      ...
      i64 8), !dbg !1180
; Konum çevirisi:
  %25 = bitcast i8* %24 to %st586_1gt2c2t*; 1
  store 
    %st586_1gt2c2t* %25,
    %st586_1gt2c2t** %22,
    align 8, !dbg !1181
  %26 = load %gt2e9t*, %gt2e9t** %13, align 8, !dbg !1182; 2:0
; tür konumu *örs::derleme::imge::çağrı::t : *örs::derleme::imge::k[%st586_1gt2c2t]
  %27 = getelementptr inbounds 
    %gt2e9t, %gt2e9t* %26,
    i32 0, i32 2
  %28 = load %st586_1gt2c2t*, %st586_1gt2c2t** %27, align 8, !dbg !1184; 2:0
;;-> (nil) 0
  %29 = load %gt263t*, %gt263t** %4, align 8, !dbg !1185; 2:0
 call void @"imge::imgeler.Yapılandır_i" (
      %st586_1gt2c2t* %28, 
      %gt263t* %29, 
      i32 32), !dbg !1186
  %30 = load %gt2e9t*, %gt2e9t** %13, align 8, !dbg !1187; 2:0
; Dönüş :
  ret %gt2e9t* %30
}
...
!1143 = !DINamespace(name:"çağrı", scope: !1142)


!1145 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !936, size: 64)
...
!1148 = !DILocalVariable(name: "Hafıza",
  scope: !1144, file: !9, line: 11, type: !1147, arg: 1)
!1150 = !DILocalVariable(name: "Ad",
  scope: !1144, file: !9, line: 11, type: !1149, arg: 2)
!1151 = !DISubroutineType(types: !1152)
!1152 = !{null, !1147, !1149 }
!1144 = distinct !DISubprogram( name: "çağrı::Yeni_i",
 scope: !1143,
 file: !9,
 line: 11,
 type: !1151, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1153 = !DILocation(line: 11, column: 19, scope: !1144)
!1154 = !DILocation(line: 11, column: 38, scope: !1144)
!1155 = distinct !DILexicalBlock(
        scope: !1144, file: !9, line: 12, column: 3)
!1156 = !DILocation(line: 13, column: 24, scope: !1155)
!1157 = !DILocation(line: 13, column: 32, scope: !1155)
!1158 = !DILocation(line: 13, column: 19, scope: !1155)
!1159 = !DILocation(line: 13, column: 5, scope: !1155)
!1160 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1161 = !DILocalVariable(name: "İmge",
  scope: !1155, file: !9, line: 13, type: !1160)
!1162 = !DILocation(line: 13, column: 5, scope: !1155)
!1163 = !DILocation(line: 14, column: 18, scope: !1155)
!1164 = !DILocation(line: 14, column: 26, scope: !1155)
!1165 = !DILocation(line: 14, column: 5, scope: !1155)
!1166 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !936, size: 64)
!1167 = !DILocalVariable(name: "Çağrı",
  scope: !1155, file: !9, line: 14, type: !1166)
!1168 = !DILocation(line: 14, column: 5, scope: !1155)
!1169 = !DILocation(line: 15, column: 5, scope: !1155)
!1170 = !DILocation(line: 15, column: 5, scope: !1155)
!1171 = !DILocation(line: 15, column: 26, scope: !1155)
!1172 = !DILocation(line: 15, column: 5, scope: !1155)
!1173 = !DILocation(line: 16, column: 5, scope: !1155)
!1174 = !DILocation(line: 16, column: 5, scope: !1155)
!1175 = !DILocation(line: 16, column: 26, scope: !1155)
!1176 = !DILocation(line: 16, column: 5, scope: !1155)
!1177 = !DILocation(line: 17, column: 5, scope: !1155)
!1178 = !DILocation(line: 17, column: 5, scope: !1155)
!1179 = !DILocation(line: 17, column: 42, scope: !1155)
!1180 = !DILocation(line: 17, column: 50, scope: !1155)
!1181 = !DILocation(line: 17, column: 5, scope: !1155)
!1182 = !DILocation(line: 18, column: 5, scope: !1155)
!1183 = !DILocation(line: 18, column: 5, scope: !1155)
!1184 = !DILocation(line: 18, column: 5, scope: !1155)
!1185 = !DILocation(line: 18, column: 35, scope: !1155)
!1186 = !DILocation(line: 18, column: 24, scope: !1155)
!1187 = !DILocation(line: 19, column: 9, scope: !1155)
