...
define external %gt2d8t* 
@"temel::Yeni_i"(%gt263t* %0, %gt2c2t* %1)#0       !dbg !1144 {
; Değişken : dönüş
  %3 = alloca %gt2d8t*, align 8
  store %gt2d8t* null, %gt2d8t** %3, align 8
; Değişken : Hafıza
...
; Değişken : İfade
  ...
  %7 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      ...
      i64 8), !dbg !1157
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt2d8t*; 1

; pascal 'Temel' örs::derleme::imge::temel::t
  %9 = alloca %gt2d8t*, align 8
  store 
    %gt2d8t* %8,
    %gt2d8t** %9,
    align 8, !dbg !1158
  call void @llvm.dbg.declare(metadata %gt2d8t** %9, metadata !1160, metadata !DIExpression()), !dbg !1161
; Atama ifadesi
  %10 = load %gt2c2t*, %gt2c2t** %5, align 8, !dbg !1162; 2:0
...
; Konum çevirisi:
  %12 = bitcast %gt2c1t* %11 to %gt2d8t**; 2
  %13 = load %gt2d8t*, %gt2d8t** %9, align 8, !dbg !1164; 2:0
  store 
    %gt2d8t* %13,
    %gt2d8t** %12,
    align 8, !dbg !1165
; Atama ifadesi
  %14 = load %gt2d8t*, %gt2d8t** %9, align 8, !dbg !1166; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt2d8t, %gt2d8t* %14,
    i32 0, i32 1
  %16 = load %gt2c2t*, %gt2c2t** %5, align 8, !dbg !1168; 2:0
  store 
    %gt2c2t* %16,
    %gt2c2t** %15,
    align 8, !dbg !1169
  %17 = load %gt2d8t*, %gt2d8t** %9, align 8, !dbg !1170; 2:0
; Dönüş :
  ret %gt2d8t* %17
}
...
!1143 = !DINamespace(name:"temel", scope: !1142)


!1145 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !888, size: 64)
...
!1148 = !DILocalVariable(name: "Hafıza",
  scope: !1144, file: !9, line: 62, type: !1147, arg: 1)
!1150 = !DILocalVariable(name: "İfade",
  scope: !1144, file: !9, line: 63, type: !1149, arg: 2)
!1151 = !DISubroutineType(types: !1152)
!1152 = !{null, !1147, !1149 }
!1144 = distinct !DISubprogram( name: "temel::Yeni_i",
 scope: !1143,
 file: !9,
 line: 61,
 type: !1151, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1153 = !DILocation(line: 62, column: 5, scope: !1144)
!1154 = !DILocation(line: 63, column: 5, scope: !1144)
!1155 = distinct !DILexicalBlock(
        scope: !1144, file: !9, line: 64, column: 5)
!1156 = !DILocation(line: 65, column: 33, scope: !1155)
!1157 = !DILocation(line: 65, column: 41, scope: !1155)
!1158 = !DILocation(line: 65, column: 7, scope: !1155)
!1159 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !888, size: 64)
!1160 = !DILocalVariable(name: "Temel",
  scope: !1155, file: !9, line: 65, type: !1159)
!1161 = !DILocation(line: 65, column: 7, scope: !1155)
!1162 = !DILocation(line: 66, column: 7, scope: !1155)
!1163 = !DILocation(line: 66, column: 7, scope: !1155)
!1164 = !DILocation(line: 66, column: 29, scope: !1155)
!1165 = !DILocation(line: 66, column: 7, scope: !1155)
!1166 = !DILocation(line: 67, column: 7, scope: !1155)
!1167 = !DILocation(line: 67, column: 7, scope: !1155)
!1168 = !DILocation(line: 67, column: 29, scope: !1155)
!1169 = !DILocation(line: 67, column: 7, scope: !1155)
!1170 = !DILocation(line: 68, column: 11, scope: !1155)
