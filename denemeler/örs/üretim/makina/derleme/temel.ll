...
@"temel::Yeni_ox149i"(%gt294t* %0, %gt3a2t* %1)#0       !dbg !1764 {
; Değişken : dönüş
  %3 = alloca %gt3det*, align 8
  store %gt3det* null, %gt3det** %3, align 8
; Değişken : Hafıza
...
; Değişken : İfade
  ...
  %7 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1777
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt3det*; 1

; pascal 'Temel' örs::derleme::imge::temel::t
  %9 = alloca %gt3det*, align 8
  store 
    %gt3det* %8,
    %gt3det** %9,
    align 8, !dbg !1778
  call void @llvm.dbg.declare(metadata %gt3det** %9, metadata !1780, metadata !DIExpression()), !dbg !1781
; Atama ifadesi
  %10 = load %gt3a2t*, %gt3a2t** %5, align 8, !dbg !1782; 2:0
...
; Konum çevirisi:
  ...
  %13 = load %gt3det*, %gt3det** %9, align 8, !dbg !1784; 2:0
;atama:
  store 
    %gt3det* %13,
    %gt3det** %12,
    align 8, !dbg !1785
; Atama ifadesi
  %14 = load %gt3det*, %gt3det** %9, align 8, !dbg !1786; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt3det, %gt3det* %14,
    i32 0, i32 1
  %16 = load %gt3a2t*, %gt3a2t** %5, align 8, !dbg !1788; 2:0
;atama:
  store 
    %gt3a2t* %16,
    %gt3a2t** %15,
    align 8, !dbg !1789
  %17 = load %gt3det*, %gt3det** %9, align 8, !dbg !1790; 2:0
; Dönüş :
  ret %gt3det* %17
}
...
!1763 = !DINamespace(name:"temel", scope: !1762)


!1765 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1474, size: 64)
...
!1768 = !DILocalVariable(name: "Hafıza",
  scope: !1764, file: !9, line: 42, type: !1767, arg: 1)
!1770 = !DILocalVariable(name: "İfade",
  scope: !1764, file: !9, line: 43, type: !1769, arg: 2)
!1771 = !DISubroutineType(types: !1772)
!1772 = !{null, !1767, !1769 }
!1764 = distinct !DISubprogram( name: "temel::Yeni_ox149i",
 scope: !1763,
 file: !9,
 line: 41,
 type: !1771, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1773 = !DILocation(line: 42, column: 5, scope: !1764)
!1774 = !DILocation(line: 43, column: 5, scope: !1764)
!1775 = distinct !DILexicalBlock(
        scope: !1764, file: !9, line: 44, column: 5)
!1776 = !DILocation(line: 45, column: 33, scope: !1775)
!1777 = !DILocation(line: 45, column: 41, scope: !1775)
!1778 = !DILocation(line: 45, column: 7, scope: !1775)
!1779 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1474, size: 64)
!1780 = !DILocalVariable(name: "Temel",
  scope: !1775, file: !9, line: 45, type: !1779)
!1781 = !DILocation(line: 45, column: 7, scope: !1775)
!1782 = !DILocation(line: 46, column: 7, scope: !1775)
!1783 = !DILocation(line: 46, column: 7, scope: !1775)
!1784 = !DILocation(line: 46, column: 29, scope: !1775)
!1785 = !DILocation(line: 46, column: 7, scope: !1775)
!1786 = !DILocation(line: 47, column: 7, scope: !1775)
!1787 = !DILocation(line: 47, column: 7, scope: !1775)
!1788 = !DILocation(line: 47, column: 29, scope: !1775)
!1789 = !DILocation(line: 47, column: 7, scope: !1775)
!1790 = !DILocation(line: 48, column: 11, scope: !1775)
