...
@"temel::Yeni_i"(%gt259t* %0, %gt2b8t* %1)#0       !dbg !915 {
; Değişken : dönüş
...
; pascal 'Temel' örs::derleme::imge::temel::t
  ...
  store 
    ...
    %gt2bft** %9,
    align 8, !dbg !929
  call void @llvm.dbg.declare(metadata %gt2bft** %9, metadata !931, metadata !DIExpression()), !dbg !932
; Atama ifadesi
  %10 = load %gt2b8t*, %gt2b8t** %5, align 8, !dbg !933; 2:0
...
; Konum çevirisi:
  %12 = bitcast %gt2b7t* %11 to %gt2bft**; 2
  %13 = load %gt2bft*, %gt2bft** %9, align 8, !dbg !935; 2:0
  store 
    %gt2bft* %13,
    %gt2bft** %12,
    align 8, !dbg !936
; Atama ifadesi
  %14 = load %gt2bft*, %gt2bft** %9, align 8, !dbg !937; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt2bft, %gt2bft* %14,
    i32 0, i32 1
  %16 = load %gt2b8t*, %gt2b8t** %5, align 8, !dbg !939; 2:0
  store 
    %gt2b8t* %16,
    %gt2b8t** %15,
    align 8, !dbg !940
  %17 = load %gt2bft*, %gt2bft** %9, align 8, !dbg !941; 2:0
; Dönüş :
  ret %gt2bft* %17
}
...
!914 = !DINamespace(name:"temel", scope: !913)


!916 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !854, size: 64)
...
!919 = !DILocalVariable(name: "Hafıza",
  scope: !915, file: !9, line: 39, type: !918, arg: 1)
!921 = !DILocalVariable(name: "İfade",
  scope: !915, file: !9, line: 40, type: !920, arg: 2)
!922 = !DISubroutineType(types: !923)
!923 = !{null, !918, !920 }
!915 = distinct !DISubprogram( name: "temel::Yeni_i",
 scope: !914,
 file: !9,
 line: 38,
 type: !922, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!924 = !DILocation(line: 39, column: 5, scope: !915)
!925 = !DILocation(line: 40, column: 5, scope: !915)
!926 = distinct !DILexicalBlock(
        scope: !915, file: !9, line: 41, column: 5)
!927 = !DILocation(line: 42, column: 33, scope: !926)
!928 = !DILocation(line: 42, column: 41, scope: !926)
!929 = !DILocation(line: 42, column: 7, scope: !926)
!930 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !854, size: 64)
!931 = !DILocalVariable(name: "Temel",
  scope: !926, file: !9, line: 42, type: !930)
!932 = !DILocation(line: 42, column: 7, scope: !926)
!933 = !DILocation(line: 43, column: 7, scope: !926)
!934 = !DILocation(line: 43, column: 7, scope: !926)
!935 = !DILocation(line: 43, column: 29, scope: !926)
!936 = !DILocation(line: 43, column: 7, scope: !926)
!937 = !DILocation(line: 44, column: 7, scope: !926)
!938 = !DILocation(line: 44, column: 7, scope: !926)
!939 = !DILocation(line: 44, column: 29, scope: !926)
!940 = !DILocation(line: 44, column: 7, scope: !926)
!941 = !DILocation(line: 45, column: 11, scope: !926)
