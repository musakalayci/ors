...
define external %gt22ct* 
@"temel::Yeni_ox125i"(%gt1e2t* %0, %gt234t* %1)#0       !dbg !1580 {
; Değişken : dönüş
  %3 = alloca %gt22ct*, align 8
  store %gt22ct* null, %gt22ct** %3, align 8
; Değişken : Hafıza
...
; Değişken : İfade
  ...
  %7 = call i8* (%gt1e2t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      ...
      i64 8), !dbg !1593
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt22ct*; 1

; pascal 'Temel' örs::derleme::imge::temel::t
  %9 = alloca %gt22ct*, align 8
  store 
    %gt22ct* %8,
    %gt22ct** %9,
    align 8, !dbg !1594
  call void @llvm.dbg.declare(metadata %gt22ct** %9, metadata !1596, metadata !DIExpression()), !dbg !1597
; Atama ifadesi
  %10 = load %gt234t*, %gt234t** %5, align 8, !dbg !1598; 2:0
...
; Konum çevirisi:
  ...
  %13 = load %gt22ct*, %gt22ct** %9, align 8, !dbg !1600; 2:0
;atama:
  store 
    %gt22ct* %13,
    %gt22ct** %12,
    align 8, !dbg !1601
; Atama ifadesi
  %14 = load %gt22ct*, %gt22ct** %9, align 8, !dbg !1602; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt22ct, %gt22ct* %14,
    i32 0, i32 1
  %16 = load %gt234t*, %gt234t** %5, align 8, !dbg !1604; 2:0
;atama:
  store 
    %gt234t* %16,
    %gt234t** %15,
    align 8, !dbg !1605
  %17 = load %gt22ct*, %gt22ct** %9, align 8, !dbg !1606; 2:0
; Dönüş :
  ret %gt22ct* %17
}
...
!1579 = !DINamespace(name:"temel", scope: !1578)


!1581 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1331, size: 64)
...
!1584 = !DILocalVariable(name: "Hafıza",
  scope: !1580, file: !9, line: 42, type: !1583, arg: 1)
!1586 = !DILocalVariable(name: "İfade",
  scope: !1580, file: !9, line: 43, type: !1585, arg: 2)
!1587 = !DISubroutineType(types: !1588)
!1588 = !{null, !1583, !1585 }
!1580 = distinct !DISubprogram( name: "temel::Yeni_ox125i",
 scope: !1579,
 file: !9,
 line: 41,
 type: !1587, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1589 = !DILocation(line: 42, column: 5, scope: !1580)
!1590 = !DILocation(line: 43, column: 5, scope: !1580)
!1591 = distinct !DILexicalBlock(
        scope: !1580, file: !9, line: 44, column: 5)
!1592 = !DILocation(line: 45, column: 33, scope: !1591)
!1593 = !DILocation(line: 45, column: 41, scope: !1591)
!1594 = !DILocation(line: 45, column: 7, scope: !1591)
!1595 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1331, size: 64)
!1596 = !DILocalVariable(name: "Temel",
  scope: !1591, file: !9, line: 45, type: !1595)
!1597 = !DILocation(line: 45, column: 7, scope: !1591)
!1598 = !DILocation(line: 46, column: 7, scope: !1591)
!1599 = !DILocation(line: 46, column: 7, scope: !1591)
!1600 = !DILocation(line: 46, column: 29, scope: !1591)
!1601 = !DILocation(line: 46, column: 7, scope: !1591)
!1602 = !DILocation(line: 47, column: 7, scope: !1591)
!1603 = !DILocation(line: 47, column: 7, scope: !1591)
!1604 = !DILocation(line: 47, column: 29, scope: !1591)
!1605 = !DILocation(line: 47, column: 7, scope: !1591)
!1606 = !DILocation(line: 48, column: 11, scope: !1591)
