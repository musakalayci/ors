...
define external %gt3e2t* 
@"temel::Yeni_ox149i"(%gt296t* %0, %gt3a6t* %1)#0       !dbg !1790 {
; Değişken : dönüş
  %3 = alloca %gt3e2t*, align 8
  store %gt3e2t* null, %gt3e2t** %3, align 8
; Değişken : Hafıza
...
; Değişken : İfade
  ...
  %7 = call i8* (%gt296t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1803
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt3e2t*; 1

; pascal 'Temel' örs::derleme::imge::temel::t
  %9 = alloca %gt3e2t*, align 8
  store 
    %gt3e2t* %8,
    %gt3e2t** %9,
    align 8, !dbg !1804
  call void @llvm.dbg.declare(metadata %gt3e2t** %9, metadata !1806, metadata !DIExpression()), !dbg !1807
; Atama ifadesi
  %10 = load %gt3a6t*, %gt3a6t** %5, align 8, !dbg !1808; 2:0
...
; Konum çevirisi:
  ...
  %13 = load %gt3e2t*, %gt3e2t** %9, align 8, !dbg !1810; 2:0
;atama:
  store 
    %gt3e2t* %13,
    %gt3e2t** %12,
    align 8, !dbg !1811
; Atama ifadesi
  %14 = load %gt3e2t*, %gt3e2t** %9, align 8, !dbg !1812; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt3e2t, %gt3e2t* %14,
    i32 0, i32 1
  %16 = load %gt3a6t*, %gt3a6t** %5, align 8, !dbg !1814; 2:0
;atama:
  store 
    %gt3a6t* %16,
    %gt3a6t** %15,
    align 8, !dbg !1815
  %17 = load %gt3e2t*, %gt3e2t** %9, align 8, !dbg !1816; 2:0
; Dönüş :
  ret %gt3e2t* %17
}
...
!1789 = !DINamespace(name:"temel", scope: !1788)


!1791 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1497, size: 64)
...
!1794 = !DILocalVariable(name: "Hafıza",
  scope: !1790, file: !9, line: 42, type: !1793, arg: 1)
!1796 = !DILocalVariable(name: "İfade",
  scope: !1790, file: !9, line: 43, type: !1795, arg: 2)
!1797 = !DISubroutineType(types: !1798)
!1798 = !{null, !1793, !1795 }
!1790 = distinct !DISubprogram( name: "temel::Yeni_ox149i",
 scope: !1789,
 file: !9,
 line: 41,
 type: !1797, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1799 = !DILocation(line: 42, column: 5, scope: !1790)
!1800 = !DILocation(line: 43, column: 5, scope: !1790)
!1801 = distinct !DILexicalBlock(
        scope: !1790, file: !9, line: 44, column: 5)
!1802 = !DILocation(line: 45, column: 33, scope: !1801)
!1803 = !DILocation(line: 45, column: 41, scope: !1801)
!1804 = !DILocation(line: 45, column: 7, scope: !1801)
!1805 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1497, size: 64)
!1806 = !DILocalVariable(name: "Temel",
  scope: !1801, file: !9, line: 45, type: !1805)
!1807 = !DILocation(line: 45, column: 7, scope: !1801)
!1808 = !DILocation(line: 46, column: 7, scope: !1801)
!1809 = !DILocation(line: 46, column: 7, scope: !1801)
!1810 = !DILocation(line: 46, column: 29, scope: !1801)
!1811 = !DILocation(line: 46, column: 7, scope: !1801)
!1812 = !DILocation(line: 47, column: 7, scope: !1801)
!1813 = !DILocation(line: 47, column: 7, scope: !1801)
!1814 = !DILocation(line: 47, column: 29, scope: !1801)
!1815 = !DILocation(line: 47, column: 7, scope: !1801)
!1816 = !DILocation(line: 48, column: 11, scope: !1801)
