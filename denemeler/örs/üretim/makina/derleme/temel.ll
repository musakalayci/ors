...
@"temel::Yeni_ox149i"(%gt294t* %0, %gt398t* %1)#0       !dbg !1724 {
; Değişken : dönüş
...
; Değişken : İfade
  ...
  %7 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1737
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt3d2t*; 1

; pascal 'Temel' örs::derleme::imge::temel::t
  %9 = alloca %gt3d2t*, align 8
  store 
    %gt3d2t* %8,
    %gt3d2t** %9,
    align 8, !dbg !1738
  call void @llvm.dbg.declare(metadata %gt3d2t** %9, metadata !1740, metadata !DIExpression()), !dbg !1741
; Atama ifadesi
  %10 = load %gt398t*, %gt398t** %5, align 8, !dbg !1742; 2:0
...
; Konum çevirisi:
  ...
  %13 = load %gt3d2t*, %gt3d2t** %9, align 8, !dbg !1744; 2:0
;atama:
  store 
    %gt3d2t* %13,
    %gt3d2t** %12,
    align 8, !dbg !1745
; Atama ifadesi
  %14 = load %gt3d2t*, %gt3d2t** %9, align 8, !dbg !1746; 2:0
; tür konumu *örs::derleme::imge::temel::t : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt3d2t, %gt3d2t* %14,
    i32 0, i32 1
  %16 = load %gt398t*, %gt398t** %5, align 8, !dbg !1748; 2:0
;atama:
  store 
    %gt398t* %16,
    %gt398t** %15,
    align 8, !dbg !1749
  %17 = load %gt3d2t*, %gt3d2t** %9, align 8, !dbg !1750; 2:0
; Dönüş :
  ret %gt3d2t* %17
}
...
!1723 = !DINamespace(name:"temel", scope: !1722)


!1725 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1437, size: 64)
...
!1728 = !DILocalVariable(name: "Hafıza",
  scope: !1724, file: !9, line: 42, type: !1727, arg: 1)
!1730 = !DILocalVariable(name: "İfade",
  scope: !1724, file: !9, line: 43, type: !1729, arg: 2)
!1731 = !DISubroutineType(types: !1732)
!1732 = !{null, !1727, !1729 }
!1724 = distinct !DISubprogram( name: "temel::Yeni_ox149i",
 scope: !1723,
 file: !9,
 line: 41,
...
!1734 = !DILocation(line: 43, column: 5, scope: !1724)
!1735 = distinct !DILexicalBlock(
        scope: !1724, file: !9, line: 44, column: 5)
!1736 = !DILocation(line: 45, column: 33, scope: !1735)
!1737 = !DILocation(line: 45, column: 41, scope: !1735)
!1738 = !DILocation(line: 45, column: 7, scope: !1735)
!1739 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1437, size: 64)
!1740 = !DILocalVariable(name: "Temel",
  scope: !1735, file: !9, line: 45, type: !1739)
!1741 = !DILocation(line: 45, column: 7, scope: !1735)
!1742 = !DILocation(line: 46, column: 7, scope: !1735)
!1743 = !DILocation(line: 46, column: 7, scope: !1735)
!1744 = !DILocation(line: 46, column: 29, scope: !1735)
!1745 = !DILocation(line: 46, column: 7, scope: !1735)
!1746 = !DILocation(line: 47, column: 7, scope: !1735)
!1747 = !DILocation(line: 47, column: 7, scope: !1735)
!1748 = !DILocation(line: 47, column: 29, scope: !1735)
!1749 = !DILocation(line: 47, column: 7, scope: !1735)
!1750 = !DILocation(line: 48, column: 11, scope: !1735)
