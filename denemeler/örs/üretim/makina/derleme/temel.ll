; ModuleID = 'örs::derleme::imge::temel'
; Ürün adı : derleme
; Birim adı : örs::derleme::imge::temel
; Yol: ./denemeler/örs/üretim/makina/derleme/
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"
source_filename = "./denemeler/örs/üretim/makina/derleme/temel.ll"
...
define external %gt3fbt* 
@"temel::Yeni_ox149i"(%gt29at* %0, %gt3bft* %1)#0       !dbg !1817 {
; Değişken : dönüş
  %3 = alloca %gt3fbt*, align 8
  store %gt3fbt* null, %gt3fbt** %3, align 8
; Değişken : Hafıza
...
; Değişken : İfade
  ...
  %7 = call i8* (%gt29at*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1830
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt3fbt*; 1

; pascal 'Temel' örs::derleme::imge::temel::t
  %9 = alloca %gt3fbt*, align 8
  store 
    %gt3fbt* %8,
    %gt3fbt** %9,
    align 8, !dbg !1831
  call void @llvm.dbg.declare(metadata %gt3fbt** %9, metadata !1833, metadata !DIExpression()), !dbg !1834
; Atama ifadesi
...
; Konum çevirisi:
  ...
  %13 = load %gt3fbt*, %gt3fbt** %9, align 8, !dbg !1837; 2:0
;atama:
  store 
    %gt3fbt* %13,
    %gt3fbt** %12,
    align 8, !dbg !1838
; Atama ifadesi
  %14 = load %gt3fbt*, %gt3fbt** %9, align 8, !dbg !1839; 2:0
...
;atama:
  store 
    ...
    %gt3bft** %15,
    align 8, !dbg !1842
  %17 = load %gt3fbt*, %gt3fbt** %9, align 8, !dbg !1843; 2:0
; Dönüş :
  ret %gt3fbt* %17
}
...
!1816 = !DINamespace(name:"temel", scope: !1815)


!1818 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1492, size: 64)
...
!1821 = !DILocalVariable(name: "Hafıza",
  scope: !1817, file: !9, line: 42, type: !1820, arg: 1)
!1823 = !DILocalVariable(name: "İfade",
  scope: !1817, file: !9, line: 43, type: !1822, arg: 2)
!1824 = !DISubroutineType(types: !1825)
!1825 = !{null, !1820, !1822 }
!1817 = distinct !DISubprogram( name: "temel::Yeni_ox149i",
 scope: !1816,
 file: !9,
 line: 41,
 type: !1824, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1826 = !DILocation(line: 42, column: 5, scope: !1817)
!1827 = !DILocation(line: 43, column: 5, scope: !1817)
!1828 = distinct !DILexicalBlock(
        scope: !1817, file: !9, line: 44, column: 5)
!1829 = !DILocation(line: 45, column: 33, scope: !1828)
!1830 = !DILocation(line: 45, column: 41, scope: !1828)
!1831 = !DILocation(line: 45, column: 7, scope: !1828)
!1832 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1492, size: 64)
!1833 = !DILocalVariable(name: "Temel",
  scope: !1828, file: !9, line: 45, type: !1832)
!1834 = !DILocation(line: 45, column: 7, scope: !1828)
!1835 = !DILocation(line: 46, column: 7, scope: !1828)
!1836 = !DILocation(line: 46, column: 7, scope: !1828)
!1837 = !DILocation(line: 46, column: 29, scope: !1828)
!1838 = !DILocation(line: 46, column: 7, scope: !1828)
!1839 = !DILocation(line: 47, column: 7, scope: !1828)
!1840 = !DILocation(line: 47, column: 7, scope: !1828)
!1841 = !DILocation(line: 47, column: 29, scope: !1828)
!1842 = !DILocation(line: 47, column: 7, scope: !1828)
!1843 = !DILocation(line: 48, column: 11, scope: !1828)
