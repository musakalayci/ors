...
define external %gt229t* 
@"temel::Yeni_ox125i"(%gt1e0t* %0, %gt231t* %1)#0       {
; Değişken : dönüş
  %3 = alloca %gt229t*, align 8
  store %gt229t* null, %gt229t** %3, align 8
; Değişken : Hafıza
...
; Değişken : İfade
  ...
  %7 = call i8* (%gt1e0t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      ...
      i64 8)
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt229t*; 1

; pascal 'Temel' örs::derleme::imge::temel::t
  %9 = alloca %gt229t*, align 8
  store 
    %gt229t* %8,
    %gt229t** %9,
    align 8
...
; Konum çevirisi:
  ...
  %13 = load %gt229t*, %gt229t** %9, align 8; 2:0
;atama:
  store 
    %gt229t* %13,
    %gt229t** %12,
    align 8
; Atama ifadesi
  %14 = load %gt229t*, %gt229t** %9, align 8; 2:0
...
;atama:
  store 
    ...
    %gt231t** %15,
    align 8
  %17 = load %gt229t*, %gt229t** %9, align 8; 2:0
; Dönüş :
  ret %gt229t* %17
}
