...
define external %gt3f5t* 
@"_ileti::Yeni_ox147i"(%gt29at* %0)#0       !dbg !1817 {
; Değişken : dönüş
  %2 = alloca %gt3f5t*, align 8
  store %gt3f5t* null, %gt3f5t** %2, align 8
; Değişken : Hafıza
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3bft** %6,
    align 8, !dbg !1828
  call void @llvm.dbg.declare(metadata %gt3bft** %6, metadata !1830, metadata !DIExpression()), !dbg !1831
  %7 = load %gt29at*, %gt29at** %3, align 8, !dbg !1832; 2:0
  %8 = call i8* (%gt29at*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt29at* %7, 
      i64 24, 
      i64 8), !dbg !1833
; Konum çevirisi:
  %9 = bitcast i8* %8 to %gt3f5t*; 1

; pascal 'İleti' örs::derleme::imge::_ileti::t
  %10 = alloca %gt3f5t*, align 8
  store 
    %gt3f5t* %9,
    %gt3f5t** %10,
    align 8, !dbg !1834
  call void @llvm.dbg.declare(metadata %gt3f5t** %10, metadata !1836, metadata !DIExpression()), !dbg !1837
; Atama ifadesi
  %11 = load %gt3f5t*, %gt3f5t** %10, align 8, !dbg !1838; 2:0
; tür konumu *örs::derleme::imge::_ileti::t : *örs::derleme::imge::t
  %12 = getelementptr inbounds 
    %gt3f5t, %gt3f5t* %11,
    i32 0, i32 0
  %13 = load %gt3bft*, %gt3bft** %6, align 8, !dbg !1840; 2:0
;atama:
  store 
    %gt3bft* %13,
    %gt3bft** %12,
    align 8, !dbg !1841
; Atama ifadesi
  %14 = load %gt3bft*, %gt3bft** %6, align 8, !dbg !1842; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt3bet* %15 to %gt3f5t**; 2
  %17 = load %gt3f5t*, %gt3f5t** %10, align 8, !dbg !1844; 2:0
;atama:
  store 
    %gt3f5t* %17,
    %gt3f5t** %16,
    align 8, !dbg !1845
  %18 = load %gt3f5t*, %gt3f5t** %10, align 8, !dbg !1846; 2:0
; Dönüş :
  ret %gt3f5t* %18
}
...
!1816 = !DINamespace(name:"_ileti", scope: !1815)


!1818 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1546, size: 64)
...
!1821 = !DILocalVariable(name: "Hafıza",
  scope: !1817, file: !9, line: 11, type: !1820, arg: 1)
!1822 = !DISubroutineType(types: !1823)
!1823 = !{null, !1820 }
!1817 = distinct !DISubprogram( name: "_ileti::Yeni_ox147i",
 scope: !1816,
 file: !9,
 line: 11,
 type: !1822, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1824 = !DILocation(line: 11, column: 19, scope: !1817)
!1825 = distinct !DILexicalBlock(
        scope: !1817, file: !9, line: 12, column: 3)
!1826 = !DILocation(line: 13, column: 25, scope: !1825)
!1827 = !DILocation(line: 13, column: 20, scope: !1825)
!1828 = !DILocation(line: 13, column: 5, scope: !1825)
!1829 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1830 = !DILocalVariable(name: "İmge",
  scope: !1825, file: !9, line: 13, type: !1829)
!1831 = !DILocation(line: 13, column: 5, scope: !1825)
!1832 = !DILocation(line: 14, column: 18, scope: !1825)
!1833 = !DILocation(line: 14, column: 26, scope: !1825)
!1834 = !DILocation(line: 14, column: 5, scope: !1825)
!1835 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1546, size: 64)
!1836 = !DILocalVariable(name: "İleti",
  scope: !1825, file: !9, line: 14, type: !1835)
!1837 = !DILocation(line: 14, column: 5, scope: !1825)
!1838 = !DILocation(line: 15, column: 5, scope: !1825)
!1839 = !DILocation(line: 15, column: 5, scope: !1825)
!1840 = !DILocation(line: 15, column: 26, scope: !1825)
!1841 = !DILocation(line: 15, column: 5, scope: !1825)
!1842 = !DILocation(line: 16, column: 5, scope: !1825)
!1843 = !DILocation(line: 16, column: 5, scope: !1825)
!1844 = !DILocation(line: 16, column: 26, scope: !1825)
!1845 = !DILocation(line: 16, column: 5, scope: !1825)
!1846 = !DILocation(line: 17, column: 9, scope: !1825)
