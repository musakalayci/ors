...
@"_ileti::Yeni_ox147i"(%gt294t* %0)#0       !dbg !1724 {
; Değişken : dönüş
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  %8 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1740
; Konum çevirisi:
  %9 = bitcast i8* %8 to %gt3cct*; 1

; pascal 'İleti' örs::derleme::imge::_ileti::t
  %10 = alloca %gt3cct*, align 8
  store 
    %gt3cct* %9,
    %gt3cct** %10,
    align 8, !dbg !1741
  call void @llvm.dbg.declare(metadata %gt3cct** %10, metadata !1743, metadata !DIExpression()), !dbg !1744
; Atama ifadesi
  %11 = load %gt3cct*, %gt3cct** %10, align 8, !dbg !1745; 2:0
...
;atama:
  store 
    ...
    align 8, !dbg !1748
; Atama ifadesi
  %14 = load %gt398t*, %gt398t** %6, align 8, !dbg !1749; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt397t* %15 to %gt3cct**; 2
  %17 = load %gt3cct*, %gt3cct** %10, align 8, !dbg !1751; 2:0
;atama:
  store 
    %gt3cct* %17,
    %gt3cct** %16,
    align 8, !dbg !1752
  %18 = load %gt3cct*, %gt3cct** %10, align 8, !dbg !1753; 2:0
; Dönüş :
  ret %gt3cct* %18
}
...
!1723 = !DINamespace(name:"_ileti", scope: !1722)


!1725 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1489, size: 64)
...
!1728 = !DILocalVariable(name: "Hafıza",
  scope: !1724, file: !9, line: 11, type: !1727, arg: 1)
!1729 = !DISubroutineType(types: !1730)
!1730 = !{null, !1727 }
!1724 = distinct !DISubprogram( name: "_ileti::Yeni_ox147i",
 scope: !1723,
 file: !9,
 line: 11,
 type: !1729, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1731 = !DILocation(line: 11, column: 19, scope: !1724)
!1732 = distinct !DILexicalBlock(
        scope: !1724, file: !9, line: 12, column: 3)
!1733 = !DILocation(line: 13, column: 25, scope: !1732)
!1734 = !DILocation(line: 13, column: 20, scope: !1732)
!1735 = !DILocation(line: 13, column: 5, scope: !1732)
!1736 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1737 = !DILocalVariable(name: "İmge",
  scope: !1732, file: !9, line: 13, type: !1736)
!1738 = !DILocation(line: 13, column: 5, scope: !1732)
!1739 = !DILocation(line: 14, column: 18, scope: !1732)
!1740 = !DILocation(line: 14, column: 26, scope: !1732)
!1741 = !DILocation(line: 14, column: 5, scope: !1732)
!1742 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1489, size: 64)
!1743 = !DILocalVariable(name: "İleti",
  scope: !1732, file: !9, line: 14, type: !1742)
!1744 = !DILocation(line: 14, column: 5, scope: !1732)
!1745 = !DILocation(line: 15, column: 5, scope: !1732)
!1746 = !DILocation(line: 15, column: 5, scope: !1732)
!1747 = !DILocation(line: 15, column: 26, scope: !1732)
!1748 = !DILocation(line: 15, column: 5, scope: !1732)
!1749 = !DILocation(line: 16, column: 5, scope: !1732)
!1750 = !DILocation(line: 16, column: 5, scope: !1732)
!1751 = !DILocation(line: 16, column: 26, scope: !1732)
!1752 = !DILocation(line: 16, column: 5, scope: !1732)
!1753 = !DILocation(line: 17, column: 9, scope: !1732)
