...
define external %gt3d8t* 
@"_ileti::Yeni_ox147i"(%gt294t* %0)#0       !dbg !1764 {
; Değişken : dönüş
  %2 = alloca %gt3d8t*, align 8
  store %gt3d8t* null, %gt3d8t** %2, align 8
; Değişken : Hafıza
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3a2t** %6,
    align 8, !dbg !1775
  call void @llvm.dbg.declare(metadata %gt3a2t** %6, metadata !1777, metadata !DIExpression()), !dbg !1778
  %7 = load %gt294t*, %gt294t** %3, align 8, !dbg !1779; 2:0
  %8 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt294t* %7, 
      i64 24, 
      i64 8), !dbg !1780
; Konum çevirisi:
  %9 = bitcast i8* %8 to %gt3d8t*; 1

; pascal 'İleti' örs::derleme::imge::_ileti::t
  %10 = alloca %gt3d8t*, align 8
  store 
    %gt3d8t* %9,
    %gt3d8t** %10,
    align 8, !dbg !1781
  call void @llvm.dbg.declare(metadata %gt3d8t** %10, metadata !1783, metadata !DIExpression()), !dbg !1784
; Atama ifadesi
  %11 = load %gt3d8t*, %gt3d8t** %10, align 8, !dbg !1785; 2:0
; tür konumu *örs::derleme::imge::_ileti::t : *örs::derleme::imge::t
  %12 = getelementptr inbounds 
    %gt3d8t, %gt3d8t* %11,
    i32 0, i32 0
  %13 = load %gt3a2t*, %gt3a2t** %6, align 8, !dbg !1787; 2:0
;atama:
  store 
    %gt3a2t* %13,
    %gt3a2t** %12,
    align 8, !dbg !1788
; Atama ifadesi
  %14 = load %gt3a2t*, %gt3a2t** %6, align 8, !dbg !1789; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt3a1t* %15 to %gt3d8t**; 2
  %17 = load %gt3d8t*, %gt3d8t** %10, align 8, !dbg !1791; 2:0
;atama:
  store 
    %gt3d8t* %17,
    %gt3d8t** %16,
    align 8, !dbg !1792
  %18 = load %gt3d8t*, %gt3d8t** %10, align 8, !dbg !1793; 2:0
; Dönüş :
  ret %gt3d8t* %18
}
...
!1763 = !DINamespace(name:"_ileti", scope: !1762)


!1765 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1526, size: 64)
...
!1768 = !DILocalVariable(name: "Hafıza",
  scope: !1764, file: !9, line: 11, type: !1767, arg: 1)
!1769 = !DISubroutineType(types: !1770)
!1770 = !{null, !1767 }
!1764 = distinct !DISubprogram( name: "_ileti::Yeni_ox147i",
 scope: !1763,
 file: !9,
 line: 11,
 type: !1769, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1771 = !DILocation(line: 11, column: 19, scope: !1764)
!1772 = distinct !DILexicalBlock(
        scope: !1764, file: !9, line: 12, column: 3)
!1773 = !DILocation(line: 13, column: 25, scope: !1772)
!1774 = !DILocation(line: 13, column: 20, scope: !1772)
!1775 = !DILocation(line: 13, column: 5, scope: !1772)
!1776 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1777 = !DILocalVariable(name: "İmge",
  scope: !1772, file: !9, line: 13, type: !1776)
!1778 = !DILocation(line: 13, column: 5, scope: !1772)
!1779 = !DILocation(line: 14, column: 18, scope: !1772)
!1780 = !DILocation(line: 14, column: 26, scope: !1772)
!1781 = !DILocation(line: 14, column: 5, scope: !1772)
!1782 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1526, size: 64)
!1783 = !DILocalVariable(name: "İleti",
  scope: !1772, file: !9, line: 14, type: !1782)
!1784 = !DILocation(line: 14, column: 5, scope: !1772)
!1785 = !DILocation(line: 15, column: 5, scope: !1772)
!1786 = !DILocation(line: 15, column: 5, scope: !1772)
!1787 = !DILocation(line: 15, column: 26, scope: !1772)
!1788 = !DILocation(line: 15, column: 5, scope: !1772)
!1789 = !DILocation(line: 16, column: 5, scope: !1772)
!1790 = !DILocation(line: 16, column: 5, scope: !1772)
!1791 = !DILocation(line: 16, column: 26, scope: !1772)
!1792 = !DILocation(line: 16, column: 5, scope: !1772)
!1793 = !DILocation(line: 17, column: 9, scope: !1772)
