...
; pascal 'İmge' örs::derleme::imge::t
  ...
  %8 = call i8* (%gt1e0t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      ...
      i64 8)
; Konum çevirisi:
  %9 = bitcast i8* %8 to %gt259t*; 1

; pascal 'İleti' örs::derleme::imge::_ileti::t
  %10 = alloca %gt259t*, align 8
  store 
    %gt259t* %9,
    %gt259t** %10,
    align 8
; Atama ifadesi
  %11 = load %gt259t*, %gt259t** %10, align 8; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt230t* %15 to %gt259t**; 2
  %17 = load %gt259t*, %gt259t** %10, align 8; 2:0
;atama:
  store 
    %gt259t* %17,
    %gt259t** %16,
    align 8
  %18 = load %gt259t*, %gt259t** %10, align 8; 2:0
; Dönüş :
  ret %gt259t* %18
}
