...
define external %gt25ct* 
@"_ileti::Yeni_ox12Ei"(%gt1e2t* %0)#0       !dbg !1580 {
; Değişken : dönüş
  %2 = alloca %gt25ct*, align 8
  store %gt25ct* null, %gt25ct** %2, align 8
; Değişken : Hafıza
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt234t** %6,
    align 8, !dbg !1590
  call void @llvm.dbg.declare(metadata %gt234t** %6, metadata !1592, metadata !DIExpression()), !dbg !1593
  %7 = load %gt1e2t*, %gt1e2t** %3, align 8, !dbg !1594; 2:0
  %8 = call i8* (%gt1e2t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      %gt1e2t* %7, 
      i64 24, 
      i64 8), !dbg !1595
; Konum çevirisi:
  %9 = bitcast i8* %8 to %gt25ct*; 1

; pascal 'İleti' örs::derleme::imge::_ileti::t
  %10 = alloca %gt25ct*, align 8
  store 
    %gt25ct* %9,
    %gt25ct** %10,
    align 8, !dbg !1596
  call void @llvm.dbg.declare(metadata %gt25ct** %10, metadata !1597, metadata !DIExpression()), !dbg !1598
; Atama ifadesi
  %11 = load %gt25ct*, %gt25ct** %10, align 8, !dbg !1599; 2:0
; tür konumu *örs::derleme::imge::_ileti::t : *örs::derleme::imge::t
  %12 = getelementptr inbounds 
    %gt25ct, %gt25ct* %11,
    i32 0, i32 0
  %13 = load %gt234t*, %gt234t** %6, align 8, !dbg !1601; 2:0
;atama:
  store 
    %gt234t* %13,
    %gt234t** %12,
    align 8, !dbg !1602
; Atama ifadesi
  %14 = load %gt234t*, %gt234t** %6, align 8, !dbg !1603; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt233t* %15 to %gt25ct**; 2
  %17 = load %gt25ct*, %gt25ct** %10, align 8, !dbg !1605; 2:0
;atama:
  store 
    %gt25ct* %17,
    %gt25ct** %16,
    align 8, !dbg !1606
  %18 = load %gt25ct*, %gt25ct** %10, align 8, !dbg !1607; 2:0
; Dönüş :
  ret %gt25ct* %18
}
...
!1579 = !DINamespace(name:"_ileti", scope: !1578)


!1581 = !DILocalVariable(name: "dönüş",
  scope: !1580, file: !9, line: 15, type: !1379)
...
!1585 = !{null, !1582 }
!1580 = distinct !DISubprogram( name: "_ileti::Yeni_ox12Ei",
 scope: !1579,
 file: !9,
 line: 11,
 type: !1584, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1586 = !DILocation(line: 11, column: 19, scope: !1580)
!1587 = distinct !DILexicalBlock(
        scope: !1580, file: !9, line: 12, column: 3)
!1588 = !DILocation(line: 13, column: 25, scope: !1587)
!1589 = !DILocation(line: 13, column: 20, scope: !1587)
!1590 = !DILocation(line: 13, column: 5, scope: !1587)
!1591 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1592 = !DILocalVariable(name: "İmge",
  scope: !1587, file: !9, line: 13, type: !1591)
!1593 = !DILocation(line: 13, column: 5, scope: !1587)
!1594 = !DILocation(line: 14, column: 18, scope: !1587)
!1595 = !DILocation(line: 14, column: 26, scope: !1587)
!1596 = !DILocation(line: 14, column: 5, scope: !1587)
!1597 = !DILocalVariable(name: "İleti",
  scope: !1587, file: !9, line: 14, type: !1379)
!1598 = !DILocation(line: 14, column: 5, scope: !1587)
!1599 = !DILocation(line: 15, column: 5, scope: !1587)
!1600 = !DILocation(line: 15, column: 5, scope: !1587)
!1601 = !DILocation(line: 15, column: 26, scope: !1587)
!1602 = !DILocation(line: 15, column: 5, scope: !1587)
!1603 = !DILocation(line: 16, column: 5, scope: !1587)
!1604 = !DILocation(line: 16, column: 5, scope: !1587)
!1605 = !DILocation(line: 16, column: 26, scope: !1587)
!1606 = !DILocation(line: 16, column: 5, scope: !1587)
!1607 = !DILocation(line: 17, column: 9, scope: !1587)
