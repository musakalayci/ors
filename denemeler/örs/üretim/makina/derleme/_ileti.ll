...
define external %gt2e7t* 
@"_ileti::Yeni_i"(%gt263t* %0)#0       !dbg !1144 {
; Değişken : dönüş
  %2 = alloca %gt2e7t*, align 8
  store %gt2e7t* null, %gt2e7t** %2, align 8
; Değişken : Hafıza
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt2c2t** %6,
    align 8, !dbg !1155
  call void @llvm.dbg.declare(metadata %gt2c2t** %6, metadata !1157, metadata !DIExpression()), !dbg !1158
  %7 = load %gt263t*, %gt263t** %3, align 8, !dbg !1159; 2:0
  %8 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      %gt263t* %7, 
      i64 24, 
      i64 8), !dbg !1160
; Konum çevirisi:
  %9 = bitcast i8* %8 to %gt2e7t*; 1

; pascal 'İleti' örs::derleme::imge::_ileti::t
  %10 = alloca %gt2e7t*, align 8
  store 
    %gt2e7t* %9,
    %gt2e7t** %10,
    align 8, !dbg !1161
  call void @llvm.dbg.declare(metadata %gt2e7t** %10, metadata !1163, metadata !DIExpression()), !dbg !1164
; Atama ifadesi
  %11 = load %gt2e7t*, %gt2e7t** %10, align 8, !dbg !1165; 2:0
; tür konumu *örs::derleme::imge::_ileti::t : *örs::derleme::imge::t
  %12 = getelementptr inbounds 
    %gt2e7t, %gt2e7t* %11,
    i32 0, i32 0
  %13 = load %gt2c2t*, %gt2c2t** %6, align 8, !dbg !1167; 2:0
  store 
    %gt2c2t* %13,
    %gt2c2t** %12,
    align 8, !dbg !1168
; Atama ifadesi
  %14 = load %gt2c2t*, %gt2c2t** %6, align 8, !dbg !1169; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt2c1t* %15 to %gt2e7t**; 2
  %17 = load %gt2e7t*, %gt2e7t** %10, align 8, !dbg !1171; 2:0
  store 
    %gt2e7t* %17,
    %gt2e7t** %16,
    align 8, !dbg !1172
  %18 = load %gt2e7t*, %gt2e7t** %10, align 8, !dbg !1173; 2:0
; Dönüş :
  ret %gt2e7t* %18
}
...
!1143 = !DINamespace(name:"_ileti", scope: !1142)


!1145 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !915, size: 64)
...
!1150 = !{null, !1147 }
!1144 = distinct !DISubprogram( name: "_ileti::Yeni_i",
 scope: !1143,
 file: !9,
 line: 11,
 type: !1149, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1151 = !DILocation(line: 11, column: 19, scope: !1144)
!1152 = distinct !DILexicalBlock(
        scope: !1144, file: !9, line: 12, column: 3)
!1153 = !DILocation(line: 13, column: 25, scope: !1152)
!1154 = !DILocation(line: 13, column: 20, scope: !1152)
!1155 = !DILocation(line: 13, column: 5, scope: !1152)
!1156 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1157 = !DILocalVariable(name: "İmge",
  scope: !1152, file: !9, line: 13, type: !1156)
!1158 = !DILocation(line: 13, column: 5, scope: !1152)
!1159 = !DILocation(line: 14, column: 18, scope: !1152)
!1160 = !DILocation(line: 14, column: 26, scope: !1152)
!1161 = !DILocation(line: 14, column: 5, scope: !1152)
!1162 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !915, size: 64)
!1163 = !DILocalVariable(name: "İleti",
  scope: !1152, file: !9, line: 14, type: !1162)
!1164 = !DILocation(line: 14, column: 5, scope: !1152)
!1165 = !DILocation(line: 15, column: 5, scope: !1152)
!1166 = !DILocation(line: 15, column: 5, scope: !1152)
!1167 = !DILocation(line: 15, column: 26, scope: !1152)
!1168 = !DILocation(line: 15, column: 5, scope: !1152)
!1169 = !DILocation(line: 16, column: 5, scope: !1152)
!1170 = !DILocation(line: 16, column: 5, scope: !1152)
!1171 = !DILocation(line: 16, column: 26, scope: !1152)
!1172 = !DILocation(line: 16, column: 5, scope: !1152)
!1173 = !DILocation(line: 17, column: 9, scope: !1152)
