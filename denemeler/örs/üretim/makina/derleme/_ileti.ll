...
@"_ileti::Yeni_ox147i"(%gt296t* %0)#0       !dbg !1790 {
; Değişken : dönüş
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3a6t** %6,
    align 8, !dbg !1801
  call void @llvm.dbg.declare(metadata %gt3a6t** %6, metadata !1803, metadata !DIExpression()), !dbg !1804
  %7 = load %gt296t*, %gt296t** %3, align 8, !dbg !1805; 2:0
  %8 = call i8* (%gt296t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt296t* %7, 
      i64 24, 
      i64 8), !dbg !1806
; Konum çevirisi:
  %9 = bitcast i8* %8 to %gt3dct*; 1

; pascal 'İleti' örs::derleme::imge::_ileti::t
  %10 = alloca %gt3dct*, align 8
  store 
    %gt3dct* %9,
    %gt3dct** %10,
    align 8, !dbg !1807
  call void @llvm.dbg.declare(metadata %gt3dct** %10, metadata !1809, metadata !DIExpression()), !dbg !1810
; Atama ifadesi
  %11 = load %gt3dct*, %gt3dct** %10, align 8, !dbg !1811; 2:0
; tür konumu *örs::derleme::imge::_ileti::t : *örs::derleme::imge::t
  %12 = getelementptr inbounds 
    %gt3dct, %gt3dct* %11,
    i32 0, i32 0
  %13 = load %gt3a6t*, %gt3a6t** %6, align 8, !dbg !1813; 2:0
;atama:
  store 
    %gt3a6t* %13,
    %gt3a6t** %12,
    align 8, !dbg !1814
; Atama ifadesi
  %14 = load %gt3a6t*, %gt3a6t** %6, align 8, !dbg !1815; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt3a5t* %15 to %gt3dct**; 2
  %17 = load %gt3dct*, %gt3dct** %10, align 8, !dbg !1817; 2:0
;atama:
  store 
    %gt3dct* %17,
    %gt3dct** %16,
    align 8, !dbg !1818
  %18 = load %gt3dct*, %gt3dct** %10, align 8, !dbg !1819; 2:0
; Dönüş :
  ret %gt3dct* %18
}
...
!1789 = !DINamespace(name:"_ileti", scope: !1788)


!1791 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1549, size: 64)
...
!1794 = !DILocalVariable(name: "Hafıza",
  scope: !1790, file: !9, line: 11, type: !1793, arg: 1)
!1795 = !DISubroutineType(types: !1796)
!1796 = !{null, !1793 }
!1790 = distinct !DISubprogram( name: "_ileti::Yeni_ox147i",
 scope: !1789,
 file: !9,
 line: 11,
 type: !1795, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1797 = !DILocation(line: 11, column: 19, scope: !1790)
!1798 = distinct !DILexicalBlock(
        scope: !1790, file: !9, line: 12, column: 3)
!1799 = !DILocation(line: 13, column: 25, scope: !1798)
!1800 = !DILocation(line: 13, column: 20, scope: !1798)
!1801 = !DILocation(line: 13, column: 5, scope: !1798)
!1802 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1803 = !DILocalVariable(name: "İmge",
  scope: !1798, file: !9, line: 13, type: !1802)
!1804 = !DILocation(line: 13, column: 5, scope: !1798)
!1805 = !DILocation(line: 14, column: 18, scope: !1798)
!1806 = !DILocation(line: 14, column: 26, scope: !1798)
!1807 = !DILocation(line: 14, column: 5, scope: !1798)
!1808 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1549, size: 64)
!1809 = !DILocalVariable(name: "İleti",
  scope: !1798, file: !9, line: 14, type: !1808)
!1810 = !DILocation(line: 14, column: 5, scope: !1798)
!1811 = !DILocation(line: 15, column: 5, scope: !1798)
!1812 = !DILocation(line: 15, column: 5, scope: !1798)
!1813 = !DILocation(line: 15, column: 26, scope: !1798)
!1814 = !DILocation(line: 15, column: 5, scope: !1798)
!1815 = !DILocation(line: 16, column: 5, scope: !1798)
!1816 = !DILocation(line: 16, column: 5, scope: !1798)
!1817 = !DILocation(line: 16, column: 26, scope: !1798)
!1818 = !DILocation(line: 16, column: 5, scope: !1798)
!1819 = !DILocation(line: 17, column: 9, scope: !1798)
