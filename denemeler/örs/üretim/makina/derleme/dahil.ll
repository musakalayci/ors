...
define external %gt2c6t* 
@"dahil::Yeni_i"(%gt259t* %0, %gt2fct* %1)#0       !dbg !915 {
; Değişken : dönüş
  %3 = alloca %gt2c6t*, align 8
  store %gt2c6t* null, %gt2c6t** %3, align 8
; Değişken : Hafıza
...
; Değişken : Kütüphane
  %5 = alloca %gt2fct*, align 8
  store %gt2fct* %1, %gt2fct** %5, align 8
  call void @llvm.dbg.declare(metadata %gt2fct** %5, metadata !921, metadata !DIExpression()), !dbg !925
;;-> (nil) 0
  %6 = load %gt259t*, %gt259t** %4, align 8, !dbg !927; 2:0
;;-> (nil) 0
  %7 = call %gt2b8t* @"imge::Yeni_i" (
      %gt259t* %6, 
      i32 261), !dbg !928
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt2b8t** %8,
    align 8, !dbg !929
  call void @llvm.dbg.declare(metadata %gt2b8t** %8, metadata !931, metadata !DIExpression()), !dbg !932
  %9 = load %gt259t*, %gt259t** %4, align 8, !dbg !933; 2:0
  %10 = call i8* (%gt259t*,i64,i64) @"hafıza::t.Yeni_i" (
      %gt259t* %9, 
      i64 32, 
      i64 8), !dbg !934
; Konum çevirisi:
  %11 = bitcast i8* %10 to %gt2c6t*; 1

; pascal 'Dahili' örs::derleme::imge::dahil::t
  %12 = alloca %gt2c6t*, align 8
  store 
    %gt2c6t* %11,
    %gt2c6t** %12,
    align 8, !dbg !935
  call void @llvm.dbg.declare(metadata %gt2c6t** %12, metadata !937, metadata !DIExpression()), !dbg !938
; Atama ifadesi
  %13 = load %gt2b8t*, %gt2b8t** %8, align 8, !dbg !939; 2:0
...
; Konum çevirisi:
  %15 = bitcast %gt2b7t* %14 to %gt2c6t**; 2
  %16 = load %gt2c6t*, %gt2c6t** %12, align 8, !dbg !941; 2:0
  store 
    %gt2c6t* %16,
    %gt2c6t** %15,
    align 8, !dbg !942
; Atama ifadesi
  %17 = load %gt2c6t*, %gt2c6t** %12, align 8, !dbg !943; 2:0
; tür konumu *örs::derleme::imge::dahil::t : *örs::derleme::imge::t
  %18 = getelementptr inbounds 
    %gt2c6t, %gt2c6t* %17,
    i32 0, i32 0
  %19 = load %gt2b8t*, %gt2b8t** %8, align 8, !dbg !945; 2:0
  store 
    %gt2b8t* %19,
    %gt2b8t** %18,
    align 8, !dbg !946
; Atama ifadesi
  %20 = load %gt2c6t*, %gt2c6t** %12, align 8, !dbg !947; 2:0
; tür konumu *örs::derleme::imge::dahil::t : *örs::derleme::kütüphane::t
  %21 = getelementptr inbounds 
    %gt2c6t, %gt2c6t* %20,
    i32 0, i32 2
  %22 = load %gt2fct*, %gt2fct** %5, align 8, !dbg !949; 2:0
  store 
    %gt2fct* %22,
    %gt2fct** %21,
    align 8, !dbg !950
  %23 = load %gt2c6t*, %gt2c6t** %12, align 8, !dbg !951; 2:0
; Dönüş :
  ret %gt2c6t* %23
}
...
!914 = !DINamespace(name:"dahil", scope: !913)


!916 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !869, size: 64)
...
!920 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !56, size: 64)
!919 = !DILocalVariable(name: "Hafıza",
  scope: !915, file: !9, line: 14, type: !918, arg: 1)
!921 = !DILocalVariable(name: "Kütüphane",
  scope: !915, file: !9, line: 14, type: !920, arg: 2)
!922 = !DISubroutineType(types: !923)
!923 = !{null, !918, !920 }
!915 = distinct !DISubprogram( name: "dahil::Yeni_i",
 scope: !914,
 file: !9,
 line: 14,
...
!927 = !DILocation(line: 16, column: 26, scope: !926)
!928 = !DILocation(line: 16, column: 21, scope: !926)
!929 = !DILocation(line: 16, column: 5, scope: !926)
!930 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!931 = !DILocalVariable(name: "İmge",
  scope: !926, file: !9, line: 16, type: !930)
!932 = !DILocation(line: 16, column: 5, scope: !926)
!933 = !DILocation(line: 17, column: 19, scope: !926)
!934 = !DILocation(line: 17, column: 27, scope: !926)
!935 = !DILocation(line: 17, column: 5, scope: !926)
!936 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !869, size: 64)
!937 = !DILocalVariable(name: "Dahili",
  scope: !926, file: !9, line: 17, type: !936)
!938 = !DILocation(line: 17, column: 5, scope: !926)
!939 = !DILocation(line: 19, column: 5, scope: !926)
!940 = !DILocation(line: 19, column: 5, scope: !926)
!941 = !DILocation(line: 19, column: 27, scope: !926)
!942 = !DILocation(line: 19, column: 5, scope: !926)
!943 = !DILocation(line: 20, column: 5, scope: !926)
!944 = !DILocation(line: 20, column: 5, scope: !926)
!945 = !DILocation(line: 20, column: 27, scope: !926)
!946 = !DILocation(line: 20, column: 5, scope: !926)
!947 = !DILocation(line: 21, column: 5, scope: !926)
!948 = !DILocation(line: 21, column: 5, scope: !926)
!949 = !DILocation(line: 21, column: 27, scope: !926)
!950 = !DILocation(line: 21, column: 5, scope: !926)
!951 = !DILocation(line: 22, column: 9, scope: !926)
