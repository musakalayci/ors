...
@"dahil::Yeni_i"(%gt263t* %0, %gt34bt* %1)#0       !dbg !1144 {
; Değişken : dönüş
...
; Değişken : Kütüphane
  ...
  call void @llvm.dbg.declare(metadata %gt34bt** %5, metadata !1150, metadata !DIExpression()), !dbg !1154
;;-> (nil) 0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt2c2t** %8,
    align 8, !dbg !1158
  call void @llvm.dbg.declare(metadata %gt2c2t** %8, metadata !1160, metadata !DIExpression()), !dbg !1161
  %9 = load %gt263t*, %gt263t** %4, align 8, !dbg !1162; 2:0
  %10 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      %gt263t* %9, 
      i64 32, 
      i64 8), !dbg !1163
; Konum çevirisi:
  %11 = bitcast i8* %10 to %gt2ebt*; 1

; pascal 'Dahili' örs::derleme::imge::dahil::t
  %12 = alloca %gt2ebt*, align 8
  store 
    %gt2ebt* %11,
    %gt2ebt** %12,
    align 8, !dbg !1164
  call void @llvm.dbg.declare(metadata %gt2ebt** %12, metadata !1166, metadata !DIExpression()), !dbg !1167
; Atama ifadesi
  %13 = load %gt2c2t*, %gt2c2t** %8, align 8, !dbg !1168; 2:0
...
; Konum çevirisi:
  %15 = bitcast %gt2c1t* %14 to %gt2ebt**; 2
  %16 = load %gt2ebt*, %gt2ebt** %12, align 8, !dbg !1170; 2:0
  store 
    %gt2ebt* %16,
    %gt2ebt** %15,
    align 8, !dbg !1171
; Atama ifadesi
  %17 = load %gt2ebt*, %gt2ebt** %12, align 8, !dbg !1172; 2:0
; tür konumu *örs::derleme::imge::dahil::t : *örs::derleme::imge::t
  %18 = getelementptr inbounds 
    %gt2ebt, %gt2ebt* %17,
    i32 0, i32 0
  %19 = load %gt2c2t*, %gt2c2t** %8, align 8, !dbg !1174; 2:0
  store 
    %gt2c2t* %19,
    %gt2c2t** %18,
    align 8, !dbg !1175
; Atama ifadesi
  %20 = load %gt2ebt*, %gt2ebt** %12, align 8, !dbg !1176; 2:0
; tür konumu *örs::derleme::imge::dahil::t : *örs::derleme::kütüphane::t
  %21 = getelementptr inbounds 
    %gt2ebt, %gt2ebt* %20,
    i32 0, i32 2
  %22 = load %gt34bt*, %gt34bt** %5, align 8, !dbg !1178; 2:0
  store 
    %gt34bt* %22,
    %gt34bt** %21,
    align 8, !dbg !1179
  %23 = load %gt2ebt*, %gt2ebt** %12, align 8, !dbg !1180; 2:0
; Dönüş :
  ret %gt2ebt* %23
}
...
!1143 = !DINamespace(name:"dahil", scope: !1142)


!1145 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !903, size: 64)
...
!1152 = !{null, !1147, !1149 }
!1144 = distinct !DISubprogram( name: "dahil::Yeni_i",
 scope: !1143,
 file: !9,
 line: 14,
 type: !1151, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1153 = !DILocation(line: 14, column: 19, scope: !1144)
!1154 = !DILocation(line: 14, column: 38, scope: !1144)
!1155 = distinct !DILexicalBlock(
        scope: !1144, file: !9, line: 15, column: 3)
!1156 = !DILocation(line: 16, column: 26, scope: !1155)
!1157 = !DILocation(line: 16, column: 21, scope: !1155)
!1158 = !DILocation(line: 16, column: 5, scope: !1155)
!1159 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1160 = !DILocalVariable(name: "İmge",
  scope: !1155, file: !9, line: 16, type: !1159)
!1161 = !DILocation(line: 16, column: 5, scope: !1155)
!1162 = !DILocation(line: 17, column: 19, scope: !1155)
!1163 = !DILocation(line: 17, column: 27, scope: !1155)
!1164 = !DILocation(line: 17, column: 5, scope: !1155)
!1165 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !903, size: 64)
!1166 = !DILocalVariable(name: "Dahili",
  scope: !1155, file: !9, line: 17, type: !1165)
!1167 = !DILocation(line: 17, column: 5, scope: !1155)
!1168 = !DILocation(line: 19, column: 5, scope: !1155)
!1169 = !DILocation(line: 19, column: 5, scope: !1155)
!1170 = !DILocation(line: 19, column: 27, scope: !1155)
!1171 = !DILocation(line: 19, column: 5, scope: !1155)
!1172 = !DILocation(line: 20, column: 5, scope: !1155)
!1173 = !DILocation(line: 20, column: 5, scope: !1155)
!1174 = !DILocation(line: 20, column: 27, scope: !1155)
!1175 = !DILocation(line: 20, column: 5, scope: !1155)
!1176 = !DILocation(line: 21, column: 5, scope: !1155)
!1177 = !DILocation(line: 21, column: 5, scope: !1155)
!1178 = !DILocation(line: 21, column: 27, scope: !1155)
!1179 = !DILocation(line: 21, column: 5, scope: !1155)
!1180 = !DILocation(line: 22, column: 9, scope: !1155)
