...
define external %gt2cct* 
@"_eğer::Yeni_i"(%gt263t* %0)#0       !dbg !1144 {
; Değişken : dönüş
  %2 = alloca %gt2cct*, align 8
  store %gt2cct* null, %gt2cct** %2, align 8
; Değişken : Hafıza
  ...
  %5 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      ...
      i64 8), !dbg !1154
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt2cct*; 1

; pascal 'Eğer' örs::derleme::imge::_eğer::t
  %7 = alloca %gt2cct*, align 8
  store 
    %gt2cct* %6,
    %gt2cct** %7,
    align 8, !dbg !1155
  call void @llvm.dbg.declare(metadata %gt2cct** %7, metadata !1157, metadata !DIExpression()), !dbg !1158
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt2cct*, %gt2cct** %7, align 8, !dbg !1165; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt2c1t* %15 to %gt2cct**; 2
  %17 = load %gt2cct*, %gt2cct** %7, align 8, !dbg !1171; 2:0
  store 
    %gt2cct* %17,
    %gt2cct** %16,
    align 8, !dbg !1172
  %18 = load %gt2cct*, %gt2cct** %7, align 8, !dbg !1173; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::k[%st561_1gt2c2t]
  %19 = getelementptr inbounds 
    %gt2cct, %gt2cct* %18,
    i32 0, i32 4
;;-> (nil) 0
  %20 = load %gt263t*, %gt263t** %3, align 8, !dbg !1175; 2:0
 call void @"imge::zincir.Yapılandır_i" (
      %st561_1gt2c2t* %19, 
      %gt263t* %20), !dbg !1176
  %21 = load %gt2cct*, %gt2cct** %7, align 8, !dbg !1177; 2:0
; Dönüş :
  ret %gt2cct* %21
}
...
define external 
%gt2cdt* @"_eğer::eğerki.Yeni_i"(%gt263t* %0)
#0       !dbg !1178 {
; Değişken : dönüş
  %2 = alloca %gt2cdt*, align 8
  store %gt2cdt* null, %gt2cdt** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt263t*, align 8
  store %gt263t* %0, %gt263t** %3, align 8
  call void @llvm.dbg.declare(metadata %gt263t** %3, metadata !1182, metadata !DIExpression()), !dbg !1185
  %4 = load %gt263t*, %gt263t** %3, align 8, !dbg !1187; 2:0
  %5 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      %gt263t* %4, 
      i64 16, 
      i64 8), !dbg !1188
...
; pascal 'Eğerki' örs::derleme::imge::_eğer::t
  ...
  store 
    ...
    %gt2cct** %7,
    align 8, !dbg !1189
  call void @llvm.dbg.declare(metadata %gt2cct** %7, metadata !1191, metadata !DIExpression()), !dbg !1192
;;-> (nil) 0
  %8 = load %gt263t*, %gt263t** %3, align 8, !dbg !1193; 2:0
;;-> (nil) 0
  %9 = call %gt2c2t* @"imge::Yeni_i" (
      %gt263t* %8, 
      i32 337), !dbg !1194
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt2c2t** %10,
    align 8, !dbg !1195
  call void @llvm.dbg.declare(metadata %gt2c2t** %10, metadata !1197, metadata !DIExpression()), !dbg !1198
; Atama ifadesi
  %11 = load %gt2c2t*, %gt2c2t** %10, align 8, !dbg !1199; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
  %12 = getelementptr inbounds 
    %gt2c2t, %gt2c2t* %11,
    i32 0, i32 5
...
; Konum çevirisi:
  %13 = bitcast %gt2c1t* %12 to %gt2cdt**; 2
  %14 = load %gt2cct*, %gt2cct** %7, align 8, !dbg !1201; 2:0
  store 
    %gt2cct* %14,
    %gt2cdt** %13,
    align 8, !dbg !1202
; Atama ifadesi
  %15 = load %gt2cct*, %gt2cct** %7, align 8, !dbg !1203; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt2cct, %gt2cct* %15,
    i32 0, i32 0
  %17 = load %gt2c2t*, %gt2c2t** %10, align 8, !dbg !1205; 2:0
  store 
    %gt2c2t* %17,
    %gt2c2t** %16,
    align 8, !dbg !1206
  %18 = load %gt2cct*, %gt2cct** %7, align 8, !dbg !1207; 2:0
; Dönüş :
  ret %gt2cct* %18
}

define external 
%gt2cft* @"_eğer::_değilse.Yeni_i"(%gt263t* %0)
#0       !dbg !1208 {
; Değişken : dönüş
...
; Değişken : Hafıza
  %3 = alloca %gt263t*, align 8
  store %gt263t* %0, %gt263t** %3, align 8
  call void @llvm.dbg.declare(metadata %gt263t** %3, metadata !1212, metadata !DIExpression()), !dbg !1215
  %4 = load %gt263t*, %gt263t** %3, align 8, !dbg !1217; 2:0
  %5 = call i8* (%gt263t*,i64,i64) @"hafıza::t.Yeni_i" (
      %gt263t* %4, 
      i64 16, 
      i64 8), !dbg !1218
...
; pascal 'Değilse' örs::derleme::imge::_eğer::t
  ...
  store 
    ...
    %gt2cct** %7,
    align 8, !dbg !1219
  call void @llvm.dbg.declare(metadata %gt2cct** %7, metadata !1221, metadata !DIExpression()), !dbg !1222
;;-> (nil) 0
  %8 = load %gt263t*, %gt263t** %3, align 8, !dbg !1223; 2:0
;;-> (nil) 0
  %9 = call %gt2c2t* @"imge::Yeni_i" (
      %gt263t* %8, 
      i32 339), !dbg !1224
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt2c2t** %10,
    align 8, !dbg !1225
  call void @llvm.dbg.declare(metadata %gt2c2t** %10, metadata !1227, metadata !DIExpression()), !dbg !1228
; Atama ifadesi
  %11 = load %gt2c2t*, %gt2c2t** %10, align 8, !dbg !1229; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
  %12 = getelementptr inbounds 
    %gt2c2t, %gt2c2t* %11,
    i32 0, i32 5
...
; Konum çevirisi:
  %13 = bitcast %gt2c1t* %12 to %gt2cft**; 2
  %14 = load %gt2cct*, %gt2cct** %7, align 8, !dbg !1231; 2:0
  store 
    %gt2cct* %14,
    %gt2cft** %13,
    align 8, !dbg !1232
; Atama ifadesi
  %15 = load %gt2cct*, %gt2cct** %7, align 8, !dbg !1233; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt2cct, %gt2cct* %15,
    i32 0, i32 0
  %17 = load %gt2c2t*, %gt2c2t** %10, align 8, !dbg !1235; 2:0
  store 
    %gt2c2t* %17,
    %gt2c2t** %16,
    align 8, !dbg !1236
  %18 = load %gt2cct*, %gt2cct** %7, align 8, !dbg !1237; 2:0
; Dönüş :
  ret %gt2cct* %18
}
...
;örs::derleme::imge::Yapılandır
  declare void @"imge::zincir.Yapılandır_i"(%st561_1gt2c2t*, %gt263t*) #0
...
!1143 = !DINamespace(name:"_eğer", scope: !1142)


!1145 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !960, size: 64)
...
!1148 = !DILocalVariable(name: "Hafıza",
  scope: !1144, file: !9, line: 49, type: !1147, arg: 1)
!1149 = !DISubroutineType(types: !1150)
!1150 = !{null, !1147 }
!1144 = distinct !DISubprogram( name: "_eğer::Yeni_i",
 scope: !1143,
 file: !9,
 line: 49,
 type: !1149, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1151 = !DILocation(line: 49, column: 19, scope: !1144)
!1152 = distinct !DILexicalBlock(
        scope: !1144, file: !9, line: 50, column: 3)
!1153 = !DILocation(line: 51, column: 17, scope: !1152)
!1154 = !DILocation(line: 51, column: 25, scope: !1152)
!1155 = !DILocation(line: 51, column: 5, scope: !1152)
!1156 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !960, size: 64)
!1157 = !DILocalVariable(name: "Eğer",
  scope: !1152, file: !9, line: 51, type: !1156)
!1158 = !DILocation(line: 51, column: 5, scope: !1152)
!1159 = !DILocation(line: 52, column: 24, scope: !1152)
!1160 = !DILocation(line: 52, column: 19, scope: !1152)
!1161 = !DILocation(line: 52, column: 5, scope: !1152)
!1162 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1163 = !DILocalVariable(name: "İmge",
  scope: !1152, file: !9, line: 52, type: !1162)
!1164 = !DILocation(line: 52, column: 5, scope: !1152)
!1165 = !DILocation(line: 53, column: 5, scope: !1152)
!1166 = !DILocation(line: 53, column: 5, scope: !1152)
!1167 = !DILocation(line: 53, column: 25, scope: !1152)
!1168 = !DILocation(line: 53, column: 5, scope: !1152)
!1169 = !DILocation(line: 54, column: 5, scope: !1152)
!1170 = !DILocation(line: 54, column: 5, scope: !1152)
!1171 = !DILocation(line: 54, column: 25, scope: !1152)
!1172 = !DILocation(line: 54, column: 5, scope: !1152)
!1173 = !DILocation(line: 55, column: 5, scope: !1152)
!1174 = !DILocation(line: 55, column: 5, scope: !1152)
!1175 = !DILocation(line: 55, column: 31, scope: !1152)
!1176 = !DILocation(line: 55, column: 20, scope: !1152)
!1177 = !DILocation(line: 56, column: 9, scope: !1152)


!1179 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !990, size: 64)
!1180 = !DILocalVariable(name: "dönüş",
  scope: !1178, file: !9, line: 15, type: !1179)
!1181 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !88, size: 64)
!1182 = !DILocalVariable(name: "Hafıza",
  scope: !1178, file: !9, line: 23, type: !1181, arg: 1)
!1183 = !DISubroutineType(types: !1184)
!1184 = !{null, !1181 }
!1178 = distinct !DISubprogram( name: "_eğer::eğerki.Yeni_i",
 scope: !1143,
 file: !9,
 line: 22,
 type: !1183, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1185 = !DILocation(line: 23, column: 5, scope: !1178)
!1186 = distinct !DILexicalBlock(
        scope: !1178, file: !9, line: 32, column: 3)
!1187 = !DILocation(line: 25, column: 20, scope: !1186)
!1188 = !DILocation(line: 25, column: 28, scope: !1186)
!1189 = !DILocation(line: 25, column: 5, scope: !1186)
!1190 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !960, size: 64)
!1191 = !DILocalVariable(name: "Eğerki",
  scope: !1186, file: !9, line: 25, type: !1190)
!1192 = !DILocation(line: 25, column: 5, scope: !1186)
!1193 = !DILocation(line: 26, column: 27, scope: !1186)
!1194 = !DILocation(line: 26, column: 22, scope: !1186)
!1195 = !DILocation(line: 26, column: 5, scope: !1186)
!1196 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1197 = !DILocalVariable(name: "İmge",
  scope: !1186, file: !9, line: 26, type: !1196)
!1198 = !DILocation(line: 26, column: 5, scope: !1186)
!1199 = !DILocation(line: 27, column: 5, scope: !1186)
!1200 = !DILocation(line: 27, column: 5, scope: !1186)
!1201 = !DILocation(line: 27, column: 27, scope: !1186)
!1202 = !DILocation(line: 27, column: 5, scope: !1186)
!1203 = !DILocation(line: 28, column: 5, scope: !1186)
!1204 = !DILocation(line: 28, column: 5, scope: !1186)
!1205 = !DILocation(line: 28, column: 27, scope: !1186)
!1206 = !DILocation(line: 28, column: 5, scope: !1186)
!1207 = !DILocation(line: 29, column: 9, scope: !1186)


!1209 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1000, size: 64)
!1210 = !DILocalVariable(name: "dönüş",
  scope: !1208, file: !9, line: 15, type: !1209)
!1211 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !88, size: 64)
!1212 = !DILocalVariable(name: "Hafıza",
  scope: !1208, file: !9, line: 40, type: !1211, arg: 1)
!1213 = !DISubroutineType(types: !1214)
!1214 = !{null, !1211 }
!1208 = distinct !DISubprogram( name: "_eğer::_değilse.Yeni_i",
 scope: !1143,
 file: !9,
 line: 39,
 type: !1213, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1215 = !DILocation(line: 40, column: 5, scope: !1208)
!1216 = distinct !DILexicalBlock(
        scope: !1208, file: !9, line: 49, column: 3)
!1217 = !DILocation(line: 42, column: 20, scope: !1216)
!1218 = !DILocation(line: 42, column: 28, scope: !1216)
!1219 = !DILocation(line: 42, column: 5, scope: !1216)
!1220 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !960, size: 64)
!1221 = !DILocalVariable(name: "Değilse",
  scope: !1216, file: !9, line: 42, type: !1220)
!1222 = !DILocation(line: 42, column: 5, scope: !1216)
!1223 = !DILocation(line: 43, column: 27, scope: !1216)
!1224 = !DILocation(line: 43, column: 22, scope: !1216)
!1225 = !DILocation(line: 43, column: 5, scope: !1216)
!1226 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1227 = !DILocalVariable(name: "İmge",
  scope: !1216, file: !9, line: 43, type: !1226)
!1228 = !DILocation(line: 43, column: 5, scope: !1216)
!1229 = !DILocation(line: 44, column: 5, scope: !1216)
!1230 = !DILocation(line: 44, column: 5, scope: !1216)
!1231 = !DILocation(line: 44, column: 28, scope: !1216)
!1232 = !DILocation(line: 44, column: 5, scope: !1216)
!1233 = !DILocation(line: 45, column: 5, scope: !1216)
!1234 = !DILocation(line: 45, column: 5, scope: !1216)
!1235 = !DILocation(line: 45, column: 28, scope: !1216)
!1236 = !DILocation(line: 45, column: 5, scope: !1216)
!1237 = !DILocation(line: 46, column: 9, scope: !1216)
