...
define external %gt254t* 
@"_eğer::Yeni_ox12Ci"(%gt1e2t* %0)#0       !dbg !1580 {
; Değişken : dönüş
  %2 = alloca %gt254t*, align 8
  store %gt254t* null, %gt254t** %2, align 8
; Değişken : Hafıza
...
; pascal 'Eğer' örs::derleme::imge::_eğer::t
  ...
  store 
    ...
    %gt254t** %7,
    align 8, !dbg !1590
  call void @llvm.dbg.declare(metadata %gt254t** %7, metadata !1591, metadata !DIExpression()), !dbg !1592
;;-> (nil) 0
  %8 = load %gt1e2t*, %gt1e2t** %3, align 8, !dbg !1593; 2:0
;;-> (nil) 0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt234t** %10,
    align 8, !dbg !1595
  call void @llvm.dbg.declare(metadata %gt234t** %10, metadata !1597, metadata !DIExpression()), !dbg !1598
; Atama ifadesi
  %11 = load %gt254t*, %gt254t** %7, align 8, !dbg !1599; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::t
  %12 = getelementptr inbounds 
    %gt254t, %gt254t* %11,
    i32 0, i32 0
  %13 = load %gt234t*, %gt234t** %10, align 8, !dbg !1601; 2:0
;atama:
  store 
    %gt234t* %13,
    %gt234t** %12,
    align 8, !dbg !1602
; Atama ifadesi
  %14 = load %gt234t*, %gt234t** %10, align 8, !dbg !1603; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt233t* %15 to %gt254t**; 2
  %17 = load %gt254t*, %gt254t** %7, align 8, !dbg !1605; 2:0
;atama:
  store 
    %gt254t* %17,
    %gt254t** %16,
    align 8, !dbg !1606
  %18 = load %gt254t*, %gt254t** %7, align 8, !dbg !1607; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::k[%st431_1gt234t]
  %19 = getelementptr inbounds 
    %gt254t, %gt254t* %18,
    i32 0, i32 4
;;-> (nil) 0
  %20 = load %gt1e2t*, %gt1e2t** %3, align 8, !dbg !1609; 2:0
 call void @"imge::zincir.Yapılandır_ox10ai" (
      %st431_1gt234t* %19, 
      %gt1e2t* %20), !dbg !1610
  %21 = load %gt254t*, %gt254t** %7, align 8, !dbg !1611; 2:0
; Dönüş :
  ret %gt254t* %21
}
...
define external 
%gt255t* @"_eğer::eğerki.Yeni_ox12ci"(%gt1e2t* %0)
#0       !dbg !1612 {
; Değişken : dönüş
...
; Değişken : Hafıza
  %3 = alloca %gt1e2t*, align 8
  store %gt1e2t* %0, %gt1e2t** %3, align 8
  call void @llvm.dbg.declare(metadata %gt1e2t** %3, metadata !1616, metadata !DIExpression()), !dbg !1619
  %4 = load %gt1e2t*, %gt1e2t** %3, align 8, !dbg !1621; 2:0
  %5 = call i8* (%gt1e2t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      %gt1e2t* %4, 
      i64 16, 
      i64 8), !dbg !1622
...
; pascal 'Eğerki' örs::derleme::imge::_eğer::t
  ...
  store 
    ...
    %gt254t** %7,
    align 8, !dbg !1623
  call void @llvm.dbg.declare(metadata %gt254t** %7, metadata !1624, metadata !DIExpression()), !dbg !1625
;;-> (nil) 0
  %8 = load %gt1e2t*, %gt1e2t** %3, align 8, !dbg !1626; 2:0
;;-> (nil) 0
  %9 = call %gt234t* @"imge::Yeni_ox10Ai" (
      %gt1e2t* %8, 
      i32 337), !dbg !1627
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt234t** %10,
    align 8, !dbg !1628
  call void @llvm.dbg.declare(metadata %gt234t** %10, metadata !1630, metadata !DIExpression()), !dbg !1631
; Atama ifadesi
  %11 = load %gt234t*, %gt234t** %10, align 8, !dbg !1632; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
  %12 = getelementptr inbounds 
    %gt234t, %gt234t* %11,
    i32 0, i32 5
...
; Konum çevirisi:
  %13 = bitcast %gt233t* %12 to %gt255t**; 2
  %14 = load %gt254t*, %gt254t** %7, align 8, !dbg !1634; 2:0
;atama:
  store 
    %gt254t* %14,
    %gt255t** %13,
    align 8, !dbg !1635
; Atama ifadesi
  %15 = load %gt254t*, %gt254t** %7, align 8, !dbg !1636; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt254t, %gt254t* %15,
    i32 0, i32 0
  %17 = load %gt234t*, %gt234t** %10, align 8, !dbg !1638; 2:0
;atama:
  store 
    %gt234t* %17,
    %gt234t** %16,
    align 8, !dbg !1639
  %18 = load %gt254t*, %gt254t** %7, align 8, !dbg !1640; 2:0
; Dönüş :
  ret %gt254t* %18
}

define external 
%gt257t* @"_eğer::_değilse.Yeni_ox12ci"(%gt1e2t* %0)
#0       !dbg !1641 {
; Değişken : dönüş
  %2 = alloca %gt257t*, align 8
  store %gt257t* null, %gt257t** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt1e2t*, align 8
  store %gt1e2t* %0, %gt1e2t** %3, align 8
  call void @llvm.dbg.declare(metadata %gt1e2t** %3, metadata !1645, metadata !DIExpression()), !dbg !1648
  %4 = load %gt1e2t*, %gt1e2t** %3, align 8, !dbg !1650; 2:0
  %5 = call i8* (%gt1e2t*,i64,i64) @"hafıza::t.Yeni_ox107i" (
      %gt1e2t* %4, 
      i64 16, 
      i64 8), !dbg !1651
...
; pascal 'Değilse' örs::derleme::imge::_eğer::t
  ...
  store 
    ...
    %gt254t** %7,
    align 8, !dbg !1652
  call void @llvm.dbg.declare(metadata %gt254t** %7, metadata !1653, metadata !DIExpression()), !dbg !1654
;;-> (nil) 0
  %8 = load %gt1e2t*, %gt1e2t** %3, align 8, !dbg !1655; 2:0
;;-> (nil) 0
  %9 = call %gt234t* @"imge::Yeni_ox10Ai" (
      %gt1e2t* %8, 
      i32 339), !dbg !1656
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt234t** %10,
    align 8, !dbg !1657
  call void @llvm.dbg.declare(metadata %gt234t** %10, metadata !1659, metadata !DIExpression()), !dbg !1660
; Atama ifadesi
  %11 = load %gt234t*, %gt234t** %10, align 8, !dbg !1661; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
  %12 = getelementptr inbounds 
    %gt234t, %gt234t* %11,
    i32 0, i32 5
...
; Konum çevirisi:
  %13 = bitcast %gt233t* %12 to %gt257t**; 2
  %14 = load %gt254t*, %gt254t** %7, align 8, !dbg !1663; 2:0
;atama:
  store 
    %gt254t* %14,
    %gt257t** %13,
    align 8, !dbg !1664
; Atama ifadesi
  %15 = load %gt254t*, %gt254t** %7, align 8, !dbg !1665; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt254t, %gt254t* %15,
    i32 0, i32 0
  %17 = load %gt234t*, %gt234t** %10, align 8, !dbg !1667; 2:0
;atama:
  store 
    %gt234t* %17,
    %gt234t** %16,
    align 8, !dbg !1668
  %18 = load %gt254t*, %gt254t** %7, align 8, !dbg !1669; 2:0
; Dönüş :
  ret %gt254t* %18
}
...
;örs::derleme::imge::Yapılandır
  declare void @"imge::zincir.Yapılandır_ox10ai"(%st431_1gt234t*, %gt1e2t*) #0
...
!1579 = !DINamespace(name:"_eğer", scope: !1578)


!1581 = !DILocalVariable(name: "dönüş",
  scope: !1580, file: !9, line: 15, type: !1422)
!1582 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1583 = !DILocalVariable(name: "Hafıza",
  scope: !1580, file: !9, line: 49, type: !1582, arg: 1)
!1584 = !DISubroutineType(types: !1585)
!1585 = !{null, !1582 }
!1580 = distinct !DISubprogram( name: "_eğer::Yeni_ox12Ci",
 scope: !1579,
 file: !9,
 line: 49,
 type: !1584, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1586 = !DILocation(line: 49, column: 19, scope: !1580)
!1587 = distinct !DILexicalBlock(
        scope: !1580, file: !9, line: 50, column: 3)
!1588 = !DILocation(line: 51, column: 17, scope: !1587)
!1589 = !DILocation(line: 51, column: 25, scope: !1587)
!1590 = !DILocation(line: 51, column: 5, scope: !1587)
!1591 = !DILocalVariable(name: "Eğer",
  scope: !1587, file: !9, line: 51, type: !1422)
!1592 = !DILocation(line: 51, column: 5, scope: !1587)
!1593 = !DILocation(line: 52, column: 24, scope: !1587)
!1594 = !DILocation(line: 52, column: 19, scope: !1587)
!1595 = !DILocation(line: 52, column: 5, scope: !1587)
!1596 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1597 = !DILocalVariable(name: "İmge",
  scope: !1587, file: !9, line: 52, type: !1596)
!1598 = !DILocation(line: 52, column: 5, scope: !1587)
!1599 = !DILocation(line: 53, column: 5, scope: !1587)
!1600 = !DILocation(line: 53, column: 5, scope: !1587)
!1601 = !DILocation(line: 53, column: 25, scope: !1587)
!1602 = !DILocation(line: 53, column: 5, scope: !1587)
!1603 = !DILocation(line: 54, column: 5, scope: !1587)
!1604 = !DILocation(line: 54, column: 5, scope: !1587)
!1605 = !DILocation(line: 54, column: 25, scope: !1587)
!1606 = !DILocation(line: 54, column: 5, scope: !1587)
!1607 = !DILocation(line: 55, column: 5, scope: !1587)
!1608 = !DILocation(line: 55, column: 5, scope: !1587)
!1609 = !DILocation(line: 55, column: 31, scope: !1587)
!1610 = !DILocation(line: 55, column: 20, scope: !1587)
!1611 = !DILocation(line: 56, column: 9, scope: !1587)


!1613 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1451, size: 64)
!1614 = !DILocalVariable(name: "dönüş",
  scope: !1612, file: !9, line: 15, type: !1613)
!1615 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1616 = !DILocalVariable(name: "Hafıza",
  scope: !1612, file: !9, line: 23, type: !1615, arg: 1)
!1617 = !DISubroutineType(types: !1618)
!1618 = !{null, !1615 }
!1612 = distinct !DISubprogram( name: "_eğer::eğerki.Yeni_ox12ci",
 scope: !1579,
 file: !9,
 line: 22,
 type: !1617, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1619 = !DILocation(line: 23, column: 5, scope: !1612)
!1620 = distinct !DILexicalBlock(
        scope: !1612, file: !9, line: 32, column: 3)
!1621 = !DILocation(line: 25, column: 20, scope: !1620)
!1622 = !DILocation(line: 25, column: 28, scope: !1620)
!1623 = !DILocation(line: 25, column: 5, scope: !1620)
!1624 = !DILocalVariable(name: "Eğerki",
  scope: !1620, file: !9, line: 25, type: !1422)
!1625 = !DILocation(line: 25, column: 5, scope: !1620)
!1626 = !DILocation(line: 26, column: 27, scope: !1620)
!1627 = !DILocation(line: 26, column: 22, scope: !1620)
!1628 = !DILocation(line: 26, column: 5, scope: !1620)
!1629 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1630 = !DILocalVariable(name: "İmge",
  scope: !1620, file: !9, line: 26, type: !1629)
!1631 = !DILocation(line: 26, column: 5, scope: !1620)
!1632 = !DILocation(line: 27, column: 5, scope: !1620)
!1633 = !DILocation(line: 27, column: 5, scope: !1620)
!1634 = !DILocation(line: 27, column: 27, scope: !1620)
!1635 = !DILocation(line: 27, column: 5, scope: !1620)
!1636 = !DILocation(line: 28, column: 5, scope: !1620)
!1637 = !DILocation(line: 28, column: 5, scope: !1620)
!1638 = !DILocation(line: 28, column: 27, scope: !1620)
!1639 = !DILocation(line: 28, column: 5, scope: !1620)
!1640 = !DILocation(line: 29, column: 9, scope: !1620)


!1642 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1461, size: 64)
!1643 = !DILocalVariable(name: "dönüş",
  scope: !1641, file: !9, line: 15, type: !1642)
!1644 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1645 = !DILocalVariable(name: "Hafıza",
  scope: !1641, file: !9, line: 40, type: !1644, arg: 1)
!1646 = !DISubroutineType(types: !1647)
!1647 = !{null, !1644 }
!1641 = distinct !DISubprogram( name: "_eğer::_değilse.Yeni_ox12ci",
 scope: !1579,
 file: !9,
 line: 39,
 type: !1646, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1648 = !DILocation(line: 40, column: 5, scope: !1641)
!1649 = distinct !DILexicalBlock(
        scope: !1641, file: !9, line: 49, column: 3)
!1650 = !DILocation(line: 42, column: 20, scope: !1649)
!1651 = !DILocation(line: 42, column: 28, scope: !1649)
!1652 = !DILocation(line: 42, column: 5, scope: !1649)
!1653 = !DILocalVariable(name: "Değilse",
  scope: !1649, file: !9, line: 42, type: !1422)
!1654 = !DILocation(line: 42, column: 5, scope: !1649)
!1655 = !DILocation(line: 43, column: 27, scope: !1649)
!1656 = !DILocation(line: 43, column: 22, scope: !1649)
!1657 = !DILocation(line: 43, column: 5, scope: !1649)
!1658 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1659 = !DILocalVariable(name: "İmge",
  scope: !1649, file: !9, line: 43, type: !1658)
!1660 = !DILocation(line: 43, column: 5, scope: !1649)
!1661 = !DILocation(line: 44, column: 5, scope: !1649)
!1662 = !DILocation(line: 44, column: 5, scope: !1649)
!1663 = !DILocation(line: 44, column: 28, scope: !1649)
!1664 = !DILocation(line: 44, column: 5, scope: !1649)
!1665 = !DILocation(line: 45, column: 5, scope: !1649)
!1666 = !DILocation(line: 45, column: 5, scope: !1649)
!1667 = !DILocation(line: 45, column: 28, scope: !1649)
!1668 = !DILocation(line: 45, column: 5, scope: !1649)
!1669 = !DILocation(line: 46, column: 9, scope: !1649)
