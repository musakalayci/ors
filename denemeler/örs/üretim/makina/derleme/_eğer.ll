...
define external %gt251t* 
@"_eğer::Yeni_ox12Ci"(%gt1e0t* %0)#0       {
; Değişken : dönüş
  %2 = alloca %gt251t*, align 8
  store %gt251t* null, %gt251t** %2, align 8
; Değişken : Hafıza
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    align 8
; Atama ifadesi
  %11 = load %gt251t*, %gt251t** %7, align 8; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt230t* %15 to %gt251t**; 2
  %17 = load %gt251t*, %gt251t** %7, align 8; 2:0
;atama:
  store 
    %gt251t* %17,
    %gt251t** %16,
    align 8
  %18 = load %gt251t*, %gt251t** %7, align 8; 2:0
...
;;-> (nil) 0
 ...
 call void @"imge::zincir.Yapılandır_ox10ai" (
      %st429_1gt231t* %19, 
      %gt1e0t* %20)
  %21 = load %gt251t*, %gt251t** %7, align 8; 2:0
; Dönüş :
  ret %gt251t* %21
}
...
define external 
%gt252t* @"_eğer::eğerki.Yeni_ox12ci"(%gt1e0t* %0)
#0       {
; Değişken : dönüş
  %2 = alloca %gt252t*, align 8
  store %gt252t* null, %gt252t** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt1e0t*, align 8
  store %gt1e0t* %0, %gt1e0t** %3, align 8
  %4 = load %gt1e0t*, %gt1e0t** %3, align 8; 2:0
...
; Konum çevirisi:
  %13 = bitcast %gt230t* %12 to %gt252t**; 2
  %14 = load %gt251t*, %gt251t** %7, align 8; 2:0
;atama:
  store 
    %gt251t* %14,
    %gt252t** %13,
    align 8
; Atama ifadesi
  %15 = load %gt251t*, %gt251t** %7, align 8; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::t
...
define external 
%gt254t* @"_eğer::_değilse.Yeni_ox12ci"(%gt1e0t* %0)
#0       {
; Değişken : dönüş
...
; Konum çevirisi:
  %13 = bitcast %gt230t* %12 to %gt254t**; 2
  %14 = load %gt251t*, %gt251t** %7, align 8; 2:0
;atama:
  store 
    %gt251t* %14,
