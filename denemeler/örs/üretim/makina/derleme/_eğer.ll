...
@"_eğer::Yeni_ox14Fi"(%gt294t* %0)#0       !dbg !1724 {
; Değişken : dönüş
  %2 = alloca %gt3eat*, align 8
  store %gt3eat* null, %gt3eat** %2, align 8
; Değişken : Hafıza
  ...
  %5 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1734
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt3eat*; 1

; pascal 'Eğer' örs::derleme::imge::_eğer::t
  %7 = alloca %gt3eat*, align 8
  store 
    %gt3eat* %6,
    %gt3eat** %7,
    align 8, !dbg !1735
  call void @llvm.dbg.declare(metadata %gt3eat** %7, metadata !1737, metadata !DIExpression()), !dbg !1738
;;-> (nil) 0
  %8 = load %gt294t*, %gt294t** %3, align 8, !dbg !1739; 2:0
...
; Atama ifadesi
  %11 = load %gt3eat*, %gt3eat** %7, align 8, !dbg !1745; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::t
  %12 = getelementptr inbounds 
    %gt3eat, %gt3eat* %11,
    i32 0, i32 0
  %13 = load %gt398t*, %gt398t** %10, align 8, !dbg !1747; 2:0
;atama:
  store 
    %gt398t* %13,
    %gt398t** %12,
    align 8, !dbg !1748
; Atama ifadesi
  %14 = load %gt398t*, %gt398t** %10, align 8, !dbg !1749; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt397t* %15 to %gt3eat**; 2
  %17 = load %gt3eat*, %gt3eat** %7, align 8, !dbg !1751; 2:0
;atama:
  store 
    %gt3eat* %17,
    %gt3eat** %16,
    align 8, !dbg !1752
  %18 = load %gt3eat*, %gt3eat** %7, align 8, !dbg !1753; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::k[%st640_1gt398t]
  %19 = getelementptr inbounds 
    %gt3eat, %gt3eat* %18,
    i32 0, i32 4
;;-> (nil) 0
  %20 = load %gt294t*, %gt294t** %3, align 8, !dbg !1755; 2:0
 call void @"imge::zincir.Yapılandır_ox110i" (
      %st640_1gt398t* %19, 
      %gt294t* %20), !dbg !1756
  %21 = load %gt3eat*, %gt3eat** %7, align 8, !dbg !1757; 2:0
; Dönüş :
  ret %gt3eat* %21
}
...
define external 
%gt3ebt* @"_eğer::eğerki.Yeni_ox14fi"(%gt294t* %0)
#0       !dbg !1758 {
; Değişken : dönüş
  %2 = alloca %gt3ebt*, align 8
  store %gt3ebt* null, %gt3ebt** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt294t*, align 8
  store %gt294t* %0, %gt294t** %3, align 8
  call void @llvm.dbg.declare(metadata %gt294t** %3, metadata !1762, metadata !DIExpression()), !dbg !1765
  %4 = load %gt294t*, %gt294t** %3, align 8, !dbg !1767; 2:0
  %5 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt294t* %4, 
      i64 16, 
      i64 8), !dbg !1768
...
; pascal 'Eğerki' örs::derleme::imge::_eğer::t
  ...
  store 
    ...
    %gt3eat** %7,
    align 8, !dbg !1769
  call void @llvm.dbg.declare(metadata %gt3eat** %7, metadata !1771, metadata !DIExpression()), !dbg !1772
;;-> (nil) 0
  %8 = load %gt294t*, %gt294t** %3, align 8, !dbg !1773; 2:0
  %9 = call %gt398t* @"imge::Yeni_ox110i" (
      %gt294t* %8, 
      i32 346), !dbg !1774
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt398t** %10,
    align 8, !dbg !1775
  call void @llvm.dbg.declare(metadata %gt398t** %10, metadata !1777, metadata !DIExpression()), !dbg !1778
; Atama ifadesi
  %11 = load %gt398t*, %gt398t** %10, align 8, !dbg !1779; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
  %12 = getelementptr inbounds 
    %gt398t, %gt398t* %11,
    i32 0, i32 5
...
; Konum çevirisi:
  %13 = bitcast %gt397t* %12 to %gt3ebt**; 2
  %14 = load %gt3eat*, %gt3eat** %7, align 8, !dbg !1781; 2:0
;atama:
  store 
    %gt3eat* %14,
    %gt3ebt** %13,
    align 8, !dbg !1782
; Atama ifadesi
  %15 = load %gt3eat*, %gt3eat** %7, align 8, !dbg !1783; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt3eat, %gt3eat* %15,
    i32 0, i32 0
  %17 = load %gt398t*, %gt398t** %10, align 8, !dbg !1785; 2:0
;atama:
  store 
    %gt398t* %17,
    %gt398t** %16,
    align 8, !dbg !1786
  %18 = load %gt3eat*, %gt3eat** %7, align 8, !dbg !1787; 2:0
; Dönüş :
  ret %gt3eat* %18
}

define external 
%gt3edt* @"_eğer::_değilse.Yeni_ox14fi"(%gt294t* %0)
#0       !dbg !1788 {
; Değişken : dönüş
  %2 = alloca %gt3edt*, align 8
  store %gt3edt* null, %gt3edt** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt294t*, align 8
  store %gt294t* %0, %gt294t** %3, align 8
...
; pascal 'Değilse' örs::derleme::imge::_eğer::t
  ...
  store 
    ...
    %gt3eat** %7,
    align 8, !dbg !1799
  call void @llvm.dbg.declare(metadata %gt3eat** %7, metadata !1801, metadata !DIExpression()), !dbg !1802
;;-> (nil) 0
  %8 = load %gt294t*, %gt294t** %3, align 8, !dbg !1803; 2:0
  %9 = call %gt398t* @"imge::Yeni_ox110i" (
      %gt294t* %8, 
      i32 348), !dbg !1804
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt398t** %10,
    align 8, !dbg !1805
  call void @llvm.dbg.declare(metadata %gt398t** %10, metadata !1807, metadata !DIExpression()), !dbg !1808
; Atama ifadesi
  %11 = load %gt398t*, %gt398t** %10, align 8, !dbg !1809; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
  %12 = getelementptr inbounds 
    %gt398t, %gt398t* %11,
    i32 0, i32 5
...
; Konum çevirisi:
  %13 = bitcast %gt397t* %12 to %gt3edt**; 2
  %14 = load %gt3eat*, %gt3eat** %7, align 8, !dbg !1811; 2:0
;atama:
  store 
    %gt3eat* %14,
    %gt3edt** %13,
    align 8, !dbg !1812
; Atama ifadesi
  %15 = load %gt3eat*, %gt3eat** %7, align 8, !dbg !1813; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt3eat, %gt3eat* %15,
    i32 0, i32 0
  %17 = load %gt398t*, %gt398t** %10, align 8, !dbg !1815; 2:0
;atama:
  store 
    %gt398t* %17,
    %gt398t** %16,
    align 8, !dbg !1816
  %18 = load %gt3eat*, %gt3eat** %7, align 8, !dbg !1817; 2:0
; Dönüş :
  ret %gt3eat* %18
}
...
!1723 = !DINamespace(name:"_eğer", scope: !1722)


!1725 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1588, size: 64)
...
!1728 = !DILocalVariable(name: "Hafıza",
  scope: !1724, file: !9, line: 49, type: !1727, arg: 1)
!1729 = !DISubroutineType(types: !1730)
!1730 = !{null, !1727 }
!1724 = distinct !DISubprogram( name: "_eğer::Yeni_ox14Fi",
 scope: !1723,
 file: !9,
 line: 49,
 type: !1729, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1731 = !DILocation(line: 49, column: 19, scope: !1724)
!1732 = distinct !DILexicalBlock(
        scope: !1724, file: !9, line: 50, column: 3)
!1733 = !DILocation(line: 51, column: 17, scope: !1732)
!1734 = !DILocation(line: 51, column: 25, scope: !1732)
!1735 = !DILocation(line: 51, column: 5, scope: !1732)
!1736 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1588, size: 64)
!1737 = !DILocalVariable(name: "Eğer",
  scope: !1732, file: !9, line: 51, type: !1736)
!1738 = !DILocation(line: 51, column: 5, scope: !1732)
!1739 = !DILocation(line: 52, column: 24, scope: !1732)
!1740 = !DILocation(line: 52, column: 19, scope: !1732)
!1741 = !DILocation(line: 52, column: 5, scope: !1732)
!1742 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1743 = !DILocalVariable(name: "İmge",
  scope: !1732, file: !9, line: 52, type: !1742)
!1744 = !DILocation(line: 52, column: 5, scope: !1732)
!1745 = !DILocation(line: 53, column: 5, scope: !1732)
!1746 = !DILocation(line: 53, column: 5, scope: !1732)
!1747 = !DILocation(line: 53, column: 25, scope: !1732)
!1748 = !DILocation(line: 53, column: 5, scope: !1732)
!1749 = !DILocation(line: 54, column: 5, scope: !1732)
!1750 = !DILocation(line: 54, column: 5, scope: !1732)
!1751 = !DILocation(line: 54, column: 25, scope: !1732)
!1752 = !DILocation(line: 54, column: 5, scope: !1732)
!1753 = !DILocation(line: 55, column: 5, scope: !1732)
!1754 = !DILocation(line: 55, column: 5, scope: !1732)
!1755 = !DILocation(line: 55, column: 31, scope: !1732)
!1756 = !DILocation(line: 55, column: 20, scope: !1732)
!1757 = !DILocation(line: 56, column: 9, scope: !1732)


!1759 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1601, size: 64)
!1760 = !DILocalVariable(name: "dönüş",
  scope: !1758, file: !9, line: 15, type: !1759)
!1761 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1762 = !DILocalVariable(name: "Hafıza",
  scope: !1758, file: !9, line: 23, type: !1761, arg: 1)
!1763 = !DISubroutineType(types: !1764)
!1764 = !{null, !1761 }
!1758 = distinct !DISubprogram( name: "_eğer::eğerki.Yeni_ox14fi",
 scope: !1723,
 file: !9,
 line: 22,
 type: !1763, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1765 = !DILocation(line: 23, column: 5, scope: !1758)
!1766 = distinct !DILexicalBlock(
        scope: !1758, file: !9, line: 32, column: 3)
!1767 = !DILocation(line: 25, column: 20, scope: !1766)
!1768 = !DILocation(line: 25, column: 28, scope: !1766)
!1769 = !DILocation(line: 25, column: 5, scope: !1766)
!1770 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1588, size: 64)
!1771 = !DILocalVariable(name: "Eğerki",
  scope: !1766, file: !9, line: 25, type: !1770)
!1772 = !DILocation(line: 25, column: 5, scope: !1766)
!1773 = !DILocation(line: 26, column: 27, scope: !1766)
!1774 = !DILocation(line: 26, column: 22, scope: !1766)
!1775 = !DILocation(line: 26, column: 5, scope: !1766)
!1776 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1777 = !DILocalVariable(name: "İmge",
  scope: !1766, file: !9, line: 26, type: !1776)
!1778 = !DILocation(line: 26, column: 5, scope: !1766)
!1779 = !DILocation(line: 27, column: 5, scope: !1766)
!1780 = !DILocation(line: 27, column: 5, scope: !1766)
!1781 = !DILocation(line: 27, column: 27, scope: !1766)
!1782 = !DILocation(line: 27, column: 5, scope: !1766)
!1783 = !DILocation(line: 28, column: 5, scope: !1766)
!1784 = !DILocation(line: 28, column: 5, scope: !1766)
!1785 = !DILocation(line: 28, column: 27, scope: !1766)
!1786 = !DILocation(line: 28, column: 5, scope: !1766)
!1787 = !DILocation(line: 29, column: 9, scope: !1766)


!1789 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1611, size: 64)
...
!1792 = !DILocalVariable(name: "Hafıza",
  scope: !1788, file: !9, line: 40, type: !1791, arg: 1)
!1793 = !DISubroutineType(types: !1794)
!1794 = !{null, !1791 }
!1788 = distinct !DISubprogram( name: "_eğer::_değilse.Yeni_ox14fi",
 scope: !1723,
 file: !9,
 line: 39,
 type: !1793, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1795 = !DILocation(line: 40, column: 5, scope: !1788)
!1796 = distinct !DILexicalBlock(
        scope: !1788, file: !9, line: 49, column: 3)
!1797 = !DILocation(line: 42, column: 20, scope: !1796)
!1798 = !DILocation(line: 42, column: 28, scope: !1796)
!1799 = !DILocation(line: 42, column: 5, scope: !1796)
!1800 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1588, size: 64)
!1801 = !DILocalVariable(name: "Değilse",
  scope: !1796, file: !9, line: 42, type: !1800)
!1802 = !DILocation(line: 42, column: 5, scope: !1796)
!1803 = !DILocation(line: 43, column: 27, scope: !1796)
!1804 = !DILocation(line: 43, column: 22, scope: !1796)
!1805 = !DILocation(line: 43, column: 5, scope: !1796)
!1806 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1807 = !DILocalVariable(name: "İmge",
  scope: !1796, file: !9, line: 43, type: !1806)
!1808 = !DILocation(line: 43, column: 5, scope: !1796)
!1809 = !DILocation(line: 44, column: 5, scope: !1796)
!1810 = !DILocation(line: 44, column: 5, scope: !1796)
!1811 = !DILocation(line: 44, column: 28, scope: !1796)
!1812 = !DILocation(line: 44, column: 5, scope: !1796)
!1813 = !DILocation(line: 45, column: 5, scope: !1796)
!1814 = !DILocation(line: 45, column: 5, scope: !1796)
!1815 = !DILocation(line: 45, column: 28, scope: !1796)
!1816 = !DILocation(line: 45, column: 5, scope: !1796)
!1817 = !DILocation(line: 46, column: 9, scope: !1796)
