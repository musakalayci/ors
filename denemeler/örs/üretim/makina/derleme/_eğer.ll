...
@"_eğer::Yeni_ox14Fi"(%gt29at* %0)#0       !dbg !1807 {
; Değişken : dönüş
...
; pascal 'Eğer' örs::derleme::imge::_eğer::t
  ...
  store 
    ...
    %gt40ft** %7,
    align 8, !dbg !1818
  call void @llvm.dbg.declare(metadata %gt40ft** %7, metadata !1820, metadata !DIExpression()), !dbg !1821
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt40ft*, %gt40ft** %7, align 8, !dbg !1828; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt3bat* %15 to %gt40ft**; 2
  %17 = load %gt40ft*, %gt40ft** %7, align 8, !dbg !1834; 2:0
;atama:
  store 
    %gt40ft* %17,
    %gt40ft** %16,
    align 8, !dbg !1835
  %18 = load %gt40ft*, %gt40ft** %7, align 8, !dbg !1836; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::k[%st646_1gt3bbt]
  %19 = getelementptr inbounds 
    %gt40ft, %gt40ft* %18,
    i32 0, i32 4
;;-> (nil) 0
  %20 = load %gt29at*, %gt29at** %3, align 8, !dbg !1838; 2:0
 call void @"imge::zincir.Yapılandır_ox110i" (
      %st646_1gt3bbt* %19, 
      %gt29at* %20), !dbg !1839
  %21 = load %gt40ft*, %gt40ft** %7, align 8, !dbg !1840; 2:0
; Dönüş :
  ret %gt40ft* %21
}
...
define external 
%gt410t* @"_eğer::eğerki.Yeni_ox14fi"(%gt29at* %0)
#0       !dbg !1841 {
; Değişken : dönüş
  %2 = alloca %gt410t*, align 8
  store %gt410t* null, %gt410t** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt29at*, align 8
  store %gt29at* %0, %gt29at** %3, align 8
...
; pascal 'Eğerki' örs::derleme::imge::_eğer::t
  ...
  store 
    ...
    %gt40ft** %7,
    align 8, !dbg !1852
  call void @llvm.dbg.declare(metadata %gt40ft** %7, metadata !1854, metadata !DIExpression()), !dbg !1855
;;-> (nil) 0
  %8 = load %gt29at*, %gt29at** %3, align 8, !dbg !1856; 2:0
  %9 = call %gt3bbt* @"imge::Yeni_ox110i" (
      %gt29at* %8, 
      i32 346), !dbg !1857
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3bbt** %10,
    align 8, !dbg !1858
  call void @llvm.dbg.declare(metadata %gt3bbt** %10, metadata !1860, metadata !DIExpression()), !dbg !1861
; Atama ifadesi
  %11 = load %gt3bbt*, %gt3bbt** %10, align 8, !dbg !1862; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
  %12 = getelementptr inbounds 
    %gt3bbt, %gt3bbt* %11,
    i32 0, i32 5
...
; Konum çevirisi:
  %13 = bitcast %gt3bat* %12 to %gt410t**; 2
  %14 = load %gt40ft*, %gt40ft** %7, align 8, !dbg !1864; 2:0
;atama:
  store 
    %gt40ft* %14,
    %gt410t** %13,
    align 8, !dbg !1865
; Atama ifadesi
  %15 = load %gt40ft*, %gt40ft** %7, align 8, !dbg !1866; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt40ft, %gt40ft* %15,
    i32 0, i32 0
  %17 = load %gt3bbt*, %gt3bbt** %10, align 8, !dbg !1868; 2:0
;atama:
  store 
    %gt3bbt* %17,
    %gt3bbt** %16,
    align 8, !dbg !1869
  %18 = load %gt40ft*, %gt40ft** %7, align 8, !dbg !1870; 2:0
; Dönüş :
  ret %gt40ft* %18
}

define external 
%gt412t* @"_eğer::_değilse.Yeni_ox14fi"(%gt29at* %0)
#0       !dbg !1871 {
; Değişken : dönüş
  %2 = alloca %gt412t*, align 8
  store %gt412t* null, %gt412t** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt29at*, align 8
  store %gt29at* %0, %gt29at** %3, align 8
  call void @llvm.dbg.declare(metadata %gt29at** %3, metadata !1874, metadata !DIExpression()), !dbg !1877
  %4 = load %gt29at*, %gt29at** %3, align 8, !dbg !1879; 2:0
  %5 = call i8* (%gt29at*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt29at* %4, 
      i64 16, 
      i64 8), !dbg !1880
...
; pascal 'Değilse' örs::derleme::imge::_eğer::t
  ...
  store 
    ...
    %gt40ft** %7,
    align 8, !dbg !1881
  call void @llvm.dbg.declare(metadata %gt40ft** %7, metadata !1883, metadata !DIExpression()), !dbg !1884
;;-> (nil) 0
  %8 = load %gt29at*, %gt29at** %3, align 8, !dbg !1885; 2:0
  %9 = call %gt3bbt* @"imge::Yeni_ox110i" (
      %gt29at* %8, 
      i32 348), !dbg !1886
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3bbt** %10,
    align 8, !dbg !1887
  call void @llvm.dbg.declare(metadata %gt3bbt** %10, metadata !1889, metadata !DIExpression()), !dbg !1890
; Atama ifadesi
  %11 = load %gt3bbt*, %gt3bbt** %10, align 8, !dbg !1891; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
  %12 = getelementptr inbounds 
    %gt3bbt, %gt3bbt* %11,
    i32 0, i32 5
...
; Konum çevirisi:
  %13 = bitcast %gt3bat* %12 to %gt412t**; 2
  %14 = load %gt40ft*, %gt40ft** %7, align 8, !dbg !1893; 2:0
;atama:
  store 
    %gt40ft* %14,
    %gt412t** %13,
    align 8, !dbg !1894
; Atama ifadesi
  %15 = load %gt40ft*, %gt40ft** %7, align 8, !dbg !1895; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt40ft, %gt40ft* %15,
    i32 0, i32 0
  %17 = load %gt3bbt*, %gt3bbt** %10, align 8, !dbg !1897; 2:0
;atama:
  store 
    %gt3bbt* %17,
    %gt3bbt** %16,
    align 8, !dbg !1898
  %18 = load %gt40ft*, %gt40ft** %7, align 8, !dbg !1899; 2:0
; Dönüş :
  ret %gt40ft* %18
}
...
!1806 = !DINamespace(name:"_eğer", scope: !1805)


!1808 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1656, size: 64)
...
!1811 = !DILocalVariable(name: "Hafıza",
  scope: !1807, file: !9, line: 49, type: !1810, arg: 1)
!1812 = !DISubroutineType(types: !1813)
!1813 = !{null, !1810 }
!1807 = distinct !DISubprogram( name: "_eğer::Yeni_ox14Fi",
 scope: !1806,
 file: !9,
 line: 49,
 type: !1812, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1814 = !DILocation(line: 49, column: 19, scope: !1807)
!1815 = distinct !DILexicalBlock(
        scope: !1807, file: !9, line: 50, column: 3)
!1816 = !DILocation(line: 51, column: 17, scope: !1815)
!1817 = !DILocation(line: 51, column: 25, scope: !1815)
!1818 = !DILocation(line: 51, column: 5, scope: !1815)
!1819 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1656, size: 64)
!1820 = !DILocalVariable(name: "Eğer",
  scope: !1815, file: !9, line: 51, type: !1819)
!1821 = !DILocation(line: 51, column: 5, scope: !1815)
!1822 = !DILocation(line: 52, column: 24, scope: !1815)
!1823 = !DILocation(line: 52, column: 19, scope: !1815)
!1824 = !DILocation(line: 52, column: 5, scope: !1815)
!1825 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1826 = !DILocalVariable(name: "İmge",
  scope: !1815, file: !9, line: 52, type: !1825)
!1827 = !DILocation(line: 52, column: 5, scope: !1815)
!1828 = !DILocation(line: 53, column: 5, scope: !1815)
!1829 = !DILocation(line: 53, column: 5, scope: !1815)
!1830 = !DILocation(line: 53, column: 25, scope: !1815)
!1831 = !DILocation(line: 53, column: 5, scope: !1815)
!1832 = !DILocation(line: 54, column: 5, scope: !1815)
!1833 = !DILocation(line: 54, column: 5, scope: !1815)
!1834 = !DILocation(line: 54, column: 25, scope: !1815)
!1835 = !DILocation(line: 54, column: 5, scope: !1815)
!1836 = !DILocation(line: 55, column: 5, scope: !1815)
!1837 = !DILocation(line: 55, column: 5, scope: !1815)
!1838 = !DILocation(line: 55, column: 31, scope: !1815)
!1839 = !DILocation(line: 55, column: 20, scope: !1815)
!1840 = !DILocation(line: 56, column: 9, scope: !1815)


!1842 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1669, size: 64)
...
!1845 = !DILocalVariable(name: "Hafıza",
  scope: !1841, file: !9, line: 23, type: !1844, arg: 1)
!1846 = !DISubroutineType(types: !1847)
!1847 = !{null, !1844 }
!1841 = distinct !DISubprogram( name: "_eğer::eğerki.Yeni_ox14fi",
 scope: !1806,
 file: !9,
 line: 22,
 type: !1846, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1848 = !DILocation(line: 23, column: 5, scope: !1841)
!1849 = distinct !DILexicalBlock(
        scope: !1841, file: !9, line: 32, column: 3)
!1850 = !DILocation(line: 25, column: 20, scope: !1849)
!1851 = !DILocation(line: 25, column: 28, scope: !1849)
!1852 = !DILocation(line: 25, column: 5, scope: !1849)
!1853 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1656, size: 64)
!1854 = !DILocalVariable(name: "Eğerki",
  scope: !1849, file: !9, line: 25, type: !1853)
!1855 = !DILocation(line: 25, column: 5, scope: !1849)
!1856 = !DILocation(line: 26, column: 27, scope: !1849)
!1857 = !DILocation(line: 26, column: 22, scope: !1849)
!1858 = !DILocation(line: 26, column: 5, scope: !1849)
!1859 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1860 = !DILocalVariable(name: "İmge",
  scope: !1849, file: !9, line: 26, type: !1859)
!1861 = !DILocation(line: 26, column: 5, scope: !1849)
!1862 = !DILocation(line: 27, column: 5, scope: !1849)
!1863 = !DILocation(line: 27, column: 5, scope: !1849)
!1864 = !DILocation(line: 27, column: 27, scope: !1849)
!1865 = !DILocation(line: 27, column: 5, scope: !1849)
!1866 = !DILocation(line: 28, column: 5, scope: !1849)
!1867 = !DILocation(line: 28, column: 5, scope: !1849)
!1868 = !DILocation(line: 28, column: 27, scope: !1849)
!1869 = !DILocation(line: 28, column: 5, scope: !1849)
!1870 = !DILocation(line: 29, column: 9, scope: !1849)


!1872 = !DILocalVariable(name: "dönüş",
  scope: !1871, file: !9, line: 15, type: !1679)
!1873 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1874 = !DILocalVariable(name: "Hafıza",
  scope: !1871, file: !9, line: 40, type: !1873, arg: 1)
!1875 = !DISubroutineType(types: !1876)
!1876 = !{null, !1873 }
!1871 = distinct !DISubprogram( name: "_eğer::_değilse.Yeni_ox14fi",
 scope: !1806,
 file: !9,
 line: 39,
 type: !1875, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1877 = !DILocation(line: 40, column: 5, scope: !1871)
!1878 = distinct !DILexicalBlock(
        scope: !1871, file: !9, line: 49, column: 3)
!1879 = !DILocation(line: 42, column: 20, scope: !1878)
!1880 = !DILocation(line: 42, column: 28, scope: !1878)
!1881 = !DILocation(line: 42, column: 5, scope: !1878)
!1882 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1656, size: 64)
!1883 = !DILocalVariable(name: "Değilse",
  scope: !1878, file: !9, line: 42, type: !1882)
!1884 = !DILocation(line: 42, column: 5, scope: !1878)
!1885 = !DILocation(line: 43, column: 27, scope: !1878)
!1886 = !DILocation(line: 43, column: 22, scope: !1878)
!1887 = !DILocation(line: 43, column: 5, scope: !1878)
!1888 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1889 = !DILocalVariable(name: "İmge",
  scope: !1878, file: !9, line: 43, type: !1888)
!1890 = !DILocation(line: 43, column: 5, scope: !1878)
!1891 = !DILocation(line: 44, column: 5, scope: !1878)
!1892 = !DILocation(line: 44, column: 5, scope: !1878)
!1893 = !DILocation(line: 44, column: 28, scope: !1878)
!1894 = !DILocation(line: 44, column: 5, scope: !1878)
!1895 = !DILocation(line: 45, column: 5, scope: !1878)
!1896 = !DILocation(line: 45, column: 5, scope: !1878)
!1897 = !DILocation(line: 45, column: 28, scope: !1878)
!1898 = !DILocation(line: 45, column: 5, scope: !1878)
!1899 = !DILocation(line: 46, column: 9, scope: !1878)
