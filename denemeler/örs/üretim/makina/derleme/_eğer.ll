...
define external %gt415t* 
@"_eğer::Yeni_ox14Fi"(%gt29at* %0)#0       !dbg !1817 {
; Değişken : dönüş
...
; Değişken : Hafıza
  ...
  call void @llvm.dbg.declare(metadata %gt29at** %3, metadata !1821, metadata !DIExpression()), !dbg !1824
  %4 = load %gt29at*, %gt29at** %3, align 8, !dbg !1826; 2:0
  %5 = call i8* (%gt29at*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt29at* %4, 
      i64 64, 
      i64 8), !dbg !1827
; Konum çevirisi:
  %6 = bitcast i8* %5 to %gt415t*; 1

; pascal 'Eğer' örs::derleme::imge::_eğer::t
  %7 = alloca %gt415t*, align 8
  store 
    %gt415t* %6,
    %gt415t** %7,
    align 8, !dbg !1828
  call void @llvm.dbg.declare(metadata %gt415t** %7, metadata !1830, metadata !DIExpression()), !dbg !1831
;;-> (nil) 0
  %8 = load %gt29at*, %gt29at** %3, align 8, !dbg !1832; 2:0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3bft** %10,
    align 8, !dbg !1834
  call void @llvm.dbg.declare(metadata %gt3bft** %10, metadata !1836, metadata !DIExpression()), !dbg !1837
; Atama ifadesi
  %11 = load %gt415t*, %gt415t** %7, align 8, !dbg !1838; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::t
  %12 = getelementptr inbounds 
    %gt415t, %gt415t* %11,
    i32 0, i32 0
  %13 = load %gt3bft*, %gt3bft** %10, align 8, !dbg !1840; 2:0
;atama:
  store 
    %gt3bft* %13,
    %gt3bft** %12,
    align 8, !dbg !1841
; Atama ifadesi
  %14 = load %gt3bft*, %gt3bft** %10, align 8, !dbg !1842; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt3bet* %15 to %gt415t**; 2
  %17 = load %gt415t*, %gt415t** %7, align 8, !dbg !1844; 2:0
;atama:
  store 
    %gt415t* %17,
    %gt415t** %16,
    align 8, !dbg !1845
  %18 = load %gt415t*, %gt415t** %7, align 8, !dbg !1846; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::k[%st646_1gt3bft]
  %19 = getelementptr inbounds 
    %gt415t, %gt415t* %18,
    i32 0, i32 4
;;-> (nil) 0
  %20 = load %gt29at*, %gt29at** %3, align 8, !dbg !1848; 2:0
 call void @"imge::zincir.Yapılandır_ox110i" (
      %st646_1gt3bft* %19, 
      %gt29at* %20), !dbg !1849
  %21 = load %gt415t*, %gt415t** %7, align 8, !dbg !1850; 2:0
; Dönüş :
  ret %gt415t* %21
}
...
define external 
%gt416t* @"_eğer::eğerki.Yeni_ox14fi"(%gt29at* %0)
#0       !dbg !1851 {
; Değişken : dönüş
...
; Değişken : Hafıza
  %3 = alloca %gt29at*, align 8
  store %gt29at* %0, %gt29at** %3, align 8
  call void @llvm.dbg.declare(metadata %gt29at** %3, metadata !1855, metadata !DIExpression()), !dbg !1858
  %4 = load %gt29at*, %gt29at** %3, align 8, !dbg !1860; 2:0
  %5 = call i8* (%gt29at*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt29at* %4, 
      i64 16, 
      i64 8), !dbg !1861
...
; pascal 'Eğerki' örs::derleme::imge::_eğer::t
  ...
  store 
    ...
    %gt415t** %7,
    align 8, !dbg !1862
  call void @llvm.dbg.declare(metadata %gt415t** %7, metadata !1864, metadata !DIExpression()), !dbg !1865
;;-> (nil) 0
  %8 = load %gt29at*, %gt29at** %3, align 8, !dbg !1866; 2:0
  %9 = call %gt3bft* @"imge::Yeni_ox110i" (
      %gt29at* %8, 
      i32 346), !dbg !1867
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3bft** %10,
    align 8, !dbg !1868
  call void @llvm.dbg.declare(metadata %gt3bft** %10, metadata !1870, metadata !DIExpression()), !dbg !1871
; Atama ifadesi
  %11 = load %gt3bft*, %gt3bft** %10, align 8, !dbg !1872; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
  %12 = getelementptr inbounds 
    %gt3bft, %gt3bft* %11,
    i32 0, i32 5
...
; Konum çevirisi:
  %13 = bitcast %gt3bet* %12 to %gt416t**; 2
  %14 = load %gt415t*, %gt415t** %7, align 8, !dbg !1874; 2:0
;atama:
  store 
    %gt415t* %14,
    %gt416t** %13,
    align 8, !dbg !1875
; Atama ifadesi
  %15 = load %gt415t*, %gt415t** %7, align 8, !dbg !1876; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt415t, %gt415t* %15,
    i32 0, i32 0
  %17 = load %gt3bft*, %gt3bft** %10, align 8, !dbg !1878; 2:0
;atama:
  store 
    %gt3bft* %17,
    %gt3bft** %16,
    align 8, !dbg !1879
  %18 = load %gt415t*, %gt415t** %7, align 8, !dbg !1880; 2:0
; Dönüş :
  ret %gt415t* %18
}

define external 
%gt418t* @"_eğer::_değilse.Yeni_ox14fi"(%gt29at* %0)
#0       !dbg !1881 {
; Değişken : dönüş
  %2 = alloca %gt418t*, align 8
  store %gt418t* null, %gt418t** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt29at*, align 8
  store %gt29at* %0, %gt29at** %3, align 8
  call void @llvm.dbg.declare(metadata %gt29at** %3, metadata !1885, metadata !DIExpression()), !dbg !1888
  %4 = load %gt29at*, %gt29at** %3, align 8, !dbg !1890; 2:0
  %5 = call i8* (%gt29at*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt29at* %4, 
      i64 16, 
      i64 8), !dbg !1891
...
; pascal 'Değilse' örs::derleme::imge::_eğer::t
  ...
  store 
    ...
    %gt415t** %7,
    align 8, !dbg !1892
  call void @llvm.dbg.declare(metadata %gt415t** %7, metadata !1894, metadata !DIExpression()), !dbg !1895
;;-> (nil) 0
  %8 = load %gt29at*, %gt29at** %3, align 8, !dbg !1896; 2:0
  %9 = call %gt3bft* @"imge::Yeni_ox110i" (
      %gt29at* %8, 
      i32 348), !dbg !1897
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt3bft** %10,
    align 8, !dbg !1898
  call void @llvm.dbg.declare(metadata %gt3bft** %10, metadata !1900, metadata !DIExpression()), !dbg !1901
; Atama ifadesi
  %11 = load %gt3bft*, %gt3bft** %10, align 8, !dbg !1902; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
  %12 = getelementptr inbounds 
    %gt3bft, %gt3bft* %11,
    i32 0, i32 5
...
; Konum çevirisi:
  %13 = bitcast %gt3bet* %12 to %gt418t**; 2
  %14 = load %gt415t*, %gt415t** %7, align 8, !dbg !1904; 2:0
;atama:
  store 
    %gt415t* %14,
    %gt418t** %13,
    align 8, !dbg !1905
; Atama ifadesi
  %15 = load %gt415t*, %gt415t** %7, align 8, !dbg !1906; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt415t, %gt415t* %15,
    i32 0, i32 0
  %17 = load %gt3bft*, %gt3bft** %10, align 8, !dbg !1908; 2:0
;atama:
  store 
    %gt3bft* %17,
    %gt3bft** %16,
    align 8, !dbg !1909
  %18 = load %gt415t*, %gt415t** %7, align 8, !dbg !1910; 2:0
; Dönüş :
  ret %gt415t* %18
}
...
!1816 = !DINamespace(name:"_eğer", scope: !1815)


!1818 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1653, size: 64)
...
!1821 = !DILocalVariable(name: "Hafıza",
  scope: !1817, file: !9, line: 49, type: !1820, arg: 1)
!1822 = !DISubroutineType(types: !1823)
!1823 = !{null, !1820 }
!1817 = distinct !DISubprogram( name: "_eğer::Yeni_ox14Fi",
 scope: !1816,
 file: !9,
 line: 49,
 type: !1822, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1824 = !DILocation(line: 49, column: 19, scope: !1817)
!1825 = distinct !DILexicalBlock(
        scope: !1817, file: !9, line: 50, column: 3)
!1826 = !DILocation(line: 51, column: 17, scope: !1825)
!1827 = !DILocation(line: 51, column: 25, scope: !1825)
!1828 = !DILocation(line: 51, column: 5, scope: !1825)
!1829 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1653, size: 64)
!1830 = !DILocalVariable(name: "Eğer",
  scope: !1825, file: !9, line: 51, type: !1829)
!1831 = !DILocation(line: 51, column: 5, scope: !1825)
!1832 = !DILocation(line: 52, column: 24, scope: !1825)
!1833 = !DILocation(line: 52, column: 19, scope: !1825)
!1834 = !DILocation(line: 52, column: 5, scope: !1825)
!1835 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1836 = !DILocalVariable(name: "İmge",
  scope: !1825, file: !9, line: 52, type: !1835)
!1837 = !DILocation(line: 52, column: 5, scope: !1825)
!1838 = !DILocation(line: 53, column: 5, scope: !1825)
!1839 = !DILocation(line: 53, column: 5, scope: !1825)
!1840 = !DILocation(line: 53, column: 25, scope: !1825)
!1841 = !DILocation(line: 53, column: 5, scope: !1825)
!1842 = !DILocation(line: 54, column: 5, scope: !1825)
!1843 = !DILocation(line: 54, column: 5, scope: !1825)
!1844 = !DILocation(line: 54, column: 25, scope: !1825)
!1845 = !DILocation(line: 54, column: 5, scope: !1825)
!1846 = !DILocation(line: 55, column: 5, scope: !1825)
!1847 = !DILocation(line: 55, column: 5, scope: !1825)
!1848 = !DILocation(line: 55, column: 31, scope: !1825)
!1849 = !DILocation(line: 55, column: 20, scope: !1825)
!1850 = !DILocation(line: 56, column: 9, scope: !1825)


!1852 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1666, size: 64)
!1853 = !DILocalVariable(name: "dönüş",
  scope: !1851, file: !9, line: 15, type: !1852)
!1854 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1855 = !DILocalVariable(name: "Hafıza",
  scope: !1851, file: !9, line: 23, type: !1854, arg: 1)
!1856 = !DISubroutineType(types: !1857)
!1857 = !{null, !1854 }
!1851 = distinct !DISubprogram( name: "_eğer::eğerki.Yeni_ox14fi",
 scope: !1816,
 file: !9,
 line: 22,
 type: !1856, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1858 = !DILocation(line: 23, column: 5, scope: !1851)
!1859 = distinct !DILexicalBlock(
        scope: !1851, file: !9, line: 32, column: 3)
!1860 = !DILocation(line: 25, column: 20, scope: !1859)
!1861 = !DILocation(line: 25, column: 28, scope: !1859)
!1862 = !DILocation(line: 25, column: 5, scope: !1859)
!1863 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1653, size: 64)
!1864 = !DILocalVariable(name: "Eğerki",
  scope: !1859, file: !9, line: 25, type: !1863)
!1865 = !DILocation(line: 25, column: 5, scope: !1859)
!1866 = !DILocation(line: 26, column: 27, scope: !1859)
!1867 = !DILocation(line: 26, column: 22, scope: !1859)
!1868 = !DILocation(line: 26, column: 5, scope: !1859)
!1869 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1870 = !DILocalVariable(name: "İmge",
  scope: !1859, file: !9, line: 26, type: !1869)
!1871 = !DILocation(line: 26, column: 5, scope: !1859)
!1872 = !DILocation(line: 27, column: 5, scope: !1859)
!1873 = !DILocation(line: 27, column: 5, scope: !1859)
!1874 = !DILocation(line: 27, column: 27, scope: !1859)
!1875 = !DILocation(line: 27, column: 5, scope: !1859)
!1876 = !DILocation(line: 28, column: 5, scope: !1859)
!1877 = !DILocation(line: 28, column: 5, scope: !1859)
!1878 = !DILocation(line: 28, column: 27, scope: !1859)
!1879 = !DILocation(line: 28, column: 5, scope: !1859)
!1880 = !DILocation(line: 29, column: 9, scope: !1859)


!1882 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1676, size: 64)
!1883 = !DILocalVariable(name: "dönüş",
  scope: !1881, file: !9, line: 15, type: !1882)
!1884 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1885 = !DILocalVariable(name: "Hafıza",
  scope: !1881, file: !9, line: 40, type: !1884, arg: 1)
!1886 = !DISubroutineType(types: !1887)
!1887 = !{null, !1884 }
!1881 = distinct !DISubprogram( name: "_eğer::_değilse.Yeni_ox14fi",
 scope: !1816,
 file: !9,
 line: 39,
 type: !1886, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1888 = !DILocation(line: 40, column: 5, scope: !1881)
!1889 = distinct !DILexicalBlock(
        scope: !1881, file: !9, line: 49, column: 3)
!1890 = !DILocation(line: 42, column: 20, scope: !1889)
!1891 = !DILocation(line: 42, column: 28, scope: !1889)
!1892 = !DILocation(line: 42, column: 5, scope: !1889)
!1893 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1653, size: 64)
!1894 = !DILocalVariable(name: "Değilse",
  scope: !1889, file: !9, line: 42, type: !1893)
!1895 = !DILocation(line: 42, column: 5, scope: !1889)
!1896 = !DILocation(line: 43, column: 27, scope: !1889)
!1897 = !DILocation(line: 43, column: 22, scope: !1889)
!1898 = !DILocation(line: 43, column: 5, scope: !1889)
!1899 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1900 = !DILocalVariable(name: "İmge",
  scope: !1889, file: !9, line: 43, type: !1899)
!1901 = !DILocation(line: 43, column: 5, scope: !1889)
!1902 = !DILocation(line: 44, column: 5, scope: !1889)
!1903 = !DILocation(line: 44, column: 5, scope: !1889)
!1904 = !DILocation(line: 44, column: 28, scope: !1889)
!1905 = !DILocation(line: 44, column: 5, scope: !1889)
!1906 = !DILocation(line: 45, column: 5, scope: !1889)
!1907 = !DILocation(line: 45, column: 5, scope: !1889)
!1908 = !DILocation(line: 45, column: 28, scope: !1889)
!1909 = !DILocation(line: 45, column: 5, scope: !1889)
!1910 = !DILocation(line: 46, column: 9, scope: !1889)
