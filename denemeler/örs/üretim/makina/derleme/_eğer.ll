...
@"_eğer::Yeni_ox14Fi"(%gt294t* %0)#0       !dbg !1716 {
; Değişken : dönüş
...
; pascal 'Eğer' örs::derleme::imge::_eğer::t
  ...
  store 
    ...
    %gt3e8t** %7,
    align 8, !dbg !1727
  call void @llvm.dbg.declare(metadata %gt3e8t** %7, metadata !1729, metadata !DIExpression()), !dbg !1730
;;-> (nil) 0
...
; Atama ifadesi
  %11 = load %gt3e8t*, %gt3e8t** %7, align 8, !dbg !1737; 2:0
...
; Konum çevirisi:
  %16 = bitcast %gt397t* %15 to %gt3e8t**; 2
  %17 = load %gt3e8t*, %gt3e8t** %7, align 8, !dbg !1743; 2:0
;atama:
  store 
    %gt3e8t* %17,
    %gt3e8t** %16,
    align 8, !dbg !1744
  %18 = load %gt3e8t*, %gt3e8t** %7, align 8, !dbg !1745; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::k[%st640_1gt398t]
  %19 = getelementptr inbounds 
    %gt3e8t, %gt3e8t* %18,
    i32 0, i32 4
;;-> (nil) 0
  %20 = load %gt294t*, %gt294t** %3, align 8, !dbg !1747; 2:0
 call void @"imge::zincir.Yapılandır_ox110i" (
      %st640_1gt398t* %19, 
      %gt294t* %20), !dbg !1748
  %21 = load %gt3e8t*, %gt3e8t** %7, align 8, !dbg !1749; 2:0
; Dönüş :
  ret %gt3e8t* %21
}
...
define external 
%gt3e9t* @"_eğer::eğerki.Yeni_ox14fi"(%gt294t* %0)
#0       !dbg !1750 {
; Değişken : dönüş
  %2 = alloca %gt3e9t*, align 8
  store %gt3e9t* null, %gt3e9t** %2, align 8
; Değişken : Hafıza
  %3 = alloca %gt294t*, align 8
  store %gt294t* %0, %gt294t** %3, align 8
  call void @llvm.dbg.declare(metadata %gt294t** %3, metadata !1754, metadata !DIExpression()), !dbg !1757
  %4 = load %gt294t*, %gt294t** %3, align 8, !dbg !1759; 2:0
  %5 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt294t* %4, 
      i64 16, 
      i64 8), !dbg !1760
...
; pascal 'Eğerki' örs::derleme::imge::_eğer::t
  ...
  store 
    ...
    %gt3e8t** %7,
    align 8, !dbg !1761
  call void @llvm.dbg.declare(metadata %gt3e8t** %7, metadata !1763, metadata !DIExpression()), !dbg !1764
;;-> (nil) 0
  %8 = load %gt294t*, %gt294t** %3, align 8, !dbg !1765; 2:0
  %9 = call %gt398t* @"imge::Yeni_ox110i" (
      %gt294t* %8, 
      i32 346), !dbg !1766
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt398t** %10,
    align 8, !dbg !1767
  call void @llvm.dbg.declare(metadata %gt398t** %10, metadata !1769, metadata !DIExpression()), !dbg !1770
; Atama ifadesi
  %11 = load %gt398t*, %gt398t** %10, align 8, !dbg !1771; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
  %12 = getelementptr inbounds 
    %gt398t, %gt398t* %11,
    i32 0, i32 5
...
; Konum çevirisi:
  %13 = bitcast %gt397t* %12 to %gt3e9t**; 2
  %14 = load %gt3e8t*, %gt3e8t** %7, align 8, !dbg !1773; 2:0
;atama:
  store 
    %gt3e8t* %14,
    %gt3e9t** %13,
    align 8, !dbg !1774
; Atama ifadesi
  %15 = load %gt3e8t*, %gt3e8t** %7, align 8, !dbg !1775; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt3e8t, %gt3e8t* %15,
    i32 0, i32 0
  %17 = load %gt398t*, %gt398t** %10, align 8, !dbg !1777; 2:0
;atama:
  store 
    %gt398t* %17,
    %gt398t** %16,
    align 8, !dbg !1778
  %18 = load %gt3e8t*, %gt3e8t** %7, align 8, !dbg !1779; 2:0
; Dönüş :
  ret %gt3e8t* %18
}

define external 
%gt3ebt* @"_eğer::_değilse.Yeni_ox14fi"(%gt294t* %0)
#0       !dbg !1780 {
; Değişken : dönüş
...
; Değişken : Hafıza
  %3 = alloca %gt294t*, align 8
  store %gt294t* %0, %gt294t** %3, align 8
  call void @llvm.dbg.declare(metadata %gt294t** %3, metadata !1784, metadata !DIExpression()), !dbg !1787
  %4 = load %gt294t*, %gt294t** %3, align 8, !dbg !1789; 2:0
  %5 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt294t* %4, 
      i64 16, 
      i64 8), !dbg !1790
...
; pascal 'Değilse' örs::derleme::imge::_eğer::t
  ...
  store 
    ...
    %gt3e8t** %7,
    align 8, !dbg !1791
  call void @llvm.dbg.declare(metadata %gt3e8t** %7, metadata !1793, metadata !DIExpression()), !dbg !1794
;;-> (nil) 0
  %8 = load %gt294t*, %gt294t** %3, align 8, !dbg !1795; 2:0
  %9 = call %gt398t* @"imge::Yeni_ox110i" (
      %gt294t* %8, 
      i32 348), !dbg !1796
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt398t** %10,
    align 8, !dbg !1797
  call void @llvm.dbg.declare(metadata %gt398t** %10, metadata !1799, metadata !DIExpression()), !dbg !1800
; Atama ifadesi
  %11 = load %gt398t*, %gt398t** %10, align 8, !dbg !1801; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
  %12 = getelementptr inbounds 
    %gt398t, %gt398t* %11,
    i32 0, i32 5
...
; Konum çevirisi:
  ...
  %14 = load %gt3e8t*, %gt3e8t** %7, align 8, !dbg !1803; 2:0
;atama:
  store 
    %gt3e8t* %14,
    %gt3ebt** %13,
    align 8, !dbg !1804
; Atama ifadesi
  %15 = load %gt3e8t*, %gt3e8t** %7, align 8, !dbg !1805; 2:0
; tür konumu *örs::derleme::imge::_eğer::t : *örs::derleme::imge::t
  %16 = getelementptr inbounds 
    %gt3e8t, %gt3e8t* %15,
    i32 0, i32 0
  %17 = load %gt398t*, %gt398t** %10, align 8, !dbg !1807; 2:0
;atama:
  store 
    %gt398t* %17,
    %gt398t** %16,
    align 8, !dbg !1808
  %18 = load %gt3e8t*, %gt3e8t** %7, align 8, !dbg !1809; 2:0
; Dönüş :
  ret %gt3e8t* %18
}
...
!1715 = !DINamespace(name:"_eğer", scope: !1714)


!1717 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1579, size: 64)
...
!1720 = !DILocalVariable(name: "Hafıza",
  scope: !1716, file: !9, line: 49, type: !1719, arg: 1)
!1721 = !DISubroutineType(types: !1722)
!1722 = !{null, !1719 }
!1716 = distinct !DISubprogram( name: "_eğer::Yeni_ox14Fi",
 scope: !1715,
 file: !9,
 line: 49,
 type: !1721, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1723 = !DILocation(line: 49, column: 19, scope: !1716)
!1724 = distinct !DILexicalBlock(
        scope: !1716, file: !9, line: 50, column: 3)
!1725 = !DILocation(line: 51, column: 17, scope: !1724)
!1726 = !DILocation(line: 51, column: 25, scope: !1724)
!1727 = !DILocation(line: 51, column: 5, scope: !1724)
!1728 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1579, size: 64)
!1729 = !DILocalVariable(name: "Eğer",
  scope: !1724, file: !9, line: 51, type: !1728)
!1730 = !DILocation(line: 51, column: 5, scope: !1724)
!1731 = !DILocation(line: 52, column: 24, scope: !1724)
!1732 = !DILocation(line: 52, column: 19, scope: !1724)
!1733 = !DILocation(line: 52, column: 5, scope: !1724)
!1734 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1735 = !DILocalVariable(name: "İmge",
  scope: !1724, file: !9, line: 52, type: !1734)
!1736 = !DILocation(line: 52, column: 5, scope: !1724)
!1737 = !DILocation(line: 53, column: 5, scope: !1724)
!1738 = !DILocation(line: 53, column: 5, scope: !1724)
!1739 = !DILocation(line: 53, column: 25, scope: !1724)
!1740 = !DILocation(line: 53, column: 5, scope: !1724)
!1741 = !DILocation(line: 54, column: 5, scope: !1724)
!1742 = !DILocation(line: 54, column: 5, scope: !1724)
!1743 = !DILocation(line: 54, column: 25, scope: !1724)
!1744 = !DILocation(line: 54, column: 5, scope: !1724)
!1745 = !DILocation(line: 55, column: 5, scope: !1724)
!1746 = !DILocation(line: 55, column: 5, scope: !1724)
!1747 = !DILocation(line: 55, column: 31, scope: !1724)
!1748 = !DILocation(line: 55, column: 20, scope: !1724)
!1749 = !DILocation(line: 56, column: 9, scope: !1724)


!1751 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1592, size: 64)
!1752 = !DILocalVariable(name: "dönüş",
  scope: !1750, file: !9, line: 15, type: !1751)
!1753 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1754 = !DILocalVariable(name: "Hafıza",
  scope: !1750, file: !9, line: 23, type: !1753, arg: 1)
!1755 = !DISubroutineType(types: !1756)
!1756 = !{null, !1753 }
!1750 = distinct !DISubprogram( name: "_eğer::eğerki.Yeni_ox14fi",
 scope: !1715,
 file: !9,
 line: 22,
 type: !1755, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1757 = !DILocation(line: 23, column: 5, scope: !1750)
!1758 = distinct !DILexicalBlock(
        scope: !1750, file: !9, line: 32, column: 3)
!1759 = !DILocation(line: 25, column: 20, scope: !1758)
!1760 = !DILocation(line: 25, column: 28, scope: !1758)
!1761 = !DILocation(line: 25, column: 5, scope: !1758)
!1762 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1579, size: 64)
!1763 = !DILocalVariable(name: "Eğerki",
  scope: !1758, file: !9, line: 25, type: !1762)
!1764 = !DILocation(line: 25, column: 5, scope: !1758)
!1765 = !DILocation(line: 26, column: 27, scope: !1758)
!1766 = !DILocation(line: 26, column: 22, scope: !1758)
!1767 = !DILocation(line: 26, column: 5, scope: !1758)
!1768 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1769 = !DILocalVariable(name: "İmge",
  scope: !1758, file: !9, line: 26, type: !1768)
!1770 = !DILocation(line: 26, column: 5, scope: !1758)
!1771 = !DILocation(line: 27, column: 5, scope: !1758)
!1772 = !DILocation(line: 27, column: 5, scope: !1758)
!1773 = !DILocation(line: 27, column: 27, scope: !1758)
!1774 = !DILocation(line: 27, column: 5, scope: !1758)
!1775 = !DILocation(line: 28, column: 5, scope: !1758)
!1776 = !DILocation(line: 28, column: 5, scope: !1758)
!1777 = !DILocation(line: 28, column: 27, scope: !1758)
!1778 = !DILocation(line: 28, column: 5, scope: !1758)
!1779 = !DILocation(line: 29, column: 9, scope: !1758)


!1781 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1602, size: 64)
!1782 = !DILocalVariable(name: "dönüş",
  scope: !1780, file: !9, line: 15, type: !1781)
!1783 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !86, size: 64)
!1784 = !DILocalVariable(name: "Hafıza",
  scope: !1780, file: !9, line: 40, type: !1783, arg: 1)
!1785 = !DISubroutineType(types: !1786)
!1786 = !{null, !1783 }
!1780 = distinct !DISubprogram( name: "_eğer::_değilse.Yeni_ox14fi",
 scope: !1715,
 file: !9,
 line: 39,
 type: !1785, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1787 = !DILocation(line: 40, column: 5, scope: !1780)
!1788 = distinct !DILexicalBlock(
        scope: !1780, file: !9, line: 49, column: 3)
!1789 = !DILocation(line: 42, column: 20, scope: !1788)
!1790 = !DILocation(line: 42, column: 28, scope: !1788)
!1791 = !DILocation(line: 42, column: 5, scope: !1788)
!1792 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1579, size: 64)
!1793 = !DILocalVariable(name: "Değilse",
  scope: !1788, file: !9, line: 42, type: !1792)
!1794 = !DILocation(line: 42, column: 5, scope: !1788)
!1795 = !DILocation(line: 43, column: 27, scope: !1788)
!1796 = !DILocation(line: 43, column: 22, scope: !1788)
!1797 = !DILocation(line: 43, column: 5, scope: !1788)
!1798 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1799 = !DILocalVariable(name: "İmge",
  scope: !1788, file: !9, line: 43, type: !1798)
!1800 = !DILocation(line: 43, column: 5, scope: !1788)
!1801 = !DILocation(line: 44, column: 5, scope: !1788)
!1802 = !DILocation(line: 44, column: 5, scope: !1788)
!1803 = !DILocation(line: 44, column: 28, scope: !1788)
!1804 = !DILocation(line: 44, column: 5, scope: !1788)
!1805 = !DILocation(line: 45, column: 5, scope: !1788)
!1806 = !DILocation(line: 45, column: 5, scope: !1788)
!1807 = !DILocation(line: 45, column: 28, scope: !1788)
!1808 = !DILocation(line: 45, column: 5, scope: !1788)
!1809 = !DILocation(line: 46, column: 9, scope: !1788)
