...
; Tanımlı değerler:
@h.ox320.ox176 = private unnamed_addr constant [16 x i8] c"m.ox%x.ox%x\00\00\00\00\00", align 8
;11->1 : 8 : 8
@m.ox320.ox175 = private unnamed_addr constant %metin {
  i32 16,
  i32 -1,
  i8* getelementptr inbounds ([16 x i8], [16 x i8]* @h.ox320.ox176, i64 0, i64 0)
} 
; Genel:
...
@"_metin::Yeni_i"(%gt263t* %0, %gt34bt* %1, %metin* %2)#0       !dbg !1144 {
; Değişken : dönüş
...
; Değişken : Hafıza
  ...
  call void @llvm.dbg.declare(metadata %gt263t** %5, metadata !1148, metadata !DIExpression()), !dbg !1155
; Değişken : Kütüphane
  %6 = alloca %gt34bt*, align 8
  store %gt34bt* %1, %gt34bt** %6, align 8
  call void @llvm.dbg.declare(metadata %gt34bt** %6, metadata !1150, metadata !DIExpression()), !dbg !1156
; Değişken : İçerik
  %7 = alloca %metin*, align 8
  store %metin* %2, %metin** %7, align 8
  call void @llvm.dbg.declare(metadata %metin** %7, metadata !1152, metadata !DIExpression()), !dbg !1157
;;-> (nil) 0
  %8 = load %gt263t*, %gt263t** %5, align 8, !dbg !1159; 2:0
;;-> (nil) 0
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  %11 = load %gt263t*, %gt263t** %5, align 8, !dbg !1165; 2:0
  %12 = call %metin* (%gt263t*,i64) @"hafıza::t.Metin_i" (
      %gt263t* %11, 
      i64 64), !dbg !1166
...
; pascal 'Ad' örs::derleme::çözümleme::tarama::metin
  ...
  store 
    ...
    %metin** %13,
    align 8, !dbg !1167
  call void @llvm.dbg.declare(metadata %metin** %13, metadata !1169, metadata !DIExpression()), !dbg !1170
  %14 = load %metin*, %metin** %13, align 8, !dbg !1171; 2:0
  %15 = load %gt34bt*, %gt34bt** %6, align 8, !dbg !1172; 2:0
; tür konumu *örs::derleme::kütüphane::t : *d32
  %16 = getelementptr inbounds 
    %gt34bt, %gt34bt* %15,
    i32 0, i32 1
;;-> (nil) 14
  %17 = load i32, i32* %16, align 4, !dbg !1174; 1:0
  %18 = load %gt263t*, %gt263t** %5, align 8, !dbg !1175; 2:0
; tür konumu *örs::derleme::hafıza::t : *örs::derleme::t
  %19 = getelementptr inbounds 
    %gt263t, %gt263t* %18,
    i32 0, i32 3
  %20 = load %gt20et*, %gt20et** %19, align 8, !dbg !1177; 2:0
; tür konumu *örs::derleme::t : *örs::derleme::sayaçlar
  %21 = getelementptr inbounds 
    %gt20et, %gt20et* %20,
    i32 0, i32 10
  %22 = call i32 (%gt212t*) @"derleme::sayaçlar.Genel_i" (
      %gt212t* %21), !dbg !1179
  %23 = call i32 (%metin*,%metin*,...) @"merkez::metin.Yaz_i" (
      %metin* %14, 
      %metin* getelementptr inbounds (%metin, %metin* @m.ox320.ox175, i64 0), 
      i32 %17, 
      i32 %22), !dbg !1180
; Atama ifadesi
  %24 = load %gt2c2t*, %gt2c2t** %10, align 8, !dbg !1181; 2:0
...
; Konum çevirisi:
  %26 = bitcast %gt2c1t* %25 to %metin**; 2
  %27 = load %metin*, %metin** %7, align 8, !dbg !1183; 2:0
  store 
    %metin* %27,
    %metin** %26,
    align 8, !dbg !1184
; Atama ifadesi
  %28 = load %gt2c2t*, %gt2c2t** %10, align 8, !dbg !1185; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::çözümleme::tarama::metin
  %29 = getelementptr inbounds 
    %gt2c2t, %gt2c2t* %28,
    i32 0, i32 2
  %30 = load %metin*, %metin** %13, align 8, !dbg !1187; 2:0
  store 
    %metin* %30,
    %metin** %29,
    align 8, !dbg !1188
  %31 = load %gt2c2t*, %gt2c2t** %10, align 8, !dbg !1189; 2:0
; Dönüş :
  ret %gt2c2t* %31
}
...
;örs::derleme::Genel
  declare i32 @"derleme::sayaçlar.Genel_i"(%gt212t*) #0
;örs::merkez::Yaz
...
!1143 = !DINamespace(name:"_metin", scope: !1142)
...
!1149 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !57, size: 64)
!1151 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !11, size: 64)
!1148 = !DILocalVariable(name: "Hafıza",
  scope: !1144, file: !9, line: 7, type: !1147, arg: 1)
!1150 = !DILocalVariable(name: "Kütüphane",
  scope: !1144, file: !9, line: 8, type: !1149, arg: 2)
!1152 = !DILocalVariable(name: "İçerik",
  scope: !1144, file: !9, line: 9, type: !1151, arg: 3)
!1153 = !DISubroutineType(types: !1154)
!1154 = !{null, !1147, !1149, !1151 }
!1144 = distinct !DISubprogram( name: "_metin::Yeni_i",
 scope: !1143,
 file: !9,
 line: 6,
 type: !1153, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1155 = !DILocation(line: 7, column: 5, scope: !1144)
!1156 = !DILocation(line: 8, column: 5, scope: !1144)
!1157 = !DILocation(line: 9, column: 5, scope: !1144)
!1158 = distinct !DILexicalBlock(
        scope: !1144, file: !9, line: 10, column: 3)
!1159 = !DILocation(line: 12, column: 24, scope: !1158)
!1160 = !DILocation(line: 12, column: 19, scope: !1158)
!1161 = !DILocation(line: 12, column: 5, scope: !1158)
!1162 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!1163 = !DILocalVariable(name: "İmge",
  scope: !1158, file: !9, line: 12, type: !1162)
!1164 = !DILocation(line: 12, column: 5, scope: !1158)
!1165 = !DILocation(line: 13, column: 13, scope: !1158)
!1166 = !DILocation(line: 13, column: 21, scope: !1158)
!1167 = !DILocation(line: 13, column: 5, scope: !1158)
!1168 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !11, size: 64)
!1169 = !DILocalVariable(name: "Ad",
  scope: !1158, file: !9, line: 13, type: !1168)
!1170 = !DILocation(line: 13, column: 5, scope: !1158)
!1171 = !DILocation(line: 14, column: 5, scope: !1158)
!1172 = !DILocation(line: 15, column: 7, scope: !1158)
!1173 = !DILocation(line: 15, column: 7, scope: !1158)
!1174 = !DILocation(line: 15, column: 7, scope: !1158)
!1175 = !DILocation(line: 15, column: 22, scope: !1158)
!1176 = !DILocation(line: 15, column: 22, scope: !1158)
!1177 = !DILocation(line: 15, column: 22, scope: !1158)
!1178 = !DILocation(line: 15, column: 22, scope: !1158)
!1179 = !DILocation(line: 15, column: 48, scope: !1158)
!1180 = !DILocation(line: 14, column: 9, scope: !1158)
!1181 = !DILocation(line: 16, column: 5, scope: !1158)
!1182 = !DILocation(line: 16, column: 5, scope: !1158)
!1183 = !DILocation(line: 16, column: 26, scope: !1158)
!1184 = !DILocation(line: 16, column: 5, scope: !1158)
!1185 = !DILocation(line: 17, column: 5, scope: !1158)
!1186 = !DILocation(line: 17, column: 5, scope: !1158)
!1187 = !DILocation(line: 17, column: 26, scope: !1158)
!1188 = !DILocation(line: 17, column: 5, scope: !1158)
!1189 = !DILocation(line: 18, column: 9, scope: !1158)
