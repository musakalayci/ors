...
@"_metin::Yeni_ox132i"(%gt1e0t* %0, %gt21ct* %1, %metin* %2)#0       {
; Değişken : dönüş
...
; pascal 'İmge' örs::derleme::imge::t
  ...
  store 
    ...
    %gt231t** %10,
    align 8
  %11 = load %gt1e0t*, %gt1e0t** %5, align 8; 2:0
  %12 = call %metin* (%gt1e0t*,i64) @"hafıza::t.Metin_ox107i" (
      %gt1e0t* %11, 
      i64 64)
...
; pascal 'Ad' örs::üzengi::metin
  ...
  %15 = load %gt21ct*, %gt21ct** %6, align 8; 2:0
...
; tür konumu *örs::derleme::t : *örs::derleme::sayaçlar
  ...
  %23 = call i32 (%metin*,%metin*,...) @"merkez::metin.Yaz_ox115i" (
      ...
      i32 %22)
; Atama ifadesi
  %24 = load %gt231t*, %gt231t** %10, align 8; 2:0
...
; Konum çevirisi:
  %26 = bitcast %gt230t* %25 to %metin**; 2
  %27 = load %metin*, %metin** %7, align 8; 2:0
;atama:
  store 
    %metin* %27,
    %metin** %26,
    align 8
; Atama ifadesi
  %28 = load %gt231t*, %gt231t** %10, align 8; 2:0
; tür konumu *örs::derleme::imge::t : *örs::üzengi::metin
  %29 = getelementptr inbounds 
    %gt231t, %gt231t* %28,
    i32 0, i32 2
  %30 = load %metin*, %metin** %13, align 8; 2:0
;atama:
  store 
    %metin* %30,
    %metin** %29,
    align 8
  %31 = load %gt231t*, %gt231t** %10, align 8; 2:0
; Dönüş :
  ret %gt231t* %31
}
