...
define external %gt3f4t* 
@"_dizi::Yeni_ox14Ei"(%gt294t* %0, %gt3a2t* %1)#0       !dbg !1764 {
; Değişken : dönüş
  %3 = alloca %gt3f4t*, align 8
  store %gt3f4t* null, %gt3f4t** %3, align 8
; Değişken : Hafıza
  %4 = alloca %gt294t*, align 8
  store %gt294t* %0, %gt294t** %4, align 8
  call void @llvm.dbg.declare(metadata %gt294t** %4, metadata !1767, metadata !DIExpression()), !dbg !1772
; Değişken : İmge
  %5 = alloca %gt3a2t*, align 8
  store %gt3a2t* %1, %gt3a2t** %5, align 8
  call void @llvm.dbg.declare(metadata %gt3a2t** %5, metadata !1769, metadata !DIExpression()), !dbg !1773
  %6 = load %gt294t*, %gt294t** %4, align 8, !dbg !1775; 2:0
  %7 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt294t* %6, 
      i64 160, 
      i64 8), !dbg !1776
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt3f4t*; 1

; pascal 'Erişim' örs::derleme::imge::_dizi::erişim
  %9 = alloca %gt3f4t*, align 8
  store 
    %gt3f4t* %8,
    %gt3f4t** %9,
    align 8, !dbg !1777
  call void @llvm.dbg.declare(metadata %gt3f4t** %9, metadata !1778, metadata !DIExpression()), !dbg !1779
; Atama ifadesi
  %10 = load %gt3a2t*, %gt3a2t** %5, align 8, !dbg !1780; 2:0
...
; Konum çevirisi:
  %12 = bitcast %gt3a1t* %11 to %gt3f4t**; 2
  %13 = load %gt3f4t*, %gt3f4t** %9, align 8, !dbg !1782; 2:0
;atama:
  store 
    %gt3f4t* %13,
    %gt3f4t** %12,
    align 8, !dbg !1783
; Atama ifadesi
  %14 = load %gt3f4t*, %gt3f4t** %9, align 8, !dbg !1784; 2:0
; tür konumu *örs::derleme::imge::_dizi::erişim : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt3f4t, %gt3f4t* %14,
    i32 0, i32 4
  %16 = load %gt3a2t*, %gt3a2t** %5, align 8, !dbg !1786; 2:0
;atama:
  store 
    %gt3a2t* %16,
    %gt3a2t** %15,
    align 8, !dbg !1787
; Atama ifadesi
  %17 = load %gt3a2t*, %gt3a2t** %5, align 8, !dbg !1788; 2:0
...
;atama:
  store 
    ...
    i32* %18,
    align 4, !dbg !1790
  %19 = load %gt3f4t*, %gt3f4t** %9, align 8, !dbg !1791; 2:0
; Dönüş :
  ret %gt3f4t* %19
}
...
!1763 = !DINamespace(name:"_dizi", scope: !1762)


!1765 = !DILocalVariable(name: "dönüş",
  scope: !1764, file: !9, line: 15, type: !1485)
...
!1767 = !DILocalVariable(name: "Hafıza",
  scope: !1764, file: !9, line: 14, type: !1766, arg: 1)
!1769 = !DILocalVariable(name: "İmge",
  scope: !1764, file: !9, line: 14, type: !1768, arg: 2)
!1770 = !DISubroutineType(types: !1771)
!1771 = !{null, !1766, !1768 }
!1764 = distinct !DISubprogram( name: "_dizi::Yeni_ox14Ei",
 scope: !1763,
 file: !9,
 line: 14,
 type: !1770, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1772 = !DILocation(line: 14, column: 19, scope: !1764)
!1773 = !DILocation(line: 14, column: 38, scope: !1764)
!1774 = distinct !DILexicalBlock(
        scope: !1764, file: !9, line: 15, column: 3)
!1775 = !DILocation(line: 16, column: 24, scope: !1774)
!1776 = !DILocation(line: 16, column: 32, scope: !1774)
!1777 = !DILocation(line: 16, column: 5, scope: !1774)
!1778 = !DILocalVariable(name: "Erişim",
  scope: !1774, file: !9, line: 16, type: !1485)
!1779 = !DILocation(line: 16, column: 5, scope: !1774)
!1780 = !DILocation(line: 17, column: 5, scope: !1774)
!1781 = !DILocation(line: 17, column: 5, scope: !1774)
!1782 = !DILocation(line: 17, column: 31, scope: !1774)
!1783 = !DILocation(line: 17, column: 5, scope: !1774)
!1784 = !DILocation(line: 18, column: 5, scope: !1774)
!1785 = !DILocation(line: 18, column: 5, scope: !1774)
!1786 = !DILocation(line: 18, column: 18, scope: !1774)
!1787 = !DILocation(line: 18, column: 5, scope: !1774)
!1788 = !DILocation(line: 19, column: 5, scope: !1774)
!1789 = !DILocation(line: 19, column: 5, scope: !1774)
!1790 = !DILocation(line: 19, column: 5, scope: !1774)
!1791 = !DILocation(line: 20, column: 9, scope: !1774)
