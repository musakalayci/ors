...
define external %gt3e6t* 
@"_dizi::Yeni_ox14Ei"(%gt294t* %0, %gt398t* %1)#0       !dbg !1716 {
; Değişken : dönüş
  %3 = alloca %gt3e6t*, align 8
  store %gt3e6t* null, %gt3e6t** %3, align 8
; Değişken : Hafıza
...
; Değişken : İmge
  ...
  %7 = call i8* (%gt294t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1729
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt3e6t*; 1

; pascal 'Erişim' örs::derleme::imge::_dizi::erişim
  %9 = alloca %gt3e6t*, align 8
  store 
    %gt3e6t* %8,
    %gt3e6t** %9,
    align 8, !dbg !1730
  call void @llvm.dbg.declare(metadata %gt3e6t** %9, metadata !1732, metadata !DIExpression()), !dbg !1733
; Atama ifadesi
  %10 = load %gt398t*, %gt398t** %5, align 8, !dbg !1734; 2:0
...
; Konum çevirisi:
  %12 = bitcast %gt397t* %11 to %gt3e6t**; 2
  %13 = load %gt3e6t*, %gt3e6t** %9, align 8, !dbg !1736; 2:0
;atama:
  store 
    %gt3e6t* %13,
    %gt3e6t** %12,
    align 8, !dbg !1737
; Atama ifadesi
  %14 = load %gt3e6t*, %gt3e6t** %9, align 8, !dbg !1738; 2:0
; tür konumu *örs::derleme::imge::_dizi::erişim : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt3e6t, %gt3e6t* %14,
    i32 0, i32 4
  %16 = load %gt398t*, %gt398t** %5, align 8, !dbg !1740; 2:0
;atama:
  store 
    %gt398t* %16,
    %gt398t** %15,
...
;atama:
  store 
    ...
    i32* %18,
    align 4, !dbg !1744
  %19 = load %gt3e6t*, %gt3e6t** %9, align 8, !dbg !1745; 2:0
; Dönüş :
  ret %gt3e6t* %19
}
...
!1715 = !DINamespace(name:"_dizi", scope: !1714)


!1717 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1440, size: 64)
...
!1720 = !DILocalVariable(name: "Hafıza",
  scope: !1716, file: !9, line: 14, type: !1719, arg: 1)
!1722 = !DILocalVariable(name: "İmge",
  scope: !1716, file: !9, line: 14, type: !1721, arg: 2)
!1723 = !DISubroutineType(types: !1724)
!1724 = !{null, !1719, !1721 }
!1716 = distinct !DISubprogram( name: "_dizi::Yeni_ox14Ei",
 scope: !1715,
 file: !9,
 line: 14,
 type: !1723, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1725 = !DILocation(line: 14, column: 19, scope: !1716)
!1726 = !DILocation(line: 14, column: 38, scope: !1716)
!1727 = distinct !DILexicalBlock(
        scope: !1716, file: !9, line: 15, column: 3)
!1728 = !DILocation(line: 16, column: 24, scope: !1727)
!1729 = !DILocation(line: 16, column: 32, scope: !1727)
!1730 = !DILocation(line: 16, column: 5, scope: !1727)
!1731 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1440, size: 64)
!1732 = !DILocalVariable(name: "Erişim",
  scope: !1727, file: !9, line: 16, type: !1731)
!1733 = !DILocation(line: 16, column: 5, scope: !1727)
!1734 = !DILocation(line: 17, column: 5, scope: !1727)
!1735 = !DILocation(line: 17, column: 5, scope: !1727)
!1736 = !DILocation(line: 17, column: 31, scope: !1727)
!1737 = !DILocation(line: 17, column: 5, scope: !1727)
!1738 = !DILocation(line: 18, column: 5, scope: !1727)
!1739 = !DILocation(line: 18, column: 5, scope: !1727)
!1740 = !DILocation(line: 18, column: 18, scope: !1727)
!1741 = !DILocation(line: 18, column: 5, scope: !1727)
!1742 = !DILocation(line: 19, column: 5, scope: !1727)
!1743 = !DILocation(line: 19, column: 5, scope: !1727)
!1744 = !DILocation(line: 19, column: 5, scope: !1727)
!1745 = !DILocation(line: 20, column: 9, scope: !1727)
