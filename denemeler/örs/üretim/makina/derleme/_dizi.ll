...
define external %gt40dt* 
@"_dizi::Yeni_ox14Ei"(%gt29at* %0, %gt3bbt* %1)#0       !dbg !1807 {
; Değişken : dönüş
  %3 = alloca %gt40dt*, align 8
  store %gt40dt* null, %gt40dt** %3, align 8
; Değişken : Hafıza
...
; Değişken : İmge
  ...
  %7 = call i8* (%gt29at*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1820
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt40dt*; 1

; pascal 'Erişim' örs::derleme::imge::_dizi::erişim
  %9 = alloca %gt40dt*, align 8
  store 
    %gt40dt* %8,
    %gt40dt** %9,
    align 8, !dbg !1821
  call void @llvm.dbg.declare(metadata %gt40dt** %9, metadata !1823, metadata !DIExpression()), !dbg !1824
; Atama ifadesi
  %10 = load %gt3bbt*, %gt3bbt** %5, align 8, !dbg !1825; 2:0
...
; Konum çevirisi:
  %12 = bitcast %gt3bat* %11 to %gt40dt**; 2
  %13 = load %gt40dt*, %gt40dt** %9, align 8, !dbg !1827; 2:0
;atama:
  store 
    %gt40dt* %13,
    %gt40dt** %12,
    align 8, !dbg !1828
; Atama ifadesi
  %14 = load %gt40dt*, %gt40dt** %9, align 8, !dbg !1829; 2:0
; tür konumu *örs::derleme::imge::_dizi::erişim : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt40dt, %gt40dt* %14,
    i32 0, i32 4
  %16 = load %gt3bbt*, %gt3bbt** %5, align 8, !dbg !1831; 2:0
;atama:
  store 
    %gt3bbt* %16,
    %gt3bbt** %15,
...
;atama:
  store 
    ...
    i32* %18,
    align 4, !dbg !1835
  %19 = load %gt40dt*, %gt40dt** %9, align 8, !dbg !1836; 2:0
; Dönüş :
  ret %gt40dt* %19
}
...
!1806 = !DINamespace(name:"_dizi", scope: !1805)


!1808 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1506, size: 64)
...
!1811 = !DILocalVariable(name: "Hafıza",
  scope: !1807, file: !9, line: 14, type: !1810, arg: 1)
!1813 = !DILocalVariable(name: "İmge",
  scope: !1807, file: !9, line: 14, type: !1812, arg: 2)
!1814 = !DISubroutineType(types: !1815)
!1815 = !{null, !1810, !1812 }
!1807 = distinct !DISubprogram( name: "_dizi::Yeni_ox14Ei",
 scope: !1806,
 file: !9,
 line: 14,
 type: !1814, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1816 = !DILocation(line: 14, column: 19, scope: !1807)
!1817 = !DILocation(line: 14, column: 38, scope: !1807)
!1818 = distinct !DILexicalBlock(
        scope: !1807, file: !9, line: 15, column: 3)
!1819 = !DILocation(line: 16, column: 24, scope: !1818)
!1820 = !DILocation(line: 16, column: 32, scope: !1818)
!1821 = !DILocation(line: 16, column: 5, scope: !1818)
!1822 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1506, size: 64)
!1823 = !DILocalVariable(name: "Erişim",
  scope: !1818, file: !9, line: 16, type: !1822)
!1824 = !DILocation(line: 16, column: 5, scope: !1818)
!1825 = !DILocation(line: 17, column: 5, scope: !1818)
!1826 = !DILocation(line: 17, column: 5, scope: !1818)
!1827 = !DILocation(line: 17, column: 31, scope: !1818)
!1828 = !DILocation(line: 17, column: 5, scope: !1818)
!1829 = !DILocation(line: 18, column: 5, scope: !1818)
!1830 = !DILocation(line: 18, column: 5, scope: !1818)
!1831 = !DILocation(line: 18, column: 18, scope: !1818)
!1832 = !DILocation(line: 18, column: 5, scope: !1818)
!1833 = !DILocation(line: 19, column: 5, scope: !1818)
!1834 = !DILocation(line: 19, column: 5, scope: !1818)
!1835 = !DILocation(line: 19, column: 5, scope: !1818)
!1836 = !DILocation(line: 20, column: 9, scope: !1818)
