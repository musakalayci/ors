...
@"_dizi::Yeni_ox14Ei"(%gt294t* %0, %gt398t* %1)#0       !dbg !1724 {
; Değişken : dönüş
...
; Değişken : Hafıza
  ...
  call void @llvm.dbg.declare(metadata %gt294t** %4, metadata !1727, metadata !DIExpression()), !dbg !1732
; Değişken : İmge
  %5 = alloca %gt398t*, align 8
  store %gt398t* %1, %gt398t** %5, align 8
  call void @llvm.dbg.declare(metadata %gt398t** %5, metadata !1729, metadata !DIExpression()), !dbg !1733
...
; pascal 'Erişim' örs::derleme::imge::_dizi::erişim
  ...
  store 
    ...
    %gt3e8t** %9,
    align 8, !dbg !1737
  call void @llvm.dbg.declare(metadata %gt3e8t** %9, metadata !1738, metadata !DIExpression()), !dbg !1739
; Atama ifadesi
  %10 = load %gt398t*, %gt398t** %5, align 8, !dbg !1740; 2:0
...
; Konum çevirisi:
  %12 = bitcast %gt397t* %11 to %gt3e8t**; 2
  %13 = load %gt3e8t*, %gt3e8t** %9, align 8, !dbg !1742; 2:0
;atama:
  store 
    %gt3e8t* %13,
    %gt3e8t** %12,
    align 8, !dbg !1743
; Atama ifadesi
  %14 = load %gt3e8t*, %gt3e8t** %9, align 8, !dbg !1744; 2:0
; tür konumu *örs::derleme::imge::_dizi::erişim : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt3e8t, %gt3e8t* %14,
    i32 0, i32 4
  %16 = load %gt398t*, %gt398t** %5, align 8, !dbg !1746; 2:0
;atama:
  store 
    %gt398t* %16,
    %gt398t** %15,
    align 8, !dbg !1747
; Atama ifadesi
  %17 = load %gt398t*, %gt398t** %5, align 8, !dbg !1748; 2:0
...
;atama:
  store 
    ...
    i32* %18,
    align 4, !dbg !1750
  %19 = load %gt3e8t*, %gt3e8t** %9, align 8, !dbg !1751; 2:0
; Dönüş :
  ret %gt3e8t* %19
}
...
!1723 = !DINamespace(name:"_dizi", scope: !1722)


!1725 = !DILocalVariable(name: "dönüş",
  scope: !1724, file: !9, line: 15, type: !1448)
...
!1727 = !DILocalVariable(name: "Hafıza",
  scope: !1724, file: !9, line: 14, type: !1726, arg: 1)
!1729 = !DILocalVariable(name: "İmge",
  scope: !1724, file: !9, line: 14, type: !1728, arg: 2)
!1730 = !DISubroutineType(types: !1731)
!1731 = !{null, !1726, !1728 }
!1724 = distinct !DISubprogram( name: "_dizi::Yeni_ox14Ei",
 scope: !1723,
 file: !9,
 line: 14,
 type: !1730, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1732 = !DILocation(line: 14, column: 19, scope: !1724)
!1733 = !DILocation(line: 14, column: 38, scope: !1724)
!1734 = distinct !DILexicalBlock(
        scope: !1724, file: !9, line: 15, column: 3)
!1735 = !DILocation(line: 16, column: 24, scope: !1734)
!1736 = !DILocation(line: 16, column: 32, scope: !1734)
!1737 = !DILocation(line: 16, column: 5, scope: !1734)
!1738 = !DILocalVariable(name: "Erişim",
  scope: !1734, file: !9, line: 16, type: !1448)
!1739 = !DILocation(line: 16, column: 5, scope: !1734)
!1740 = !DILocation(line: 17, column: 5, scope: !1734)
!1741 = !DILocation(line: 17, column: 5, scope: !1734)
!1742 = !DILocation(line: 17, column: 31, scope: !1734)
!1743 = !DILocation(line: 17, column: 5, scope: !1734)
!1744 = !DILocation(line: 18, column: 5, scope: !1734)
!1745 = !DILocation(line: 18, column: 5, scope: !1734)
!1746 = !DILocation(line: 18, column: 18, scope: !1734)
!1747 = !DILocation(line: 18, column: 5, scope: !1734)
!1748 = !DILocation(line: 19, column: 5, scope: !1734)
!1749 = !DILocation(line: 19, column: 5, scope: !1734)
!1750 = !DILocation(line: 19, column: 5, scope: !1734)
!1751 = !DILocation(line: 20, column: 9, scope: !1734)
