; ModuleID = 'örs::derleme::imge::_dizi'
; Ürün adı : derleme
; Birim adı : örs::derleme::imge::_dizi
; Yol: ./denemeler/örs/üretim/makina/derleme/
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"
source_filename = "./denemeler/örs/üretim/makina/derleme/_dizi.ll"
...
;örs::derleme::imge::_dizi::Yeni
define external %gt413t* 
@"_dizi::Yeni_ox14Ei"(%gt29at* %0, %gt3bft* %1)#0       !dbg !1817 {
; Değişken : dönüş
  %3 = alloca %gt413t*, align 8
  store %gt413t* null, %gt413t** %3, align 8
; Değişken : Hafıza
...
; Değişken : İmge
  ...
  %7 = call i8* (%gt29at*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      ...
      i64 8), !dbg !1830
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt413t*; 1

; pascal 'Erişim' örs::derleme::imge::_dizi::erişim
  %9 = alloca %gt413t*, align 8
  store 
    %gt413t* %8,
    %gt413t** %9,
    align 8, !dbg !1831
  call void @llvm.dbg.declare(metadata %gt413t** %9, metadata !1833, metadata !DIExpression()), !dbg !1834
; Atama ifadesi
  %10 = load %gt3bft*, %gt3bft** %5, align 8, !dbg !1835; 2:0
; tür konumu *örs::derleme::imge::t : *örs::derleme::imge::içerik
  %11 = getelementptr inbounds 
    %gt3bft, %gt3bft* %10,
    i32 0, i32 5

; Ortak çevirisi *örs::derleme::imge::içerik ==> *örs::derleme::imge::_dizi::erişim (1, 2)
; Konum çevirisi:
  %12 = bitcast %gt3bet* %11 to %gt413t**; 2
  %13 = load %gt413t*, %gt413t** %9, align 8, !dbg !1837; 2:0
;atama:
  store 
    %gt413t* %13,
    %gt413t** %12,
    align 8, !dbg !1838
; Atama ifadesi
  %14 = load %gt413t*, %gt413t** %9, align 8, !dbg !1839; 2:0
; tür konumu *örs::derleme::imge::_dizi::erişim : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt413t, %gt413t* %14,
    i32 0, i32 4
  %16 = load %gt3bft*, %gt3bft** %5, align 8, !dbg !1841; 2:0
;atama:
  store 
    %gt3bft* %16,
    %gt3bft** %15,
...
;atama:
  store 
    ...
    i32* %18,
    align 4, !dbg !1845
  %19 = load %gt413t*, %gt413t** %9, align 8, !dbg !1846; 2:0
; Dönüş :
  ret %gt413t* %19
}
...
!llvm.dbg.cu = !{!8}
!9 = !DIFile(
  filename: "./denemeler/\C3\B6rs/kaynak/derleme/imge/dizi.\C3\B6rs",
...
!1816 = !DINamespace(name:"_dizi", scope: !1815)


!1818 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1505, size: 64)
...
!1821 = !DILocalVariable(name: "Hafıza",
  scope: !1817, file: !9, line: 14, type: !1820, arg: 1)
!1823 = !DILocalVariable(name: "İmge",
  scope: !1817, file: !9, line: 14, type: !1822, arg: 2)
!1824 = !DISubroutineType(types: !1825)
!1825 = !{null, !1820, !1822 }
!1817 = distinct !DISubprogram( name: "_dizi::Yeni_ox14Ei",
 scope: !1816,
 file: !9,
 line: 14,
 type: !1824, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1826 = !DILocation(line: 14, column: 19, scope: !1817)
!1827 = !DILocation(line: 14, column: 38, scope: !1817)
!1828 = distinct !DILexicalBlock(
        scope: !1817, file: !9, line: 15, column: 3)
!1829 = !DILocation(line: 16, column: 24, scope: !1828)
!1830 = !DILocation(line: 16, column: 32, scope: !1828)
!1831 = !DILocation(line: 16, column: 5, scope: !1828)
!1832 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1505, size: 64)
!1833 = !DILocalVariable(name: "Erişim",
  scope: !1828, file: !9, line: 16, type: !1832)
!1834 = !DILocation(line: 16, column: 5, scope: !1828)
!1835 = !DILocation(line: 17, column: 5, scope: !1828)
!1836 = !DILocation(line: 17, column: 5, scope: !1828)
!1837 = !DILocation(line: 17, column: 31, scope: !1828)
!1838 = !DILocation(line: 17, column: 5, scope: !1828)
!1839 = !DILocation(line: 18, column: 5, scope: !1828)
!1840 = !DILocation(line: 18, column: 5, scope: !1828)
!1841 = !DILocation(line: 18, column: 18, scope: !1828)
!1842 = !DILocation(line: 18, column: 5, scope: !1828)
!1843 = !DILocation(line: 19, column: 5, scope: !1828)
!1844 = !DILocation(line: 19, column: 5, scope: !1828)
!1845 = !DILocation(line: 19, column: 5, scope: !1828)
!1846 = !DILocation(line: 20, column: 9, scope: !1828)
