...
define external %gt3f8t* 
@"_dizi::Yeni_ox14Ei"(%gt296t* %0, %gt3a6t* %1)#0       !dbg !1790 {
; Değişken : dönüş
  %3 = alloca %gt3f8t*, align 8
  store %gt3f8t* null, %gt3f8t** %3, align 8
; Değişken : Hafıza
  %4 = alloca %gt296t*, align 8
  store %gt296t* %0, %gt296t** %4, align 8
  call void @llvm.dbg.declare(metadata %gt296t** %4, metadata !1793, metadata !DIExpression()), !dbg !1798
; Değişken : İmge
  %5 = alloca %gt3a6t*, align 8
  store %gt3a6t* %1, %gt3a6t** %5, align 8
  call void @llvm.dbg.declare(metadata %gt3a6t** %5, metadata !1795, metadata !DIExpression()), !dbg !1799
  %6 = load %gt296t*, %gt296t** %4, align 8, !dbg !1801; 2:0
  %7 = call i8* (%gt296t*,i64,i64) @"hafıza::t.Yeni_ox108i" (
      %gt296t* %6, 
      i64 160, 
      i64 8), !dbg !1802
; Konum çevirisi:
  %8 = bitcast i8* %7 to %gt3f8t*; 1

; pascal 'Erişim' örs::derleme::imge::_dizi::erişim
  %9 = alloca %gt3f8t*, align 8
  store 
    %gt3f8t* %8,
    %gt3f8t** %9,
    align 8, !dbg !1803
  call void @llvm.dbg.declare(metadata %gt3f8t** %9, metadata !1804, metadata !DIExpression()), !dbg !1805
; Atama ifadesi
  %10 = load %gt3a6t*, %gt3a6t** %5, align 8, !dbg !1806; 2:0
...
; Konum çevirisi:
  %12 = bitcast %gt3a5t* %11 to %gt3f8t**; 2
  %13 = load %gt3f8t*, %gt3f8t** %9, align 8, !dbg !1808; 2:0
;atama:
  store 
    %gt3f8t* %13,
    %gt3f8t** %12,
    align 8, !dbg !1809
; Atama ifadesi
  %14 = load %gt3f8t*, %gt3f8t** %9, align 8, !dbg !1810; 2:0
; tür konumu *örs::derleme::imge::_dizi::erişim : *örs::derleme::imge::t
  %15 = getelementptr inbounds 
    %gt3f8t, %gt3f8t* %14,
    i32 0, i32 4
  %16 = load %gt3a6t*, %gt3a6t** %5, align 8, !dbg !1812; 2:0
;atama:
  store 
    %gt3a6t* %16,
    %gt3a6t** %15,
    align 8, !dbg !1813
; Atama ifadesi
  %17 = load %gt3a6t*, %gt3a6t** %5, align 8, !dbg !1814; 2:0
...
;atama:
  store 
    ...
    i32* %18,
    align 4, !dbg !1816
  %19 = load %gt3f8t*, %gt3f8t** %9, align 8, !dbg !1817; 2:0
; Dönüş :
  ret %gt3f8t* %19
}
...
!1789 = !DINamespace(name:"_dizi", scope: !1788)


!1791 = !DILocalVariable(name: "dönüş",
  scope: !1790, file: !9, line: 15, type: !1508)
...
!1793 = !DILocalVariable(name: "Hafıza",
  scope: !1790, file: !9, line: 14, type: !1792, arg: 1)
!1795 = !DILocalVariable(name: "İmge",
  scope: !1790, file: !9, line: 14, type: !1794, arg: 2)
!1796 = !DISubroutineType(types: !1797)
!1797 = !{null, !1792, !1794 }
!1790 = distinct !DISubprogram( name: "_dizi::Yeni_ox14Ei",
 scope: !1789,
 file: !9,
 line: 14,
 type: !1796, unit: !8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition)
  ;Yeni
!1798 = !DILocation(line: 14, column: 19, scope: !1790)
!1799 = !DILocation(line: 14, column: 38, scope: !1790)
!1800 = distinct !DILexicalBlock(
        scope: !1790, file: !9, line: 15, column: 3)
!1801 = !DILocation(line: 16, column: 24, scope: !1800)
!1802 = !DILocation(line: 16, column: 32, scope: !1800)
!1803 = !DILocation(line: 16, column: 5, scope: !1800)
!1804 = !DILocalVariable(name: "Erişim",
  scope: !1800, file: !9, line: 16, type: !1508)
!1805 = !DILocation(line: 16, column: 5, scope: !1800)
!1806 = !DILocation(line: 17, column: 5, scope: !1800)
!1807 = !DILocation(line: 17, column: 5, scope: !1800)
!1808 = !DILocation(line: 17, column: 31, scope: !1800)
!1809 = !DILocation(line: 17, column: 5, scope: !1800)
!1810 = !DILocation(line: 18, column: 5, scope: !1800)
!1811 = !DILocation(line: 18, column: 5, scope: !1800)
!1812 = !DILocation(line: 18, column: 18, scope: !1800)
!1813 = !DILocation(line: 18, column: 5, scope: !1800)
!1814 = !DILocation(line: 19, column: 5, scope: !1800)
!1815 = !DILocation(line: 19, column: 5, scope: !1800)
!1816 = !DILocation(line: 19, column: 5, scope: !1800)
!1817 = !DILocation(line: 20, column: 9, scope: !1800)
