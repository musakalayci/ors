...
source_filename = "/home/moseschrist/Merkez/Işler/Örs/denemeler/örs/üretim/makina/merkez/dirent.ll"
...
;örs::merkez::c::dirent::opendir
  declare %gt15dt* @opendir(i8*)
;örs::merkez::c::dirent::fdopendir
  declare %gt15dt* @fdopendir(i32)
;örs::merkez::c::dirent::closedir
  declare i32 @closedir(%gt15dt*)
...
!llvm.dbg.cu = !{!8}
!9 = !DIFile(
  filename: "/home/moseschrist/Merkez/I\C5\9Fler/\C3\96rs/denemeler/\C3\B6rs/kaynak/merkez/c/dirent.ors",
...
!20 = !DIFile(
  filename: "<unknown>",
  directory: "/home/moseschrist/Merkez/I\C5\9Fler/\C3\96rs/denemeler/\C3\B6rs/kaynak")
!19 = !DICompositeType(tag: DW_TAG_structure_type, name: "%gt15dt", file: !20, line: 17, flags: DIFlagFwdDecl)!21 = !DINamespace(name:"kök", scope: null)
