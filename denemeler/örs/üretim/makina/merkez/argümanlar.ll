...
source_filename = "/home/moseschrist/Merkez/Işler/Örs/denemeler/örs/üretim/makina/merkez/argümanlar.ll"
...
%gte5t = type {i32, i8**, i8**}
 ; örs::merkez::argümanlar::argümanlar siralama : 8, boyut :24, no: 229
...
define dso_local void @"arg\C3\BCmanlar_arg\C3\BCmanlar_Yap\C4\B1land\C4\B1r_i"(%gte5t* %0, i32 %1, i8** %2, i8** %3) !dbg !33 {
; Değişken : öz:5
  %5 = alloca %gte5t*, align 8
  store %gte5t* %0, %gte5t** %5, align 8
  call void @llvm.dbg.declare(metadata  %gte5t** %5, metadata !35, metadata !DIExpression()), !dbg !46
; Değişken : sayı:6
...
; Atama ifadesi
  %9 = load %gte5t*, %gte5t** %5, align 8, !dbg !51; 2:0
; tür konumu *örs::merkez::argümanlar::argümanlar : *t32
  ...
  store 
    ...
    align 4, !dbg !54
; Atama ifadesi
  %12 = load %gte5t*, %gte5t** %5, align 8, !dbg !55; 2:0
; tür konumu *örs::merkez::argümanlar::argümanlar : **t8
  ...
  store 
    ...
    align 8, !dbg !58
; Atama ifadesi
  %15 = load %gte5t*, %gte5t** %5, align 8, !dbg !59; 2:0
; tür konumu *örs::merkez::argümanlar::argümanlar : **t8
...
define dso_local void @"arg\C3\BCmanlar_arg\C3\BCmanlar_GirdiYazd\C4\B1r_i"(%gte5t* %0) !dbg !63 {
; Değişken : öz:2
  %2 = alloca %gte5t*, align 8
  store %gte5t* %0, %gte5t** %2, align 8
  call void @llvm.dbg.declare(metadata  %gte5t** %2, metadata !65, metadata !DIExpression()), !dbg !69
  %3 = load %gte5t*, %gte5t** %2, align 8, !dbg !71; 2:0
; tür konumu *örs::merkez::argümanlar::argümanlar : **t8
...
!llvm.dbg.cu = !{!8}
!9 = !DIFile(
  filename: "/home/moseschrist/Merkez/I\C5\9Fler/\C3\96rs/denemeler/\C3\B6rs/kaynak/merkez/arg\C3\BCmanlar.ors",
...
!44 = !{null, !34, !12, !38, !41 }
!33 = distinct !DISubprogram( name: "arg\C3\BCmanlar_arg\C3\BCmanlar_Yap\C4\B1land\C4\B1r_i",
 scope: !32,
 file: !9,
 line: 11,
...
!67 = !{null, !64 }
!63 = distinct !DISubprogram( name: "arg\C3\BCmanlar_arg\C3\BCmanlar_GirdiYazd\C4\B1r_i",
 scope: !32,
 file: !9,
 line: 22,
