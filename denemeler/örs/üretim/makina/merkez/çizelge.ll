...
;örs::merkez::küme::çizelge::kök[%st581_0i32_1i8]
; ./denemeler/örs/kaynak/merkez/küme/çizelge.ors:6:9 [93:97]
;siralama : 8, boyut :24, no: 1645

%st550_1st581_0i32_1i8 = type {i32, i32, %st581_0i32_1i8**}
;örs::merkez::küme::çizelge::k[%st550_1st581_0i32_1i8]
; ./denemeler/örs/kaynak/merkez/dizi/dizi.ors:1:9 [9:10]
;siralama : 8, boyut :16, no: 1646

%st582_0i32_1i8 = type {i32, i32, %st550_1st581_0i32_1i8, %st581_0i32_1i8**}
;örs::merkez::küme::çizelge::k[%st582_0i32_1i8]
; ./denemeler/örs/kaynak/merkez/küme/çizelge.ors:14:9 [200:201]
;siralama : 8, boyut :32, no: 1644

%gt247t = type {%st582_0i32_1i8*}
;*örs::merkez::küme::çizelge::k[%st582_0i32_1i8]
...
; Konum çevirisi:
  %7 = bitcast i8* %6 to %st582_0i32_1i8*; 1

; pascal 'çizelge' örs::merkez::küme::çizelge::k[%st582_0i32_1i8]
  %8 = alloca %st582_0i32_1i8*, align 8
  store 
    %st582_0i32_1i8* %7,
    %st582_0i32_1i8** %8,
    align 8, !dbg !61
  call void @llvm.dbg.declare(metadata %st582_0i32_1i8** %8, metadata !63, metadata !DIExpression()), !dbg !64
...
; Sanal çağrı p
  %13 = load %st582_0i32_1i8*, %st582_0i32_1i8** %8, align 8, !dbg !69; 2:0
; tür konumu *örs::merkez::küme::çizelge::k[%st582_0i32_1i8] : *d32
  %14 = getelementptr inbounds 
    %st582_0i32_1i8, %st582_0i32_1i8* %13,
    i32 0, i32 1
; Değişken : dönüş
...
@"çizelge::_qs_bol_ox139i"(%st581_0i32_1i8** %0, i32 %1, i32 %2)#0       !dbg !89 {
; Değişken : dönüş
  %4 = alloca i32, align 4
  store i32 0, i32* %4, align 4 ; 0 
; Değişken : Kök
  %5 = alloca %st581_0i32_1i8**, align 8
  store %st581_0i32_1i8** %0, %st581_0i32_1i8*** %5, align 8
  call void @llvm.dbg.declare(metadata %st581_0i32_1i8*** %5, metadata !93, metadata !DIExpression()), !dbg !98
; Değişken : dip
...
; Dizi erişim Kök
  ...
  %9 = load %st581_0i32_1i8**, %st581_0i32_1i8*** %5, align 8, !dbg !103; 3:0
  %10 = sext i32 %8 to i64;eie??
;tekil
  %11 = getelementptr inbounds
     %st581_0i32_1i8*, %st581_0i32_1i8**  %9,
     i64 %10
  %12 = load %st581_0i32_1i8*, %st581_0i32_1i8** %11, align 8, !dbg !104; 2:0
; tür konumu *örs::merkez::küme::çizelge::kök[%st581_0i32_1i8] : *t32
  %13 = getelementptr inbounds 
    %st581_0i32_1i8, %st581_0i32_1i8* %12,
    i32 0, i32 2
...
; Dizi erişim Kök
  ...
  %30 = load %st581_0i32_1i8**, %st581_0i32_1i8*** %5, align 8, !dbg !124; 3:0
  %31 = sext i32 %29 to i64;eie??
;tekil
  %32 = getelementptr inbounds
     %st581_0i32_1i8*, %st581_0i32_1i8**  %30,
     i64 %31
  %33 = load %st581_0i32_1i8*, %st581_0i32_1i8** %32, align 8, !dbg !125; 2:0
; tür konumu *örs::merkez::küme::çizelge::kök[%st581_0i32_1i8] : *t32
  %34 = getelementptr inbounds 
    %st581_0i32_1i8, %st581_0i32_1i8* %33,
    i32 0, i32 2
...
; Dizi erişim Kök
  ...
  %43 = load %st581_0i32_1i8**, %st581_0i32_1i8*** %5, align 8, !dbg !134; 3:0
  %44 = sext i32 %42 to i64;eie??
;tekil
  %45 = getelementptr inbounds
     %st581_0i32_1i8*, %st581_0i32_1i8**  %43,
     i64 %44
  %46 = getelementptr inbounds
    %st581_0i32_1i8*, %st581_0i32_1i8** %45,
    i64 0; konum alınıyor
; Dizi erişim
; Dizi erişim Kök
  %47 = load i32, i32* %20, align 4, !dbg !135; 1:0
  %48 = load %st581_0i32_1i8**, %st581_0i32_1i8*** %5, align 8, !dbg !136; 3:0
  %49 = sext i32 %47 to i64;eie??
;tekil
  %50 = getelementptr inbounds
     %st581_0i32_1i8*, %st581_0i32_1i8**  %48,
     i64 %49
  %51 = getelementptr inbounds
    %st581_0i32_1i8*, %st581_0i32_1i8** %50,
    i64 0; konum alınıyor
  %52 = load %st581_0i32_1i8*, %st581_0i32_1i8** %46, align 8, !dbg !137; 2:0
  %53 = alloca %st581_0i32_1i8*, align 8
  store 
    %st581_0i32_1i8* %52,
    %st581_0i32_1i8** %53,
    align 8, !dbg !138
  %54 = load %st581_0i32_1i8*, %st581_0i32_1i8** %51, align 8, !dbg !139; 2:0
  store 
    %st581_0i32_1i8* %54,
    %st581_0i32_1i8** %46,
    align 8, !dbg !140
  %55 = load %st581_0i32_1i8*, %st581_0i32_1i8** %53, align 8, !dbg !141; 2:0
  store 
    %st581_0i32_1i8* %55,
    %st581_0i32_1i8** %51,
    align 8, !dbg !142
...
; Ikiz işlem '+'
  ...
  %57 = add i32 %56, 1
  %58 = load %st581_0i32_1i8**, %st581_0i32_1i8*** %5, align 8, !dbg !144; 3:0
  %59 = sext i32 %57 to i64;eie??
;tekil
  %60 = getelementptr inbounds
     %st581_0i32_1i8*, %st581_0i32_1i8**  %58,
     i64 %59
  %61 = getelementptr inbounds
    %st581_0i32_1i8*, %st581_0i32_1i8** %60,
    i64 0; konum alınıyor
; Dizi erişim
; Dizi erişim Kök
  %62 = load i32, i32* %7, align 4, !dbg !145; 1:0
  %63 = load %st581_0i32_1i8**, %st581_0i32_1i8*** %5, align 8, !dbg !146; 3:0
  %64 = sext i32 %62 to i64;eie??
;tekil
  %65 = getelementptr inbounds
     %st581_0i32_1i8*, %st581_0i32_1i8**  %63,
     i64 %64
  %66 = getelementptr inbounds
    %st581_0i32_1i8*, %st581_0i32_1i8** %65,
    i64 0; konum alınıyor
  %67 = load %st581_0i32_1i8*, %st581_0i32_1i8** %61, align 8, !dbg !147; 2:0
  %68 = alloca %st581_0i32_1i8*, align 8
  store 
    %st581_0i32_1i8* %67,
    %st581_0i32_1i8** %68,
    align 8, !dbg !148
  %69 = load %st581_0i32_1i8*, %st581_0i32_1i8** %66, align 8, !dbg !149; 2:0
  store 
    %st581_0i32_1i8* %69,
    %st581_0i32_1i8** %61,
    align 8, !dbg !150
  %70 = load %st581_0i32_1i8*, %st581_0i32_1i8** %68, align 8, !dbg !151; 2:0
  store 
    %st581_0i32_1i8* %70,
    %st581_0i32_1i8** %66,
    align 8, !dbg !152
...
@"çizelge::quickSort_ox139i"(%st581_0i32_1i8** %0, i32 %1, i32 %2)#0       !dbg !154 {
; Değişken : Girdi
  %4 = alloca %st581_0i32_1i8**, align 8
  store %st581_0i32_1i8** %0, %st581_0i32_1i8*** %4, align 8
  call void @llvm.dbg.declare(metadata %st581_0i32_1i8*** %4, metadata !157, metadata !DIExpression()), !dbg !162
; Değişken : dip
  %5 = alloca i32, align 4
  store i32 %1, i32* %5, align 4
...
egera.beden.ox0:
;;-> (nil) 0
  %11 = load %st581_0i32_1i8**, %st581_0i32_1i8*** %4, align 8, !dbg !169; 3:0
;;-> (nil) 0
...
;;-> (nil) 0
  %16 = load %st581_0i32_1i8**, %st581_0i32_1i8*** %4, align 8, !dbg !176; 3:0
;;-> (nil) 0
...
; Ikiz işlem '-'
  ...
  call void @"çizelge::quickSort_ox139i"(
      ...
      i32 %19), !dbg !179
;;-> (nil) 0
  %20 = load %st581_0i32_1i8**, %st581_0i32_1i8*** %4, align 8, !dbg !180; 3:0
; Ikiz işlem '+'
