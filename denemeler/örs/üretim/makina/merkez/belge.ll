...
source_filename = "/home/moseschrist/Merkez/Işler/Örs/denemeler/örs/üretim/makina/merkez/belge.ll"
...
define dso_local i32 @"belge_baytlar_Yap\C4\B1land\C4\B1r_i"(%gt12ct* %0, i8* %1) !dbg !31 {
; Değişken : dönüş:3
...
; Değişken : öz:4
  ...
  call void @llvm.dbg.declare(metadata  %gt12ct** %4, metadata !35, metadata !DIExpression()), !dbg !41
; Değişken : _konum:5
  %5 = alloca i8*, align 8
...
; Değer 'stat'
  %19 = alloca %gt190t, align 8
  %20 = bitcast %gt190t* %19 to i8*
  call void @llvm.memset.p0i8.i64(
    i8* align 8 %20, 
    i8 0, 
    i64 144, 
    i1 false)
  call void @llvm.dbg.declare(metadata  %gt190t* %19, metadata !91, metadata !DIExpression()), !dbg !92
; Eğer ardılsız:
  br label %egera.ox4
egera.ox4:
; Karşılaştırma
...
egera.son.ox4:
; Atama ifadesi
  %29 = load %gt12ct*, %gt12ct** %4, align 8, !dbg !99; 2:0
...
; tür konumu *örs::merkez::c::sys::stat_t : *örs::merkez::c::sys::off_t
  ...
  store 
    ...
    align 8, !dbg !103
; Atama ifadesi
  %34 = load %gt12ct*, %gt12ct** %4, align 8, !dbg !104; 2:0
; tür konumu *örs::merkez::belge::baytlar : *t8
  %35 = getelementptr inbounds 
    %gt12ct, %gt12ct* %34,
    i32 0, i32 1
  %36 = load %gt12ct*, %gt12ct** %4, align 8, !dbg !106; 2:0
; tür konumu *örs::merkez::belge::baytlar : *t64
...
; Temiz i64 1: 'i8'
  ...
  store 
    ...
    align 8, !dbg !109
; Atama ifadesi
  %41 = load %gt12ct*, %gt12ct** %4, align 8, !dbg !110; 2:0
; tür konumu *örs::merkez::belge::baytlar : *t8
  ...
  %45 = load %gt12ct*, %gt12ct** %4, align 8, !dbg !115; 2:0
; tür konumu *örs::merkez::belge::baytlar : *t8
  %46 = getelementptr inbounds 
    %gt12ct, %gt12ct* %45,
    i32 0, i32 1
  %47 = load i8*, i8** %46, align 8, !dbg !117; 2:0
  %48 = load %gt12ct*, %gt12ct** %4, align 8, !dbg !118; 2:0
; tür konumu *örs::merkez::belge::baytlar : *t64
  ...
  %51 = call i64 (i32,i8*,i64) @read (
      ...
      i64 %50), !dbg !121
; Atama ifadesi
  %52 = load %gt12ct*, %gt12ct** %4, align 8, !dbg !122; 2:0
; tür konumu *örs::merkez::belge::baytlar : *t8
...
; dizi erişim2 Dizi
; Ikiz işlem '-'
  %55 = load %gt12ct*, %gt12ct** %4, align 8, !dbg !125; 2:0
; tür konumu *örs::merkez::belge::baytlar : *t64
...
define dso_local i64 @"belge_baytlar_Yazd\C4\B1r_i"(%gt12ct* %0) !dbg !132 {
; Değişken : dönüş:2
  %2 = alloca i64, align 8
  store i64 0, i64* %2, align 8 ; 0 
; Değişken : öz:3
  %3 = alloca %gt12ct*, align 8
  store %gt12ct* %0, %gt12ct** %3, align 8
  call void @llvm.dbg.declare(metadata  %gt12ct** %3, metadata !135, metadata !DIExpression()), !dbg !139
  %4 = load %gt12ct*, %gt12ct** %3, align 8, !dbg !141; 2:0
; tür konumu *örs::merkez::belge::baytlar : *t8
  %5 = getelementptr inbounds 
    %gt12ct, %gt12ct* %4,
    i32 0, i32 1
  %6 = load i8*, i8** %5, align 8, !dbg !143; 2:0
  %7 = load %gt12ct*, %gt12ct** %3, align 8, !dbg !144; 2:0
; tür konumu *örs::merkez::belge::baytlar : *t64
...
define dso_local i32 @belge_baytlar_Temizle_i(%gt12ct* %0) !dbg !149 {
; Değişken : dönüş:2
...
; Değişken : öz:3
  %3 = alloca %gt12ct*, align 8
  store %gt12ct* %0, %gt12ct** %3, align 8
  call void @llvm.dbg.declare(metadata  %gt12ct** %3, metadata !152, metadata !DIExpression()), !dbg !156
; Sil : 
  %4 = load %gt12ct*, %gt12ct** %3, align 8, !dbg !158; 2:0
; tür konumu *örs::merkez::belge::baytlar : *t8
  %5 = getelementptr inbounds 
    %gt12ct, %gt12ct* %4,
    i32 0, i32 1
...
; Iç Dönüş :
  %8 = load i32, i32* %2, align 4, !dbg !161; 1:0
  ret i32 %8
}
...
!32 = !DIFile(
  filename: "/home/moseschrist/Merkez/I\C5\9Fler/\C3\96rs/denemeler/\C3\B6rs/kaynak/merkez/belge/baytlar.ors",
  directory: "/home/moseschrist/Merkez/I\C5\9Fler/\C3\96rs/denemeler/\C3\B6rs/kaynak")
...
!39 = !{null, !34, !36 }
!31 = distinct !DISubprogram( name: "belge_baytlar_Yap\C4\B1land\C4\B1r_i",
 scope: !30,
 file: !32,
 line: 10,
...
!137 = !{null, !134 }
!132 = distinct !DISubprogram( name: "belge_baytlar_Yazd\C4\B1r_i",
 scope: !30,
 file: !32,
 line: 39,
