...
@stderr = external global  %gt444t**, align 8
@stdin = external global  %gt444t**, align 8
; Genel:
...
;örs::merkez::c::stdio::fscanf
  declare i32 @fscanf(%gt444t*, i8*, ...) #0
