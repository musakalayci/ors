...
@stderr = external global  %gt1b6t**, align 8
@stdin = external global  %gt1b6t**, align 8
; Genel:
...
;örs::merkez::c::stdio::fscanf
  declare i32 @fscanf(%gt1b6t*, i8*, ...) #0
